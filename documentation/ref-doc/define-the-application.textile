...
h2(#Use_Case_Diagram). Capture the use cases
...
h2(#Package_Diagram). Define the package system structure
...
h2(#Component_Diagram). Define the components
...
h3(#Manage_relationships). Manage relationships
...
h2(#Composite_Structure_Diagram). Define the system interfaces
...
h2(#Deployment_Diagram). Define the system environment
...
h3(#Profile_Diagram). Define extensions
...
Another solution is to *right_click* on a model element in the Model Explorer and select the menu _New Representation > Profile Diagram_.
...
h3(#Manage_profiles_and_stereotypes). Manage profiles and stereotypes
