...
_The documentation is build manually but in the future all this will be done automatically by the continuous integration build._
...
To update the online web-site, just copy/paste manually the sontent of the _site folder to the gh-pages branch on your repo. Commit and push the new version of the web-site.
