	...
	public void modify(Object element, String property, Object value) {
		...
		case 1: // NAVIGABLE_COLUMN
			if (associationEnd.isNavigable()) {
				memberEndsTable.getReferencesTableListener()
						.handleUncheckNavigableEnds(associationEnd);
			} else {
				memberEndsTable.getReferencesTableListener()
						.handleCheckNavigableEnds(associationEnd);
			}
			break;
		case 2: // OWNED_COLUMN
			if (associationEnd.eContainer() instanceof Association) {
				memberEndsTable.getReferencesTableListener()
						.handleUncheckOwnedEnds(associationEnd);
			} else {
				memberEndsTable.getReferencesTableListener()
						.handleCheckOwnedEnds(associationEnd);
			}
		default:
		}
	}
