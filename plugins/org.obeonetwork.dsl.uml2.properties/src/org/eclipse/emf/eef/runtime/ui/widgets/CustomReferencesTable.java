 ...
 * @see ReferencesTable
 */
public class CustomReferencesTable implements IPropertiesFilteredWidget {
	 ...
	 */
	public CustomReferencesTable(String labeltoDisplay,
	...
	/**
	 * Disable all buttons (Hide Add, Remove and Up and Down buttons)
	 */
