 ...
 */
public class ProfilesPropertiesEditionPartForm extends CustomSectionPropertiesEditingPart implements IFormPropertiesEditionPart, ProfilesPropertiesEditionPart {
     ...
     */
    public ProfilesPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
    ...
    protected Composite createAppliedProfilesReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.appliedProfiles = new ReferencesTable(getDescription(CustomUmlViewsRepository.Profiles.appliedProfiles, CustomUmlMessages.ProfilesPropertiesEditionPart_AppliedProfilesLabel),
        ...
        this.appliedProfiles.setHelpText(propertiesEditionComponent.getHelpContent(CustomUmlViewsRepository.Profiles.appliedProfiles, UmlViewsRepository.FORM_KIND));
        ...
        this.appliedProfiles.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProfilesPropertiesEditionPartForm.this, CustomUmlViewsRepository.Profiles.appliedProfiles,
    ...
    protected void addAppliedProfiles() {
        TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(appliedProfiles.getInput(), appliedProfilesFilters, appliedProfilesBusinessFilters, "appliedProfiles",
