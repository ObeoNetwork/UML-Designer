...
public class UmlPropertiesEditionProvider extends PropertiesEditingProviderImpl {
     ...
     */
    public UmlPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof NamedElement) && (UMLPackage.Literals.NAMED_ELEMENT == editingContext.getEObject().eClass());
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part) {
        if (editingContext.getEObject() instanceof org.eclipse.uml2.uml.Package) {
            if (PackageProfilesPropertiesEditionComponent.PROFILES_PART.equals(part))
                return new PackageProfilesPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }

        if (editingContext.getEObject() instanceof NamedElement) {
            if (NamedElementStereotypesPropertiesEditionComponent.STEREOTYPES_PART.equals(part))
                return new NamedElementStereotypesPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (NamedElementRelationshipsPropertiesEditionComponent.RELATIONSHIPS_PART.equals(part))
                return new NamedElementRelationshipsPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (StereotypeApplicationsPropertiesEditionComponent.STEREOTYPE_APPLICATIONS_PART.equals(part))
                return new StereotypeApplicationsPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }

        if (editingContext.getEObject() instanceof Element) {
            if (ElementDocumentationPropertiesEditionComponent.DOCUMENTATION_PART.equals(part))
                return new ElementDocumentationPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        ...
        if (editingContext.getEObject() instanceof NamedElement) {
            if (NamedElementStereotypesPropertiesEditionComponent.STEREOTYPES_PART.equals(part) && refinement == NamedElementStereotypesPropertiesEditionComponent.class)
                return new NamedElementStereotypesPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
    ...
    public static class EditionFilter implements IFilter {
        ...
        public boolean select(Object toTest) {
            ...
            return (eObj != null && UMLPackage.Literals.NAMED_ELEMENT == eObj.eClass()) || (eObj != null && UMLPackage.Literals.ELEMENT == eObj.eClass());
        }
