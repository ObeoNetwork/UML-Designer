 ...
 */
public class StereotypeApplicationsPropertiesEditionComponent extends
	 ...
	 * Default constructor
	 */
	public StereotypeApplicationsPropertiesEditionComponent(
	...
	public void initPart(Object key, int kind, EObject elt,
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(CustomUmlViewsRepository.StereotypeApplications.stereotypeApplications)) {
				stereotypeApplicationsSettings = new OperationsTableSettings(
						semanticObject, this);
				
				stereotypesPart
						.initStereotypeApplications((OperationsTableSettings) stereotypeApplicationsSettings);
			}
			// init filters
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (CustomUmlViewsRepository.StereotypeApplications.stereotypeApplications == event
				.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.EDIT) {								
				StereotypeApplicationProperty element = (StereotypeApplicationProperty) newValue;
				
				// TODO get the related stereotype application (EObject) as element
	...
	public class SAPropertyContext extends EObjectPropertiesEditionContext {
		 ...
		 * @param property
		 */
		public SAPropertyContext(PropertiesEditingContext parentContext,
				IPropertiesEditionComponent propertiesEditionComponent,
				EObject eObject, AdapterFactory adapterFactory, StereotypeApplicationProperty property) {
