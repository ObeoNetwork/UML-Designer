 ...
 */
public class RelationshipsPropertiesEditionPartForm extends CustomSectionPropertiesEditingPart implements IFormPropertiesEditionPart, RelationshipsPropertiesEditionPart {
     ...
     */
    public RelationshipsPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence relationshipsStep = new BindingCompositionSequence(propertiesEditionComponent);
        relationshipsStep.addStep(CustomUmlViewsRepository.Relationships.relationshipsOriginating);
        relationshipsStep.addStep(CustomUmlViewsRepository.Relationships.relationshipsTargeting);
        ...
        composer = new PartComposer(relationshipsStep) {
            ...
            public Composite addToPart(Composite parent, Object key) {
                if (key == CustomUmlViewsRepository.Relationships.relationshipsOriginating) {
                    return createRelationshipsReferencesTable(widgetFactory, parent);
                }
                if (key == CustomUmlViewsRepository.Relationships.relationshipsTargeting) {
                    return createRelationshipsTargetingReferencesTable(widgetFactory, parent);
                }
                return parent;
            }
        };
    ...
    protected Composite createRelationshipsReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.relationshipsOriginating = new CustomReferencesTable(getDescription(CustomUmlViewsRepository.Relationships.relationshipsOriginating,
                CustomUmlMessages.RelationshipsPropertiesEditionPart_RelationshipsOriginatingLabel), new ReferencesTableListener() {
            ...
            public void handleMove(EObject element, int oldIndex, int newIndex) {
                moveRelationshipsOriginating(element, oldIndex, newIndex);
            }
                ...
                return new AdapterFactoryLabelProvider(adapterFactory) {
                    ...
                    public String getColumnText(Object object, int columnIndex) {
                        if (object instanceof Relationship) {
                            ...
                            if (columnIndex == tableColumnService.indexOf(TableColumnName.OTHER_RELATED_ELEMENTS)) {
                                return labelService.caseOtherRelatedElements(relationships);
                            }
                        }
                        return "";
                    }
        ...
        this.relationshipsOriginating.setHelpText(propertiesEditionComponent.getHelpContent(CustomUmlViewsRepository.Relationships.relationshipsOriginating, UmlViewsRepository.FORM_KIND));
        this.relationshipsOriginating.createControls(parent, widgetFactory);
        this.relationshipsOriginating.addSelectionListener(new SelectionAdapter() {

            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RelationshipsPropertiesEditionPartForm.this,
                            CustomUmlViewsRepository.Relationships.relationshipsOriginating, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
        ...
        relationshipsOriginating.setID(CustomUmlViewsRepository.Relationships.relationshipsOriginating);
        ...
        tableColumnService.createMediumColumn(table, TableColumnName.OTHER_RELATED_ELEMENTS);
        // End of user code
        return parent;
    }

    protected void addRelationshipsOriginating() {
        TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(relationshipsOriginating.getInput(), relationshipsOriginatingFilters, relationshipsOriginatingBusinessFilters,
                "relationshipsOriginating", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
            @Override
            public void process(IStructuredSelection selection) {
                for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
                    EObject elem = (EObject) iter.next();
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RelationshipsPropertiesEditionPartForm.this,
                            CustomUmlViewsRepository.Relationships.relationshipsOriginating, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
                }
    ...
    protected void moveRelationshipsOriginating(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RelationshipsPropertiesEditionPartForm.this, CustomUmlViewsRepository.Relationships.relationshipsOriginating,
    ...
    protected Composite createRelationshipsTargetingReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.relationshipsTargeting = new CustomReferencesTable(getDescription(CustomUmlViewsRepository.Relationships.relationshipsTargeting,
                CustomUmlMessages.RelationshipsPropertiesEditionPart_RelationshipsTargetingLabel), new ReferencesTableListener() {
            public void handleAdd() {
        ...
        this.relationshipsTargeting.setHelpText(propertiesEditionComponent.getHelpContent(CustomUmlViewsRepository.Relationships.relationshipsTargeting, UmlViewsRepository.FORM_KIND));
        this.relationshipsTargeting.createControls(parent, widgetFactory);
        this.relationshipsTargeting.addSelectionListener(new SelectionAdapter() {

            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RelationshipsPropertiesEditionPartForm.this,
                            CustomUmlViewsRepository.Relationships.relationshipsTargeting, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }

        });
        GridData relationshipsTargetingData = new GridData(GridData.FILL_HORIZONTAL);
        ...
        relationshipsTargeting.setID(CustomUmlViewsRepository.Relationships.relationshipsTargeting);
    ...
    protected void addRelationshipsTargeting() {
        TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(relationshipsTargeting.getInput(), relationshipsTargetingFilters, relationshipsTargetingBusinessFilters,
                "relationshipsTargeting", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
            @Override
            public void process(IStructuredSelection selection) {
                for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
                    EObject elem = (EObject) iter.next();
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RelationshipsPropertiesEditionPartForm.this,
                            CustomUmlViewsRepository.Relationships.relationshipsTargeting, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
                }
    ...
    protected void moveRelationshipsTargeting(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RelationshipsPropertiesEditionPartForm.this, CustomUmlViewsRepository.Relationships.relationshipsTargeting,
                PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
        relationshipsTargeting.refresh();
    }
    ...
    public boolean isContainedInRelationshipsOriginatingTable(EObject element) {
        return ((ReferencesTableSettings) relationshipsOriginating.getInput()).contains(element);
    }
    ...
    public boolean isContainedInRelationshipsTargetingTable(EObject element) {
        return ((ReferencesTableSettings) relationshipsTargeting.getInput()).contains(element);
    }
    ...
    public void initRelationshipsOriginating(OperationsTableSettings settings) {
        ...
        if (eefElementEditorReadOnlyState && relationshipsOriginating.getTable().isEnabled()) {
            relationshipsOriginating.setEnabled(false);
            relationshipsOriginating.setToolTipText(CustomUmlMessages.Relationships_ReadOnly);
        } else if (!eefElementEditorReadOnlyState && !relationshipsOriginating.getTable().isEnabled()) {
    ...
    public void initRelationshipsTargeting(OperationsTableSettings settings) {
        ...
        if (eefElementEditorReadOnlyState && relationshipsTargeting.getTable().isEnabled()) {
            relationshipsTargeting.setEnabled(false);
            relationshipsTargeting.setToolTipText(CustomUmlMessages.Relationships_ReadOnly);
        } else if (!eefElementEditorReadOnlyState && !relationshipsTargeting.getTable().isEnabled()) {
    ...
    public String getDescription(Object editor, String alternate) {
        if (editor.equals(CustomUmlViewsRepository.Relationships.relationshipsOriginating))
