 ...
 */
public class EndsCustomPropertiesEditionPartForm extends
		EndsPropertiesEditionPartForm {
	...
	@Override
	protected Composite createEndsTableComposition(FormToolkit widgetFactory,
			Composite parent) {
		this.ends = new ReferencesTable(getDescription(
				UmlViewsRepository.Ends.ends_,
				UmlMessages.EndsPropertiesEditionPart_EndsLabel),
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent
								.firePropertiesChanged(new PropertiesEditionEvent(
										EndsCustomPropertiesEditionPartForm.this,
										UmlViewsRepository.Ends.ends_,
		...
		this.ends.setHelpText(propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.Ends.ends_, UmlViewsRepository.FORM_KIND));
