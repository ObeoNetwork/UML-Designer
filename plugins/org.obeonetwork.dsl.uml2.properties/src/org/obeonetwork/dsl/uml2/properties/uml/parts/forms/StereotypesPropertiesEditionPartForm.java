 ...
 */
public class StereotypesPropertiesEditionPartForm extends CustomSectionPropertiesEditingPart implements IFormPropertiesEditionPart, StereotypesPropertiesEditionPart {
     ...
     */
    public StereotypesPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        stereotypesStep.addStep(CustomUmlViewsRepository.Stereotypes.appliedStereotypes);
        ...
        composer = new PartComposer(stereotypesStep) {
            ...
            public Composite addToPart(Composite parent, Object key) {
                if (key == CustomUmlViewsRepository.Stereotypes.appliedStereotypes) {
                    return createAppliedStereotypesReferencesTable(widgetFactory, parent);
                }
                return parent;
            }
        };
    ...
    protected Composite createAppliedStereotypesReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.appliedStereotypes = new ReferencesTable(getDescription(CustomUmlViewsRepository.Stereotypes.appliedStereotypes,
                CustomUmlMessages.StereotypesPropertiesEditionPart_AppliedStereotypesLabel), new ReferencesTableListener() {
                ...
                return new AdapterFactoryLabelProvider(adapterFactory) {
                    ...
                    public String getColumnText(Object object, int columnIndex) {
                        if (object instanceof Stereotype) {
                            ...
                            if (columnIndex == tableColumnService.indexOf(TableColumnName.REQUIRED)) {
        ...
        this.appliedStereotypes.setHelpText(propertiesEditionComponent.getHelpContent(CustomUmlViewsRepository.Stereotypes.appliedStereotypes, UmlViewsRepository.FORM_KIND));
        ...
        this.appliedStereotypes.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StereotypesPropertiesEditionPartForm.this, CustomUmlViewsRepository.Stereotypes.appliedStereotypes,
        ...
        appliedStereotypes.setID(CustomUmlViewsRepository.Stereotypes.appliedStereotypes);
    ...
    protected void addAppliedStereotypes() {
        TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(appliedStereotypes.getInput(), appliedStereotypesFilters, appliedStereotypesBusinessFilters, "appliedStereotypes",
    ...
    protected void moveAppliedStereotypes(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StereotypesPropertiesEditionPartForm.this, CustomUmlViewsRepository.Stereotypes.appliedStereotypes,
    ...
    public boolean isContainedInAppliedStereotypesTable(EObject element) {
        return ((ReferencesTableSettings) appliedStereotypes.getInput()).contains(element);
    }
    ...
    public void initAppliedStereotypes(OperationsTableSettings settings) {
        ...
        if (eefElementEditorReadOnlyState && appliedStereotypes.isEnabled()) {
            ...
            appliedStereotypes.setToolTipText(CustomUmlMessages.Stereotypes_ReadOnly);
        } else if (!eefElementEditorReadOnlyState && !appliedStereotypes.isEnabled()) {
