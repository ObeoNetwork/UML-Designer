...
public class GeneralCustomPropertiesEditionPartForm extends
	...
	@Override
	protected Composite createMemberEndReferencesTable(
			FormToolkit widgetFactory, Composite parent) {
		this.memberEnd = new MemberEndsTable(getDescription(
				UmlViewsRepository.General.memberEnd,
				UmlMessages.GeneralPropertiesEditionPart_MemberEndLabel),
				new MemberEndsTableListener() {
					...
					public void handleUncheckNavigableEnds(EObject element) {
						addToOwnedEnds(
								element,
								CustomUmlViewsRepository.General.memberEndNavigable,
								true);
					}
					...
					public void handleCheckOwnedEnds(EObject element) {
						addToOwnedEnds(
								element,
								CustomUmlViewsRepository.General.memberEndOwned,
								false);
					}
			...
			public AdapterFactoryLabelProvider getLabelProvider() {
				return new AdapterFactoryLabelProvider(adapterFactory) {
					...
					public String getColumnText(Object object, int columnIndex) {
						...
						if (object instanceof Property) {
							...
							if (columnIndex == tableColumnService
									.indexOf(TableColumnName.PROPERTY)) {
								return labelService.caseProperty(property);
							}
							if (columnIndex == tableColumnService
									.indexOf(TableColumnName.NAVIGABILITY)) {
								return "";
							}
							if (columnIndex == tableColumnService
									.indexOf(TableColumnName.OWNED)) {
								return "";
							}
						}
					...
					public Image getColumnImage(Object object, int columnIndex) {
						...
						if (columnIndex == tableColumnService
								.indexOf(TableColumnName.NAVIGABILITY)) {
							return CheckboxUtils.getCheckboxImage(labelService
									.caseNavigability(object));
						}
						if (columnIndex == tableColumnService
								.indexOf(TableColumnName.OWNED)) {
							return CheckboxUtils.getCheckboxImage(labelService
		...
		this.memberEnd.setHelpText(propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.memberEnd,
				...
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									GeneralCustomPropertiesEditionPartForm.this,
									UmlViewsRepository.General.memberEnd,
	...
	private void addToNavigableOwnedEnds(EObject element) {
		propertiesEditionComponent
				.firePropertiesChanged(new PropertiesEditionEvent(
						...
						PropertiesEditionEvent.EDIT, false, element));
		memberEnd.refresh();
	}
	 ...
	 *            Property
	 */
	private void addToOwnedEnds(EObject element, String memberEndKind,
			boolean wasOwned) {
		propertiesEditionComponent
				.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralCustomPropertiesEditionPartForm.this,
						memberEndKind, PropertiesEditionEvent.COMMIT,
