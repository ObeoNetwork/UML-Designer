 ...
 */
public class StereotypeApplicationsPropertiesEditionPartForm extends CustomSectionPropertiesEditingPart implements IFormPropertiesEditionPart, StereotypeApplicationsPropertiesEditionPart {
     ...
     */
    public StereotypeApplicationsPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence stereotypesStep = new BindingCompositionSequence(propertiesEditionComponent);
        stereotypesStep.addStep(CustomUmlViewsRepository.StereotypeApplications.stereotypeApplications);
        ...
        composer = new PartComposer(stereotypesStep) {
            ...
            public Composite addToPart(Composite parent, Object key) {
                if (key == CustomUmlViewsRepository.StereotypeApplications.stereotypeApplications) {
                    return createStereotypeApplicationsReferencesTable(widgetFactory, parent);
                }
                return parent;
            }
        };
     ...
     * @return
     */
    protected Composite createStereotypeApplicationsReferencesTable(FormToolkit widgetFactory, Composite parent) {
        ...
        this.stereotypeApplications = new ReferencesTable(getDescription(CustomUmlViewsRepository.StereotypeApplications.stereotypeApplications,
                CustomUmlMessages.StereotypeApplicationsPropertiesEditionPart_StereotypeApplicationsLabel), referencesTableListener) {
                ...
                return new AdapterFactoryLabelProvider(adapterFactory) {
                    ...
                    public String getColumnText(Object object, int columnIndex) {
                        ...
                        if (object instanceof StereotypeApplicationProperty) {
                            ...
                            if (columnIndex == tableColumnService.indexOf(TableColumnName.STEREOTYPE)) {
                                return labelService.caseStereotype(property.getStereotype());
                            }
                            if (columnIndex == tableColumnService.indexOf(TableColumnName.ESTRUCTURAL_FEATURE)) {
                                return labelService.caseEStructuralFeature(property.getFeature());
                            }
                            if (columnIndex == tableColumnService.indexOf(TableColumnName.VALUE)) {
        ...
        this.stereotypeApplications.setHelpText(propertiesEditionComponent.getHelpContent(CustomUmlViewsRepository.StereotypeApplications.stereotypeApplications, UmlViewsRepository.FORM_KIND));
        this.stereotypeApplications.createControls(parent, widgetFactory);
        this.stereotypeApplications.addSelectionListener(new SelectionAdapter() {

            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StereotypeApplicationsPropertiesEditionPartForm.this,
                            CustomUmlViewsRepository.StereotypeApplications.stereotypeApplications, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
        ...
        stereotypeApplications.setID(CustomUmlViewsRepository.StereotypeApplications.stereotypeApplications);
        ...
        tableColumnService.createMediumColumn(table, TableColumnName.ESTRUCTURAL_FEATURE);
    ...
    protected void editStereotypeApplication(Object element) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StereotypeApplicationsPropertiesEditionPartForm.this,
                CustomUmlViewsRepository.StereotypeApplications.stereotypeApplications, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
    ...
    public void initStereotypeApplications(OperationsTableSettings settings) {
        ...
        if (eefElementEditorReadOnlyState && stereotypeApplications.isEnabled()) {
            ...
            stereotypeApplications.setToolTipText(CustomUmlMessages.Stereotypes_ReadOnly);
        } else if (!eefElementEditorReadOnlyState && !stereotypeApplications.isEnabled()) {
