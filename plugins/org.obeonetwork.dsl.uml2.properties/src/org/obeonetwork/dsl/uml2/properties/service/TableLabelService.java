...
public class TableLabelService {
    ...
    public enum TableColumnName {
        NAME("Name"), TYPE("Type"), DEFAULT_VALUE("Default value"), VISIBILITY("Visibility"), IS_STATIC("Static"), MULTIPLICITY("Multiplicity"), IS_ABSTRACT("Abstract"), PARAMETERS("Parameters"), DIRECTION(
                "Direction"), STEREOTYPE("Stereotype"), PROFILE("Profile"), REQUIRED("Required"), OTHER_RELATED_ELEMENTS("Other Related Element(s)"), ROLE("Role"), PROPERTY("Property"), NAVIGABILITY(
    ...
    public String caseStereotypeApplicationPropertyValue(StereotypeApplicationProperty property, AdapterFactoryLabelProvider factory) {
        ...
        if (adapterFactory instanceof ComposedAdapterFactory) {
            ((ComposedAdapterFactory) adapterFactory).addAdapterFactory(new UMLResourceItemProviderAdapterFactory());
            ((ComposedAdapterFactory) adapterFactory).addAdapterFactory(new UMLItemProviderAdapterFactory());
            ((ComposedAdapterFactory) adapterFactory).addAdapterFactory(new EcoreItemProviderAdapterFactory());
            ((ComposedAdapterFactory) adapterFactory).addAdapterFactory(new UMLReflectiveItemProviderAdapterFactory());
        }
        IItemLabelProvider itemProvider = (IItemLabelProvider) adapterFactory.adapt(property.getValue(), IItemLabelProvider.class);
    ...
    public String caseName(Object object) {
        if (object instanceof Element) {
            String label = PropertiesViewUtils.computeUmlLabel((Element) object);
    ...
    public String caseOtherRelatedElements(Object object) {
        if (object instanceof Relationship) {
            ...
            for (int i = 0; i < elementsWithoutSource.size(); i++) {
                ...
                result.append(PropertiesViewUtils.computeUmlLabel(element));
