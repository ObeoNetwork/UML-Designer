    ...
    public boolean select(Object toTest) {
        ...
        return eObj != null
                && (eObj instanceof org.eclipse.uml2.uml.Package || eObj instanceof Class || eObj instanceof Interface || eObj instanceof DataType || eObj instanceof PrimitiveType
                        ...
                        || eObj instanceof Association || eObj instanceof Connector || eObj instanceof Dependency || eObj instanceof Deployment || eObj instanceof EnumerationLiteral
                        || eObj instanceof Extension || eObj instanceof InterfaceRealization || eObj instanceof Transition || eObj instanceof Usage || eObj instanceof Actor
                        || eObj instanceof Artifact || eObj instanceof CallOperationAction || eObj instanceof Collaboration || eObj instanceof ActivityEdge || eObj instanceof DataStoreNode
                        || eObj instanceof ControlNode || eObj instanceof Extend || eObj instanceof FinalState || eObj instanceof Include || eObj instanceof Pin || eObj instanceof OpaqueAction
