 ...
 */
public class AttributesCustomPropertiesEditionPartForm extends
		AttributesPropertiesEditionPartForm {
	...
	@Override
	protected Composite createAttributesTableComposition(
			FormToolkit widgetFactory, Composite parent) {
		this.attributes = new ReferencesTable(getDescription(
				UmlViewsRepository.Attributes.attributes_,
				UmlMessages.AttributesPropertiesEditionPart_AttributesLabel),
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent
								.firePropertiesChanged(new PropertiesEditionEvent(
										AttributesCustomPropertiesEditionPartForm.this,
										UmlViewsRepository.Attributes.attributes_,
				...
				return new AdapterFactoryLabelProvider(adapterFactory) {
					...
					public String getColumnText(Object object, int columnIndex) {
						...
						if (object instanceof Property) {
							...
							if (columnIndex == tableColumnService
									.indexOf(TableColumnName.DEFAULT_VALUE)) {
							...
							if (columnIndex == tableColumnService
									.indexOf(TableColumnName.MULTIPLICITY)) {
		...
		this.attributes.setHelpText(propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.Attributes.attributes_,
		...
		tableColumnService
				.createMediumColumn(table, TableColumnName.DEFAULT_VALUE);
