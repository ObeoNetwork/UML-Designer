...
import org.eclipse.uml2.uml.parts.Class_PropertiesEditionPart;
...
public class Class_PropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, Class_PropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.Class_PropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Class_.Properties.name, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.Class_PropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Class_.Properties.visibility, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createOwningTemplateParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.Class_PropertiesEditionPart_OwningTemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Class_.Properties.owningTemplateParameter, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createTemplateParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.Class_PropertiesEditionPart_TemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Class_.Properties.templateParameter, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createRepresentationFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.Class_PropertiesEditionPart_RepresentationLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Class_.Properties.representation, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createClassifierBehaviorFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.Class_PropertiesEditionPart_ClassifierBehaviorLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Class_.Properties.classifierBehavior, UmlViewsRepository.FORM_KIND));
