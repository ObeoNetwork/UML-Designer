...
public class GeneralOrderingPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, GeneralOrderingPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.GeneralOrderingPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.GeneralOrdering.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.GeneralOrderingPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.GeneralOrdering.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createBeforeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.GeneralOrderingPropertiesEditionPart_BeforeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.GeneralOrdering.Properties.before, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createAfterFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.GeneralOrderingPropertiesEditionPart_AfterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.GeneralOrdering.Properties.after, UmlViewsRepository.SWT_KIND));
