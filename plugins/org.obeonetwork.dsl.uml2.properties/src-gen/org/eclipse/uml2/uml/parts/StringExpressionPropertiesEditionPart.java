...
public interface StringExpressionPropertiesEditionPart {
	...
	/**
	 * @return the owningExpression
	 * 
	 */
	public EObject getOwningExpression();

	/**
	 * Init the owningExpression
	 * @param settings the combo setting
	 */
	public void initOwningExpression(EObjectFlatComboSettings settings);

	/**
	 * Defines a new owningExpression
	 * @param newValue the new owningExpression to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the owningExpression edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
