...
import org.eclipse.uml2.uml.parts.GeneralizationSetPropertiesEditionPart;
...
public class GeneralizationSetPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, GeneralizationSetPropertiesEditionPart {
		...
		composer = new PartComposer(generalizationSetStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == UmlViewsRepository.GeneralizationSet.Properties.isCovering) {
					return createIsCoveringCheckbox(widgetFactory, parent);
				}
				if (key == UmlViewsRepository.GeneralizationSet.Properties.isDisjoint) {
					return createIsDisjointCheckbox(widgetFactory, parent);
				}
				if (key == UmlViewsRepository.GeneralizationSet.Properties.powertype) {
					return createPowertypeFlatComboViewer(parent, widgetFactory);
				}
				if (key == UmlViewsRepository.GeneralizationSet.Properties.generalization) {
					return createGeneralizationReferencesTable(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.GeneralizationSetPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.GeneralizationSet.Properties.name, UmlViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.GeneralizationSet.Properties.name, UmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.GeneralizationSetPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.GeneralizationSet.Properties.visibility, UmlViewsRepository.FORM_KIND));
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.visibility, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVisibility()));
			}

		});
		visibility.setID(UmlViewsRepository.GeneralizationSet.Properties.visibility);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.GeneralizationSet.Properties.visibility, UmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.GeneralizationSet.Properties.clientDependency, UmlViewsRepository.FORM_KIND));
		this.clientDependency.createControls(parent, widgetFactory);
		this.clientDependency.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.clientDependency, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"clientDependency", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.clientDependency,
	...
	protected void moveClientDependency(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		clientDependency.refresh();
	}
	...
	protected void removeFromClientDependency(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		clientDependency.refresh();
	}
	...
	protected Composite createOwningTemplateParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.GeneralizationSetPropertiesEditionPart_OwningTemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.GeneralizationSet.Properties.owningTemplateParameter, UmlViewsRepository.FORM_KIND));
		owningTemplateParameter = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(UmlViewsRepository.GeneralizationSet.Properties.owningTemplateParameter, UmlViewsRepository.FORM_KIND));
		...
		owningTemplateParameter.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.owningTemplateParameter, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOwningTemplateParameter()));
			}

		});
		owningTemplateParameter.setID(UmlViewsRepository.GeneralizationSet.Properties.owningTemplateParameter);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.GeneralizationSet.Properties.owningTemplateParameter, UmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createTemplateParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.GeneralizationSetPropertiesEditionPart_TemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.GeneralizationSet.Properties.templateParameter, UmlViewsRepository.FORM_KIND));
		templateParameter = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(UmlViewsRepository.GeneralizationSet.Properties.templateParameter, UmlViewsRepository.FORM_KIND));
		...
		templateParameter.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.templateParameter, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTemplateParameter()));
			}

		});
		templateParameter.setID(UmlViewsRepository.GeneralizationSet.Properties.templateParameter);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.GeneralizationSet.Properties.templateParameter, UmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIsCoveringCheckbox(FormToolkit widgetFactory, Composite parent) {
		...
		isCovering.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.isCovering, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isCovering.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.GeneralizationSet.Properties.isCovering, UmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIsDisjointCheckbox(FormToolkit widgetFactory, Composite parent) {
		...
		isDisjoint.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.isDisjoint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isDisjoint.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.GeneralizationSet.Properties.isDisjoint, UmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createPowertypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.GeneralizationSetPropertiesEditionPart_PowertypeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.GeneralizationSet.Properties.powertype, UmlViewsRepository.FORM_KIND));
		powertype = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(UmlViewsRepository.GeneralizationSet.Properties.powertype, UmlViewsRepository.FORM_KIND));
		widgetFactory.adapt(powertype);
		...
		powertype.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.powertype, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPowertype()));
			}

		});
		powertype.setID(UmlViewsRepository.GeneralizationSet.Properties.powertype);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.GeneralizationSet.Properties.powertype, UmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createGeneralizationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.generalization.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.GeneralizationSet.Properties.generalization, UmlViewsRepository.FORM_KIND));
		this.generalization.createControls(parent, widgetFactory);
		this.generalization.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.generalization, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addGeneralization() {
		...
		"generalization", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.generalization,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveGeneralization(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.generalization, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		generalization.refresh();
	}
	...
	protected void removeFromGeneralization(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralizationSetPropertiesEditionPartForm.this, UmlViewsRepository.GeneralizationSet.Properties.generalization, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		generalization.refresh();
	}
