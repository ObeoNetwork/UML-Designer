...
import org.eclipse.uml2.uml.parts.ExecutionOccurrenceSpecificationPropertiesEditionPart;
 ...
 * 
 */
public class ExecutionOccurrenceSpecificationPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ExecutionOccurrenceSpecificationPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ExecutionOccurrenceSpecificationPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.name, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ExecutionOccurrenceSpecificationPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.visibility, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createEnclosingInteractionFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ExecutionOccurrenceSpecificationPropertiesEditionPart_EnclosingInteractionLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.enclosingInteraction, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createEnclosingOperandFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ExecutionOccurrenceSpecificationPropertiesEditionPart_EnclosingOperandLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.enclosingOperand, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createEventFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ExecutionOccurrenceSpecificationPropertiesEditionPart_EventLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.event, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createExecutionFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ExecutionOccurrenceSpecificationPropertiesEditionPart_ExecutionLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.execution, UmlViewsRepository.FORM_KIND));
