...
public class DurationIntervalPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DurationIntervalPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.DurationIntervalPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.DurationIntervalPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createOwningTemplateParameterFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.DurationIntervalPropertiesEditionPart_OwningTemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.owningTemplateParameter, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createTemplateParameterFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.DurationIntervalPropertiesEditionPart_TemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.templateParameter, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.DurationIntervalPropertiesEditionPart_TypeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.type, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createMinFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.DurationIntervalPropertiesEditionPart_MinLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.min, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createMaxFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.DurationIntervalPropertiesEditionPart_MaxLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.max, UmlViewsRepository.SWT_KIND));
