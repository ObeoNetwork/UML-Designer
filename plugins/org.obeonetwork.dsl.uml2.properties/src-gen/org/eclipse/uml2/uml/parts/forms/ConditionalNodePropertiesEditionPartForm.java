...
import org.eclipse.uml2.uml.parts.ConditionalNodePropertiesEditionPart;
...
public class ConditionalNodePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ConditionalNodePropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ConditionalNodePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ConditionalNode.Properties.name, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ConditionalNodePropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ConditionalNode.Properties.visibility, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(UmlMessages.ConditionalNodePropertiesEditionPart_ClientDependencyLabel, new ReferencesTableListener	() {
	...
	protected Composite createInStructuredNodeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ConditionalNodePropertiesEditionPart_InStructuredNodeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ConditionalNode.Properties.inStructuredNode, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createActivityFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ConditionalNodePropertiesEditionPart_ActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ConditionalNode.Properties.activity, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outgoing = new ReferencesTable(UmlMessages.ConditionalNodePropertiesEditionPart_OutgoingLabel, new ReferencesTableListener	() {
	...
	protected Composite createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incoming = new ReferencesTable(UmlMessages.ConditionalNodePropertiesEditionPart_IncomingLabel, new ReferencesTableListener	() {
	...
	protected Composite createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inPartition = new ReferencesTable(UmlMessages.ConditionalNodePropertiesEditionPart_InPartitionLabel, new ReferencesTableListener	() {
	...
	protected Composite createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inInterruptibleRegion = new ReferencesTable(UmlMessages.ConditionalNodePropertiesEditionPart_InInterruptibleRegionLabel, new ReferencesTableListener	() {
	...
	protected Composite createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedNode = new ReferencesTable(UmlMessages.ConditionalNodePropertiesEditionPart_RedefinedNodeLabel, new ReferencesTableListener	() {
	...
	protected Composite createInActivityFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ConditionalNodePropertiesEditionPart_InActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ConditionalNode.Properties.inActivity, UmlViewsRepository.FORM_KIND));
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.ConditionalNodePropertiesEditionPart#initVisibility(EEnum eenum, Enumerator current)
	 */
