...
public class CommunicationPathPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CommunicationPathPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CommunicationPathPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CommunicationPath.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CommunicationPathPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CommunicationPath.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsLeafCheckbox(Composite parent) {
		...
		isLeaf.setText(UmlMessages.CommunicationPathPropertiesEditionPart_IsLeafLabel);
	...
	protected Composite createOwningTemplateParameterFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CommunicationPathPropertiesEditionPart_OwningTemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CommunicationPath.Properties.owningTemplateParameter, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createTemplateParameterFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CommunicationPathPropertiesEditionPart_TemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CommunicationPath.Properties.templateParameter, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsAbstractCheckbox(Composite parent) {
		...
		isAbstract.setText(UmlMessages.CommunicationPathPropertiesEditionPart_IsAbstractLabel);
	...
	protected Composite createRepresentationFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CommunicationPathPropertiesEditionPart_RepresentationLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CommunicationPath.Properties.representation, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsDerivedCheckbox(Composite parent) {
		...
		isDerived.setText(UmlMessages.CommunicationPathPropertiesEditionPart_IsDerivedLabel);
