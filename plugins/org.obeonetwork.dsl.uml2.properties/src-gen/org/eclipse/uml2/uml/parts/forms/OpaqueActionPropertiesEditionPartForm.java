...
import org.eclipse.uml2.uml.parts.OpaqueActionPropertiesEditionPart;
 ...
 * 
 */
public class OpaqueActionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, OpaqueActionPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.OpaqueActionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.OpaqueAction.Properties.name, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.OpaqueActionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.OpaqueAction.Properties.visibility, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, UmlMessages.OpaqueActionPropertiesEditionPart_IsLeafLabel, SWT.CHECK);
	...
	protected Composite createInStructuredNodeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.OpaqueActionPropertiesEditionPart_InStructuredNodeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.OpaqueAction.Properties.inStructuredNode, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createActivityFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.OpaqueActionPropertiesEditionPart_ActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.OpaqueAction.Properties.activity, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createBodyMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editBody = widgetFactory.createButton(parent, UmlMessages.OpaqueActionPropertiesEditionPart_BodyLabel, SWT.NONE);
	...
	protected Composite createLanguageMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editLanguage = widgetFactory.createButton(parent, UmlMessages.OpaqueActionPropertiesEditionPart_LanguageLabel, SWT.NONE);
