...
public class ControlFlowPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ControlFlowPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ControlFlowPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ControlFlow.Properties.name, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ControlFlowPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ControlFlow.Properties.visibility, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createSourceFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ControlFlowPropertiesEditionPart_SourceLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ControlFlow.Properties.source, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createTargetFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ControlFlowPropertiesEditionPart_TargetLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ControlFlow.Properties.target, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createInterruptsFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ControlFlowPropertiesEditionPart_InterruptsLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ControlFlow.Properties.interrupts, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createInStructuredNodeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ControlFlowPropertiesEditionPart_InStructuredNodeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ControlFlow.Properties.inStructuredNode, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createActivityFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ControlFlowPropertiesEditionPart_ActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ControlFlow.Properties.activity, UmlViewsRepository.FORM_KIND));
