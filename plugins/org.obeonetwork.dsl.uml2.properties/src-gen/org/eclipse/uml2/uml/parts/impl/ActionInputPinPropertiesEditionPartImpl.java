...
import org.eclipse.uml2.uml.parts.ActionInputPinPropertiesEditionPart;
...
public class ActionInputPinPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ActionInputPinPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ActionInputPinPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ActionInputPin.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ActionInputPinPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ActionInputPin.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsLeafCheckbox(Composite parent) {
		...
		isLeaf.setText(UmlMessages.ActionInputPinPropertiesEditionPart_IsLeafLabel);
	...
	protected Composite createInStructuredNodeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ActionInputPinPropertiesEditionPart_InStructuredNodeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ActionInputPin.Properties.inStructuredNode, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createActivityFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ActionInputPinPropertiesEditionPart_ActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ActionInputPin.Properties.activity, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ActionInputPinPropertiesEditionPart_TypeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ActionInputPin.Properties.type, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createOrderingEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ActionInputPinPropertiesEditionPart_OrderingLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ActionInputPin.Properties.ordering, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsControlTypeCheckbox(Composite parent) {
		...
		isControlType.setText(UmlMessages.ActionInputPinPropertiesEditionPart_IsControlTypeLabel);
	...
	protected Composite createSelectionFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ActionInputPinPropertiesEditionPart_SelectionLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ActionInputPin.Properties.selection, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsOrderedCheckbox(Composite parent) {
		...
		isOrdered.setText(UmlMessages.ActionInputPinPropertiesEditionPart_IsOrderedLabel);
	...
	protected Composite createIsUniqueCheckbox(Composite parent) {
		...
		isUnique.setText(UmlMessages.ActionInputPinPropertiesEditionPart_IsUniqueLabel);
	...
	protected Composite createIsControlCheckbox(Composite parent) {
		...
		isControl.setText(UmlMessages.ActionInputPinPropertiesEditionPart_IsControlLabel);
