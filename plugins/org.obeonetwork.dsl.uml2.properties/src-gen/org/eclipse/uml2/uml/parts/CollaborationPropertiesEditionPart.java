 ...
 * 
 */
public interface CollaborationPropertiesEditionPart {
	...
	/**
	 * Init the collaborationRole
	 * @param settings settings for the collaborationRole ReferencesTable 
	 */
	public void initCollaborationRole(ReferencesTableSettings settings);

	/**
	 * Update the collaborationRole
	 * @param newValue the collaborationRole to update
	 * 
	 */
	public void updateCollaborationRole();

	/**
	 * Adds the given filter to the collaborationRole edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the collaborationRole table
	 * 
	 */
