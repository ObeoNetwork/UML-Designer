...
public class CallBehaviorActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CallBehaviorActionPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CallBehaviorActionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CallBehaviorAction.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CallBehaviorActionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CallBehaviorAction.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsLeafCheckbox(Composite parent) {
		...
		isLeaf.setText(UmlMessages.CallBehaviorActionPropertiesEditionPart_IsLeafLabel);
	...
	protected Composite createInStructuredNodeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CallBehaviorActionPropertiesEditionPart_InStructuredNodeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CallBehaviorAction.Properties.inStructuredNode, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createActivityFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CallBehaviorActionPropertiesEditionPart_ActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CallBehaviorAction.Properties.activity, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createOnPortFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CallBehaviorActionPropertiesEditionPart_OnPortLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CallBehaviorAction.Properties.onPort, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsSynchronousCheckbox(Composite parent) {
		...
		isSynchronous.setText(UmlMessages.CallBehaviorActionPropertiesEditionPart_IsSynchronousLabel);
	...
	protected Composite createBehaviorFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CallBehaviorActionPropertiesEditionPart_BehaviorLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CallBehaviorAction.Properties.behavior, UmlViewsRepository.SWT_KIND));
