...
import org.eclipse.uml2.uml.parts.ExtendPropertiesEditionPart;
 ...
 * 
 */
public class ExtendPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ExtendPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ExtendPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Extend.Properties.name, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ExtendPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Extend.Properties.visibility, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createExtendedCaseFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ExtendPropertiesEditionPart_ExtendedCaseLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Extend.Properties.extendedCase, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createExtensionFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ExtendPropertiesEditionPart_ExtensionLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Extend.Properties.extension, UmlViewsRepository.FORM_KIND));
