...
public class OperationTemplateParameterPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, OperationTemplateParameterPropertiesEditionPart {
	...
	protected Composite createSignatureFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.OperationTemplateParameterPropertiesEditionPart_SignatureLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.OperationTemplateParameter.Properties.signature, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createParameteredElementFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.OperationTemplateParameterPropertiesEditionPart_ParameteredElementLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.OperationTemplateParameter.Properties.parameteredElement, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createDefault_FlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.OperationTemplateParameterPropertiesEditionPart_Default_Label, propertiesEditionComponent.isRequired(UmlViewsRepository.OperationTemplateParameter.Properties.default_, UmlViewsRepository.SWT_KIND));
