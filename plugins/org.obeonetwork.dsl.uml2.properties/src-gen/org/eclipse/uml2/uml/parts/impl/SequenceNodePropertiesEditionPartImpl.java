...
import org.eclipse.uml2.uml.parts.SequenceNodePropertiesEditionPart;
...
public class SequenceNodePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, SequenceNodePropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.SequenceNodePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.SequenceNode.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.SequenceNodePropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.SequenceNode.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createInStructuredNodeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.SequenceNodePropertiesEditionPart_InStructuredNodeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.SequenceNode.Properties.inStructuredNode, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createActivityFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.SequenceNodePropertiesEditionPart_ActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.SequenceNode.Properties.activity, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createInActivityFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.SequenceNodePropertiesEditionPart_InActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.SequenceNode.Properties.inActivity, UmlViewsRepository.SWT_KIND));
