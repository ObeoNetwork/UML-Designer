...
import org.eclipse.uml2.uml.parts.ConnectionPointReferencePropertiesEditionPart;
...
public class ConnectionPointReferencePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ConnectionPointReferencePropertiesEditionPart {
		...
		composer = new PartComposer(connectionPointReferenceStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == UmlViewsRepository.ConnectionPointReference.Properties.entry) {
					return createEntryReferencesTable(widgetFactory, parent);
				}
				if (key == UmlViewsRepository.ConnectionPointReference.Properties.exit) {
					return createExitReferencesTable(widgetFactory, parent);
				}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ConnectionPointReferencePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ConnectionPointReference.Properties.name, UmlViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ConnectionPointReference.Properties.name, UmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ConnectionPointReferencePropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ConnectionPointReference.Properties.visibility, UmlViewsRepository.FORM_KIND));
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.visibility, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVisibility()));
			}

		});
		visibility.setID(UmlViewsRepository.ConnectionPointReference.Properties.visibility);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ConnectionPointReference.Properties.visibility, UmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.ConnectionPointReference.Properties.clientDependency, UmlViewsRepository.FORM_KIND));
		this.clientDependency.createControls(parent, widgetFactory);
		this.clientDependency.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.clientDependency, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"clientDependency", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.clientDependency,
	...
	protected void moveClientDependency(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		clientDependency.refresh();
	}
	...
	protected void removeFromClientDependency(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		clientDependency.refresh();
	}
	...
	protected Composite createContainerFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ConnectionPointReferencePropertiesEditionPart_ContainerLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ConnectionPointReference.Properties.container, UmlViewsRepository.FORM_KIND));
		container = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(UmlViewsRepository.ConnectionPointReference.Properties.container, UmlViewsRepository.FORM_KIND));
		...
		container.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.container, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getContainer()));
			}

		});
		container.setID(UmlViewsRepository.ConnectionPointReference.Properties.container);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ConnectionPointReference.Properties.container, UmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createEntryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.entry.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.ConnectionPointReference.Properties.entry, UmlViewsRepository.FORM_KIND));
		this.entry.createControls(parent, widgetFactory);
		this.entry.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.entry, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addEntry() {
		...
		"entry", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.entry,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				entry.refresh();
			}
	...
	protected void moveEntry(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.entry, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		entry.refresh();
	}
	...
	protected void removeFromEntry(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.entry, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		entry.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createExitReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.exit.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.ConnectionPointReference.Properties.exit, UmlViewsRepository.FORM_KIND));
		this.exit.createControls(parent, widgetFactory);
		this.exit.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.exit, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addExit() {
		...
		"exit", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.exit,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				exit.refresh();
			}
	...
	protected void moveExit(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.exit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		exit.refresh();
	}
	...
	protected void removeFromExit(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.exit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		exit.refresh();
	}
	...
	protected Composite createStateFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ConnectionPointReferencePropertiesEditionPart_StateLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ConnectionPointReference.Properties.state, UmlViewsRepository.FORM_KIND));
		state = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(UmlViewsRepository.ConnectionPointReference.Properties.state, UmlViewsRepository.FORM_KIND));
		...
		state.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartForm.this, UmlViewsRepository.ConnectionPointReference.Properties.state, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getState()));
			}

		});
		state.setID(UmlViewsRepository.ConnectionPointReference.Properties.state);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ConnectionPointReference.Properties.state, UmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
