...
public class TriggerPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TriggerPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.TriggerPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Trigger.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.TriggerPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Trigger.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createEventFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.TriggerPropertiesEditionPart_EventLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Trigger.Properties.event, UmlViewsRepository.SWT_KIND));
