 ...
 * 
 */
public class DurationIntervalPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, DurationIntervalPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.DurationIntervalPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.name, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.DurationIntervalPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.visibility, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(UmlMessages.DurationIntervalPropertiesEditionPart_ClientDependencyLabel, new ReferencesTableListener	() {
	...
	protected Composite createOwningTemplateParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.DurationIntervalPropertiesEditionPart_OwningTemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.owningTemplateParameter, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createTemplateParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.DurationIntervalPropertiesEditionPart_TemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.templateParameter, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createTypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.DurationIntervalPropertiesEditionPart_TypeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.type, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createMinFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.DurationIntervalPropertiesEditionPart_MinLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.min, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createMaxFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.DurationIntervalPropertiesEditionPart_MaxLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.DurationInterval.Properties.max, UmlViewsRepository.FORM_KIND));
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.DurationIntervalPropertiesEditionPart#initVisibility(EEnum eenum, Enumerator current)
	 */
