...
public class ValuePinPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ValuePinPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ValuePinPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ValuePin.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ValuePinPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ValuePin.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createInStructuredNodeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ValuePinPropertiesEditionPart_InStructuredNodeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ValuePin.Properties.inStructuredNode, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createActivityFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ValuePinPropertiesEditionPart_ActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ValuePin.Properties.activity, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ValuePinPropertiesEditionPart_TypeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ValuePin.Properties.type, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createOrderingEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ValuePinPropertiesEditionPart_OrderingLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ValuePin.Properties.ordering, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createSelectionFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ValuePinPropertiesEditionPart_SelectionLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ValuePin.Properties.selection, UmlViewsRepository.SWT_KIND));
