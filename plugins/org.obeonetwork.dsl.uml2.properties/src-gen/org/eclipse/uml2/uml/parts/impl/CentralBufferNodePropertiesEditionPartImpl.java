...
public class CentralBufferNodePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CentralBufferNodePropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CentralBufferNodePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CentralBufferNode.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CentralBufferNodePropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CentralBufferNode.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsLeafCheckbox(Composite parent) {
		...
		isLeaf.setText(UmlMessages.CentralBufferNodePropertiesEditionPart_IsLeafLabel);
	...
	protected Composite createInStructuredNodeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CentralBufferNodePropertiesEditionPart_InStructuredNodeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CentralBufferNode.Properties.inStructuredNode, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createActivityFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CentralBufferNodePropertiesEditionPart_ActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CentralBufferNode.Properties.activity, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CentralBufferNodePropertiesEditionPart_TypeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CentralBufferNode.Properties.type, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createOrderingEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CentralBufferNodePropertiesEditionPart_OrderingLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CentralBufferNode.Properties.ordering, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsControlTypeCheckbox(Composite parent) {
		...
		isControlType.setText(UmlMessages.CentralBufferNodePropertiesEditionPart_IsControlTypeLabel);
	...
	protected Composite createSelectionFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.CentralBufferNodePropertiesEditionPart_SelectionLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.CentralBufferNode.Properties.selection, UmlViewsRepository.SWT_KIND));
