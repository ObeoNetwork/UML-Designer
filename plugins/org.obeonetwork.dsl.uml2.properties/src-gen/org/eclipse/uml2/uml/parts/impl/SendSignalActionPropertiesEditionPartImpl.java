...
import org.eclipse.uml2.uml.parts.SendSignalActionPropertiesEditionPart;
...
public class SendSignalActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, SendSignalActionPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.SendSignalActionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.SendSignalAction.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.SendSignalActionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.SendSignalAction.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsLeafCheckbox(Composite parent) {
		...
		isLeaf.setText(UmlMessages.SendSignalActionPropertiesEditionPart_IsLeafLabel);
	...
	protected Composite createInStructuredNodeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.SendSignalActionPropertiesEditionPart_InStructuredNodeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.SendSignalAction.Properties.inStructuredNode, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createActivityFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.SendSignalActionPropertiesEditionPart_ActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.SendSignalAction.Properties.activity, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createOnPortFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.SendSignalActionPropertiesEditionPart_OnPortLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.SendSignalAction.Properties.onPort, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createSignalFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.SendSignalActionPropertiesEditionPart_SignalLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.SendSignalAction.Properties.signal, UmlViewsRepository.SWT_KIND));
