...
public class ExecutionEventPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ExecutionEventPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ExecutionEventPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ExecutionEvent.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ExecutionEventPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ExecutionEvent.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createOwningTemplateParameterFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ExecutionEventPropertiesEditionPart_OwningTemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ExecutionEvent.Properties.owningTemplateParameter, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createTemplateParameterFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ExecutionEventPropertiesEditionPart_TemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ExecutionEvent.Properties.templateParameter, UmlViewsRepository.SWT_KIND));
