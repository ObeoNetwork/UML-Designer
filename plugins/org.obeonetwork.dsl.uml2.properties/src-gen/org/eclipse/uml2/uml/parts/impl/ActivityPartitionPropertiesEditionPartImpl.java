...
public class ActivityPartitionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ActivityPartitionPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ActivityPartitionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ActivityPartition.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ActivityPartitionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ActivityPartition.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createInActivityFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ActivityPartitionPropertiesEditionPart_InActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ActivityPartition.Properties.inActivity, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createSuperPartitionFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ActivityPartitionPropertiesEditionPart_SuperPartitionLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ActivityPartition.Properties.superPartition, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createRepresentsFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ActivityPartitionPropertiesEditionPart_RepresentsLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.ActivityPartition.Properties.represents, UmlViewsRepository.SWT_KIND));
