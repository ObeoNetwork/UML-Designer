...
import org.eclipse.uml2.uml.parts.PinPropertiesEditionPart;
...
public class PinPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, PinPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.PinPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Pin.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.PinPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Pin.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsLeafCheckbox(Composite parent) {
		...
		isLeaf.setText(UmlMessages.PinPropertiesEditionPart_IsLeafLabel);
	...
	protected Composite createInStructuredNodeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.PinPropertiesEditionPart_InStructuredNodeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Pin.Properties.inStructuredNode, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createActivityFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.PinPropertiesEditionPart_ActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Pin.Properties.activity, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.PinPropertiesEditionPart_TypeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Pin.Properties.type, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createOrderingEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.PinPropertiesEditionPart_OrderingLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Pin.Properties.ordering, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsControlTypeCheckbox(Composite parent) {
		...
		isControlType.setText(UmlMessages.PinPropertiesEditionPart_IsControlTypeLabel);
	...
	protected Composite createSelectionFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.PinPropertiesEditionPart_SelectionLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Pin.Properties.selection, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsOrderedCheckbox(Composite parent) {
		...
		isOrdered.setText(UmlMessages.PinPropertiesEditionPart_IsOrderedLabel);
	...
	protected Composite createIsUniqueCheckbox(Composite parent) {
		...
		isUnique.setText(UmlMessages.PinPropertiesEditionPart_IsUniqueLabel);
	...
	protected Composite createIsControlCheckbox(Composite parent) {
		...
		isControl.setText(UmlMessages.PinPropertiesEditionPart_IsControlLabel);
