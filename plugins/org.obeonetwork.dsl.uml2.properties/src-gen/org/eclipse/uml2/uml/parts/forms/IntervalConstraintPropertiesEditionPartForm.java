...
import org.eclipse.uml2.uml.parts.IntervalConstraintPropertiesEditionPart;
 ...
 * 
 */
public class IntervalConstraintPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, IntervalConstraintPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.IntervalConstraintPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.IntervalConstraint.Properties.name, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.IntervalConstraintPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.IntervalConstraint.Properties.visibility, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(UmlMessages.IntervalConstraintPropertiesEditionPart_ClientDependencyLabel, new ReferencesTableListener	() {
	...
	protected Composite createOwningTemplateParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.IntervalConstraintPropertiesEditionPart_OwningTemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.IntervalConstraint.Properties.owningTemplateParameter, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createTemplateParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.IntervalConstraintPropertiesEditionPart_TemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.IntervalConstraint.Properties.templateParameter, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createConstrainedElementReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.constrainedElement = new ReferencesTable(UmlMessages.IntervalConstraintPropertiesEditionPart_ConstrainedElementLabel, new ReferencesTableListener	() {
	...
	protected Composite createContextFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.IntervalConstraintPropertiesEditionPart_ContextLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.IntervalConstraint.Properties.context, UmlViewsRepository.FORM_KIND));
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.IntervalConstraintPropertiesEditionPart#initVisibility(EEnum eenum, Enumerator current)
	 */
