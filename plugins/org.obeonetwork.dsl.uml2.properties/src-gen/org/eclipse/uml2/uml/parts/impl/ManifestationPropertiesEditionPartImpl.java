...
public class ManifestationPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ManifestationPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ManifestationPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Manifestation.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ManifestationPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Manifestation.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createOwningTemplateParameterFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ManifestationPropertiesEditionPart_OwningTemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Manifestation.Properties.owningTemplateParameter, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createTemplateParameterFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ManifestationPropertiesEditionPart_TemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Manifestation.Properties.templateParameter, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createUtilizedElementFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.ManifestationPropertiesEditionPart_UtilizedElementLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Manifestation.Properties.utilizedElement, UmlViewsRepository.SWT_KIND));
