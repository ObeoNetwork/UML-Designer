...
public class RemoveVariableValueActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, RemoveVariableValueActionPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.RemoveVariableValueActionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.RemoveVariableValueAction.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.RemoveVariableValueActionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.RemoveVariableValueAction.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsLeafCheckbox(Composite parent) {
		...
		isLeaf.setText(UmlMessages.RemoveVariableValueActionPropertiesEditionPart_IsLeafLabel);
	...
	protected Composite createInStructuredNodeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.RemoveVariableValueActionPropertiesEditionPart_InStructuredNodeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.RemoveVariableValueAction.Properties.inStructuredNode, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createActivityFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.RemoveVariableValueActionPropertiesEditionPart_ActivityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.RemoveVariableValueAction.Properties.activity, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVariableFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.RemoveVariableValueActionPropertiesEditionPart_VariableLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.RemoveVariableValueAction.Properties.variable, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsRemoveDuplicatesCheckbox(Composite parent) {
		...
		isRemoveDuplicates.setText(UmlMessages.RemoveVariableValueActionPropertiesEditionPart_IsRemoveDuplicatesLabel);
