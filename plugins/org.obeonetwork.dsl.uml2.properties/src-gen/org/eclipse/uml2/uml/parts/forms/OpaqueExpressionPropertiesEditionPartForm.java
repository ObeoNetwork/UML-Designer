...
import org.eclipse.uml2.uml.parts.OpaqueExpressionPropertiesEditionPart;
 ...
 * 
 */
public class OpaqueExpressionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, OpaqueExpressionPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.OpaqueExpressionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.OpaqueExpression.Properties.name, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.OpaqueExpressionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.OpaqueExpression.Properties.visibility, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(UmlMessages.OpaqueExpressionPropertiesEditionPart_ClientDependencyLabel, new ReferencesTableListener	() {
	...
	protected Composite createOwningTemplateParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.OpaqueExpressionPropertiesEditionPart_OwningTemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.OpaqueExpression.Properties.owningTemplateParameter, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createTemplateParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.OpaqueExpressionPropertiesEditionPart_TemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.OpaqueExpression.Properties.templateParameter, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createTypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.OpaqueExpressionPropertiesEditionPart_TypeLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.OpaqueExpression.Properties.type, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createBodyMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editBody = widgetFactory.createButton(parent, UmlMessages.OpaqueExpressionPropertiesEditionPart_BodyLabel, SWT.NONE);
	...
	protected Composite createLanguageMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editLanguage = widgetFactory.createButton(parent, UmlMessages.OpaqueExpressionPropertiesEditionPart_LanguageLabel, SWT.NONE);
	...
	protected Composite createBehaviorFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.OpaqueExpressionPropertiesEditionPart_BehaviorLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.OpaqueExpression.Properties.behavior, UmlViewsRepository.FORM_KIND));
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.OpaqueExpressionPropertiesEditionPart#initVisibility(EEnum eenum, Enumerator current)
	 */
