 ...
 * 
 */
public interface DestroyObjectActionPropertiesEditionPart {
	...
	/**
	 * @return the isDestroyLinks
	 * 
	 */
	public Boolean getIsDestroyLinks();

	/**
	 * Defines a new isDestroyLinks
	 * @param newValue the new isDestroyLinks to set
	 * 
	 */
	...
	/**
	 * @return the isDestroyOwnedObjects
	 * 
	 */
	public Boolean getIsDestroyOwnedObjects();

	/**
	 * Defines a new isDestroyOwnedObjects
	 * @param newValue the new isDestroyOwnedObjects to set
	 * 
	 */
