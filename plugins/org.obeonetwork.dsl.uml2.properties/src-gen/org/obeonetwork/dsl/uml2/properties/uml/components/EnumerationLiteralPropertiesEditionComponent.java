...
public class EnumerationLiteralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public EnumerationLiteralPropertiesEditionComponent(PropertiesEditingContext editingContext,
			EObject enumerationLiteral, String editing_mode) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(
						EEFUtils.choiceOfValues(enumerationLiteral,
								UMLPackage.eINSTANCE.getNamedElement_Visibility()),
						enumerationLiteral.getVisibility());
			}
			// init filters
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			enumerationLiteral.setName((java.lang.String)EEFConverterUtil
