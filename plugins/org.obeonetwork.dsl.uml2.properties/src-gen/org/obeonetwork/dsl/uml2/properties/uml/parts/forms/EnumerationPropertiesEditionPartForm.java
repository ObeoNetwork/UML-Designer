...
public class EnumerationPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, EnumerationPropertiesEditionPart {
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              ...
              UmlViewsRepository.Enumeration.Properties.name,
    ...
    this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.Enumeration.Properties.clientDependency, UmlMessages.EnumerationPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
    ...
    isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Enumeration.Properties.isLeaf, UmlMessages.EnumerationPropertiesEditionPart_IsLeafLabel), SWT.CHECK);
    ...
    isAbstract = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Enumeration.Properties.isAbstract, UmlMessages.EnumerationPropertiesEditionPart_IsAbstractLabel), SWT.CHECK);
    ...
    this.powertypeExtent = new ReferencesTable(getDescription(UmlViewsRepository.Enumeration.Properties.powertypeExtent, UmlMessages.EnumerationPropertiesEditionPart_PowertypeExtentLabel), new ReferencesTableListener	() {
    ...
    this.redefinedClassifier = new ReferencesTable(getDescription(UmlViewsRepository.Enumeration.Properties.redefinedClassifier, UmlMessages.EnumerationPropertiesEditionPart_RedefinedClassifierLabel), new ReferencesTableListener	() {
    ...
    this.useCase = new ReferencesTable(getDescription(UmlViewsRepository.Enumeration.Properties.useCase, UmlMessages.EnumerationPropertiesEditionPart_UseCaseLabel), new ReferencesTableListener	() {
