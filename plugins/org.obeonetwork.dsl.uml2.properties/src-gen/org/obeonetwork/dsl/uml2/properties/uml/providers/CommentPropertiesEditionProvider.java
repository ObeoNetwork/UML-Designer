 ...
 * @generated
 */
public class CommentPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Comment) && (UMLPackage.Literals.COMMENT == editingContext.getEObject().eClass());
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Comment) {
            if (CommentPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == CommentPropertiesEditionComponent.class)
                return new CommentPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
