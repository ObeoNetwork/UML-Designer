...
public class Class_PropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, Class_PropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.Class_PropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Class_.Properties.name, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.Class_PropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Class_.Properties.visibility, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createClientDependencyAdvancedReferencesTable(Composite parent) {
		this.clientDependency = new ReferencesTable(UmlMessages.Class_PropertiesEditionPart_ClientDependencyLabel, new ReferencesTableListener() {
	...
	protected Composite createIsLeafCheckbox(Composite parent) {
		...
		isLeaf.setText(UmlMessages.Class_PropertiesEditionPart_IsLeafLabel);
	...
	protected Composite createOwningTemplateParameterFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.Class_PropertiesEditionPart_OwningTemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Class_.Properties.owningTemplateParameter, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createTemplateParameterFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.Class_PropertiesEditionPart_TemplateParameterLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Class_.Properties.templateParameter, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsAbstractCheckbox(Composite parent) {
		...
		isAbstract.setText(UmlMessages.Class_PropertiesEditionPart_IsAbstractLabel);
	...
	protected Composite createPowertypeExtentAdvancedReferencesTable(Composite parent) {
		this.powertypeExtent = new ReferencesTable(UmlMessages.Class_PropertiesEditionPart_PowertypeExtentLabel, new ReferencesTableListener() {
	...
	protected Composite createRedefinedClassifierAdvancedReferencesTable(Composite parent) {
		this.redefinedClassifier = new ReferencesTable(UmlMessages.Class_PropertiesEditionPart_RedefinedClassifierLabel, new ReferencesTableListener() {
	...
	protected Composite createRepresentationFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.Class_PropertiesEditionPart_RepresentationLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Class_.Properties.representation, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createUseCaseAdvancedReferencesTable(Composite parent) {
		this.useCase = new ReferencesTable(UmlMessages.Class_PropertiesEditionPart_UseCaseLabel, new ReferencesTableListener() {
	...
	protected Composite createClassifierBehaviorFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmlMessages.Class_PropertiesEditionPart_ClassifierBehaviorLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Class_.Properties.classifierBehavior, UmlViewsRepository.SWT_KIND));
	...
	protected Composite createIsActiveCheckbox(Composite parent) {
		...
		isActive.setText(UmlMessages.Class_PropertiesEditionPart_IsActiveLabel);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.Class_PropertiesEditionPart#initVisibility(EEnum eenum, Enumerator current)
	 */
