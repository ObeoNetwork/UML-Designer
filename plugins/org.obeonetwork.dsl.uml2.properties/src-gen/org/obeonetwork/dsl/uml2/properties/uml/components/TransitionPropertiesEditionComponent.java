...
public class TransitionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(UMLPackage.eINSTANCE.getNamedElement_Name(), UMLPackage.eINSTANCE.getNamedElement_Visibility(),
                UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf(), UMLPackage.eINSTANCE.getTransition_Kind(), UMLPackage.eINSTANCE.getTransition_Trigger(),
                UMLPackage.eINSTANCE.getTransition_Guard(), UMLPackage.eINSTANCE.getTransition_Effect(), UMLPackage.eINSTANCE.getTransition_Source(), UMLPackage.eINSTANCE.getTransition_Target(),
    ...
    public boolean mustBeComposed(Object key, int kind) {
        return key == UmlViewsRepository.General.name || key == UmlViewsRepository.General.visibility || key == UmlViewsRepository.General.Qualifiers.leaf || key == UmlViewsRepository.General.kind
                || key == UmlViewsRepository.General.trigger || key == UmlViewsRepository.General.guard || key == UmlViewsRepository.General.effect || key == UmlViewsRepository.General.source
                || key == UmlViewsRepository.General.target || key == UmlViewsRepository.General.ownedRule || key == UmlViewsRepository.General.Qualifiers.class;
    }
