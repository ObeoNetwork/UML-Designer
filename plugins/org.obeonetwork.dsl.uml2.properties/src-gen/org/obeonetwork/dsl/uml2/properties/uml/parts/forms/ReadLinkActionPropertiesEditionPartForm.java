 ...
 * @generated
 */
public class ReadLinkActionPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ReadLinkActionPropertiesEditionPart {
	 ...
	 */
	public ReadLinkActionPropertiesEditionPartForm() { super(); }
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              ReadLinkActionPropertiesEditionPartForm.this,
              UmlViewsRepository.ReadLinkAction.Properties.name,
    ...
    this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.ReadLinkAction.Properties.clientDependency, UmlMessages.ReadLinkActionPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
    ...
    isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.ReadLinkAction.Properties.isLeaf, UmlMessages.ReadLinkActionPropertiesEditionPart_IsLeafLabel), SWT.CHECK);
    ...
    this.outgoing = new ReferencesTable(getDescription(UmlViewsRepository.ReadLinkAction.Properties.outgoing, UmlMessages.ReadLinkActionPropertiesEditionPart_OutgoingLabel), new ReferencesTableListener	() {
    ...
    this.incoming = new ReferencesTable(getDescription(UmlViewsRepository.ReadLinkAction.Properties.incoming, UmlMessages.ReadLinkActionPropertiesEditionPart_IncomingLabel), new ReferencesTableListener	() {
    ...
    this.inPartition = new ReferencesTable(getDescription(UmlViewsRepository.ReadLinkAction.Properties.inPartition, UmlMessages.ReadLinkActionPropertiesEditionPart_InPartitionLabel), new ReferencesTableListener	() {
    ...
    this.inInterruptibleRegion = new ReferencesTable(getDescription(UmlViewsRepository.ReadLinkAction.Properties.inInterruptibleRegion, UmlMessages.ReadLinkActionPropertiesEditionPart_InInterruptibleRegionLabel), new ReferencesTableListener	() {
    ...
    this.redefinedNode = new ReferencesTable(getDescription(UmlViewsRepository.ReadLinkAction.Properties.redefinedNode, UmlMessages.ReadLinkActionPropertiesEditionPart_RedefinedNodeLabel), new ReferencesTableListener	() {
