...
public class TestIdentityActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TestIdentityActionPropertiesEditionPart {
    ...
    String label = getDescription(UmlViewsRepository.TestIdentityAction.Properties.clientDependency, UmlMessages.TestIdentityActionPropertiesEditionPart_ClientDependencyLabel);		 
    ...
    isLeaf.setText(getDescription(UmlViewsRepository.TestIdentityAction.Properties.isLeaf, UmlMessages.TestIdentityActionPropertiesEditionPart_IsLeafLabel));
    ...
    String label = getDescription(UmlViewsRepository.TestIdentityAction.Properties.outgoing, UmlMessages.TestIdentityActionPropertiesEditionPart_OutgoingLabel);		 
    ...
    String label = getDescription(UmlViewsRepository.TestIdentityAction.Properties.incoming, UmlMessages.TestIdentityActionPropertiesEditionPart_IncomingLabel);		 
    ...
    String label = getDescription(UmlViewsRepository.TestIdentityAction.Properties.inPartition, UmlMessages.TestIdentityActionPropertiesEditionPart_InPartitionLabel);		 
    ...
    String label = getDescription(UmlViewsRepository.TestIdentityAction.Properties.inInterruptibleRegion, UmlMessages.TestIdentityActionPropertiesEditionPart_InInterruptibleRegionLabel);		 
    ...
    String label = getDescription(UmlViewsRepository.TestIdentityAction.Properties.redefinedNode, UmlMessages.TestIdentityActionPropertiesEditionPart_RedefinedNodeLabel);		 
