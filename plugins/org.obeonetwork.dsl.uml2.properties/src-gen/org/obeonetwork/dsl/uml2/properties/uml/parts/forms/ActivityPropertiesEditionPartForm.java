...
public class ActivityPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ActivityPropertiesEditionPart {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							UmlViewsRepository.Activity.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.Activity.Properties.clientDependency, UmlMessages.ActivityPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Activity.Properties.isLeaf, UmlMessages.ActivityPropertiesEditionPart_IsLeafLabel), SWT.CHECK);
	...
	protected Composite createIsAbstractCheckbox(FormToolkit widgetFactory, Composite parent) {
		isAbstract = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Activity.Properties.isAbstract, UmlMessages.ActivityPropertiesEditionPart_IsAbstractLabel), SWT.CHECK);
	...
	protected Composite createPowertypeExtentReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.powertypeExtent = new ReferencesTable(getDescription(UmlViewsRepository.Activity.Properties.powertypeExtent, UmlMessages.ActivityPropertiesEditionPart_PowertypeExtentLabel), new ReferencesTableListener	() {
	...
	protected Composite createRedefinedClassifierReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedClassifier = new ReferencesTable(getDescription(UmlViewsRepository.Activity.Properties.redefinedClassifier, UmlMessages.ActivityPropertiesEditionPart_RedefinedClassifierLabel), new ReferencesTableListener	() {
	...
	protected Composite createUseCaseReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.useCase = new ReferencesTable(getDescription(UmlViewsRepository.Activity.Properties.useCase, UmlMessages.ActivityPropertiesEditionPart_UseCaseLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsActiveCheckbox(FormToolkit widgetFactory, Composite parent) {
		isActive = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Activity.Properties.isActive, UmlMessages.ActivityPropertiesEditionPart_IsActiveLabel), SWT.CHECK);
	...
	protected Composite createIsReentrantCheckbox(FormToolkit widgetFactory, Composite parent) {
		isReentrant = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Activity.Properties.isReentrant, UmlMessages.ActivityPropertiesEditionPart_IsReentrantLabel), SWT.CHECK);
	...
	protected Composite createRedefinedBehaviorReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedBehavior = new ReferencesTable(getDescription(UmlViewsRepository.Activity.Properties.redefinedBehavior, UmlMessages.ActivityPropertiesEditionPart_RedefinedBehaviorLabel), new ReferencesTableListener	() {
	...
	protected Composite createPreconditionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.precondition = new ReferencesTable(getDescription(UmlViewsRepository.Activity.Properties.precondition, UmlMessages.ActivityPropertiesEditionPart_PreconditionLabel), new ReferencesTableListener	() {
	...
	protected Composite createPostconditionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.postcondition = new ReferencesTable(getDescription(UmlViewsRepository.Activity.Properties.postcondition, UmlMessages.ActivityPropertiesEditionPart_PostconditionLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsReadOnlyCheckbox(FormToolkit widgetFactory, Composite parent) {
		isReadOnly = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Activity.Properties.isReadOnly, UmlMessages.ActivityPropertiesEditionPart_IsReadOnlyLabel), SWT.CHECK);
	...
	protected Composite createPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.partition = new ReferencesTable(getDescription(UmlViewsRepository.Activity.Properties.partition, UmlMessages.ActivityPropertiesEditionPart_PartitionLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsSingleExecutionCheckbox(FormToolkit widgetFactory, Composite parent) {
		isSingleExecution = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Activity.Properties.isSingleExecution, UmlMessages.ActivityPropertiesEditionPart_IsSingleExecutionLabel), SWT.CHECK);
