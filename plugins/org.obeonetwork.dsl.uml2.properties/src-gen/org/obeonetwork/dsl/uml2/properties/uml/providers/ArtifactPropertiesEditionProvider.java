...
public class ArtifactPropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Artifact)
				&& (UMLPackage.Literals.ARTIFACT == editingContext.getEObject().eClass());
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof Artifact)
				&& (ArtifactGeneralPropertiesEditionComponent.GENERAL_PART.equals(part)
						|| ArtifactAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part)
						|| ArtifactOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof Artifact) {
			if (ArtifactGeneralPropertiesEditionComponent.GENERAL_PART.equals(part))
				return new ArtifactGeneralPropertiesEditionComponent(editingContext,
						editingContext.getEObject(), mode);
			if (ArtifactAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part))
				return new ArtifactAttributesPropertiesEditionComponent(editingContext,
						editingContext.getEObject(), mode);
			if (ArtifactOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part))
				return new ArtifactOperationsPropertiesEditionComponent(editingContext,
						editingContext.getEObject(), mode);
		}
