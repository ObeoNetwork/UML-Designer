 ...
 * 
 */
public interface JoinNodePropertiesEditionPart {
	...
	/**
	 * @return the isCombineDuplicate
	 * 
	 */
	public Boolean getIsCombineDuplicate();

	/**
	 * Defines a new isCombineDuplicate
	 * @param newValue the new isCombineDuplicate to set
	 * 
	 */
