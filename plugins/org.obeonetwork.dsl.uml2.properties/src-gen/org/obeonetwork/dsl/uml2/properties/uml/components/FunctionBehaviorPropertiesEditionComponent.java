...
public class FunctionBehaviorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(UmlViewsRepository.FunctionBehavior.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, functionBehavior.getName()));
			
			if (isAccessible(UmlViewsRepository.FunctionBehavior.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(functionBehavior, UMLPackage.eINSTANCE.getNamedElement_Visibility()), functionBehavior.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.FunctionBehavior.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.FunctionBehavior.Properties.isAbstract)) {
			...
			if (isAccessible(UmlViewsRepository.FunctionBehavior.Properties.isActive)) {
				basePart.setIsActive(functionBehavior.isActive());
			}
			if (isAccessible(UmlViewsRepository.FunctionBehavior.Properties.isReentrant)) {
			...
			if (isAccessible(UmlViewsRepository.FunctionBehavior.Properties.body))
				basePart.setBody(functionBehavior.getBodies());
			
			if (isAccessible(UmlViewsRepository.FunctionBehavior.Properties.language))
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.FunctionBehavior.Properties.name == event.getAffectedEditor()) {
			functionBehavior.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
		}
		...
		if (UmlViewsRepository.FunctionBehavior.Properties.body == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				...
				functionBehavior.getBodies().addAll(((EList) event.getNewValue()));
			}
		}
		if (UmlViewsRepository.FunctionBehavior.Properties.language == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				functionBehavior.getLanguages().clear();
				functionBehavior.getLanguages().addAll(((EList) event.getNewValue()));
			}
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.FunctionBehavior.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.FunctionBehavior.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.FunctionBehavior.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getClassifier_IsAbstract().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.FunctionBehavior.Properties.isAbstract))
			...
			if (UMLPackage.eINSTANCE.getClass_IsActive().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.FunctionBehavior.Properties.isActive))
				basePart.setIsActive((Boolean)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getBehavior_IsReentrant().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.FunctionBehavior.Properties.isReentrant))
			...
			if (UMLPackage.eINSTANCE.getOpaqueBehavior_Body().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.FunctionBehavior.Properties.body)) {
				basePart.setBody((EList<?>)msg.getNewValue());
			}
			
			if (UMLPackage.eINSTANCE.getOpaqueBehavior_Language().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.FunctionBehavior.Properties.language)) {
