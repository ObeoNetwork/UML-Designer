 ...
 * 
 */
public class ControlFlowPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof ControlFlow) 
					&& (UMLPackage.eINSTANCE.getControlFlow() == editingContext.getEObject().eClass());
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof ControlFlow) && (ControlFlowPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof ControlFlow) && ((ControlFlowPropertiesEditionComponent.BASE_PART.equals(part) && refinement == ControlFlowPropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part) {
		if (editingContext.getEObject() instanceof ControlFlow) {
			if (ControlFlowPropertiesEditionComponent.BASE_PART.equals(part))
				return new ControlFlowPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
