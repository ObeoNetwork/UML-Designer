...
public class ClausePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ClausePropertiesEditionPart {
    ...
    composer = new PartComposer(clauseStep) {
      ...
      public Composite addToPart(Composite parent, Object key) {
        ...
        if (key == UmlViewsRepository.Clause.Properties.body) {
          return createBodyAdvancedReferencesTable(parent);
        }
        if (key == UmlViewsRepository.Clause.Properties.predecessorClause) {
          return createPredecessorClauseAdvancedReferencesTable(parent);
        }
        if (key == UmlViewsRepository.Clause.Properties.successorClause) {
          return createSuccessorClauseAdvancedReferencesTable(parent);
        }
    ...
    String label = getDescription(UmlViewsRepository.Clause.Properties.test, UmlMessages.ClausePropertiesEditionPart_TestLabel);		 
    ...
    this.test.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.Clause.Properties.test, UmlViewsRepository.SWT_KIND));
    this.test.createControls(parent);
    this.test.addSelectionListener(new SelectionAdapter() {
      
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.test, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
    ...
    "test", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
      ...
      public void process(IStructuredSelection selection) {
        for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
          ...
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.test,
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.test, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
    test.refresh();
  }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.test, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
    test.refresh();
  }
	 ...
	 * @generated
	 */
	protected Composite createBodyAdvancedReferencesTable(Composite parent) {
    String label = getDescription(UmlViewsRepository.Clause.Properties.body, UmlMessages.ClausePropertiesEditionPart_BodyLabel);		 
    this.body = new ReferencesTable(label, new ReferencesTableListener() {
    ...
    this.body.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.Clause.Properties.body, UmlViewsRepository.SWT_KIND));
    this.body.createControls(parent);
    this.body.addSelectionListener(new SelectionAdapter() {
      
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.body, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
    ...
    "body", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
      ...
      public void process(IStructuredSelection selection) {
        for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
          EObject elem = (EObject) iter.next();
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.body,
            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
        }
        body.refresh();
      }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.body, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
    body.refresh();
  }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.body, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
    body.refresh();
  }
	 ...
	 * @generated
	 */
	protected Composite createPredecessorClauseAdvancedReferencesTable(Composite parent) {
    String label = getDescription(UmlViewsRepository.Clause.Properties.predecessorClause, UmlMessages.ClausePropertiesEditionPart_PredecessorClauseLabel);		 
    this.predecessorClause = new ReferencesTable(label, new ReferencesTableListener() {
    ...
    this.predecessorClause.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.Clause.Properties.predecessorClause, UmlViewsRepository.SWT_KIND));
    this.predecessorClause.createControls(parent);
    this.predecessorClause.addSelectionListener(new SelectionAdapter() {
      
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.predecessorClause, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
    ...
    "predecessorClause", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
      ...
      public void process(IStructuredSelection selection) {
        for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
          EObject elem = (EObject) iter.next();
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.predecessorClause,
            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
        }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.predecessorClause, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
    predecessorClause.refresh();
  }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.predecessorClause, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
    predecessorClause.refresh();
  }
	 ...
	 * @generated
	 */
	protected Composite createSuccessorClauseAdvancedReferencesTable(Composite parent) {
    String label = getDescription(UmlViewsRepository.Clause.Properties.successorClause, UmlMessages.ClausePropertiesEditionPart_SuccessorClauseLabel);		 
    this.successorClause = new ReferencesTable(label, new ReferencesTableListener() {
    ...
    this.successorClause.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.Clause.Properties.successorClause, UmlViewsRepository.SWT_KIND));
    this.successorClause.createControls(parent);
    this.successorClause.addSelectionListener(new SelectionAdapter() {
      
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.successorClause, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
    ...
    "successorClause", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
      ...
      public void process(IStructuredSelection selection) {
        for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
          EObject elem = (EObject) iter.next();
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.successorClause,
            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
        }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.successorClause, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
    successorClause.refresh();
  }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.successorClause, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
    successorClause.refresh();
  }
    ...
    decider = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(UmlViewsRepository.Clause.Properties.decider, UmlViewsRepository.SWT_KIND));
    ...
    decider.addSelectionChangedListener(new ISelectionChangedListener() {
      ...
      public void selectionChanged(SelectionChangedEvent event) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.decider, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getDecider()));
      }
    ...
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.Clause.Properties.decider, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    String label = getDescription(UmlViewsRepository.Clause.Properties.bodyOutput, UmlMessages.ClausePropertiesEditionPart_BodyOutputLabel);		 
    ...
    this.bodyOutput.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.Clause.Properties.bodyOutput, UmlViewsRepository.SWT_KIND));
    this.bodyOutput.createControls(parent);
    this.bodyOutput.addSelectionListener(new SelectionAdapter() {
      
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.bodyOutput, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
    ...
    "bodyOutput", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
      ...
      public void process(IStructuredSelection selection) {
        for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
          EObject elem = (EObject) iter.next();
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.bodyOutput,
            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
        }
        bodyOutput.refresh();
      }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.bodyOutput, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
    bodyOutput.refresh();
  }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartImpl.this, UmlViewsRepository.Clause.Properties.bodyOutput, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
    bodyOutput.refresh();
  }
