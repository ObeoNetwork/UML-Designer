...
public class OutputPinPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(UmlViewsRepository.OutputPin.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, outputPin.getName()));
			
			if (isAccessible(UmlViewsRepository.OutputPin.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(outputPin, UMLPackage.eINSTANCE.getNamedElement_Visibility()), outputPin.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.OutputPin.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.OutputPin.Properties.ordering)) {
				basePart.initOrdering(EEFUtils.choiceOfValues(outputPin, UMLPackage.eINSTANCE.getObjectNode_Ordering()), outputPin.getOrdering());
			}
			if (isAccessible(UmlViewsRepository.OutputPin.Properties.isControlType)) {
			...
			if (isAccessible(UmlViewsRepository.OutputPin.Properties.isOrdered)) {
				basePart.setIsOrdered(outputPin.isOrdered());
			}
			if (isAccessible(UmlViewsRepository.OutputPin.Properties.isUnique)) {
				basePart.setIsUnique(outputPin.isUnique());
			}
			if (isAccessible(UmlViewsRepository.OutputPin.Properties.isControl)) {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == UmlViewsRepository.OutputPin.Properties.name) {
			return UMLPackage.eINSTANCE.getNamedElement_Name();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.visibility) {
			return UMLPackage.eINSTANCE.getNamedElement_Visibility();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.clientDependency) {
			return UMLPackage.eINSTANCE.getNamedElement_ClientDependency();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.isLeaf) {
			return UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.inStructuredNode) {
			return UMLPackage.eINSTANCE.getActivityNode_InStructuredNode();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.activity) {
			return UMLPackage.eINSTANCE.getActivityNode_Activity();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.outgoing) {
			return UMLPackage.eINSTANCE.getActivityNode_Outgoing();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.incoming) {
			return UMLPackage.eINSTANCE.getActivityNode_Incoming();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.inPartition) {
			return UMLPackage.eINSTANCE.getActivityNode_InPartition();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.inInterruptibleRegion) {
			return UMLPackage.eINSTANCE.getActivityNode_InInterruptibleRegion();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.redefinedNode) {
			return UMLPackage.eINSTANCE.getActivityNode_RedefinedNode();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.type) {
			return UMLPackage.eINSTANCE.getTypedElement_Type();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.ordering) {
			return UMLPackage.eINSTANCE.getObjectNode_Ordering();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.isControlType) {
			return UMLPackage.eINSTANCE.getObjectNode_IsControlType();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.inState) {
			return UMLPackage.eINSTANCE.getObjectNode_InState();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.selection) {
			return UMLPackage.eINSTANCE.getObjectNode_Selection();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.isOrdered) {
			return UMLPackage.eINSTANCE.getMultiplicityElement_IsOrdered();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.isUnique) {
			return UMLPackage.eINSTANCE.getMultiplicityElement_IsUnique();
		}
		if (editorKey == UmlViewsRepository.OutputPin.Properties.isControl) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.OutputPin.Properties.name == event.getAffectedEditor()) {
			outputPin.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.OutputPin.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.OutputPin.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.OutputPin.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getObjectNode_Ordering().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.OutputPin.Properties.ordering))
				basePart.setOrdering((ObjectNodeOrderingKind)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getObjectNode_IsControlType().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.OutputPin.Properties.isControlType))
			...
			if (UMLPackage.eINSTANCE.getMultiplicityElement_IsOrdered().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.OutputPin.Properties.isOrdered))
				basePart.setIsOrdered((Boolean)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getMultiplicityElement_IsUnique().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.OutputPin.Properties.isUnique))
				basePart.setIsUnique((Boolean)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getPin_IsControl().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.OutputPin.Properties.isControl))
