...
public class StateMachinePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, StateMachinePropertiesEditionPart {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							UmlViewsRepository.StateMachine.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.StateMachine.Properties.clientDependency, UmlMessages.StateMachinePropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.StateMachine.Properties.isLeaf, UmlMessages.StateMachinePropertiesEditionPart_IsLeafLabel), SWT.CHECK);
	...
	protected Composite createIsAbstractCheckbox(FormToolkit widgetFactory, Composite parent) {
		isAbstract = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.StateMachine.Properties.isAbstract, UmlMessages.StateMachinePropertiesEditionPart_IsAbstractLabel), SWT.CHECK);
	...
	protected Composite createPowertypeExtentReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.powertypeExtent = new ReferencesTable(getDescription(UmlViewsRepository.StateMachine.Properties.powertypeExtent, UmlMessages.StateMachinePropertiesEditionPart_PowertypeExtentLabel), new ReferencesTableListener	() {
	...
	protected Composite createRedefinedClassifierReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedClassifier = new ReferencesTable(getDescription(UmlViewsRepository.StateMachine.Properties.redefinedClassifier, UmlMessages.StateMachinePropertiesEditionPart_RedefinedClassifierLabel), new ReferencesTableListener	() {
	...
	protected Composite createUseCaseReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.useCase = new ReferencesTable(getDescription(UmlViewsRepository.StateMachine.Properties.useCase, UmlMessages.StateMachinePropertiesEditionPart_UseCaseLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsActiveCheckbox(FormToolkit widgetFactory, Composite parent) {
		isActive = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.StateMachine.Properties.isActive, UmlMessages.StateMachinePropertiesEditionPart_IsActiveLabel), SWT.CHECK);
	...
	protected Composite createIsReentrantCheckbox(FormToolkit widgetFactory, Composite parent) {
		isReentrant = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.StateMachine.Properties.isReentrant, UmlMessages.StateMachinePropertiesEditionPart_IsReentrantLabel), SWT.CHECK);
	...
	protected Composite createRedefinedBehaviorReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedBehavior = new ReferencesTable(getDescription(UmlViewsRepository.StateMachine.Properties.redefinedBehavior, UmlMessages.StateMachinePropertiesEditionPart_RedefinedBehaviorLabel), new ReferencesTableListener	() {
	...
	protected Composite createPreconditionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.precondition = new ReferencesTable(getDescription(UmlViewsRepository.StateMachine.Properties.precondition, UmlMessages.StateMachinePropertiesEditionPart_PreconditionLabel), new ReferencesTableListener	() {
	...
	protected Composite createPostconditionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.postcondition = new ReferencesTable(getDescription(UmlViewsRepository.StateMachine.Properties.postcondition, UmlMessages.StateMachinePropertiesEditionPart_PostconditionLabel), new ReferencesTableListener	() {
	...
	protected Composite createSubmachineStateReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.submachineState = new ReferencesTable(getDescription(UmlViewsRepository.StateMachine.Properties.submachineState, UmlMessages.StateMachinePropertiesEditionPart_SubmachineStateLabel), new ReferencesTableListener	() {
	...
	protected Composite createExtendedStateMachineReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.extendedStateMachine = new ReferencesTable(getDescription(UmlViewsRepository.StateMachine.Properties.extendedStateMachine, UmlMessages.StateMachinePropertiesEditionPart_ExtendedStateMachineLabel), new ReferencesTableListener	() {
