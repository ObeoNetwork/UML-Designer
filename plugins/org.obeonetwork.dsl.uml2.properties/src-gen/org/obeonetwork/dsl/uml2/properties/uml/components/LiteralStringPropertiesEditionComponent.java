...
public class LiteralStringPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (literalString.getName() != null && isAccessible(UmlViewsRepository.LiteralString.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.eINSTANCE.getString(), literalString.getName()));
			
			if (isAccessible(UmlViewsRepository.LiteralString.Properties.visibility)) {
				basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), literalString.getVisibility());
			}
			...
			if (literalString.getValue() != null && isAccessible(UmlViewsRepository.LiteralString.Properties.value))
				basePart.setValue(EEFConverterUtil.convertToString(UMLPackage.eINSTANCE.getString(), literalString.getValue()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.LiteralString.Properties.name == event.getAffectedEditor()) {
			literalString.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
		...
		if (UmlViewsRepository.LiteralString.Properties.value == event.getAffectedEditor()) {
			literalString.setValue((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
	}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.LiteralString.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.LiteralString.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getLiteralString_Value().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.LiteralString.Properties.value)) {
				if (msg.getNewValue() != null) {
					basePart.setValue(EcoreUtil.convertToString(UMLPackage.eINSTANCE.getString(), msg.getNewValue()));
				} else {
					basePart.setValue("");
				}
			}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (UmlViewsRepository.LiteralString.Properties.value == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getLiteralString_Value().getEAttributeType(), (String)newValue);
					}
