 ...
 * @generated
 */
public class NodePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, NodePropertiesEditionPart {
	 ...
	 */
	public NodePropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							NodePropertiesEditionPartForm.this,
							UmlViewsRepository.Node.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.Node.Properties.clientDependency, UmlMessages.NodePropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Node.Properties.isLeaf, UmlMessages.NodePropertiesEditionPart_IsLeafLabel), SWT.CHECK);
	...
	protected Composite createIsAbstractCheckbox(FormToolkit widgetFactory, Composite parent) {
		isAbstract = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Node.Properties.isAbstract, UmlMessages.NodePropertiesEditionPart_IsAbstractLabel), SWT.CHECK);
	...
	protected Composite createPowertypeExtentReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.powertypeExtent = new ReferencesTable(getDescription(UmlViewsRepository.Node.Properties.powertypeExtent, UmlMessages.NodePropertiesEditionPart_PowertypeExtentLabel), new ReferencesTableListener	() {
	...
	protected Composite createRedefinedClassifierReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedClassifier = new ReferencesTable(getDescription(UmlViewsRepository.Node.Properties.redefinedClassifier, UmlMessages.NodePropertiesEditionPart_RedefinedClassifierLabel), new ReferencesTableListener	() {
	...
	protected Composite createUseCaseReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.useCase = new ReferencesTable(getDescription(UmlViewsRepository.Node.Properties.useCase, UmlMessages.NodePropertiesEditionPart_UseCaseLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsActiveCheckbox(FormToolkit widgetFactory, Composite parent) {
		isActive = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Node.Properties.isActive, UmlMessages.NodePropertiesEditionPart_IsActiveLabel), SWT.CHECK);
