...
public class CommunicationPathPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(UmlViewsRepository.CommunicationPath.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, communicationPath.getName()));
			
			if (isAccessible(UmlViewsRepository.CommunicationPath.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(communicationPath, UMLPackage.eINSTANCE.getNamedElement_Visibility()), communicationPath.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.CommunicationPath.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.CommunicationPath.Properties.isAbstract)) {
			...
			if (isAccessible(UmlViewsRepository.CommunicationPath.Properties.isDerived)) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.CommunicationPath.Properties.name == event.getAffectedEditor()) {
			communicationPath.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.CommunicationPath.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.CommunicationPath.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.CommunicationPath.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getClassifier_IsAbstract().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.CommunicationPath.Properties.isAbstract))
			...
			if (UMLPackage.eINSTANCE.getAssociation_IsDerived().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.CommunicationPath.Properties.isDerived))
