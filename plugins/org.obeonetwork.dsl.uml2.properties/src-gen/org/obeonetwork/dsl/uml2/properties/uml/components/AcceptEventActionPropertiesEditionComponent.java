...
public class AcceptEventActionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public AcceptEventActionPropertiesEditionComponent(PropertiesEditingContext editingContext,
			EObject acceptEventAction, String editing_mode) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.name))
				generalPart.setName(EEFConverterUtil.convertToString(TypesPackage.Literals.STRING,
						acceptEventAction.getName()));

			if (isAccessible(UmlViewsRepository.General.trigger)) {
				triggerSettings = new ReferencesTableSettings(acceptEventAction,
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			acceptEventAction.setName((java.lang.String)EEFConverterUtil
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getAcceptEventAction_IsUnmarshall().equals(msg.getFeature())
					&& msg.getNotifier().equals(semanticObject) && generalPart != null
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == UmlViewsRepository.General.name || key == UmlViewsRepository.General.trigger
				|| key == UmlViewsRepository.General.unmarshall;
	}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (UmlViewsRepository.General.unmarshall == event.getAffectedEditor()) {
					...
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(
								UMLPackage.eINSTANCE.getAcceptEventAction_IsUnmarshall().getEAttributeType(),
								(String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(
							UMLPackage.eINSTANCE.getAcceptEventAction_IsUnmarshall().getEAttributeType(),
