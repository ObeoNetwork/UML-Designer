...
public class DataTypePropertiesEditionComponent extends ComposedPropertiesEditionComponent {
    ...
    public DataTypePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject dataType, String editing_mode) {
        ...
        if (dataType instanceof DataType) {
            ...
            dataTypeGeneralPropertiesEditionComponent = (DataTypeGeneralPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    DataTypeGeneralPropertiesEditionComponent.GENERAL_PART, DataTypeGeneralPropertiesEditionComponent.class);
            addSubComponent(dataTypeGeneralPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(dataType, PropertiesEditingProvider.class);
            dataTypeAttributesPropertiesEditionComponent = (DataTypeAttributesPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    DataTypeAttributesPropertiesEditionComponent.ATTRIBUTES_PART, DataTypeAttributesPropertiesEditionComponent.class);
            addSubComponent(dataTypeAttributesPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(dataType, PropertiesEditingProvider.class);
            dataTypeOperationsPropertiesEditionComponent = (DataTypeOperationsPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    DataTypeOperationsPropertiesEditionComponent.OPERATIONS_PART, DataTypeOperationsPropertiesEditionComponent.class);
