...
import org.obeonetwork.dsl.uml2.properties.uml.components.DurationConstraintPropertiesEditionComponent;

/**
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 * 
 */
public class DurationConstraintPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public DurationConstraintPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public DurationConstraintPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof DurationConstraint) 
					&& (UMLPackage.eINSTANCE.getDurationConstraint() == editingContext.getEObject().eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
		if (editingContext.getEObject() instanceof DurationConstraint) {
			if (DurationConstraintPropertiesEditionComponent.BASE_PART.equals(part)
				&& refinement == DurationConstraintPropertiesEditionComponent.class)
				return new DurationConstraintPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
