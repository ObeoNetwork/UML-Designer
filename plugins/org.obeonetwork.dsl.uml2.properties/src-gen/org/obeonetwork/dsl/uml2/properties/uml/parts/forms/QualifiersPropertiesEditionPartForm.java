 ...
 * @generated
 */
public class QualifiersPropertiesEditionPartForm extends CustomSectionPropertiesEditingPart implements IFormPropertiesEditionPart, QualifiersPropertiesEditionPart {
	 ...
	 */
	public QualifiersPropertiesEditionPartForm() {
		super();
	}
	 ...
	 * @generated
	 */
	public QualifiersPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(qualifiersStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				if (key == UmlViewsRepository.Qualifiers.qualifiers_) {
					return createQualifiersTableComposition(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createQualifiersTableComposition(FormToolkit widgetFactory, Composite parent) {
				...
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								QualifiersPropertiesEditionPartForm.this,
		...
		this.qualifiers.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.Qualifiers.qualifiers_, UmlViewsRepository.FORM_KIND));
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(QualifiersPropertiesEditionPartForm.this,
