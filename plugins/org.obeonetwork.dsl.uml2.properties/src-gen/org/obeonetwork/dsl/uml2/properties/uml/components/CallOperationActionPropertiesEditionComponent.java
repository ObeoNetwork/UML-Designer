    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(UmlViewsRepository.General.name))
                generalPart.setName(EEFConverterUtil.convertToString(TypesPackage.Literals.STRING, callOperationAction.getName()));

            if (isAccessible(UmlViewsRepository.General.visibility)) {
                generalPart.initVisibility(EEFUtils.choiceOfValues(callOperationAction, UMLPackage.eINSTANCE.getNamedElement_Visibility()), callOperationAction.getVisibility());
            }
            generalPart.setLeaf(callOperationAction.isLeaf());
