...
import org.obeonetwork.dsl.uml2.properties.uml.components.LinkEndCreationDataPropertiesEditionComponent;

/**
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 * 
 */
public class LinkEndCreationDataPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public LinkEndCreationDataPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public LinkEndCreationDataPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof LinkEndCreationData) 
					&& (UMLPackage.eINSTANCE.getLinkEndCreationData() == editingContext.getEObject().eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
		if (editingContext.getEObject() instanceof LinkEndCreationData) {
			if (LinkEndCreationDataPropertiesEditionComponent.BASE_PART.equals(part)
				&& refinement == LinkEndCreationDataPropertiesEditionComponent.class)
				return new LinkEndCreationDataPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
