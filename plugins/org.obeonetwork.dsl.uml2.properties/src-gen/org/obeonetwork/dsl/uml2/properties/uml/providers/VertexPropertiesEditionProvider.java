...
public class VertexPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Vertex) && (UMLPackage.Literals.VERTEX == editingContext.getEObject().eClass());
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Vertex) {
            if (VertexPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == VertexPropertiesEditionComponent.class)
                return new VertexPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
