 ...
 * 
 */
public interface ManifestationPropertiesEditionPart {
	...
	/**
	 * @return the utilizedElement
	 * 
	 */
	public EObject getUtilizedElement();

	/**
	 * Init the utilizedElement
	 * @param settings the combo setting
	 */
	public void initUtilizedElement(EObjectFlatComboSettings settings);

	/**
	 * Defines a new utilizedElement
	 * @param newValue the new utilizedElement to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the utilizedElement edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
