...
public class CombinedFragmentPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, CombinedFragmentPropertiesEditionPart {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							UmlViewsRepository.CombinedFragment.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.CombinedFragment.Properties.clientDependency, UmlMessages.CombinedFragmentPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
	...
	protected Composite createCoveredReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.covered = new ReferencesTable(getDescription(UmlViewsRepository.CombinedFragment.Properties.covered, UmlMessages.CombinedFragmentPropertiesEditionPart_CoveredLabel), new ReferencesTableListener	() {
