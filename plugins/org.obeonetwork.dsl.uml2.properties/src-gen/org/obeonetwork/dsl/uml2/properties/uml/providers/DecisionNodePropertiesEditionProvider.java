 ...
 * 
 */
public class DecisionNodePropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof DecisionNode) 
					&& (UMLPackage.eINSTANCE.getDecisionNode() == editingContext.getEObject().eClass());
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof DecisionNode) && (DecisionNodePropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof DecisionNode) && ((DecisionNodePropertiesEditionComponent.BASE_PART.equals(part) && refinement == DecisionNodePropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part) {
		if (editingContext.getEObject() instanceof DecisionNode) {
			if (DecisionNodePropertiesEditionComponent.BASE_PART.equals(part))
				return new DecisionNodePropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
