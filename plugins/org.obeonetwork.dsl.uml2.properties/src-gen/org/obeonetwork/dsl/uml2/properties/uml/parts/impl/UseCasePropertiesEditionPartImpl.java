...
public class UseCasePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, UseCasePropertiesEditionPart {
    ...
    String label = getDescription(UmlViewsRepository.UseCase.Properties.clientDependency, UmlMessages.UseCasePropertiesEditionPart_ClientDependencyLabel);		 
    ...
    isLeaf.setText(getDescription(UmlViewsRepository.UseCase.Properties.isLeaf, UmlMessages.UseCasePropertiesEditionPart_IsLeafLabel));
    ...
    isAbstract.setText(getDescription(UmlViewsRepository.UseCase.Properties.isAbstract, UmlMessages.UseCasePropertiesEditionPart_IsAbstractLabel));
    ...
    String label = getDescription(UmlViewsRepository.UseCase.Properties.powertypeExtent, UmlMessages.UseCasePropertiesEditionPart_PowertypeExtentLabel);		 
    ...
    String label = getDescription(UmlViewsRepository.UseCase.Properties.redefinedClassifier, UmlMessages.UseCasePropertiesEditionPart_RedefinedClassifierLabel);		 
    ...
    String label = getDescription(UmlViewsRepository.UseCase.Properties.useCase_, UmlMessages.UseCasePropertiesEditionPart_UseCaseLabel);		 
    ...
    String label = getDescription(UmlViewsRepository.UseCase.Properties.subject, UmlMessages.UseCasePropertiesEditionPart_SubjectLabel);		 
    this.subject = new ReferencesTable(label, new ReferencesTableListener() {
