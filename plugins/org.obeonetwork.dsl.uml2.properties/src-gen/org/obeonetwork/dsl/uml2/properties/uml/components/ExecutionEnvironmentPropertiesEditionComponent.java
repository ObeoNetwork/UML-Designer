...
public class ExecutionEnvironmentPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(UmlViewsRepository.ExecutionEnvironment.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, executionEnvironment.getName()));
			
			if (isAccessible(UmlViewsRepository.ExecutionEnvironment.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(executionEnvironment, UMLPackage.eINSTANCE.getNamedElement_Visibility()), executionEnvironment.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.ExecutionEnvironment.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.ExecutionEnvironment.Properties.isAbstract)) {
			...
			if (isAccessible(UmlViewsRepository.ExecutionEnvironment.Properties.isActive)) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.ExecutionEnvironment.Properties.name == event.getAffectedEditor()) {
			executionEnvironment.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ExecutionEnvironment.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.ExecutionEnvironment.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ExecutionEnvironment.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getClassifier_IsAbstract().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ExecutionEnvironment.Properties.isAbstract))
			...
			if (UMLPackage.eINSTANCE.getClass_IsActive().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ExecutionEnvironment.Properties.isActive))
