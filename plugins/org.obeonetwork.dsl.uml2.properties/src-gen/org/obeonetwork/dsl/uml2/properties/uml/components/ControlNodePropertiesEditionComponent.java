...
public class ControlNodePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public ControlNodePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject controlNode,
			String editing_mode) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(
						EEFUtils.choiceOfValues(controlNode,
								UMLPackage.eINSTANCE.getNamedElement_Visibility()),
						controlNode.getVisibility());
			}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			controlNode.setName((java.lang.String)EEFConverterUtil
