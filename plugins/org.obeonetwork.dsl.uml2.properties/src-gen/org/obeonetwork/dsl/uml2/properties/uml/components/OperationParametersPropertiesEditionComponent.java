...
public class OperationParametersPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public OperationParametersPropertiesEditionComponent(PropertiesEditingContext editingContext,
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.Parameters.parameters_)) {
				parametersSettings = new ReferencesTableSettings(operation,
		...
		if (UmlViewsRepository.Parameters.parameters_ == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(
						editingContext, this, parametersSettings, editingContext.getAdapterFactory());
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getBehavioralFeature_OwnedParameter().equals(msg.getFeature())
					&& isAccessible(UmlViewsRepository.Parameters.parameters_))
