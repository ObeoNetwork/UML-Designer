...
public class ActivityParameterNodePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(UmlViewsRepository.ActivityParameterNode.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, activityParameterNode.getName()));
			
			if (isAccessible(UmlViewsRepository.ActivityParameterNode.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(activityParameterNode, UMLPackage.eINSTANCE.getNamedElement_Visibility()), activityParameterNode.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.ActivityParameterNode.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.ActivityParameterNode.Properties.ordering)) {
				basePart.initOrdering(EEFUtils.choiceOfValues(activityParameterNode, UMLPackage.eINSTANCE.getObjectNode_Ordering()), activityParameterNode.getOrdering());
			}
			if (isAccessible(UmlViewsRepository.ActivityParameterNode.Properties.isControlType)) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.ActivityParameterNode.Properties.name == event.getAffectedEditor()) {
			activityParameterNode.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ActivityParameterNode.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.ActivityParameterNode.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ActivityParameterNode.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getObjectNode_Ordering().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.ActivityParameterNode.Properties.ordering))
				basePart.setOrdering((ObjectNodeOrderingKind)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getObjectNode_IsControlType().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ActivityParameterNode.Properties.isControlType))
