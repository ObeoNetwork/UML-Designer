 ...
 * @generated
 */
public class SendObjectActionPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, SendObjectActionPropertiesEditionPart {
	 ...
	 */
	public SendObjectActionPropertiesEditionPartForm() { super(); }
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              SendObjectActionPropertiesEditionPartForm.this,
              UmlViewsRepository.SendObjectAction.Properties.name,
    ...
    this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.SendObjectAction.Properties.clientDependency, UmlMessages.SendObjectActionPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
    ...
    isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.SendObjectAction.Properties.isLeaf, UmlMessages.SendObjectActionPropertiesEditionPart_IsLeafLabel), SWT.CHECK);
    ...
    this.outgoing = new ReferencesTable(getDescription(UmlViewsRepository.SendObjectAction.Properties.outgoing, UmlMessages.SendObjectActionPropertiesEditionPart_OutgoingLabel), new ReferencesTableListener	() {
    ...
    this.incoming = new ReferencesTable(getDescription(UmlViewsRepository.SendObjectAction.Properties.incoming, UmlMessages.SendObjectActionPropertiesEditionPart_IncomingLabel), new ReferencesTableListener	() {
    ...
    this.inPartition = new ReferencesTable(getDescription(UmlViewsRepository.SendObjectAction.Properties.inPartition, UmlMessages.SendObjectActionPropertiesEditionPart_InPartitionLabel), new ReferencesTableListener	() {
    ...
    this.inInterruptibleRegion = new ReferencesTable(getDescription(UmlViewsRepository.SendObjectAction.Properties.inInterruptibleRegion, UmlMessages.SendObjectActionPropertiesEditionPart_InInterruptibleRegionLabel), new ReferencesTableListener	() {
    ...
    this.redefinedNode = new ReferencesTable(getDescription(UmlViewsRepository.SendObjectAction.Properties.redefinedNode, UmlMessages.SendObjectActionPropertiesEditionPart_RedefinedNodeLabel), new ReferencesTableListener	() {
