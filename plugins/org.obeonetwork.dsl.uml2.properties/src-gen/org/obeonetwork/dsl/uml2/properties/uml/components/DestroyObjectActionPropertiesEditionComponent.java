...
public class DestroyObjectActionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(UmlViewsRepository.DestroyObjectAction.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, destroyObjectAction.getName()));
			
			if (isAccessible(UmlViewsRepository.DestroyObjectAction.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(destroyObjectAction, UMLPackage.eINSTANCE.getNamedElement_Visibility()), destroyObjectAction.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.DestroyObjectAction.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.DestroyObjectAction.Properties.isDestroyLinks)) {
				basePart.setIsDestroyLinks(destroyObjectAction.isDestroyLinks());
			}
			if (isAccessible(UmlViewsRepository.DestroyObjectAction.Properties.isDestroyOwnedObjects)) {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.name) {
			return UMLPackage.eINSTANCE.getNamedElement_Name();
		}
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.visibility) {
			return UMLPackage.eINSTANCE.getNamedElement_Visibility();
		}
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.clientDependency) {
			return UMLPackage.eINSTANCE.getNamedElement_ClientDependency();
		}
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.isLeaf) {
			return UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf();
		}
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.inStructuredNode) {
			return UMLPackage.eINSTANCE.getActivityNode_InStructuredNode();
		}
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.activity) {
			return UMLPackage.eINSTANCE.getActivityNode_Activity();
		}
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.outgoing) {
			return UMLPackage.eINSTANCE.getActivityNode_Outgoing();
		}
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.incoming) {
			return UMLPackage.eINSTANCE.getActivityNode_Incoming();
		}
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.inPartition) {
			return UMLPackage.eINSTANCE.getActivityNode_InPartition();
		}
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.inInterruptibleRegion) {
			return UMLPackage.eINSTANCE.getActivityNode_InInterruptibleRegion();
		}
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.redefinedNode) {
			return UMLPackage.eINSTANCE.getActivityNode_RedefinedNode();
		}
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.isDestroyLinks) {
			return UMLPackage.eINSTANCE.getDestroyObjectAction_IsDestroyLinks();
		}
		if (editorKey == UmlViewsRepository.DestroyObjectAction.Properties.isDestroyOwnedObjects) {
			return UMLPackage.eINSTANCE.getDestroyObjectAction_IsDestroyOwnedObjects();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.DestroyObjectAction.Properties.name == event.getAffectedEditor()) {
			destroyObjectAction.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.DestroyObjectAction.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.DestroyObjectAction.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.DestroyObjectAction.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getDestroyObjectAction_IsDestroyLinks().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.DestroyObjectAction.Properties.isDestroyLinks))
				basePart.setIsDestroyLinks((Boolean)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getDestroyObjectAction_IsDestroyOwnedObjects().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.DestroyObjectAction.Properties.isDestroyOwnedObjects))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			UMLPackage.eINSTANCE.getDestroyObjectAction_IsDestroyOwnedObjects()		);
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (UmlViewsRepository.DestroyObjectAction.Properties.isDestroyLinks == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getDestroyObjectAction_IsDestroyLinks().getEAttributeType(), (String)newValue);
					}
				...
				if (UmlViewsRepository.DestroyObjectAction.Properties.isDestroyOwnedObjects == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getDestroyObjectAction_IsDestroyOwnedObjects().getEAttributeType(), (String)newValue);
					}
