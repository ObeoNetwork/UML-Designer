 ...
 * @generated
 */
public class ExtendPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Extend) && (UMLPackage.Literals.EXTEND == editingContext.getEObject().eClass());
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Extend) {
            if (ExtendPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == ExtendPropertiesEditionComponent.class)
                return new ExtendPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
