...
public class LiteralsPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, LiteralsPropertiesEditionPart {
	...
	protected Composite createLiteralsAdvancedTableComposition(Composite parent) {
				...
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								LiteralsPropertiesEditionPartImpl.this, UmlViewsRepository.Literals.literals_,
					...
					public void handleMove(EObject element, int oldIndex, int newIndex) {
						propertiesEditionComponent.firePropertiesChanged(
								new PropertiesEditionEvent(LiteralsPropertiesEditionPartImpl.this,
		...
		this.literals.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.Literals.literals_, UmlViewsRepository.SWT_KIND));
