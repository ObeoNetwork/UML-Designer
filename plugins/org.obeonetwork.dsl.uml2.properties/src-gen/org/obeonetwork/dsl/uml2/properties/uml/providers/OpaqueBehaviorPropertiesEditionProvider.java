...
public class OpaqueBehaviorPropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof OpaqueBehavior)
				&& (OpaqueBehaviorPropertiesEditionComponent.GENERAL_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof OpaqueBehavior) {
			return new OpaqueBehaviorPropertiesEditionComponent(editingContext, editingContext.getEObject(),
					mode);
		}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof OpaqueBehavior) {
			if (OpaqueBehaviorPropertiesEditionComponent.GENERAL_PART.equals(part))
				return new OpaqueBehaviorPropertiesEditionComponent(editingContext,
