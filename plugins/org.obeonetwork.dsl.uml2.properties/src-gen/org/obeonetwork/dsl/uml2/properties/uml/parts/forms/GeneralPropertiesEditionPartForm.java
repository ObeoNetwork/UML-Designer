...
public class GeneralPropertiesEditionPartForm extends CustomSectionPropertiesEditingPart implements IFormPropertiesEditionPart, GeneralPropertiesEditionPart {
		...
		composer = new PartComposer(generalStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == UmlViewsRepository.General.unmarshall) {
					return createUnmarshallCheckbox(widgetFactory, parent);
				}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.name,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this,
									UmlViewsRepository.General.name, PropertiesEditionEvent.FOCUS_CHANGED,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.name, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.visibility, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createOrderedCheckbox(FormToolkit widgetFactory, Composite parent) {
		ordered = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.Qualifiers.ordered,
		...
		FormUtils
				.createHelpButton(widgetFactory, parent,
						propertiesEditionComponent.getHelpContent(
								UmlViewsRepository.General.Qualifiers.ordered, UmlViewsRepository.FORM_KIND),
				null); // $NON-NLS-1$
	...
	protected Composite createAbstract_Checkbox(FormToolkit widgetFactory, Composite parent) {
		abstract_ = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.Qualifiers.abstract_,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.abstract_, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		leaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.General.Qualifiers.leaf,
				UmlMessages.GeneralPropertiesEditionPart_LeafLabel), SWT.CHECK);
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.leaf, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createStatic_Checkbox(FormToolkit widgetFactory, Composite parent) {
		static_ = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.Qualifiers.static_,
		...
		FormUtils
				.createHelpButton(widgetFactory, parent,
						propertiesEditionComponent.getHelpContent(
								UmlViewsRepository.General.Qualifiers.static_, UmlViewsRepository.FORM_KIND),
				null); // $NON-NLS-1$
	...
	protected Composite createUniqueCheckbox(FormToolkit widgetFactory, Composite parent) {
		unique = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.Qualifiers.unique,
		...
		FormUtils
				.createHelpButton(widgetFactory, parent,
						propertiesEditionComponent.getHelpContent(
								UmlViewsRepository.General.Qualifiers.unique, UmlViewsRepository.FORM_KIND),
				null); // $NON-NLS-1$
	...
	protected Composite createQueryCheckbox(FormToolkit widgetFactory, Composite parent) {
		query = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.General.Qualifiers.query,
				UmlMessages.GeneralPropertiesEditionPart_QueryLabel), SWT.CHECK);
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.query, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createReadOnlyCheckbox(FormToolkit widgetFactory, Composite parent) {
		readOnly = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.Qualifiers.readOnly,
		...
		FormUtils
				.createHelpButton(widgetFactory, parent,
						propertiesEditionComponent.getHelpContent(
								UmlViewsRepository.General.Qualifiers.readOnly, UmlViewsRepository.FORM_KIND),
				null); // $NON-NLS-1$
	...
	protected Composite createDerivedCheckbox(FormToolkit widgetFactory, Composite parent) {
		derived = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.Qualifiers.derived,
		...
		FormUtils
				.createHelpButton(widgetFactory, parent,
						propertiesEditionComponent.getHelpContent(
								UmlViewsRepository.General.Qualifiers.derived, UmlViewsRepository.FORM_KIND),
				null); // $NON-NLS-1$
	...
	protected Composite createDerivedUnionCheckbox(FormToolkit widgetFactory, Composite parent) {
		derivedUnion = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.Qualifiers.derivedUnion,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.derivedUnion, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSubstitutableCheckbox(FormToolkit widgetFactory, Composite parent) {
		substitutable = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.Qualifiers.substitutable,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.substitutable, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createActiveCheckbox(FormToolkit widgetFactory, Composite parent) {
		active = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.Qualifiers.active,
		...
		FormUtils
				.createHelpButton(widgetFactory, parent,
						propertiesEditionComponent.getHelpContent(
								UmlViewsRepository.General.Qualifiers.active, UmlViewsRepository.FORM_KIND),
				null); // $NON-NLS-1$
	...
	protected Composite createBehaviorCheckbox(FormToolkit widgetFactory, Composite parent) {
		behavior = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.Qualifiers.behavior,
		...
		FormUtils
				.createHelpButton(widgetFactory, parent,
						propertiesEditionComponent.getHelpContent(
								UmlViewsRepository.General.Qualifiers.behavior, UmlViewsRepository.FORM_KIND),
				null); // $NON-NLS-1$
	...
	protected Composite createServiceCheckbox(FormToolkit widgetFactory, Composite parent) {
		service = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.Qualifiers.service,
		...
		FormUtils
				.createHelpButton(widgetFactory, parent,
						propertiesEditionComponent.getHelpContent(
								UmlViewsRepository.General.Qualifiers.service, UmlViewsRepository.FORM_KIND),
				null); // $NON-NLS-1$
	...
	protected Composite createReentrantCheckbox(FormToolkit widgetFactory, Composite parent) {
		reentrant = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.Qualifiers.reentrant,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.reentrant, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createIndirectlyInstantiatedCheckbox(FormToolkit widgetFactory, Composite parent) {
		indirectlyInstantiated = widgetFactory
				.createButton(parent,
						getDescription(UmlViewsRepository.General.Qualifiers.indirectlyInstantiated,
	...
	protected Composite createTypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.type,
		...
		// create widget
		type = new AdvancedEObjectFlatComboViewer(UmlMessages.GeneralPropertiesEditionPart_TypeLabel,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.type, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createDirectionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		direction.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.direction,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.direction, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createAggregationEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.aggregation, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createLowerValueText(FormToolkit widgetFactory, Composite parent) {
		...
		lowerValue.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.lowerValue,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.lowerValue, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createUpperValueText(FormToolkit widgetFactory, Composite parent) {
		...
		upperValue.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.upperValue,
							PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
							upperValue.getText()));
				}
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.upperValue, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createDefaultValueLinkEReferenceViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.defaultValue,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		defaultValue = new LinkEReferenceViewer(UmlMessages.GeneralPropertiesEditionPart_DefaultValueLabel,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.defaultValue, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createMemberEndReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.memberEnd = new ReferencesTable(
				getDescription(UmlViewsRepository.General.memberEnd,
		...
		this.memberEnd.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.memberEnd, UmlViewsRepository.FORM_KIND));
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(memberEnd.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.memberEnd,
	...
	protected Composite createSupplierReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.supplier = new ReferencesTable(
				getDescription(UmlViewsRepository.General.supplier,
		...
		this.supplier.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.supplier, UmlViewsRepository.FORM_KIND));
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(supplier.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject)iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.supplier,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				supplier.refresh();
			}
	...
	protected Composite createClientReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.client = new ReferencesTable(getDescription(UmlViewsRepository.General.client,
				UmlMessages.GeneralPropertiesEditionPart_ClientLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addClient();
					}
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(client.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject)iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.client,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				client.refresh();
			}
	...
	protected Composite createKindEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		kind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.kind,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.kind, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createKind_readonlyEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.kind_readonly, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createTriggerTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.trigger = new ReferencesTable(
				...
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.trigger,
								PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
						trigger.refresh();
					}
	...
	protected Composite createEffectSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		effect.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.effect,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.effect, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createGuardLinkEReferenceViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.guard,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		guard = new LinkEReferenceViewer(UmlMessages.GeneralPropertiesEditionPart_GuardLabel, resourceSet,
				guardFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(), listener);
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.guard, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSourceFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.source,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		source = new AdvancedEObjectFlatComboViewer(UmlMessages.GeneralPropertiesEditionPart_SourceLabel,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.source, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createTargetFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.target,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		target = new AdvancedEObjectFlatComboViewer(UmlMessages.GeneralPropertiesEditionPart_TargetLabel,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.target, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createOwnedRuleTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedRule = new ReferencesTable(
				...
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.ownedRule,
								PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
						ownedRule.refresh();
					}
		...
		this.ownedRule.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.ownedRule, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createIconImageViewer(FormToolkit widgetFactory, Composite parent) {
		...
		icon.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.icon,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getIcon()));
			}
		});
		icon.setID(UmlViewsRepository.General.icon);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.icon, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createExtendedCaseEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.extendedCase, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createAdditionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		addition.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.addition,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.addition, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createRoleFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.role,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		role = new AdvancedEObjectFlatComboViewer(UmlMessages.GeneralPropertiesEditionPart_RoleLabel,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.role, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createUsecaseReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.usecase = new ReferencesTable(
				getDescription(UmlViewsRepository.General.usecase,
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(usecase.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject)iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.usecase,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				usecase.refresh();
			}
	...
	protected Composite createSubjectsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.subjects = new ReferencesTable(
				getDescription(UmlViewsRepository.General.subjects,
		...
		this.subjects.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.subjects, UmlViewsRepository.FORM_KIND));
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(subjects.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject)iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.subjects,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				subjects.refresh();
			}
	...
	protected Composite createEntryFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.entry,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		entry = new AdvancedEObjectFlatComboViewer(UmlMessages.GeneralPropertiesEditionPart_EntryLabel,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.entry, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createExitFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.exit,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		exit = new AdvancedEObjectFlatComboViewer(UmlMessages.GeneralPropertiesEditionPart_ExitLabel,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.exit, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createDo_FlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.do_,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		do_ = new AdvancedEObjectFlatComboViewer(UmlMessages.GeneralPropertiesEditionPart_Do_Label,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.do_, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSubmachineLinkEReferenceViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.submachine,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		submachine = new LinkEReferenceViewer(UmlMessages.GeneralPropertiesEditionPart_SubmachineLabel,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.submachine, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSpecificationSingleCompositionEditor(Composite parent,
		...
		specification.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.specification,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.specification, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createInstanceValueLinkEReferenceViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.instanceValue,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		instanceValue = new LinkEReferenceViewer(UmlMessages.GeneralPropertiesEditionPart_InstanceValueLabel,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.instanceValue, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createMinLinkFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.min,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		min = new LinkEObjectFlatComboViewer(UmlMessages.GeneralPropertiesEditionPart_MinLabel, resourceSet,
				minFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(), listener);
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.min, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createInstanceLinkFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.instance,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		instance = new LinkEObjectFlatComboViewer(UmlMessages.GeneralPropertiesEditionPart_InstanceLabel,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.instance, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createMaxLinkFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.max,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		max = new LinkEObjectFlatComboViewer(UmlMessages.GeneralPropertiesEditionPart_MaxLabel, resourceSet,
				maxFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(), listener);
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.max, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createEventLinkEReferenceViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.event,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		event = new LinkEReferenceViewer(UmlMessages.GeneralPropertiesEditionPart_EventLabel, resourceSet,
				eventFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(), listener);
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.event, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createWhenSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		when.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.when,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));
				when.refresh();
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.when, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createChangeExpressionSingleCompositionEditor(Composite parent,
		...
		changeExpression.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.changeExpression,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.changeExpression, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createRegionSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		region.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.region,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));
				region.refresh();
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.region, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createBehaviourFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.behaviour,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		behaviour = new AdvancedEObjectFlatComboViewer(
				UmlMessages.GeneralPropertiesEditionPart_BehaviourLabel, resourceSet, behaviourFilter,
				propertiesEditionComponent.getEditingContext().getAdapterFactory(), listener);
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.behaviour, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createUnmarshallCheckbox(FormToolkit widgetFactory, Composite parent) {
		unmarshall = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.General.unmarshall,
				UmlMessages.GeneralPropertiesEditionPart_UnmarshallLabel), SWT.CHECK);
		unmarshall.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.unmarshall,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.unmarshall, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createOperationFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		operation = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
				.isRequired(UmlViewsRepository.General.operation, UmlViewsRepository.FORM_KIND));
		...
		operation.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.operation,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOperation()));
			}

		});
		operation.setID(UmlViewsRepository.General.operation);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.operation, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSignalFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		signal = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
				.isRequired(UmlViewsRepository.General.signal, UmlViewsRepository.FORM_KIND));
		...
		signal.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.signal,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getSignal()));
			}

		});
		signal.setID(UmlViewsRepository.General.signal);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.signal, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSymbolText(FormToolkit widgetFactory, Composite parent) {
		...
		symbol.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					...
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this,
									UmlViewsRepository.General.symbol, PropertiesEditionEvent.FOCUS_CHANGED,
									PropertiesEditionEvent.FOCUS_LOST, null, symbol.getText()));
				}
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.symbol, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createNameExpressionSingleCompositionViewer(FormToolkit widgetFactory,
			Composite parent) {
		...
		this.nameExpression = new SingleCompositionViewer<EObject>(
				...
				parent, SWT.NONE, widgetFactory, UmlViewsRepository.FORM_KIND, propertiesEditionComponent
						.isRequired(UmlViewsRepository.General.nameExpression, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createOperandTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.operand = new ReferencesTable(
				...
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.operand,
								PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
						operand.refresh();
					}
	...
	protected Composite createBooleanValueCheckbox(FormToolkit widgetFactory, Composite parent) {
		booleanValue = widgetFactory.createButton(parent,
				getDescription(UmlViewsRepository.General.booleanValue,
		...
		booleanValue.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.booleanValue,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.booleanValue, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createIntegerValueText(FormToolkit widgetFactory, Composite parent) {
		...
		integerValue.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.integerValue,
							PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
							integerValue.getText()));
				}
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.integerValue, UmlViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createLanguageMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editLanguage = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.General.language,
				UmlMessages.GeneralPropertiesEditionPart_LanguageLabel), SWT.NONE);
		...
		editLanguage.addSelectionListener(new SelectionAdapter() {
			 ...
			 */
			public void widgetSelected(SelectionEvent e) {
				EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(language.getShell(),
						"DurationObservation", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
	...
	protected Composite createBodyMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editBody = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.General.body,
				UmlMessages.GeneralPropertiesEditionPart_BodyLabel), SWT.NONE);
		...
		editBody.addSelectionListener(new SelectionAdapter() {
			 ...
			 */
			public void widgetSelected(SelectionEvent e) {
				EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(body.getShell(),
						"DurationObservation", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
	 ...
	 * @generated
	 */
	protected TableViewer createObservationViewer(Composite container, FormToolkit widgetFactory,
	...
	protected void createObservationControlPanel(Composite container, FormToolkit widgetFactory) {
		...
		addObservation = widgetFactory.createButton(result,
				UmlMessages.PropertiesEditionPart_AddListViewerLabel, SWT.NONE);
		...
		removeObservation = widgetFactory.createButton(result,
				UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, SWT.NONE);
		...
		EMFModelViewerDialog dialog = new EMFModelViewerDialog(
			...
			public void process(IStructuredSelection selection) {
				for (Iterator iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject)iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, UmlViewsRepository.General.observation,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
			}
