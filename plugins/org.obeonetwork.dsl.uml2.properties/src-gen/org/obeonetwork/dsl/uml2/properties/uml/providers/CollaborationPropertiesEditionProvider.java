...
public class CollaborationPropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof Collaboration)
				&& (CollaborationPropertiesEditionComponent.GENERAL_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof Collaboration) {
			return new CollaborationPropertiesEditionComponent(editingContext, editingContext.getEObject(),
					mode);
		}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof Collaboration) {
			if (CollaborationPropertiesEditionComponent.GENERAL_PART.equals(part))
				return new CollaborationPropertiesEditionComponent(editingContext,
