 ...
 * @generated
 */
public class CollaborationPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Collaboration) && (UMLPackage.Literals.COLLABORATION == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof Collaboration)
                && ((CollaborationPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == CollaborationPropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Collaboration) {
            if (CollaborationPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == CollaborationPropertiesEditionComponent.class)
                return new CollaborationPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
