...
public class Interface_PropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Interface) && (UMLPackage.Literals.INTERFACE == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part) {
        return (editingContext.getEObject() instanceof Interface)
                && (InterfaceGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) || InterfaceOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part) || InterfaceAttributesPropertiesEditionComponent.ATTRIBUTES_PART
                        .equals(part));
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof Interface)
                && (refinement == InterfaceGeneralPropertiesEditionComponent.class || refinement == InterfaceOperationsPropertiesEditionComponent.class || refinement == InterfaceAttributesPropertiesEditionComponent.class);
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof Interface)
                && ((InterfaceGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == InterfaceGeneralPropertiesEditionComponent.class)
                        || (InterfaceOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part) && refinement == InterfaceOperationsPropertiesEditionComponent.class) || (InterfaceAttributesPropertiesEditionComponent.ATTRIBUTES_PART
                        .equals(part) && refinement == InterfaceAttributesPropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Interface) {
            if (InterfaceGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == InterfaceGeneralPropertiesEditionComponent.class)
                return new InterfaceGeneralPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (InterfaceOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part) && refinement == InterfaceOperationsPropertiesEditionComponent.class)
                return new InterfaceOperationsPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (InterfaceAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part) && refinement == InterfaceAttributesPropertiesEditionComponent.class)
                return new InterfaceAttributesPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
