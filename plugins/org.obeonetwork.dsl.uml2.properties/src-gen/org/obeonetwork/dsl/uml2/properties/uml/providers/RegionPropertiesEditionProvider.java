...
public class RegionPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Region) && (UMLPackage.Literals.REGION == editingContext.getEObject().eClass());
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Region) {
            if (RegionPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == RegionPropertiesEditionComponent.class)
                return new RegionPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
