...
import org.obeonetwork.dsl.uml2.properties.uml.components.TemplateParameterSubstitutionPropertiesEditionComponent;

/**
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 * 
 */
public class TemplateParameterSubstitutionPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public TemplateParameterSubstitutionPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public TemplateParameterSubstitutionPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof TemplateParameterSubstitution) 
					&& (UMLPackage.eINSTANCE.getTemplateParameterSubstitution() == editingContext.getEObject().eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
		if (editingContext.getEObject() instanceof TemplateParameterSubstitution) {
			if (TemplateParameterSubstitutionPropertiesEditionComponent.BASE_PART.equals(part)
				&& refinement == TemplateParameterSubstitutionPropertiesEditionComponent.class)
				return new TemplateParameterSubstitutionPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
