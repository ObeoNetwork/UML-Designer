...
public class ReadStructuralFeatureActionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
    ...
    partKey = UmlViewsRepository.ReadStructuralFeatureAction.class;
  }
    ...
    if (editingPart != null && key == partKey) {
      ...
      if (isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.activity)) {
        // init part
        activitySettings = new EObjectFlatComboSettings(readStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_Activity());
      ...
      if (isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.outgoing)) {
        outgoingSettings = new ReferencesTableSettings(readStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_Outgoing());
        basePart.initOutgoing(outgoingSettings);
      }
      if (isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.incoming)) {
        incomingSettings = new ReferencesTableSettings(readStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_Incoming());
      ...
      if (isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.inPartition)) {
        inPartitionSettings = new ReferencesTableSettings(readStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_InPartition());
      ...
      if (isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.inInterruptibleRegion)) {
        inInterruptibleRegionSettings = new ReferencesTableSettings(readStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_InInterruptibleRegion());
      ...
      if (isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.redefinedNode)) {
        redefinedNodeSettings = new ReferencesTableSettings(readStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_RedefinedNode());
      ...
      if (isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.structuralFeature)) {
        // init part
        structuralFeatureSettings = new EObjectFlatComboSettings(readStructuralFeatureAction, UMLPackage.eINSTANCE.getStructuralFeatureAction_StructuralFeature());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == UmlViewsRepository.ReadStructuralFeatureAction.Properties.visibility) {
			return UMLPackage.eINSTANCE.getNamedElement_Visibility();
		}
		if (editorKey == UmlViewsRepository.ReadStructuralFeatureAction.Properties.clientDependency) {
			return UMLPackage.eINSTANCE.getNamedElement_ClientDependency();
		}
		if (editorKey == UmlViewsRepository.ReadStructuralFeatureAction.Properties.isLeaf) {
			return UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf();
		}
		if (editorKey == UmlViewsRepository.ReadStructuralFeatureAction.Properties.inStructuredNode) {
			return UMLPackage.eINSTANCE.getActivityNode_InStructuredNode();
		}
		if (editorKey == UmlViewsRepository.ReadStructuralFeatureAction.Properties.activity) {
			return UMLPackage.eINSTANCE.getActivityNode_Activity();
		}
		if (editorKey == UmlViewsRepository.ReadStructuralFeatureAction.Properties.outgoing) {
			return UMLPackage.eINSTANCE.getActivityNode_Outgoing();
		}
		if (editorKey == UmlViewsRepository.ReadStructuralFeatureAction.Properties.incoming) {
			return UMLPackage.eINSTANCE.getActivityNode_Incoming();
		}
		if (editorKey == UmlViewsRepository.ReadStructuralFeatureAction.Properties.inPartition) {
			return UMLPackage.eINSTANCE.getActivityNode_InPartition();
		}
		if (editorKey == UmlViewsRepository.ReadStructuralFeatureAction.Properties.inInterruptibleRegion) {
			return UMLPackage.eINSTANCE.getActivityNode_InInterruptibleRegion();
		}
		if (editorKey == UmlViewsRepository.ReadStructuralFeatureAction.Properties.redefinedNode) {
			return UMLPackage.eINSTANCE.getActivityNode_RedefinedNode();
		}
		if (editorKey == UmlViewsRepository.ReadStructuralFeatureAction.Properties.structuralFeature) {
    ...
    if (UmlViewsRepository.ReadStructuralFeatureAction.Properties.clientDependency == event.getAffectedEditor()) {
    ...
    if (UmlViewsRepository.ReadStructuralFeatureAction.Properties.isLeaf == event.getAffectedEditor()) {
      readStructuralFeatureAction.setIsLeaf((Boolean)event.getNewValue());
    }
    if (UmlViewsRepository.ReadStructuralFeatureAction.Properties.inStructuredNode == event.getAffectedEditor()) {
    ...
    if (UmlViewsRepository.ReadStructuralFeatureAction.Properties.activity == event.getAffectedEditor()) {
      if (event.getKind() == PropertiesEditionEvent.SET) {
    ...
    if (UmlViewsRepository.ReadStructuralFeatureAction.Properties.outgoing == event.getAffectedEditor()) {
      if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getActivityNode_Activity().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.activity))
				basePart.setActivity((EObject)msg.getNewValue());
			if (UMLPackage.eINSTANCE.getActivityNode_Outgoing().equals(msg.getFeature())  && isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.outgoing))
				basePart.updateOutgoing();
			if (UMLPackage.eINSTANCE.getActivityNode_Incoming().equals(msg.getFeature())  && isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.incoming))
				basePart.updateIncoming();
			if (UMLPackage.eINSTANCE.getActivityNode_InPartition().equals(msg.getFeature())  && isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.inPartition))
				basePart.updateInPartition();
			if (UMLPackage.eINSTANCE.getActivityNode_InInterruptibleRegion().equals(msg.getFeature())  && isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.inInterruptibleRegion))
				basePart.updateInInterruptibleRegion();
			if (UMLPackage.eINSTANCE.getActivityNode_RedefinedNode().equals(msg.getFeature())  && isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.redefinedNode))
				basePart.updateRedefinedNode();
			if (UMLPackage.eINSTANCE.getStructuralFeatureAction_StructuralFeature().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.ReadStructuralFeatureAction.Properties.structuralFeature))
