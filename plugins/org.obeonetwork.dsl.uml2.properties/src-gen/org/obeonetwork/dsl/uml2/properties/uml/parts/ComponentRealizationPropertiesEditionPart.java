 ...
 * 
 */
public interface ComponentRealizationPropertiesEditionPart {
	 ...
	 * @param newValue the new abstraction to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the abstraction edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * Init the realizingClassifier
	 * @param settings settings for the realizingClassifier ReferencesTable 
	 */
	public void initRealizingClassifier(ReferencesTableSettings settings);

	/**
	 * Update the realizingClassifier
	 * @param newValue the realizingClassifier to update
	 * 
	 */
	public void updateRealizingClassifier();

	/**
	 * Adds the given filter to the realizingClassifier edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the realizingClassifier table
	 * 
	 */
