...
import org.obeonetwork.dsl.uml2.properties.uml.components.ActorPropertiesEditionComponent;

/**
 * @author <a href="mailto:cedric.brun@obeo.fr">Cédric Brun</a>
 * @generated
 */
public class ActorPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Actor) && (UMLPackage.Literals.ACTOR == editingContext.getEObject().eClass());
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Actor) {
            if (ActorPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == ActorPropertiesEditionComponent.class)
                return new ActorPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
    ...
    public static class EditionFilter implements IFilter {
        ...
        public boolean select(Object toTest) {
            ...
            return eObj != null && UMLPackage.Literals.ACTOR == eObj.eClass();
        }
