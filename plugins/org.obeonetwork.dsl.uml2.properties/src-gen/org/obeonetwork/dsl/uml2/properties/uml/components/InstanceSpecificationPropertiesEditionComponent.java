...
public class InstanceSpecificationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public InstanceSpecificationPropertiesEditionComponent(PropertiesEditingContext editingContext,
			EObject instanceSpecification, String editing_mode) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			instanceSpecification.setName((java.lang.String)EEFConverterUtil
