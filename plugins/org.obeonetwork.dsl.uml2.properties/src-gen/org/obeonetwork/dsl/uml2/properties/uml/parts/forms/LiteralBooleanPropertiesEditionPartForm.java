 ...
 * @generated
 */
public class LiteralBooleanPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, LiteralBooleanPropertiesEditionPart {
	 ...
	 */
	public LiteralBooleanPropertiesEditionPartForm() { super(); }
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              LiteralBooleanPropertiesEditionPartForm.this,
              UmlViewsRepository.LiteralBoolean.Properties.name,
    ...
    this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.LiteralBoolean.Properties.clientDependency, UmlMessages.LiteralBooleanPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
    ...
    value = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.LiteralBoolean.Properties.value, UmlMessages.LiteralBooleanPropertiesEditionPart_ValueLabel), SWT.CHECK);
