 ...
 * @generated
 */
public class VertexGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public VertexGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject vertex, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.name))
				generalPart.setName(EEFConverterUtil.convertToString(TypesPackage.Literals.STRING, vertex.getName()));
			
			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(EEFUtils.choiceOfValues(vertex, UMLPackage.eINSTANCE.getNamedElement_Visibility()), vertex.getVisibility());
			}
			// init filters
