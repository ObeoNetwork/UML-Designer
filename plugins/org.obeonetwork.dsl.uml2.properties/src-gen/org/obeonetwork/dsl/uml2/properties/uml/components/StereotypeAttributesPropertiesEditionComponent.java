 ...
 * @generated
 */
public class StereotypeAttributesPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {

    /**
     * @generated
     */

    public static String ATTRIBUTES_PART = "Attributes"; //$NON-NLS-1$
     ...
     * @generated
     */
    public StereotypeAttributesPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject stereotype, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(UmlViewsRepository.Attributes.attributes_)) {
                attributesSettings = new ReferencesTableSettings(stereotype, UMLPackage.eINSTANCE.getStructuredClassifier_OwnedAttribute());
    ...
    public EStructuralFeature associatedFeature(Object editorKey) {
        if (editorKey == UmlViewsRepository.Attributes.attributes_) {
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            AttributesPropertiesEditionPart attributesPart = (AttributesPropertiesEditionPart) editingPart;
            if (UMLPackage.eINSTANCE.getStructuredClassifier_OwnedAttribute().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.Attributes.attributes_))
                attributesPart.updateAttributes();
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(UMLPackage.eINSTANCE.getStructuredClassifier_OwnedAttribute());
