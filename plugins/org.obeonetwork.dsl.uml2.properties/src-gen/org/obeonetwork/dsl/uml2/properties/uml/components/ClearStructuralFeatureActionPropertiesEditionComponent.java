 ...
 * @generated
 */
public class ClearStructuralFeatureActionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public ClearStructuralFeatureActionPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject clearStructuralFeatureAction, String editing_mode) {
		super(editingContext, clearStructuralFeatureAction, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = UmlViewsRepository.class;
		partKey = UmlViewsRepository.ClearStructuralFeatureAction.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final ClearStructuralFeatureAction clearStructuralFeatureAction = (ClearStructuralFeatureAction)elt;
			final ClearStructuralFeatureActionPropertiesEditionPart basePart = (ClearStructuralFeatureActionPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, clearStructuralFeatureAction.getName()));
			
			if (isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(clearStructuralFeatureAction, UMLPackage.eINSTANCE.getNamedElement_Visibility()), clearStructuralFeatureAction.getVisibility());
			}
			if (isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.clientDependency)) {
				clientDependencySettings = new ReferencesTableSettings(clearStructuralFeatureAction, UMLPackage.eINSTANCE.getNamedElement_ClientDependency());
				basePart.initClientDependency(clientDependencySettings);
			}
			if (isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.isLeaf)) {
				basePart.setIsLeaf(clearStructuralFeatureAction.isLeaf());
			}
			if (isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.inStructuredNode)) {
				// init part
				inStructuredNodeSettings = new EObjectFlatComboSettings(clearStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_InStructuredNode());
				basePart.initInStructuredNode(inStructuredNodeSettings);
				// set the button mode
				basePart.setInStructuredNodeButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.activity)) {
				// init part
				activitySettings = new EObjectFlatComboSettings(clearStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_Activity());
				basePart.initActivity(activitySettings);
				// set the button mode
				basePart.setActivityButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.outgoing)) {
				outgoingSettings = new ReferencesTableSettings(clearStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_Outgoing());
				basePart.initOutgoing(outgoingSettings);
			}
			if (isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.incoming)) {
				incomingSettings = new ReferencesTableSettings(clearStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_Incoming());
				basePart.initIncoming(incomingSettings);
			}
			if (isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.inPartition)) {
				inPartitionSettings = new ReferencesTableSettings(clearStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_InPartition());
				basePart.initInPartition(inPartitionSettings);
			}
			if (isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.inInterruptibleRegion)) {
				inInterruptibleRegionSettings = new ReferencesTableSettings(clearStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_InInterruptibleRegion());
				basePart.initInInterruptibleRegion(inInterruptibleRegionSettings);
			}
			if (isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.redefinedNode)) {
				redefinedNodeSettings = new ReferencesTableSettings(clearStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_RedefinedNode());
				basePart.initRedefinedNode(redefinedNodeSettings);
			}
			if (isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.structuralFeature)) {
				// init part
				structuralFeatureSettings = new EObjectFlatComboSettings(clearStructuralFeatureAction, UMLPackage.eINSTANCE.getStructuralFeatureAction_StructuralFeature());
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		ClearStructuralFeatureAction clearStructuralFeatureAction = (ClearStructuralFeatureAction)semanticObject;
		if (UmlViewsRepository.ClearStructuralFeatureAction.Properties.name == event.getAffectedEditor()) {
			clearStructuralFeatureAction.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (UmlViewsRepository.ClearStructuralFeatureAction.Properties.visibility == event.getAffectedEditor()) {
		...
		if (UmlViewsRepository.ClearStructuralFeatureAction.Properties.isLeaf == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			ClearStructuralFeatureActionPropertiesEditionPart basePart = (ClearStructuralFeatureActionPropertiesEditionPart)editingPart;
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.visibility))
				basePart.setVisibility((VisibilityKind)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getNamedElement_ClientDependency().equals(msg.getFeature())  && isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.clientDependency))
				basePart.updateClientDependency();
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.isLeaf))
				basePart.setIsLeaf((Boolean)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getActivityNode_InStructuredNode().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.inStructuredNode))
				basePart.setInStructuredNode((EObject)msg.getNewValue());
			if (UMLPackage.eINSTANCE.getActivityNode_Activity().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.activity))
				basePart.setActivity((EObject)msg.getNewValue());
			if (UMLPackage.eINSTANCE.getActivityNode_Outgoing().equals(msg.getFeature())  && isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.outgoing))
				basePart.updateOutgoing();
			if (UMLPackage.eINSTANCE.getActivityNode_Incoming().equals(msg.getFeature())  && isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.incoming))
				basePart.updateIncoming();
			if (UMLPackage.eINSTANCE.getActivityNode_InPartition().equals(msg.getFeature())  && isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.inPartition))
				basePart.updateInPartition();
			if (UMLPackage.eINSTANCE.getActivityNode_InInterruptibleRegion().equals(msg.getFeature())  && isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.inInterruptibleRegion))
				basePart.updateInInterruptibleRegion();
			if (UMLPackage.eINSTANCE.getActivityNode_RedefinedNode().equals(msg.getFeature())  && isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.redefinedNode))
				basePart.updateRedefinedNode();
			if (UMLPackage.eINSTANCE.getStructuralFeatureAction_StructuralFeature().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.ClearStructuralFeatureAction.Properties.structuralFeature))
	...
	public boolean isRequired(Object key, int kind) {
		return key == UmlViewsRepository.ClearStructuralFeatureAction.Properties.isLeaf || key == UmlViewsRepository.ClearStructuralFeatureAction.Properties.structuralFeature;
	}
