 ...
 * @generated
 */
public class ValuePinPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ValuePinPropertiesEditionPart {
	 ...
	 */
	public ValuePinPropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ValuePinPropertiesEditionPartForm.this,
							UmlViewsRepository.ValuePin.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.ValuePin.Properties.clientDependency, UmlMessages.ValuePinPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.ValuePin.Properties.isLeaf, UmlMessages.ValuePinPropertiesEditionPart_IsLeafLabel), SWT.CHECK);
	...
	protected Composite createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outgoing = new ReferencesTable(getDescription(UmlViewsRepository.ValuePin.Properties.outgoing, UmlMessages.ValuePinPropertiesEditionPart_OutgoingLabel), new ReferencesTableListener	() {
	...
	protected Composite createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incoming = new ReferencesTable(getDescription(UmlViewsRepository.ValuePin.Properties.incoming, UmlMessages.ValuePinPropertiesEditionPart_IncomingLabel), new ReferencesTableListener	() {
	...
	protected Composite createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inPartition = new ReferencesTable(getDescription(UmlViewsRepository.ValuePin.Properties.inPartition, UmlMessages.ValuePinPropertiesEditionPart_InPartitionLabel), new ReferencesTableListener	() {
	...
	protected Composite createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inInterruptibleRegion = new ReferencesTable(getDescription(UmlViewsRepository.ValuePin.Properties.inInterruptibleRegion, UmlMessages.ValuePinPropertiesEditionPart_InInterruptibleRegionLabel), new ReferencesTableListener	() {
	...
	protected Composite createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedNode = new ReferencesTable(getDescription(UmlViewsRepository.ValuePin.Properties.redefinedNode, UmlMessages.ValuePinPropertiesEditionPart_RedefinedNodeLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsControlTypeCheckbox(FormToolkit widgetFactory, Composite parent) {
		isControlType = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.ValuePin.Properties.isControlType, UmlMessages.ValuePinPropertiesEditionPart_IsControlTypeLabel), SWT.CHECK);
	...
	protected Composite createInStateReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inState = new ReferencesTable(getDescription(UmlViewsRepository.ValuePin.Properties.inState, UmlMessages.ValuePinPropertiesEditionPart_InStateLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsOrderedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOrdered = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.ValuePin.Properties.isOrdered, UmlMessages.ValuePinPropertiesEditionPart_IsOrderedLabel), SWT.CHECK);
	...
	protected Composite createIsUniqueCheckbox(FormToolkit widgetFactory, Composite parent) {
		isUnique = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.ValuePin.Properties.isUnique, UmlMessages.ValuePinPropertiesEditionPart_IsUniqueLabel), SWT.CHECK);
	...
	protected Composite createIsControlCheckbox(FormToolkit widgetFactory, Composite parent) {
		isControl = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.ValuePin.Properties.isControl, UmlMessages.ValuePinPropertiesEditionPart_IsControlLabel), SWT.CHECK);
