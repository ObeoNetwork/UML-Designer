...
public class DataTypeGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public DataTypeGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext,
			EObject dataType, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.name))
				generalPart.setName(
						EEFConverterUtil.convertToString(TypesPackage.Literals.STRING, dataType.getName()));

			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(
						EEFUtils.choiceOfValues(dataType, UMLPackage.eINSTANCE.getNamedElement_Visibility()),
						dataType.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.General.usecase)) {
				usecaseSettings = new ReferencesTableSettings(dataType,
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			dataType.setName((java.lang.String)EEFConverterUtil.createFromString(TypesPackage.Literals.STRING,
