 ...
 * @generated
 */
public class JoinNodePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, JoinNodePropertiesEditionPart {
	 ...
	 */
	public JoinNodePropertiesEditionPartForm() { super(); }
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              JoinNodePropertiesEditionPartForm.this,
              UmlViewsRepository.JoinNode.Properties.name,
    ...
    this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.JoinNode.Properties.clientDependency, UmlMessages.JoinNodePropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
    ...
    isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.JoinNode.Properties.isLeaf, UmlMessages.JoinNodePropertiesEditionPart_IsLeafLabel), SWT.CHECK);
    ...
    this.outgoing = new ReferencesTable(getDescription(UmlViewsRepository.JoinNode.Properties.outgoing, UmlMessages.JoinNodePropertiesEditionPart_OutgoingLabel), new ReferencesTableListener	() {
    ...
    this.incoming = new ReferencesTable(getDescription(UmlViewsRepository.JoinNode.Properties.incoming, UmlMessages.JoinNodePropertiesEditionPart_IncomingLabel), new ReferencesTableListener	() {
    ...
    this.inPartition = new ReferencesTable(getDescription(UmlViewsRepository.JoinNode.Properties.inPartition, UmlMessages.JoinNodePropertiesEditionPart_InPartitionLabel), new ReferencesTableListener	() {
    ...
    this.inInterruptibleRegion = new ReferencesTable(getDescription(UmlViewsRepository.JoinNode.Properties.inInterruptibleRegion, UmlMessages.JoinNodePropertiesEditionPart_InInterruptibleRegionLabel), new ReferencesTableListener	() {
    ...
    this.redefinedNode = new ReferencesTable(getDescription(UmlViewsRepository.JoinNode.Properties.redefinedNode, UmlMessages.JoinNodePropertiesEditionPart_RedefinedNodeLabel), new ReferencesTableListener	() {
    ...
    isCombineDuplicate = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.JoinNode.Properties.isCombineDuplicate, UmlMessages.JoinNodePropertiesEditionPart_IsCombineDuplicateLabel), SWT.CHECK);
