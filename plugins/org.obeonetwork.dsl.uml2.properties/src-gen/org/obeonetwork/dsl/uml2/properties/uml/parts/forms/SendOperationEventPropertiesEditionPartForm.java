 ...
 * @generated
 */
public class SendOperationEventPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, SendOperationEventPropertiesEditionPart {
	 ...
	 */
	public SendOperationEventPropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SendOperationEventPropertiesEditionPartForm.this,
							UmlViewsRepository.SendOperationEvent.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.SendOperationEvent.Properties.clientDependency, UmlMessages.SendOperationEventPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
