 ...
 * @generated
 */
public interface SubstitutionPropertiesEditionPart {
	...
	/**
	 * @return the substitutingClassifier
	 * @generated
	 */
	public EObject getSubstitutingClassifier();

	/**
	 * Init the substitutingClassifier
	 * @param settings the combo setting
	 */
	public void initSubstitutingClassifier(EObjectFlatComboSettings settings);

	/**
	 * Defines a new substitutingClassifier
	 * @param newValue the new substitutingClassifier to set
	 * @generated
	 */
	...
	/**
	 * Adds the given filter to the substitutingClassifier edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
