 ...
 * @generated
 */
public class GeneralizationPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Generalization) && (UMLPackage.Literals.GENERALIZATION == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof Generalization)
                && ((GeneralizationPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == GeneralizationPropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Generalization) {
            if (GeneralizationPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == GeneralizationPropertiesEditionComponent.class)
                return new GeneralizationPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
