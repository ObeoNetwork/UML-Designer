...
public class GeneralizationPropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof Generalization)
				&& (GeneralizationPropertiesEditionComponent.GENERAL_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof Generalization) {
			return new GeneralizationPropertiesEditionComponent(editingContext, editingContext.getEObject(),
					mode);
		}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof Generalization) {
			if (GeneralizationPropertiesEditionComponent.GENERAL_PART.equals(part))
				return new GeneralizationPropertiesEditionComponent(editingContext,
