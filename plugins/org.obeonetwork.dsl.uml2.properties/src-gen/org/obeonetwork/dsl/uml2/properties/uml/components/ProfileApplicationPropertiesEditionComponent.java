...
public class ProfileApplicationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.ProfileApplication.Properties.isStrict)) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getProfileApplication_IsStrict().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ProfileApplication.Properties.isStrict))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			UMLPackage.eINSTANCE.getProfileApplication_IsStrict(),
			UMLPackage.eINSTANCE.getProfileApplication_ApplyingPackage()		);
			...
			try {
				if (UmlViewsRepository.ProfileApplication.Properties.isStrict == event.getAffectedEditor()) {
					...
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getProfileApplication_IsStrict().getEAttributeType(), (String)newValue);
					}
