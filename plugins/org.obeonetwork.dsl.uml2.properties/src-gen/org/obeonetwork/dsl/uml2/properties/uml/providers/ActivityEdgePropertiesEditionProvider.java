...
public class ActivityEdgePropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof ActivityEdge)
				&& (ActivityEdgePropertiesEditionComponent.GENERAL_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof ActivityEdge) {
			return new ActivityEdgePropertiesEditionComponent(editingContext, editingContext.getEObject(),
					mode);
		}
