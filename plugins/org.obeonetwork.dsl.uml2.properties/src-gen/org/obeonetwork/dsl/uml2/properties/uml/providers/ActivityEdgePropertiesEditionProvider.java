...
public class ActivityEdgePropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof ActivityEdge) && (UMLPackage.Literals.ACTIVITY_EDGE == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof ActivityEdge)
                && ((ActivityEdgePropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == ActivityEdgePropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof ActivityEdge) {
            if (ActivityEdgePropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == ActivityEdgePropertiesEditionComponent.class)
                return new ActivityEdgePropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
