...
public class ClassOperationsPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public ClassOperationsPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject class_,
			String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.Operations.operations_)) {
				operationsSettings = new ReferencesTableSettings(class_,
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getClass_OwnedOperation().equals(msg.getFeature())
