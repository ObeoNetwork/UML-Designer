 ...
 * @generated
 */
public class ClassOperationsPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * @generated
     */
    public ClassOperationsPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject class_, String editing_mode) {
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (UMLPackage.eINSTANCE.getClass_OwnedOperation().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.Operations.operations_))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(UMLPackage.eINSTANCE.getClass_OwnedOperation());
