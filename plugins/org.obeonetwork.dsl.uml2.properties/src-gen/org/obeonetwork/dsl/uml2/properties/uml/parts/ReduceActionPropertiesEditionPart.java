 ...
 * 
 */
public interface ReduceActionPropertiesEditionPart {
	...
	/**
	 * Defines a new reducer
	 * @param newValue the new reducer to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the reducer edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
