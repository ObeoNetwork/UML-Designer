 ...
 * 
 */
public interface ExpansionNodePropertiesEditionPart {
	...
	/**
	 * @return the regionAsOutput
	 * 
	 */
	public EObject getRegionAsOutput();

	/**
	 * Init the regionAsOutput
	 * @param settings the combo setting
	 */
	public void initRegionAsOutput(EObjectFlatComboSettings settings);

	/**
	 * Defines a new regionAsOutput
	 * @param newValue the new regionAsOutput to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the regionAsOutput edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return the regionAsInput
	 * 
	 */
	public EObject getRegionAsInput();

	/**
	 * Init the regionAsInput
	 * @param settings the combo setting
	 */
	public void initRegionAsInput(EObjectFlatComboSettings settings);

	/**
	 * Defines a new regionAsInput
	 * @param newValue the new regionAsInput to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the regionAsInput edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
