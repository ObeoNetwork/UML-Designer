...
public interface EnumerationLiteralPropertiesEditionPart {
	...
	/**
	 * Init the classifier
	 * @param settings settings for the classifier ReferencesTable 
	 */
	 ...
	 * @param newValue the new enumeration to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the enumeration edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
