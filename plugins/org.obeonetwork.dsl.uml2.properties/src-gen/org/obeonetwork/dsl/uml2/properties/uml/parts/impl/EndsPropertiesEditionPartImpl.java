...
public class EndsPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EndsPropertiesEditionPart {
	...
	protected Composite createEndsAdvancedTableComposition(Composite parent) {
		this.ends = new ReferencesTable(getDescription(UmlViewsRepository.Ends.ends_,
				UmlMessages.EndsPropertiesEditionPart_EndsLabel), new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								EndsPropertiesEditionPartImpl.this, UmlViewsRepository.Ends.ends_,
					...
					public void handleMove(EObject element, int oldIndex, int newIndex) {
						propertiesEditionComponent.firePropertiesChanged(
								new PropertiesEditionEvent(EndsPropertiesEditionPartImpl.this,
										UmlViewsRepository.Ends.ends_, PropertiesEditionEvent.COMMIT,
		...
		this.ends.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.Ends.ends_,
		...
		this.ends.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(EndsPropertiesEditionPartImpl.this,
									UmlViewsRepository.Ends.ends_, PropertiesEditionEvent.CHANGE,
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.EndsPropertiesEditionPart#initEnds(EObject current,
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.EndsPropertiesEditionPart#addFilterEnds(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.EndsPropertiesEditionPart#addBusinessFilterEnds(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.EndsPropertiesEditionPart#isContainedInEndsTable(EObject
	 *      element)
	 * @generated
	 */
