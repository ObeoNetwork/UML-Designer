 ...
 * @generated
 */
public class ArtifactAttributesPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * @generated
     */
    public ArtifactAttributesPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject artifact, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(UmlViewsRepository.Attributes.attributes_)) {
                attributesSettings = new ReferencesTableSettings(artifact, UMLPackage.eINSTANCE.getArtifact_OwnedAttribute());
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (UMLPackage.eINSTANCE.getArtifact_OwnedAttribute().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.Attributes.attributes_))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(UMLPackage.eINSTANCE.getArtifact_OwnedAttribute());
