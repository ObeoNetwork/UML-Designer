...
public class OpaqueActionPropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof OpaqueAction)
				&& (OpaqueActionPropertiesEditionComponent.GENERAL_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof OpaqueAction) {
			return new OpaqueActionPropertiesEditionComponent(editingContext, editingContext.getEObject(),
					mode);
		}
