 ...
 * @generated
 */
public class OpaqueActionPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof OpaqueAction) && (UMLPackage.Literals.OPAQUE_ACTION == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof OpaqueAction)
                && ((OpaqueActionPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == OpaqueActionPropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof OpaqueAction) {
            if (OpaqueActionPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == OpaqueActionPropertiesEditionComponent.class)
                return new OpaqueActionPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
