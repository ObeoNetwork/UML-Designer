 ...
 * 
 */
public interface UnmarshallActionPropertiesEditionPart {
	...
	/**
	 * @return the unmarshallType
	 * 
	 */
	public EObject getUnmarshallType();

	/**
	 * Init the unmarshallType
	 * @param settings the combo setting
	 */
	public void initUnmarshallType(EObjectFlatComboSettings settings);

	/**
	 * Defines a new unmarshallType
	 * @param newValue the new unmarshallType to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the unmarshallType edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
