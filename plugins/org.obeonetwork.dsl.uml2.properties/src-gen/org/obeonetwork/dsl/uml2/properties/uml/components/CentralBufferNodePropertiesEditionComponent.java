...
public class CentralBufferNodePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (centralBufferNode.getName() != null && isAccessible(UmlViewsRepository.CentralBufferNode.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.eINSTANCE.getString(), centralBufferNode.getName()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.CentralBufferNode.Properties.name == event.getAffectedEditor()) {
			centralBufferNode.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.CentralBufferNode.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.CentralBufferNode.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.CentralBufferNode.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getObjectNode_Ordering().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.CentralBufferNode.Properties.ordering))
				basePart.setOrdering((Enumerator)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getObjectNode_IsControlType().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.CentralBufferNode.Properties.isControlType))
