...
public class EnumerationPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Enumeration) && (UMLPackage.Literals.ENUMERATION == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part) {
        return (editingContext.getEObject() instanceof Enumeration)
                && (EnumerationGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) || EnumerationLiteralsPropertiesEditionComponent.LITERALS_PART.equals(part)
                        || EnumerationAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part) || EnumerationOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part));
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof Enumeration)
                && (refinement == EnumerationGeneralPropertiesEditionComponent.class || refinement == EnumerationLiteralsPropertiesEditionComponent.class
                        || refinement == EnumerationAttributesPropertiesEditionComponent.class || refinement == EnumerationOperationsPropertiesEditionComponent.class);
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof Enumeration)
                && ((EnumerationGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == EnumerationGeneralPropertiesEditionComponent.class)
                        || (EnumerationLiteralsPropertiesEditionComponent.LITERALS_PART.equals(part) && refinement == EnumerationLiteralsPropertiesEditionComponent.class)
                        || (EnumerationAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part) && refinement == EnumerationAttributesPropertiesEditionComponent.class) || (EnumerationOperationsPropertiesEditionComponent.OPERATIONS_PART
                        .equals(part) && refinement == EnumerationOperationsPropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Enumeration) {
            if (EnumerationGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == EnumerationGeneralPropertiesEditionComponent.class)
                return new EnumerationGeneralPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (EnumerationLiteralsPropertiesEditionComponent.LITERALS_PART.equals(part) && refinement == EnumerationLiteralsPropertiesEditionComponent.class)
                return new EnumerationLiteralsPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (EnumerationAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part) && refinement == EnumerationAttributesPropertiesEditionComponent.class)
                return new EnumerationAttributesPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (EnumerationOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part) && refinement == EnumerationOperationsPropertiesEditionComponent.class)
                return new EnumerationOperationsPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
