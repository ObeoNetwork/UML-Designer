...
public class EnumerationPropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof Enumeration)
				&& (EnumerationGeneralPropertiesEditionComponent.GENERAL_PART.equals(part)
						|| EnumerationLiteralsPropertiesEditionComponent.LITERALS_PART.equals(part)
						|| EnumerationAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part)
						|| EnumerationOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof Enumeration) {
			return new EnumerationPropertiesEditionComponent(editingContext, editingContext.getEObject(),
					mode);
		}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof Enumeration) {
			if (EnumerationGeneralPropertiesEditionComponent.GENERAL_PART.equals(part))
				return new EnumerationGeneralPropertiesEditionComponent(editingContext,
						editingContext.getEObject(), mode);
			if (EnumerationLiteralsPropertiesEditionComponent.LITERALS_PART.equals(part))
				return new EnumerationLiteralsPropertiesEditionComponent(editingContext,
						editingContext.getEObject(), mode);
			if (EnumerationAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part))
				return new EnumerationAttributesPropertiesEditionComponent(editingContext,
						editingContext.getEObject(), mode);
			if (EnumerationOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part))
				return new EnumerationOperationsPropertiesEditionComponent(editingContext,
						editingContext.getEObject(), mode);
		}
