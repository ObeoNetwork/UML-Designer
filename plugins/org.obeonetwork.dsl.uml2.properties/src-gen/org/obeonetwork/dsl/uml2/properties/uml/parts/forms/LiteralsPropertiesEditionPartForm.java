...
public class LiteralsPropertiesEditionPartForm extends CustomSectionPropertiesEditingPart implements IFormPropertiesEditionPart, LiteralsPropertiesEditionPart {
	 ...
	 */
	public LiteralsPropertiesEditionPartForm() {
		super();
	}
	...
	protected Composite createLiteralsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.literals = new ReferencesTable(
				getDescription(UmlViewsRepository.Literals.literals_,
						UmlMessages.LiteralsPropertiesEditionPart_LiteralsLabel),
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								LiteralsPropertiesEditionPartForm.this, UmlViewsRepository.Literals.literals_,
					...
					public void handleMove(EObject element, int oldIndex, int newIndex) {
						propertiesEditionComponent.firePropertiesChanged(
								new PropertiesEditionEvent(LiteralsPropertiesEditionPartForm.this,
										UmlViewsRepository.Literals.literals_, PropertiesEditionEvent.COMMIT,
		...
		this.literals.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.Literals.literals_, UmlViewsRepository.FORM_KIND));
		...
		this.literals.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(LiteralsPropertiesEditionPartForm.this,
									UmlViewsRepository.Literals.literals_, PropertiesEditionEvent.CHANGE,
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.LiteralsPropertiesEditionPart#initLiterals(EObject
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.LiteralsPropertiesEditionPart#addFilterLiterals(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.LiteralsPropertiesEditionPart#addBusinessFilterLiterals(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.LiteralsPropertiesEditionPart#isContainedInLiteralsTable(EObject
	 *      element)
	 * @generated
	 */
