 ...
 * @generated
 */
public class PrimitiveTypeOperationsPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public PrimitiveTypeOperationsPropertiesEditionComponent(PropertiesEditingContext editingContext,
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.Operations.operations_)) {
				operationsSettings = new ReferencesTableSettings(primitiveType,
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getDataType_OwnedOperation().equals(msg.getFeature())
