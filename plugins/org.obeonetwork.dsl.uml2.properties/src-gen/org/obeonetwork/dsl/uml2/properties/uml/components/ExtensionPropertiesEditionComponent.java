...
public class ExtensionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(UmlViewsRepository.Extension.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, extension.getName()));
			
			if (isAccessible(UmlViewsRepository.Extension.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(extension, UMLPackage.eINSTANCE.getNamedElement_Visibility()), extension.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.Extension.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.Extension.Properties.isAbstract)) {
			...
			if (isAccessible(UmlViewsRepository.Extension.Properties.isDerived)) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.Extension.Properties.name == event.getAffectedEditor()) {
			extension.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Extension.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.Extension.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Extension.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getClassifier_IsAbstract().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Extension.Properties.isAbstract))
			...
			if (UMLPackage.eINSTANCE.getAssociation_IsDerived().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Extension.Properties.isDerived))
