...
public class GeneralPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, GeneralPropertiesEditionPart {
	...
	protected EList languageList;

	protected Text body;

	protected Button editBody;

	protected EList bodyList;
		...
		composer = new PartComposer(generalStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == UmlViewsRepository.General.min) {
					return createMinLinkFlatComboViewer(parent);
				}
				if (key == UmlViewsRepository.General.instance) {
					return createInstanceLinkFlatComboViewer(parent);
				}
				if (key == UmlViewsRepository.General.max) {
					return createMaxLinkFlatComboViewer(parent);
				}
				...
				if (key == UmlViewsRepository.General.nameExpression) {
					return createNameExpressionSingleCompositionViewer(parent);
				}
				if (key == UmlViewsRepository.General.operand) {
					return createOperandAdvancedTableComposition(parent);
				}
				if (key == UmlViewsRepository.General.booleanValue) {
					return createBooleanValueCheckbox(parent);
				}
				if (key == UmlViewsRepository.General.integerValue) {
					return createIntegerValueText(parent);
				}
				...
				if (key == UmlViewsRepository.General.observation) {
					return createObservationReferencesTable(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createNameText(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.name,
				UmlMessages.GeneralPropertiesEditionPart_NameLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.name,
				...
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(
								new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
										UmlViewsRepository.General.name, PropertiesEditionEvent.COMMIT,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.name, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createVisibilityEMFComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.visibility,
				UmlMessages.GeneralPropertiesEditionPart_VisibilityLabel);
		visibility = new EMFComboViewer(parent);
		visibility.setContentProvider(new ArrayContentProvider());
		visibility.setLabelProvider(
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.visibility, PropertiesEditionEvent.COMMIT,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.visibility, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createOrderedCheckbox(Composite parent) {
		...
		ordered.setText(getDescription(UmlViewsRepository.General.Qualifiers.ordered,
				UmlMessages.GeneralPropertiesEditionPart_OrderedLabel));
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							UmlViewsRepository.General.Qualifiers.ordered, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(ordered.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.ordered, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createAbstract_Checkbox(Composite parent) {
		...
		abstract_.setText(getDescription(UmlViewsRepository.General.Qualifiers.abstract_,
				UmlMessages.GeneralPropertiesEditionPart_Abstract_Label));
		abstract_.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this,
							UmlViewsRepository.General.Qualifiers.abstract_, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(abstract_.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.abstract_, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createLeafCheckbox(Composite parent) {
		...
		leaf.setText(getDescription(UmlViewsRepository.General.Qualifiers.leaf,
				UmlMessages.GeneralPropertiesEditionPart_LeafLabel));
		leaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.Qualifiers.leaf, PropertiesEditionEvent.COMMIT,
									PropertiesEditionEvent.SET, null, new Boolean(leaf.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.leaf, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createStatic_Checkbox(Composite parent) {
		...
		static_.setText(getDescription(UmlViewsRepository.General.Qualifiers.static_,
				UmlMessages.GeneralPropertiesEditionPart_Static_Label));
		static_.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this,
							UmlViewsRepository.General.Qualifiers.static_, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(static_.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.static_, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createUniqueCheckbox(Composite parent) {
		...
		unique.setText(getDescription(UmlViewsRepository.General.Qualifiers.unique,
				UmlMessages.GeneralPropertiesEditionPart_UniqueLabel));
		unique.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this,
							UmlViewsRepository.General.Qualifiers.unique, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(unique.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.unique, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createQueryCheckbox(Composite parent) {
		...
		query.setText(getDescription(UmlViewsRepository.General.Qualifiers.query,
				UmlMessages.GeneralPropertiesEditionPart_QueryLabel));
		query.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this,
							UmlViewsRepository.General.Qualifiers.query, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(query.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.query, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createReadOnlyCheckbox(Composite parent) {
		...
		readOnly.setText(getDescription(UmlViewsRepository.General.Qualifiers.readOnly,
				UmlMessages.GeneralPropertiesEditionPart_ReadOnlyLabel));
		readOnly.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this,
							UmlViewsRepository.General.Qualifiers.readOnly, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(readOnly.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.readOnly, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createDerivedCheckbox(Composite parent) {
		...
		derived.setText(getDescription(UmlViewsRepository.General.Qualifiers.derived,
				UmlMessages.GeneralPropertiesEditionPart_DerivedLabel));
		derived.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this,
							UmlViewsRepository.General.Qualifiers.derived, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(derived.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.derived, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createDerivedUnionCheckbox(Composite parent) {
		...
		derivedUnion.setText(getDescription(UmlViewsRepository.General.Qualifiers.derivedUnion,
				UmlMessages.GeneralPropertiesEditionPart_DerivedUnionLabel));
		derivedUnion.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this,
							UmlViewsRepository.General.Qualifiers.derivedUnion, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(derivedUnion.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.derivedUnion, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSubstitutableCheckbox(Composite parent) {
		...
		substitutable.setText(getDescription(UmlViewsRepository.General.Qualifiers.substitutable,
				UmlMessages.GeneralPropertiesEditionPart_SubstitutableLabel));
		substitutable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.Qualifiers.substitutable,
									PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
									new Boolean(substitutable.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.substitutable, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createActiveCheckbox(Composite parent) {
		...
		active.setText(getDescription(UmlViewsRepository.General.Qualifiers.active,
				UmlMessages.GeneralPropertiesEditionPart_ActiveLabel));
		active.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this,
							UmlViewsRepository.General.Qualifiers.active, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(active.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.active, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createBehaviorCheckbox(Composite parent) {
		...
		behavior.setText(getDescription(UmlViewsRepository.General.Qualifiers.behavior,
				UmlMessages.GeneralPropertiesEditionPart_BehaviorLabel));
		behavior.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this,
							UmlViewsRepository.General.Qualifiers.behavior, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(behavior.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.behavior, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createServiceCheckbox(Composite parent) {
		...
		service.setText(getDescription(UmlViewsRepository.General.Qualifiers.service,
				UmlMessages.GeneralPropertiesEditionPart_ServiceLabel));
		service.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this,
							UmlViewsRepository.General.Qualifiers.service, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(service.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.service, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createReentrantCheckbox(Composite parent) {
		...
		reentrant.setText(getDescription(UmlViewsRepository.General.Qualifiers.reentrant,
				UmlMessages.GeneralPropertiesEditionPart_ReentrantLabel));
		reentrant.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this,
							UmlViewsRepository.General.Qualifiers.reentrant, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(reentrant.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.Qualifiers.reentrant, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createIndirectlyInstantiatedCheckbox(Composite parent) {
		...
		indirectlyInstantiated
				.setText(getDescription(UmlViewsRepository.General.Qualifiers.indirectlyInstantiated,
						UmlMessages.GeneralPropertiesEditionPart_IndirectlyInstantiatedLabel));
		indirectlyInstantiated.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.Qualifiers.indirectlyInstantiated,
									PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
									new Boolean(indirectlyInstantiated.getSelection())));
			}
		...
		EditingUtils.setID(indirectlyInstantiated,
				UmlViewsRepository.General.Qualifiers.indirectlyInstantiated);
	...
	protected Composite createTypeAdvancedFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.type,
				UmlMessages.GeneralPropertiesEditionPart_TypeLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.type,
		...
		// create widget
		type = new AdvancedEObjectFlatComboViewer(
				getDescription(UmlViewsRepository.General.type,
						UmlMessages.GeneralPropertiesEditionPart_TypeLabel),
				resourceSet, typeFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(),
				listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.type, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createDirectionEMFComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.direction,
				UmlMessages.GeneralPropertiesEditionPart_DirectionLabel);
		direction = new EMFComboViewer(parent);
		direction.setContentProvider(new ArrayContentProvider());
		direction.setLabelProvider(
				new AdapterFactoryLabelProvider(EEFRuntimePlugin.getDefault().getAdapterFactory()));
		...
		direction.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.direction,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.direction, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createAggregationEMFComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.aggregation,
				UmlMessages.GeneralPropertiesEditionPart_AggregationLabel);
		aggregation = new EMFComboViewer(parent);
		aggregation.setContentProvider(new ArrayContentProvider());
		aggregation.setLabelProvider(
				new AdapterFactoryLabelProvider(EEFRuntimePlugin.getDefault().getAdapterFactory()));
		...
		aggregation.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.aggregation, PropertiesEditionEvent.COMMIT,
									PropertiesEditionEvent.SET, null, getAggregation()));
			}

		});
		aggregation.setID(UmlViewsRepository.General.aggregation);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.aggregation, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createLowerValueText(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.lowerValue,
				UmlMessages.GeneralPropertiesEditionPart_LowerValueLabel);
		...
		lowerValue.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.lowerValue, PropertiesEditionEvent.COMMIT,
									PropertiesEditionEvent.SET, null, lowerValue.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.lowerValue, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createUpperValueText(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.upperValue,
				UmlMessages.GeneralPropertiesEditionPart_UpperValueLabel);
		...
		upperValue.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.upperValue, PropertiesEditionEvent.COMMIT,
									PropertiesEditionEvent.SET, null, upperValue.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.upperValue, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createDefaultValueLinkEReferenceViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.defaultValue,
				UmlMessages.GeneralPropertiesEditionPart_DefaultValueLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.defaultValue,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		defaultValue = new LinkEReferenceViewer(
				getDescription(UmlViewsRepository.General.defaultValue,
						UmlMessages.GeneralPropertiesEditionPart_DefaultValueLabel),
				resourceSet, defaultValueFilter,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.defaultValue, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createMemberEndAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmlViewsRepository.General.memberEnd,
				UmlMessages.GeneralPropertiesEditionPart_MemberEndLabel);
		...
		this.memberEnd.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.memberEnd, UmlViewsRepository.SWT_KIND));
		...
		this.memberEnd.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.memberEnd, PropertiesEditionEvent.CHANGE,
	...
	protected void addMemberEnd() {
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(memberEnd.getInput(),
				memberEndFilters, memberEndBusinessFilters, "memberEnd",
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.memberEnd,
	...
	protected void editMemberEnd(EObject element) {
		EObjectPropertiesEditionContext context = new EObjectPropertiesEditionContext(
				propertiesEditionComponent.getEditingContext(), propertiesEditionComponent, element,
				adapterFactory);
	...
	protected Composite createSupplierAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmlViewsRepository.General.supplier,
				UmlMessages.GeneralPropertiesEditionPart_SupplierLabel);
		...
		this.supplier.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.supplier, UmlViewsRepository.SWT_KIND));
		...
		this.supplier.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.supplier, PropertiesEditionEvent.CHANGE,
									PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addSupplier() {
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(supplier.getInput(),
				supplierFilters, supplierBusinessFilters, "supplier",
				propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			@Override
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject)iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.supplier,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				supplier.refresh();
			}
	...
	protected Composite createClientAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmlViewsRepository.General.client,
				UmlMessages.GeneralPropertiesEditionPart_ClientLabel);
		...
		this.client.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.General.client,
				UmlViewsRepository.SWT_KIND));
		...
		this.client.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.client, PropertiesEditionEvent.CHANGE,
									PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addClient() {
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(client.getInput(),
				clientFilters, clientBusinessFilters, "client",
				propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			@Override
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject)iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.client,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				client.refresh();
			}
	...
	protected Composite createKindEMFComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.kind,
				UmlMessages.GeneralPropertiesEditionPart_KindLabel);
		kind = new EMFComboViewer(parent);
		kind.setContentProvider(new ArrayContentProvider());
		kind.setLabelProvider(
				new AdapterFactoryLabelProvider(EEFRuntimePlugin.getDefault().getAdapterFactory()));
		...
		kind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.kind,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.kind, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createKind_readonlyEMFComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.kind_readonly,
				UmlMessages.GeneralPropertiesEditionPart_Kind_readonlyLabel);
		kind_readonly = new EMFComboViewer(parent);
		kind_readonly.setContentProvider(new ArrayContentProvider());
		kind_readonly.setLabelProvider(
				new AdapterFactoryLabelProvider(EEFRuntimePlugin.getDefault().getAdapterFactory()));
		...
		kind_readonly.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.kind_readonly, PropertiesEditionEvent.COMMIT,
									PropertiesEditionEvent.SET, null, getKind_readonly()));
			}

		});
		kind_readonly.setID(UmlViewsRepository.General.kind_readonly);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.kind_readonly, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createTriggerAdvancedTableComposition(Composite parent) {
		this.trigger = new ReferencesTable(
				getDescription(UmlViewsRepository.General.trigger,
						UmlMessages.GeneralPropertiesEditionPart_TriggerLabel),
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.trigger,
								PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
						trigger.refresh();
					}
					...
					public void handleMove(EObject element, int oldIndex, int newIndex) {
						propertiesEditionComponent.firePropertiesChanged(
								new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
										UmlViewsRepository.General.trigger, PropertiesEditionEvent.COMMIT,
		...
		this.trigger.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.General.trigger,
				UmlViewsRepository.SWT_KIND));
		...
		this.trigger.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.trigger, PropertiesEditionEvent.CHANGE,
									PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createEffectSingleCompositionEditor(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.effect,
				UmlMessages.GeneralPropertiesEditionPart_EffectLabel);
		// create widget
		...
		effect.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.effect,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.effect, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createGuardLinkEReferenceViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.guard,
				UmlMessages.GeneralPropertiesEditionPart_GuardLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.guard,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		guard = new LinkEReferenceViewer(
				getDescription(UmlViewsRepository.General.guard,
						UmlMessages.GeneralPropertiesEditionPart_GuardLabel),
				resourceSet, guardFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(),
				listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.guard, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSourceAdvancedFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.source,
				UmlMessages.GeneralPropertiesEditionPart_SourceLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.source,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		source = new AdvancedEObjectFlatComboViewer(
				getDescription(UmlViewsRepository.General.source,
						UmlMessages.GeneralPropertiesEditionPart_SourceLabel),
				resourceSet, sourceFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(),
				listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.source, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createTargetAdvancedFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.target,
				UmlMessages.GeneralPropertiesEditionPart_TargetLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.target,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		target = new AdvancedEObjectFlatComboViewer(
				getDescription(UmlViewsRepository.General.target,
						UmlMessages.GeneralPropertiesEditionPart_TargetLabel),
				resourceSet, targetFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(),
				listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.target, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createOwnedRuleAdvancedTableComposition(Composite parent) {
		this.ownedRule = new ReferencesTable(
				getDescription(UmlViewsRepository.General.ownedRule,
						UmlMessages.GeneralPropertiesEditionPart_OwnedRuleLabel),
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.ownedRule,
								PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
						ownedRule.refresh();
					}
					...
					public void handleMove(EObject element, int oldIndex, int newIndex) {
						propertiesEditionComponent.firePropertiesChanged(
								new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
										UmlViewsRepository.General.ownedRule, PropertiesEditionEvent.COMMIT,
										PropertiesEditionEvent.MOVE, element, newIndex));
						ownedRule.refresh();
					}
		...
		this.ownedRule.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.ownedRule, UmlViewsRepository.SWT_KIND));
		...
		this.ownedRule.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.ownedRule, PropertiesEditionEvent.CHANGE,
									PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createIconImageViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.icon,
				UmlMessages.GeneralPropertiesEditionPart_IconLabel);
		...
		icon.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.icon,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getIcon()));
			}
		});
		icon.setID(UmlViewsRepository.General.icon);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.icon, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createExtendedCaseEMFComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.extendedCase,
				UmlMessages.GeneralPropertiesEditionPart_ExtendedCaseLabel);
		...
		extendedCase.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.extendedCase, PropertiesEditionEvent.COMMIT,
									PropertiesEditionEvent.SET, null, getExtendedCase()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.extendedCase, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createAdditionEMFComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.addition,
				UmlMessages.GeneralPropertiesEditionPart_AdditionLabel);
		...
		addition.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.addition,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getAddition()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.addition, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createRoleAdvancedFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.role,
				UmlMessages.GeneralPropertiesEditionPart_RoleLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.role,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		role = new AdvancedEObjectFlatComboViewer(
				getDescription(UmlViewsRepository.General.role,
						UmlMessages.GeneralPropertiesEditionPart_RoleLabel),
				resourceSet, roleFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(),
				listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.role, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createUsecaseAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmlViewsRepository.General.usecase,
				UmlMessages.GeneralPropertiesEditionPart_UsecaseLabel);
		...
		this.usecase.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.General.usecase,
				UmlViewsRepository.SWT_KIND));
		...
		this.usecase.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.usecase, PropertiesEditionEvent.CHANGE,
									PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addUsecase() {
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(usecase.getInput(),
				usecaseFilters, usecaseBusinessFilters, "usecase",
				propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			@Override
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject)iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.usecase,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				usecase.refresh();
			}
	...
	protected Composite createSubjectsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmlViewsRepository.General.subjects,
				UmlMessages.GeneralPropertiesEditionPart_SubjectsLabel);
		this.subjects = new ReferencesTable(label, new ReferencesTableListener() {
			...
			public void handleEdit(EObject element) {
				editSubjects(element);
			}

			public void handleMove(EObject element, int oldIndex, int newIndex) {
				moveSubjects(element, oldIndex, newIndex);
			}

			public void handleRemove(EObject element) {
				removeFromSubjects(element);
			}

			public void navigateTo(EObject element) {
			}
		});
		this.subjects.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.subjects, UmlViewsRepository.SWT_KIND));
		...
		this.subjects.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.subjects, PropertiesEditionEvent.CHANGE,
									PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addSubjects() {
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(subjects.getInput(),
				subjectsFilters, subjectsBusinessFilters, "subjects",
				propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			@Override
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject)iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.subjects,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				subjects.refresh();
			}
	...
	protected Composite createEntryAdvancedFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.entry,
				UmlMessages.GeneralPropertiesEditionPart_EntryLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.entry,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		entry = new AdvancedEObjectFlatComboViewer(
				getDescription(UmlViewsRepository.General.entry,
						UmlMessages.GeneralPropertiesEditionPart_EntryLabel),
				resourceSet, entryFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(),
				listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.entry, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createExitAdvancedFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.exit,
				UmlMessages.GeneralPropertiesEditionPart_ExitLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.exit,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		exit = new AdvancedEObjectFlatComboViewer(
				getDescription(UmlViewsRepository.General.exit,
						UmlMessages.GeneralPropertiesEditionPart_ExitLabel),
				resourceSet, exitFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(),
				listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.exit, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createDo_AdvancedFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.do_,
				UmlMessages.GeneralPropertiesEditionPart_Do_Label);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.do_,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		do_ = new AdvancedEObjectFlatComboViewer(
				getDescription(UmlViewsRepository.General.do_,
						UmlMessages.GeneralPropertiesEditionPart_Do_Label),
				resourceSet, do_Filter, propertiesEditionComponent.getEditingContext().getAdapterFactory(),
				listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.do_, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSubmachineLinkEReferenceViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.submachine,
				UmlMessages.GeneralPropertiesEditionPart_SubmachineLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.submachine,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		submachine = new LinkEReferenceViewer(
				getDescription(UmlViewsRepository.General.submachine,
						UmlMessages.GeneralPropertiesEditionPart_SubmachineLabel),
				resourceSet, submachineFilter,
				propertiesEditionComponent.getEditingContext().getAdapterFactory(), listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.submachine, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSpecificationSingleCompositionEditor(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.specification,
				UmlMessages.GeneralPropertiesEditionPart_SpecificationLabel);
		// create widget
		...
		specification.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.specification,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.specification, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createInstanceValueLinkEReferenceViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.instanceValue,
				UmlMessages.GeneralPropertiesEditionPart_InstanceValueLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.instanceValue,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		instanceValue = new LinkEReferenceViewer(
				getDescription(UmlViewsRepository.General.instanceValue,
						UmlMessages.GeneralPropertiesEditionPart_InstanceValueLabel),
				resourceSet, instanceValueFilter,
				propertiesEditionComponent.getEditingContext().getAdapterFactory(), listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.instanceValue, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	 ...
	 * @generated
	 */
	protected Composite createMinLinkFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.min,
				UmlMessages.GeneralPropertiesEditionPart_MinLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.min,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		min = new LinkEObjectFlatComboViewer(
				getDescription(UmlViewsRepository.General.min,
						UmlMessages.GeneralPropertiesEditionPart_MinLabel),
				resourceSet, minFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(),
				listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.min, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	 ...
	 * @generated
	 */
	protected Composite createInstanceLinkFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.instance,
				UmlMessages.GeneralPropertiesEditionPart_InstanceLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.instance,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		instance = new LinkEObjectFlatComboViewer(
				getDescription(UmlViewsRepository.General.instance,
						UmlMessages.GeneralPropertiesEditionPart_InstanceLabel),
				resourceSet, instanceFilter,
				propertiesEditionComponent.getEditingContext().getAdapterFactory(), listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.instance, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	 ...
	 * @generated
	 */
	protected Composite createMaxLinkFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.max,
				UmlMessages.GeneralPropertiesEditionPart_MaxLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.max,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		max = new LinkEObjectFlatComboViewer(
				getDescription(UmlViewsRepository.General.max,
						UmlMessages.GeneralPropertiesEditionPart_MaxLabel),
				resourceSet, maxFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(),
				listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.max, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createEventLinkEReferenceViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.event,
				UmlMessages.GeneralPropertiesEditionPart_EventLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.event,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		event = new LinkEReferenceViewer(
				getDescription(UmlViewsRepository.General.event,
						UmlMessages.GeneralPropertiesEditionPart_EventLabel),
				resourceSet, eventFilter, propertiesEditionComponent.getEditingContext().getAdapterFactory(),
				listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.event, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createWhenSingleCompositionEditor(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.when,
				UmlMessages.GeneralPropertiesEditionPart_WhenLabel);
		// create widget
		...
		when.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.when,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));
				when.refresh();
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.when, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createChangeExpressionSingleCompositionEditor(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.changeExpression,
				UmlMessages.GeneralPropertiesEditionPart_ChangeExpressionLabel);
		// create widget
		...
		changeExpression.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.changeExpression,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UmlViewsRepository.General.changeExpression, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createRegionSingleCompositionEditor(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.region,
				UmlMessages.GeneralPropertiesEditionPart_RegionLabel);
		// create widget
		...
		region.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.region,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));
				region.refresh();
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.region, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createBehaviourAdvancedFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.behaviour,
				UmlMessages.GeneralPropertiesEditionPart_BehaviourLabel);
		// create callback listener
		EObjectFlatComboViewerListener listener = new EObjectFlatComboViewerListener() {
			public void handleSet(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.behaviour,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, element));
			}
		...
		// create widget
		behaviour = new AdvancedEObjectFlatComboViewer(
				getDescription(UmlViewsRepository.General.behaviour,
						UmlMessages.GeneralPropertiesEditionPart_BehaviourLabel),
				resourceSet, behaviourFilter,
				propertiesEditionComponent.getEditingContext().getAdapterFactory(), listener);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.behaviour, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createUnmarshallCheckbox(Composite parent) {
		...
		unmarshall.setText(getDescription(UmlViewsRepository.General.unmarshall,
				UmlMessages.GeneralPropertiesEditionPart_UnmarshallLabel));
		unmarshall.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.unmarshall,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
							new Boolean(unmarshall.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.unmarshall, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createOperationFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.operation,
				UmlMessages.GeneralPropertiesEditionPart_OperationLabel);
		operation = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
				.isRequired(UmlViewsRepository.General.operation, UmlViewsRepository.SWT_KIND));
		...
		operation.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.operation,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getOperation()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.operation, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSignalFlatComboViewer(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.signal,
				UmlMessages.GeneralPropertiesEditionPart_SignalLabel);
		signal = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
				.isRequired(UmlViewsRepository.General.signal, UmlViewsRepository.SWT_KIND));
		...
		signal.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.signal,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getSignal()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.signal, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSymbolText(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.symbol,
				UmlMessages.GeneralPropertiesEditionPart_SymbolLabel);
		symbol = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		symbol.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.symbol, PropertiesEditionEvent.COMMIT,
									PropertiesEditionEvent.SET, null, symbol.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.symbol, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createNameExpressionSingleCompositionViewer(Composite parent) {
		GridData nameExpressionData = new GridData(GridData.FILL_HORIZONTAL);
		nameExpressionData.horizontalSpan = 3;
		this.nameExpression = new SingleCompositionViewer<EObject>(
				getDescription(UmlViewsRepository.General.nameExpression,
						UmlMessages.GeneralPropertiesEditionPart_NameExpressionLabel),
				parent, SWT.NONE, null, UmlViewsRepository.SWT_KIND, propertiesEditionComponent
						.isRequired(UmlViewsRepository.General.nameExpression, UmlViewsRepository.SWT_KIND));
		...
		this.nameExpression.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.nameExpression, PropertiesEditionEvent.COMMIT,
									PropertiesEditionEvent.SET, null, getNameExpression()));
					nameExpression.update(getNameExpression());
					...
					Point newSize = scrolledComposite.computeSize(FormUtil.getWidthHint(clientArea.width, c),
	 ...
	 * @generated
	 */
	protected Composite createOperandAdvancedTableComposition(Composite parent) {
		this.operand = new ReferencesTable(
				getDescription(UmlViewsRepository.General.operand,
						UmlMessages.GeneralPropertiesEditionPart_OperandLabel),
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.operand,
								PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
						operand.refresh();
					}
					...
					public void handleMove(EObject element, int oldIndex, int newIndex) {
						propertiesEditionComponent.firePropertiesChanged(
								new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
										UmlViewsRepository.General.operand, PropertiesEditionEvent.COMMIT,
										PropertiesEditionEvent.MOVE, element, newIndex));
						operand.refresh();
					}
		...
		this.operand.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.General.operand,
				UmlViewsRepository.SWT_KIND));
		...
		this.operand.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.operand, PropertiesEditionEvent.CHANGE,
									PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createOperandAdvancedTableComposition
	...
	protected Composite createBooleanValueCheckbox(Composite parent) {
		booleanValue = new Button(parent, SWT.CHECK);
		booleanValue.setText(getDescription(UmlViewsRepository.General.booleanValue,
				UmlMessages.GeneralPropertiesEditionPart_BooleanValueLabel));
		booleanValue.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.booleanValue,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
							new Boolean(booleanValue.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.booleanValue, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createIntegerValueText(Composite parent) {
		createDescription(parent, UmlViewsRepository.General.integerValue,
				UmlMessages.GeneralPropertiesEditionPart_IntegerValueLabel);
		integerValue = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		integerValue.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.integerValue, PropertiesEditionEvent.COMMIT,
									PropertiesEditionEvent.SET, null, integerValue.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.General.integerValue, UmlViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createLanguageMultiValuedEditor(Composite parent) {
		...
		editLanguage.setText(getDescription(UmlViewsRepository.General.language,
				UmlMessages.GeneralPropertiesEditionPart_LanguageLabel));
		...
		editLanguage.addSelectionListener(new SelectionAdapter() {
			 ...
			 */
			public void widgetSelected(SelectionEvent e) {
				EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(language.getShell(), "Package", //$NON-NLS-1$
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.language, PropertiesEditionEvent.COMMIT,
									PropertiesEditionEvent.SET, null, new BasicEList(languageList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createBodyMultiValuedEditor(Composite parent) {
		...
		editBody.setText(getDescription(UmlViewsRepository.General.body,
				UmlMessages.GeneralPropertiesEditionPart_BodyLabel));
		...
		editBody.addSelectionListener(new SelectionAdapter() {
			 ...
			 */
			public void widgetSelected(SelectionEvent e) {
				EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(body.getShell(), "Package", //$NON-NLS-1$
						new AdapterFactoryLabelProvider(adapterFactory),
						bodyList, UMLPackage.eINSTANCE.getComment_Body().getEType(), null, false, true, null,
						null);
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(GeneralPropertiesEditionPartImpl.this,
									UmlViewsRepository.General.body, PropertiesEditionEvent.COMMIT,
	 ...
	 * @generated
	 */
	protected Composite createObservationReferencesTable(Composite parent) {
		Label observationLabel = createDescription(parent, UmlViewsRepository.General.observation,
				UmlMessages.GeneralPropertiesEditionPart_ObservationLabel);
		...
		observation = createObservationViewer(parent, adapterFactory);
		...
		createObservationControlPanel(parent);
		return parent;
	}
	 ...
	 * @generated
	 */
	protected TableViewer createObservationViewer(Composite container, AdapterFactory adapter) {
		org.eclipse.swt.widgets.Table table = new org.eclipse.swt.widgets.Table(container,
				SWT.FULL_SELECTION);
	 ...
	 * @generated
	 */
	protected void createObservationControlPanel(Composite container) {
		Composite result = new Composite(container, SWT.NONE);
		GridLayout layout = new GridLayout();
		layout.numColumns = 1;
		result.setLayout(layout);
		addObservation = new Button(result, SWT.NONE);
		addObservation.setText(UmlMessages.PropertiesEditionPart_AddListViewerLabel);
		...
		removeObservation = new Button(result, SWT.NONE);
		removeObservation.setText(UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	protected void addObservation() {
		EMFModelViewerDialog dialog = new EMFModelViewerDialog(
				new AdapterFactoryLabelProvider(adapterFactory), observation.getInput(), observationFilters,
				observationBusinessFilters, false, true) {
			public void process(IStructuredSelection selection) {
				for (Iterator iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject)iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartImpl.this, UmlViewsRepository.General.observation,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
			}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setName(String
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#initVisibility(Object
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setVisibility(Enumerator
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setOrdered(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setAbstract_(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setLeaf(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setStatic_(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setUnique(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setQuery(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setReadOnly(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setDerived(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setDerivedUnion(Boolean
	 *      newValue)
	 * @generated
	 */
	public void setDerivedUnion(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(
				UmlViewsRepository.General.Qualifiers.derivedUnion);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setSubstitutable(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setActive(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setBehavior(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setService(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setReentrant(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setIndirectlyInstantiated(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setType(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setTypeButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterType(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterType(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#initDirection(Object
	 *      input, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setDirection(Enumerator
	 *      newValue)
	 * @generated
	 */
	...
	public Enumerator getAggregation() {
		Enumerator selection = (Enumerator)((StructuredSelection)aggregation.getSelection())
				.getFirstElement();
		return selection;
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#initAggregation(Object
	 *      input, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setAggregation(Enumerator
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setLowerValue(String
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setUpperValue(String
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setDefaultValue(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setDefaultValueButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterDefaultValue(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterDefaultValue(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterMemberEnd(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterMemberEnd(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#isContainedInMemberEndTable(EObject
	 *      element)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterSupplier(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterSupplier(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#isContainedInSupplierTable(EObject
	 *      element)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterClient(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterClient(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#isContainedInClientTable(EObject
	 *      element)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#initKind(Object input,
	 *      Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setKind(Enumerator
	 *      newValue)
	 * @generated
	 */
	...
	public Enumerator getKind_readonly() {
		Enumerator selection = (Enumerator)((StructuredSelection)kind_readonly.getSelection())
				.getFirstElement();
		return selection;
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#initKind_readonly(Object
	 *      input, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setKind_readonly(Enumerator
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#initTrigger(EObject
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterTrigger(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterTrigger(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#isContainedInTriggerTable(EObject
	 *      element)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setEffect(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setGuard(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setGuardButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterGuard(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterGuard(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setSource(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setSourceButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterSource(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterSource(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setTarget(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setTargetButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterTarget(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterTarget(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#initOwnedRule(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterOwnedRule(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterOwnedRule(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#isContainedInOwnedRuleTable(EObject
	 *      element)
	 * @generated
	 */
	...
	public String getIcon() {
		...
		if (selection instanceof StructuredSelection
				&& ((StructuredSelection)selection).getFirstElement() instanceof String) {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#initIcon(String key,
	 *      String newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setIcon(String
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#initExtendedCase(Object
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setExtendedCase(Object
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterExtendedCase(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#initAddition(Object
	 *      input, Object currentValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setAddition(Object
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterAddition(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setRole(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setRoleButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterRole(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterRole(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterUsecase(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterUsecase(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#isContainedInUsecaseTable(EObject
	 *      element)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterSubjects(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterSubjects(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#isContainedInSubjectsTable(EObject
	 *      element)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setEntry(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setEntryButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterEntry(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterEntry(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setExit(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setExitButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterExit(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterExit(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setDo_(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setDo_ButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterDo_(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterDo_(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setSubmachine(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setSubmachineButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterSubmachine(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterSubmachine(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setSpecification(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setInstanceValue(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setInstanceValueButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterInstanceValue(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterInstanceValue(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setMin(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setMinButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterMin(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterMin(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setInstance(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setInstanceButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterInstance(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterInstance(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setMax(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setMaxButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterMax(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterMax(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setEvent(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setEventButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterEvent(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterEvent(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setWhen(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setChangeExpression(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setRegion(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setBehaviour(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setBehaviourButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterBehaviour(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterBehaviour(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setUnmarshall(Boolean
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setOperation(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setOperationButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterOperation(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterOperation(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setSignal(EObject
	 *      newValue)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setSignalButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addFilterSignal(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#addBusinessFilterSignal(ViewerFilter
	 *      filter)
	 * @generated
	 */
	 ...
	 *      current, EReference containingFeature, EReference feature, EditingDomain editingDomain)
	 */
	public void initNameExpression(EObject current, EReference containingFeature, EReference feature,
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.GeneralPropertiesEditionPart#setBody(EList newValue)
	 * @generated
	 */
