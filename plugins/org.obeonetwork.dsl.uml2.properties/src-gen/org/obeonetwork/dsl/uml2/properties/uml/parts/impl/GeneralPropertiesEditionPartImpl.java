...
public class GeneralPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, GeneralPropertiesEditionPart {
    ...
    protected Composite createMinLinkEReferenceViewer(Composite parent) {
        ...
        // create widget
        min = new LinkEReferenceViewer(getDescription(UmlViewsRepository.General.min, UmlMessages.GeneralPropertiesEditionPart_MinLabel), resourceSet, minFilter, propertiesEditionComponent
                .getEditingContext().getAdapterFactory(), listener);
    ...
    protected Composite createInstanceLinkEReferenceViewer(Composite parent) {
        ...
        // create widget
        instance = new LinkEReferenceViewer(getDescription(UmlViewsRepository.General.instance, UmlMessages.GeneralPropertiesEditionPart_InstanceLabel), resourceSet, instanceFilter,
                propertiesEditionComponent.getEditingContext().getAdapterFactory(), listener);
    ...
    protected Composite createMaxLinkEReferenceViewer(Composite parent) {
        ...
        // create widget
        max = new LinkEReferenceViewer(getDescription(UmlViewsRepository.General.max, UmlMessages.GeneralPropertiesEditionPart_MaxLabel), resourceSet, maxFilter, propertiesEditionComponent
                .getEditingContext().getAdapterFactory(), listener);
