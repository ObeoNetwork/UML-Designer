...
public class StereotypeGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == UmlViewsRepository.General.name || key == UmlViewsRepository.General.visibility || key == UmlViewsRepository.General.Qualifiers.abstract_ || key == UmlViewsRepository.General.Qualifiers.leaf || key == UmlViewsRepository.General.icon || key == UmlViewsRepository.General.Qualifiers.active || key == UmlViewsRepository.General.Qualifiers.class;
	}
