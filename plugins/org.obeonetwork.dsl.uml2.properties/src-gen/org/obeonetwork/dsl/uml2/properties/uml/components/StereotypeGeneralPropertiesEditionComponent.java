...
public class StereotypeGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * @generated
     */
    public StereotypeGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject stereotype, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(UmlViewsRepository.General.name))
                generalPart.setName(EEFConverterUtil.convertToString(TypesPackage.Literals.STRING, stereotype.getName()));

            if (isAccessible(UmlViewsRepository.General.visibility)) {
                generalPart.initVisibility(EEFUtils.choiceOfValues(stereotype, UMLPackage.eINSTANCE.getNamedElement_Visibility()), stereotype.getVisibility());
            }
            ...
            // values : icon, General, Stereotype.
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (UmlViewsRepository.General.icon == event.getAffectedEditor()) {
            ...
            // 'declareEObjectUpdater' for the case : icon, General, Stereotype.
        }
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(UMLPackage.eINSTANCE.getNamedElement_Name(), UMLPackage.eINSTANCE.getNamedElement_Visibility(),
                UMLPackage.eINSTANCE.getClassifier_IsAbstract(), UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf(), UMLPackage.eINSTANCE.getStereotype_Icon(),
    ...
    public boolean mustBeComposed(Object key, int kind) {
        return key == UmlViewsRepository.General.name || key == UmlViewsRepository.General.visibility || key == UmlViewsRepository.General.Qualifiers.abstract_
                || key == UmlViewsRepository.General.Qualifiers.leaf || key == UmlViewsRepository.General.icon || key == UmlViewsRepository.General.Qualifiers.active
