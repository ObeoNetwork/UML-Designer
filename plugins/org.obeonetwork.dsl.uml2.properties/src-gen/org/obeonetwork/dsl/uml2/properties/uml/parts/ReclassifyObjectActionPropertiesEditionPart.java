 ...
 * @generated
 */
public interface ReclassifyObjectActionPropertiesEditionPart {
	...
	/**
	 * Init the oldClassifier
	 * @param settings settings for the oldClassifier ReferencesTable 
	 */
	public void initOldClassifier(ReferencesTableSettings settings);

	/**
	 * Update the oldClassifier
	 * @param newValue the oldClassifier to update
	 * @generated
	 */
	public void updateOldClassifier();

	/**
	 * Adds the given filter to the oldClassifier edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the oldClassifier table
	 * @generated
	 */
	...
	/**
	 * Init the newClassifier
	 * @param settings settings for the newClassifier ReferencesTable 
	 */
	public void initNewClassifier(ReferencesTableSettings settings);

	/**
	 * Update the newClassifier
	 * @param newValue the newClassifier to update
	 * @generated
	 */
	public void updateNewClassifier();

	/**
	 * Adds the given filter to the newClassifier edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the newClassifier table
	 * @generated
	 */
