...
public class AttributesPropertiesEditionPartForm extends CustomSectionPropertiesEditingPart implements IFormPropertiesEditionPart, AttributesPropertiesEditionPart {
	 ...
	 */
	public AttributesPropertiesEditionPartForm() {
		super();
	}
	...
	protected Composite createAttributesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.attributes = new ReferencesTable(
				getDescription(UmlViewsRepository.Attributes.attributes_,
						UmlMessages.AttributesPropertiesEditionPart_AttributesLabel),
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								AttributesPropertiesEditionPartForm.this,
								UmlViewsRepository.Attributes.attributes_, PropertiesEditionEvent.COMMIT,
		...
		this.attributes.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.Attributes.attributes_, UmlViewsRepository.FORM_KIND));
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(AttributesPropertiesEditionPartForm.this,
									UmlViewsRepository.Attributes.attributes_, PropertiesEditionEvent.CHANGE,
