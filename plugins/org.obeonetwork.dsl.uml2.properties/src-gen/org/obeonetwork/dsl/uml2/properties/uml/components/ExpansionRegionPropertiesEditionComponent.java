...
public class ExpansionRegionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (expansionRegion.getName() != null && isAccessible(UmlViewsRepository.ExpansionRegion.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.eINSTANCE.getString(), expansionRegion.getName()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.ExpansionRegion.Properties.name == event.getAffectedEditor()) {
			expansionRegion.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.ExpansionRegion.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.ExpansionRegion.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.ExpansionRegion.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getStructuredActivityNode_MustIsolate().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.ExpansionRegion.Properties.mustIsolate))
				basePart.setMustIsolate((Boolean)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getExpansionRegion_Mode().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.ExpansionRegion.Properties.mode))
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (UmlViewsRepository.ExpansionRegion.Properties.mode == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getExpansionRegion_Mode().getEAttributeType(), (String)newValue);
					}
