...
public class Package_PropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, Package_PropertiesEditionPart {
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              ...
              UmlViewsRepository.Package_.Properties.name,
    ...
    this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.Package_.Properties.clientDependency, UmlMessages.Package_PropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
