...
public class EnumerationOperationsPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * @generated
     */
    public EnumerationOperationsPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject enumeration, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(UmlViewsRepository.Operations.operations_)) {
                operationsSettings = new ReferencesTableSettings(enumeration, UMLPackage.eINSTANCE.getDataType_OwnedOperation());
