...
public class TransitionPropertiesEditionProvider extends UmlPropertiesEditionProvider {
     ...
     */
    public TransitionPropertiesEditionProvider() {
        super();
    }
     ...
     */
    public TransitionPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Transition) && (UMLPackage.Literals.TRANSITION == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part) {
        return (editingContext.getEObject() instanceof Transition) && (TransitionPropertiesEditionComponent.GENERAL_PART.equals(part));
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof Transition) && ((TransitionPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == TransitionPropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Transition) {
            if (TransitionPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == TransitionPropertiesEditionComponent.class)
                return new TransitionPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
    ...
    public static class EditionFilter implements IFilter {
        ...
        public boolean select(Object toTest) {
            ...
            return eObj != null && UMLPackage.Literals.TRANSITION == eObj.eClass();
        }
