...
public class ArtifactPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	 ...
	 * @generated
	 */
	public ArtifactPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject artifact,
			String editing_mode) {
		super(editingContext, editing_mode);
		if (artifact instanceof Artifact) {
			PropertiesEditingProvider provider = null;
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(artifact,
					PropertiesEditingProvider.class);
			artifactGeneralPropertiesEditionComponent = (ArtifactGeneralPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							ArtifactGeneralPropertiesEditionComponent.GENERAL_PART,
							ArtifactGeneralPropertiesEditionComponent.class);
			addSubComponent(artifactGeneralPropertiesEditionComponent);
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(artifact,
					PropertiesEditingProvider.class);
			artifactAttributesPropertiesEditionComponent = (ArtifactAttributesPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							ArtifactAttributesPropertiesEditionComponent.ATTRIBUTES_PART,
							ArtifactAttributesPropertiesEditionComponent.class);
			addSubComponent(artifactAttributesPropertiesEditionComponent);
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(artifact,
					PropertiesEditingProvider.class);
			artifactOperationsPropertiesEditionComponent = (ArtifactOperationsPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							ArtifactOperationsPropertiesEditionComponent.OPERATIONS_PART,
							ArtifactOperationsPropertiesEditionComponent.class);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (ArtifactGeneralPropertiesEditionComponent.GENERAL_PART.equals(key)) {
			generalPart = (GeneralPropertiesEditionPart)artifactGeneralPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
			return (IPropertiesEditionPart)generalPart;
		}
		if (ArtifactAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(key)) {
			attributesPart = (AttributesPropertiesEditionPart)artifactAttributesPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
			return (IPropertiesEditionPart)attributesPart;
		}
		if (ArtifactOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(key)) {
			operationsPart = (OperationsPropertiesEditionPart)artifactOperationsPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
