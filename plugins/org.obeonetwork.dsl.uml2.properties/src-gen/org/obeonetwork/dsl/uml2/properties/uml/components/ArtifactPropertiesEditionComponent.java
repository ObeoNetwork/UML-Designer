...
public class ArtifactPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
    ...
    public ArtifactPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject artifact, String editing_mode) {
        ...
        if (artifact instanceof Artifact) {
            ...
            artifactGeneralPropertiesEditionComponent = (ArtifactGeneralPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    ArtifactGeneralPropertiesEditionComponent.GENERAL_PART, ArtifactGeneralPropertiesEditionComponent.class);
            addSubComponent(artifactGeneralPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(artifact, PropertiesEditingProvider.class);
            artifactAttributesPropertiesEditionComponent = (ArtifactAttributesPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    ArtifactAttributesPropertiesEditionComponent.ATTRIBUTES_PART, ArtifactAttributesPropertiesEditionComponent.class);
            addSubComponent(artifactAttributesPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(artifact, PropertiesEditingProvider.class);
            artifactOperationsPropertiesEditionComponent = (ArtifactOperationsPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    ArtifactOperationsPropertiesEditionComponent.OPERATIONS_PART, ArtifactOperationsPropertiesEditionComponent.class);
