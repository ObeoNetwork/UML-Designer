...
public class OperationPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Operation) && (UMLPackage.Literals.OPERATION == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part) {
        return (editingContext.getEObject() instanceof Operation)
                && (OperationGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) || OperationParametersPropertiesEditionComponent.PARAMETERS_PART.equals(part));
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof Operation)
                && (refinement == OperationGeneralPropertiesEditionComponent.class || refinement == OperationParametersPropertiesEditionComponent.class);
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof Operation)
                && ((OperationGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == OperationGeneralPropertiesEditionComponent.class) || (OperationParametersPropertiesEditionComponent.PARAMETERS_PART
                        .equals(part) && refinement == OperationParametersPropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Operation) {
            if (OperationGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == OperationGeneralPropertiesEditionComponent.class)
                return new OperationGeneralPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (OperationParametersPropertiesEditionComponent.PARAMETERS_PART.equals(part) && refinement == OperationParametersPropertiesEditionComponent.class)
                return new OperationParametersPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
