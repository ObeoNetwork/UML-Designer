...
public class DataTypePropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof DataType) && (UMLPackage.Literals.DATA_TYPE == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part) {
        return (editingContext.getEObject() instanceof DataType)
                && (DataTypeGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) || DataTypeAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part) || DataTypeOperationsPropertiesEditionComponent.OPERATIONS_PART
                        .equals(part));
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof DataType)
                && (refinement == DataTypeGeneralPropertiesEditionComponent.class || refinement == DataTypeAttributesPropertiesEditionComponent.class || refinement == DataTypeOperationsPropertiesEditionComponent.class);
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof DataType)
                && ((DataTypeGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == DataTypeGeneralPropertiesEditionComponent.class)
                        || (DataTypeAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part) && refinement == DataTypeAttributesPropertiesEditionComponent.class) || (DataTypeOperationsPropertiesEditionComponent.OPERATIONS_PART
                        .equals(part) && refinement == DataTypeOperationsPropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part) {
        if (editingContext.getEObject() instanceof DataType) {
            ...
            if (DataTypeOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part))
                return new DataTypeOperationsPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof DataType) {
            if (DataTypeGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == DataTypeGeneralPropertiesEditionComponent.class)
                return new DataTypeGeneralPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (DataTypeAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part) && refinement == DataTypeAttributesPropertiesEditionComponent.class)
                return new DataTypeAttributesPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (DataTypeOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part) && refinement == DataTypeOperationsPropertiesEditionComponent.class)
                return new DataTypeOperationsPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
