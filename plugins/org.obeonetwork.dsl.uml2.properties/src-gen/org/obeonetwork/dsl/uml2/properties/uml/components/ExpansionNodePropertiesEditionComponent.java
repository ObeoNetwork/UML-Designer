...
public class ExpansionNodePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(UmlViewsRepository.ExpansionNode.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, expansionNode.getName()));
			
			if (isAccessible(UmlViewsRepository.ExpansionNode.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(expansionNode, UMLPackage.eINSTANCE.getNamedElement_Visibility()), expansionNode.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.ExpansionNode.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.ExpansionNode.Properties.ordering)) {
				basePart.initOrdering(EEFUtils.choiceOfValues(expansionNode, UMLPackage.eINSTANCE.getObjectNode_Ordering()), expansionNode.getOrdering());
			}
			if (isAccessible(UmlViewsRepository.ExpansionNode.Properties.isControlType)) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.ExpansionNode.Properties.name == event.getAffectedEditor()) {
			expansionNode.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ExpansionNode.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.ExpansionNode.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ExpansionNode.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getObjectNode_Ordering().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.ExpansionNode.Properties.ordering))
				basePart.setOrdering((ObjectNodeOrderingKind)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getObjectNode_IsControlType().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.ExpansionNode.Properties.isControlType))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			UMLPackage.eINSTANCE.getExpansionNode_RegionAsOutput(),
			UMLPackage.eINSTANCE.getExpansionNode_RegionAsInput()		);
