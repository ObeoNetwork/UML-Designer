...
import org.obeonetwork.dsl.uml2.properties.uml.components.TimeEventPropertiesEditionComponent;

/**
 * @author <a href="mailto:cedric.brun@obeo.fr">Cédric Brun</a>
 * @generated
 */
public class TimeEventPropertiesEditionProvider extends PropertiesEditingProviderImpl {
    ...
    return (editingContext.getEObject() instanceof TimeEvent) && (TimeEventPropertiesEditionComponent.BASE_PART.equals(part));
  }
    ...
    return (editingContext.getEObject() instanceof TimeEvent) && ((TimeEventPropertiesEditionComponent.BASE_PART.equals(part) && refinement == TimeEventPropertiesEditionComponent.class));
  }
    ...
    if (editingContext.getEObject() instanceof TimeEvent) {
      if (TimeEventPropertiesEditionComponent.BASE_PART.equals(part))
        return new TimeEventPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
    }
