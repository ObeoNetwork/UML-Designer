 ...
 * 
 */
public interface StartObjectBehaviorActionPropertiesEditionPart {
	...
	/**
	 * Defines a new onPort
	 * @param newValue the new onPort to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the onPort edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
