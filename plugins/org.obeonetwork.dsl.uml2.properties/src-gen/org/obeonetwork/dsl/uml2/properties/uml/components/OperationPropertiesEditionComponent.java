...
public class OperationPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
    ...
    public OperationPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject operation, String editing_mode) {
        ...
        if (operation instanceof Operation) {
            ...
            operationGeneralPropertiesEditionComponent = (OperationGeneralPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    OperationGeneralPropertiesEditionComponent.GENERAL_PART, OperationGeneralPropertiesEditionComponent.class);
            addSubComponent(operationGeneralPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(operation, PropertiesEditingProvider.class);
            operationParametersPropertiesEditionComponent = (OperationParametersPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    OperationParametersPropertiesEditionComponent.PARAMETERS_PART, OperationParametersPropertiesEditionComponent.class);
