...
public class OperationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.Operation.Properties.isLeaf)) {
				basePart.setIsLeaf(operation.isLeaf());
			}
			if (isAccessible(UmlViewsRepository.Operation.Properties.isStatic)) {
				basePart.setIsStatic(operation.isStatic());
			}
			if (isAccessible(UmlViewsRepository.Operation.Properties.isAbstract)) {
			...
			if (isAccessible(UmlViewsRepository.Operation.Properties.isQuery)) {
