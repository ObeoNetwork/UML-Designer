...
import org.obeonetwork.dsl.uml2.properties.uml.components.ParameterSetPropertiesEditionComponent;

/**
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 * 
 */
public class ParameterSetPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public ParameterSetPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public ParameterSetPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof ParameterSet) 
					&& (UMLPackage.eINSTANCE.getParameterSet() == editingContext.getEObject().eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
		if (editingContext.getEObject() instanceof ParameterSet) {
			if (ParameterSetPropertiesEditionComponent.BASE_PART.equals(part)
				&& refinement == ParameterSetPropertiesEditionComponent.class)
				return new ParameterSetPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
