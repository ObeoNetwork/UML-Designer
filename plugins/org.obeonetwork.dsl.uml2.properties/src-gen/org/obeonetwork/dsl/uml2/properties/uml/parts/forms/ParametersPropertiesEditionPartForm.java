 ...
 * @generated
 */
public class ParametersPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ParametersPropertiesEditionPart {
	 ...
	 */
	public ParametersPropertiesEditionPartForm() { super(); }
    ...
    this.parameters = new ReferencesTable(getDescription(UmlViewsRepository.Parameters.parameters_, UmlMessages.ParametersPropertiesEditionPart_ParametersLabel), new ReferencesTableListener() {
      public void handleAdd() {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ParametersPropertiesEditionPartForm.this, UmlViewsRepository.Parameters.parameters_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        parameters.refresh();
      }
      public void handleEdit(EObject element) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ParametersPropertiesEditionPartForm.this, UmlViewsRepository.Parameters.parameters_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
        parameters.refresh();
      }
      public void handleMove(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ParametersPropertiesEditionPartForm.this, UmlViewsRepository.Parameters.parameters_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
        parameters.refresh();
      }
      public void handleRemove(EObject element) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ParametersPropertiesEditionPartForm.this, UmlViewsRepository.Parameters.parameters_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
        parameters.refresh();
      }
    ...
    this.parameters.addSelectionListener(new SelectionAdapter() {
      ...
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ParametersPropertiesEditionPartForm.this, UmlViewsRepository.Parameters.parameters_, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
