 ...
 * @generated
 */
public class ParameterGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public ParameterGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject parameter, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.name))
				generalPart.setName(EEFConverterUtil.convertToString(TypesPackage.Literals.STRING, parameter.getName()));
			
			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(EEFUtils.choiceOfValues(parameter, UMLPackage.eINSTANCE.getNamedElement_Visibility()), parameter.getVisibility());
			}
			if (isAccessible(UmlViewsRepository.General.direction)) {
				generalPart.initDirection(EEFUtils.choiceOfValues(parameter, UMLPackage.eINSTANCE.getParameter_Direction()), parameter.getDirection());
			}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getParameter_Direction().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.General.direction))
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == UmlViewsRepository.General.name || key == UmlViewsRepository.General.visibility || key == UmlViewsRepository.General.direction || key == UmlViewsRepository.General.type;
	}
