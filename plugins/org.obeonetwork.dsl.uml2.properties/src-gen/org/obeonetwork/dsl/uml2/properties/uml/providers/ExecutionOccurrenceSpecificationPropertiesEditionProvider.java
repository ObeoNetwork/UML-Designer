...
import org.obeonetwork.dsl.uml2.properties.uml.components.ExecutionOccurrenceSpecificationPropertiesEditionComponent;

/**
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 * 
 */
public class ExecutionOccurrenceSpecificationPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public ExecutionOccurrenceSpecificationPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public ExecutionOccurrenceSpecificationPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof ExecutionOccurrenceSpecification) 
					&& (UMLPackage.eINSTANCE.getExecutionOccurrenceSpecification() == editingContext.getEObject().eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
		if (editingContext.getEObject() instanceof ExecutionOccurrenceSpecification) {
			if (ExecutionOccurrenceSpecificationPropertiesEditionComponent.BASE_PART.equals(part)
				&& refinement == ExecutionOccurrenceSpecificationPropertiesEditionComponent.class)
				return new ExecutionOccurrenceSpecificationPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
