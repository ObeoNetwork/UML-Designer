...
public class LoopNodePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.LoopNode.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.LoopNode.Properties.mustIsolate)) {
				basePart.setMustIsolate(loopNode.isMustIsolate());
			}
			if (isAccessible(UmlViewsRepository.LoopNode.Properties.isTestedFirst)) {
