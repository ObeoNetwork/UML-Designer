...
public class InterfaceGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public InterfaceGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext,
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.name))
				generalPart.setName(
						EEFConverterUtil.convertToString(TypesPackage.Literals.STRING, interface_.getName()));

			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(
						EEFUtils.choiceOfValues(interface_,
								UMLPackage.eINSTANCE.getNamedElement_Visibility()),
						interface_.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.General.usecase)) {
				usecaseSettings = new ReferencesTableSettings(interface_,
