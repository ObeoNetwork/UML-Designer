...
public class LiteralUnlimitedNaturalPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (literalUnlimitedNatural.getName() != null && isAccessible(UmlViewsRepository.LiteralUnlimitedNatural.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.eINSTANCE.getString(), literalUnlimitedNatural.getName()));
			...
			if (isAccessible(UmlViewsRepository.LiteralUnlimitedNatural.Properties.value)) {
				basePart.setValue(EEFConverterUtil.convertToString(UMLPackage.eINSTANCE.getUnlimitedNatural(), literalUnlimitedNatural.getValue()));
			}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.LiteralUnlimitedNatural.Properties.name == event.getAffectedEditor()) {
			literalUnlimitedNatural.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
		...
		if (UmlViewsRepository.LiteralUnlimitedNatural.Properties.value == event.getAffectedEditor()) {
			literalUnlimitedNatural.setValue((EEFConverterUtil.createIntFromString(UMLPackage.eINSTANCE.getUnlimitedNatural(), (String)event.getNewValue())));
		}
	}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.LiteralUnlimitedNatural.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.LiteralUnlimitedNatural.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getLiteralUnlimitedNatural_Value().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.LiteralUnlimitedNatural.Properties.value)) {
				if (msg.getNewValue() != null) {
					basePart.setValue(EcoreUtil.convertToString(UMLPackage.eINSTANCE.getUnlimitedNatural(), msg.getNewValue()));
				} else {
					basePart.setValue("");
				}
			}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (UmlViewsRepository.LiteralUnlimitedNatural.Properties.value == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getLiteralUnlimitedNatural_Value().getEAttributeType(), (String)newValue);
					}
