 ...
 * @generated
 */
public class SendSignalEventPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, SendSignalEventPropertiesEditionPart {
	 ...
	 */
	public SendSignalEventPropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SendSignalEventPropertiesEditionPartForm.this,
							UmlViewsRepository.SendSignalEvent.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.SendSignalEvent.Properties.clientDependency, UmlMessages.SendSignalEventPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
