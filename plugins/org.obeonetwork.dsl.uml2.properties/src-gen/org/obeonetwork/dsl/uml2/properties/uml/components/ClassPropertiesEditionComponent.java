...
public class ClassPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
    ...
    public ClassPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject class_, String editing_mode) {
        ...
        if (class_ instanceof Class) {
            ...
            classGeneralPropertiesEditionComponent = (ClassGeneralPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    ClassGeneralPropertiesEditionComponent.GENERAL_PART, ClassGeneralPropertiesEditionComponent.class);
            addSubComponent(classGeneralPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(class_, PropertiesEditingProvider.class);
            classAttributesPropertiesEditionComponent = (ClassAttributesPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    ClassAttributesPropertiesEditionComponent.ATTRIBUTES_PART, ClassAttributesPropertiesEditionComponent.class);
            addSubComponent(classAttributesPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(class_, PropertiesEditingProvider.class);
            classOperationsPropertiesEditionComponent = (ClassOperationsPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    ClassOperationsPropertiesEditionComponent.OPERATIONS_PART, ClassOperationsPropertiesEditionComponent.class);
