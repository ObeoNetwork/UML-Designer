...
public class ClassPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.Class_.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.Class_.Properties.isAbstract)) {
			...
			if (isAccessible(UmlViewsRepository.Class_.Properties.isActive)) {
