...
public class ClassPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	 ...
	 * @generated
	 */
	public ClassPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject class_,
			String editing_mode) {
		super(editingContext, editing_mode);
		if (class_ instanceof Class) {
			PropertiesEditingProvider provider = null;
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(class_,
					PropertiesEditingProvider.class);
			classGeneralPropertiesEditionComponent = (ClassGeneralPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							ClassGeneralPropertiesEditionComponent.GENERAL_PART,
							ClassGeneralPropertiesEditionComponent.class);
			addSubComponent(classGeneralPropertiesEditionComponent);
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(class_,
					PropertiesEditingProvider.class);
			classAttributesPropertiesEditionComponent = (ClassAttributesPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							ClassAttributesPropertiesEditionComponent.ATTRIBUTES_PART,
							ClassAttributesPropertiesEditionComponent.class);
			addSubComponent(classAttributesPropertiesEditionComponent);
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(class_,
					PropertiesEditingProvider.class);
			classOperationsPropertiesEditionComponent = (ClassOperationsPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							ClassOperationsPropertiesEditionComponent.OPERATIONS_PART,
							ClassOperationsPropertiesEditionComponent.class);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (ClassGeneralPropertiesEditionComponent.GENERAL_PART.equals(key)) {
			generalPart = (GeneralPropertiesEditionPart)classGeneralPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
			return (IPropertiesEditionPart)generalPart;
		}
		if (ClassAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(key)) {
			attributesPart = (AttributesPropertiesEditionPart)classAttributesPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
			return (IPropertiesEditionPart)attributesPart;
		}
		if (ClassOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(key)) {
			operationsPart = (OperationsPropertiesEditionPart)classOperationsPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
