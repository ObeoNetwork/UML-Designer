 ...
 * 
 */
public interface RemoveStructuralFeatureValueActionPropertiesEditionPart {
	...
	/**
	 * Init the structuralFeature
	 * @param settings the combo setting
	 */
	public void initStructuralFeature(EObjectFlatComboSettings settings);

	/**
	 * Defines a new structuralFeature
	 * @param newValue the new structuralFeature to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the structuralFeature edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return the isRemoveDuplicates
	 * 
	 */
	public Boolean getIsRemoveDuplicates();

	/**
	 * Defines a new isRemoveDuplicates
	 * @param newValue the new isRemoveDuplicates to set
	 * 
	 */
