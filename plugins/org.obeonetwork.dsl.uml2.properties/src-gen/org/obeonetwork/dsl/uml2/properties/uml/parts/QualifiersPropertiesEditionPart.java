 ...
 * @generated
 */
public interface QualifiersPropertiesEditionPart {
	 ...
	 * 
	 * @param newValue
	 *            the qualifiers to update
	 * @generated
	 */
	public void updateQualifiers();

	/**
	 * Adds the given filter to the qualifiers edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the qualifiers table
	 * @generated
	 */
