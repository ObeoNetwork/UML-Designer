...
public class InitialNodePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, InitialNodePropertiesEditionPart {
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              ...
              UmlViewsRepository.InitialNode.Properties.name,
    ...
    this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.InitialNode.Properties.clientDependency, UmlMessages.InitialNodePropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
    ...
    isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.InitialNode.Properties.isLeaf, UmlMessages.InitialNodePropertiesEditionPart_IsLeafLabel), SWT.CHECK);
    ...
    this.outgoing = new ReferencesTable(getDescription(UmlViewsRepository.InitialNode.Properties.outgoing, UmlMessages.InitialNodePropertiesEditionPart_OutgoingLabel), new ReferencesTableListener	() {
    ...
    this.incoming = new ReferencesTable(getDescription(UmlViewsRepository.InitialNode.Properties.incoming, UmlMessages.InitialNodePropertiesEditionPart_IncomingLabel), new ReferencesTableListener	() {
    ...
    this.inPartition = new ReferencesTable(getDescription(UmlViewsRepository.InitialNode.Properties.inPartition, UmlMessages.InitialNodePropertiesEditionPart_InPartitionLabel), new ReferencesTableListener	() {
    ...
    this.inInterruptibleRegion = new ReferencesTable(getDescription(UmlViewsRepository.InitialNode.Properties.inInterruptibleRegion, UmlMessages.InitialNodePropertiesEditionPart_InInterruptibleRegionLabel), new ReferencesTableListener	() {
    ...
    this.redefinedNode = new ReferencesTable(getDescription(UmlViewsRepository.InitialNode.Properties.redefinedNode, UmlMessages.InitialNodePropertiesEditionPart_RedefinedNodeLabel), new ReferencesTableListener	() {
