...
public class ConnectorPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	 ...
	 * @generated
	 */
	public ConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject connector,
			String editing_mode) {
		super(editingContext, editing_mode);
		if (connector instanceof Connector) {
			PropertiesEditingProvider provider = null;
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(connector,
					PropertiesEditingProvider.class);
			connectorGeneralPropertiesEditionComponent = (ConnectorGeneralPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							ConnectorGeneralPropertiesEditionComponent.GENERAL_PART,
							ConnectorGeneralPropertiesEditionComponent.class);
			addSubComponent(connectorGeneralPropertiesEditionComponent);
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(connector,
					PropertiesEditingProvider.class);
			connectorEndsPropertiesEditionComponent = (ConnectorEndsPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							ConnectorEndsPropertiesEditionComponent.ENDS_PART,
							ConnectorEndsPropertiesEditionComponent.class);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (ConnectorGeneralPropertiesEditionComponent.GENERAL_PART.equals(key)) {
			generalPart = (GeneralPropertiesEditionPart)connectorGeneralPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
			return (IPropertiesEditionPart)generalPart;
		}
		if (ConnectorEndsPropertiesEditionComponent.ENDS_PART.equals(key)) {
			endsPart = (EndsPropertiesEditionPart)connectorEndsPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
