...
public class ConnectorPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
    ...
    public ConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject connector, String editing_mode) {
        ...
        if (connector instanceof Connector) {
            ...
            connectorGeneralPropertiesEditionComponent = (ConnectorGeneralPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    ConnectorGeneralPropertiesEditionComponent.GENERAL_PART, ConnectorGeneralPropertiesEditionComponent.class);
            addSubComponent(connectorGeneralPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(connector, PropertiesEditingProvider.class);
            connectorEndsPropertiesEditionComponent = (ConnectorEndsPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    ConnectorEndsPropertiesEditionComponent.ENDS_PART, ConnectorEndsPropertiesEditionComponent.class);
