 ...
 * 
 */
public interface DecisionNodePropertiesEditionPart {
	...
	/**
	 * Init the decisionInput
	 * @param settings the combo setting
	 */
	public void initDecisionInput(EObjectFlatComboSettings settings);

	/**
	 * Defines a new decisionInput
	 * @param newValue the new decisionInput to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the decisionInput edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return the decisionInputFlow
	 * 
	 */
	public EObject getDecisionInputFlow();

	/**
	 * Init the decisionInputFlow
	 * @param settings the combo setting
	 */
	public void initDecisionInputFlow(EObjectFlatComboSettings settings);

	/**
	 * Defines a new decisionInputFlow
	 * @param newValue the new decisionInputFlow to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the decisionInputFlow edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
