...
public class StereotypePropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof Stereotype)
				&& (StereotypeGeneralPropertiesEditionComponent.GENERAL_PART.equals(part)
						|| StereotypeOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part)
						|| StereotypeAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof Stereotype) {
			return new StereotypePropertiesEditionComponent(editingContext, editingContext.getEObject(),
					mode);
		}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof Stereotype) {
			if (StereotypeGeneralPropertiesEditionComponent.GENERAL_PART.equals(part))
				return new StereotypeGeneralPropertiesEditionComponent(editingContext,
						editingContext.getEObject(), mode);
			if (StereotypeOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part))
				return new StereotypeOperationsPropertiesEditionComponent(editingContext,
						editingContext.getEObject(), mode);
			if (StereotypeAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part))
				return new StereotypeAttributesPropertiesEditionComponent(editingContext,
						editingContext.getEObject(), mode);
		}
