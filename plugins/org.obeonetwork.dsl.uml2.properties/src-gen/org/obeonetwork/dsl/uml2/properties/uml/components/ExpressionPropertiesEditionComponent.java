...
public class ExpressionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (expression.getName() != null && isAccessible(UmlViewsRepository.Expression.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.eINSTANCE.getString(), expression.getName()));
			
			if (isAccessible(UmlViewsRepository.Expression.Properties.visibility)) {
				basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), expression.getVisibility());
			}
			...
			if (expression.getSymbol() != null && isAccessible(UmlViewsRepository.Expression.Properties.symbol))
				basePart.setSymbol(EEFConverterUtil.convertToString(UMLPackage.eINSTANCE.getString(), expression.getSymbol()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.Expression.Properties.name == event.getAffectedEditor()) {
			expression.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
		...
		if (UmlViewsRepository.Expression.Properties.symbol == event.getAffectedEditor()) {
			expression.setSymbol((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
	}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.Expression.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.Expression.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getExpression_Symbol().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.Expression.Properties.symbol)) {
				if (msg.getNewValue() != null) {
