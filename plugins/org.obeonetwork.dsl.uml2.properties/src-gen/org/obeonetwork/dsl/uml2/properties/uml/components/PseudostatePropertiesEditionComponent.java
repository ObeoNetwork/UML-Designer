...
public class PseudostatePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(UmlViewsRepository.Pseudostate.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, pseudostate.getName()));
			
			if (isAccessible(UmlViewsRepository.Pseudostate.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(pseudostate, UMLPackage.eINSTANCE.getNamedElement_Visibility()), pseudostate.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.Pseudostate.Properties.kind)) {
				basePart.initKind(EEFUtils.choiceOfValues(pseudostate, UMLPackage.eINSTANCE.getPseudostate_Kind()), pseudostate.getKind());
			}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == UmlViewsRepository.Pseudostate.Properties.name) {
			return UMLPackage.eINSTANCE.getNamedElement_Name();
		}
		if (editorKey == UmlViewsRepository.Pseudostate.Properties.visibility) {
			return UMLPackage.eINSTANCE.getNamedElement_Visibility();
		}
		if (editorKey == UmlViewsRepository.Pseudostate.Properties.clientDependency) {
			return UMLPackage.eINSTANCE.getNamedElement_ClientDependency();
		}
		if (editorKey == UmlViewsRepository.Pseudostate.Properties.container) {
			return UMLPackage.eINSTANCE.getVertex_Container();
		}
		if (editorKey == UmlViewsRepository.Pseudostate.Properties.kind) {
			return UMLPackage.eINSTANCE.getPseudostate_Kind();
		}
		if (editorKey == UmlViewsRepository.Pseudostate.Properties.stateMachine) {
			return UMLPackage.eINSTANCE.getPseudostate_StateMachine();
		}
		if (editorKey == UmlViewsRepository.Pseudostate.Properties.state) {
			return UMLPackage.eINSTANCE.getPseudostate_State();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.Pseudostate.Properties.name == event.getAffectedEditor()) {
			pseudostate.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Pseudostate.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.Pseudostate.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getPseudostate_Kind().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.Pseudostate.Properties.kind))
				basePart.setKind((PseudostateKind)msg.getNewValue());
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			UMLPackage.eINSTANCE.getPseudostate_StateMachine(),
			UMLPackage.eINSTANCE.getPseudostate_State()		);
