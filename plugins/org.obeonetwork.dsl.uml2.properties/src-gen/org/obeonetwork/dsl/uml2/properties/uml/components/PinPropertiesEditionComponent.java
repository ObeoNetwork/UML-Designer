...
public class PinPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(UmlViewsRepository.Pin.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, pin.getName()));
			
			if (isAccessible(UmlViewsRepository.Pin.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(pin, UMLPackage.eINSTANCE.getNamedElement_Visibility()), pin.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.Pin.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.Pin.Properties.ordering)) {
				basePart.initOrdering(EEFUtils.choiceOfValues(pin, UMLPackage.eINSTANCE.getObjectNode_Ordering()), pin.getOrdering());
			}
			if (isAccessible(UmlViewsRepository.Pin.Properties.isControlType)) {
			...
			if (isAccessible(UmlViewsRepository.Pin.Properties.isOrdered)) {
				basePart.setIsOrdered(pin.isOrdered());
			}
			if (isAccessible(UmlViewsRepository.Pin.Properties.isUnique)) {
				basePart.setIsUnique(pin.isUnique());
			}
			if (isAccessible(UmlViewsRepository.Pin.Properties.isControl)) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.Pin.Properties.name == event.getAffectedEditor()) {
			pin.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Pin.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.Pin.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Pin.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getObjectNode_Ordering().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.Pin.Properties.ordering))
				basePart.setOrdering((ObjectNodeOrderingKind)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getObjectNode_IsControlType().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Pin.Properties.isControlType))
			...
			if (UMLPackage.eINSTANCE.getMultiplicityElement_IsOrdered().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Pin.Properties.isOrdered))
				basePart.setIsOrdered((Boolean)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getMultiplicityElement_IsUnique().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Pin.Properties.isUnique))
				basePart.setIsUnique((Boolean)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getPin_IsControl().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Pin.Properties.isControl))
