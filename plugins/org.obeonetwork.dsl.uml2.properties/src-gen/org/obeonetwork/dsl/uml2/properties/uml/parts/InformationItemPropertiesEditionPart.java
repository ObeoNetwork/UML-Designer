 ...
 * 
 */
public interface InformationItemPropertiesEditionPart {
	...
	/**
	 * Init the represented
	 * @param settings settings for the represented ReferencesTable 
	 */
	public void initRepresented(ReferencesTableSettings settings);

	/**
	 * Update the represented
	 * @param newValue the represented to update
	 * 
	 */
	public void updateRepresented();

	/**
	 * Adds the given filter to the represented edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the represented table
	 * 
	 */
