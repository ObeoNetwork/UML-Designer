 ...
 * @generated
 */
public class CallBehaviorActionPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, CallBehaviorActionPropertiesEditionPart {
	 ...
	 */
	public CallBehaviorActionPropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CallBehaviorActionPropertiesEditionPartForm.this,
							UmlViewsRepository.CallBehaviorAction.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.CallBehaviorAction.Properties.clientDependency, UmlMessages.CallBehaviorActionPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.CallBehaviorAction.Properties.isLeaf, UmlMessages.CallBehaviorActionPropertiesEditionPart_IsLeafLabel), SWT.CHECK);
	...
	protected Composite createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outgoing = new ReferencesTable(getDescription(UmlViewsRepository.CallBehaviorAction.Properties.outgoing, UmlMessages.CallBehaviorActionPropertiesEditionPart_OutgoingLabel), new ReferencesTableListener	() {
	...
	protected Composite createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incoming = new ReferencesTable(getDescription(UmlViewsRepository.CallBehaviorAction.Properties.incoming, UmlMessages.CallBehaviorActionPropertiesEditionPart_IncomingLabel), new ReferencesTableListener	() {
	...
	protected Composite createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inPartition = new ReferencesTable(getDescription(UmlViewsRepository.CallBehaviorAction.Properties.inPartition, UmlMessages.CallBehaviorActionPropertiesEditionPart_InPartitionLabel), new ReferencesTableListener	() {
	...
	protected Composite createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inInterruptibleRegion = new ReferencesTable(getDescription(UmlViewsRepository.CallBehaviorAction.Properties.inInterruptibleRegion, UmlMessages.CallBehaviorActionPropertiesEditionPart_InInterruptibleRegionLabel), new ReferencesTableListener	() {
	...
	protected Composite createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedNode = new ReferencesTable(getDescription(UmlViewsRepository.CallBehaviorAction.Properties.redefinedNode, UmlMessages.CallBehaviorActionPropertiesEditionPart_RedefinedNodeLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsSynchronousCheckbox(FormToolkit widgetFactory, Composite parent) {
		isSynchronous = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.CallBehaviorAction.Properties.isSynchronous, UmlMessages.CallBehaviorActionPropertiesEditionPart_IsSynchronousLabel), SWT.CHECK);
