...
public class OpaqueActionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public OpaqueActionPropertiesEditionComponent(PropertiesEditingContext editingContext,
			EObject opaqueAction, String editing_mode) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(
						EEFUtils.choiceOfValues(opaqueAction,
								UMLPackage.eINSTANCE.getNamedElement_Visibility()),
						opaqueAction.getVisibility());
			}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			opaqueAction.setName((java.lang.String)EEFConverterUtil
