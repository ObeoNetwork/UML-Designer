...
public class OpaqueActionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (opaqueAction.getName() != null && isAccessible(UmlViewsRepository.OpaqueAction.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.eINSTANCE.getString(), opaqueAction.getName()));
			...
			if (opaqueAction.getBodies() != null && isAccessible(UmlViewsRepository.OpaqueAction.Properties.body))
				basePart.setBody(opaqueAction.getBodies());
			
			if (opaqueAction.getLanguages() != null && isAccessible(UmlViewsRepository.OpaqueAction.Properties.language))
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.OpaqueAction.Properties.name == event.getAffectedEditor()) {
			opaqueAction.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.OpaqueAction.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.OpaqueAction.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.OpaqueAction.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getOpaqueAction_Body().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.OpaqueAction.Properties.body)) {
				basePart.setBody(((OpaqueAction)semanticObject).getBodies());
			}
			
			if (UMLPackage.eINSTANCE.getOpaqueAction_Language().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.OpaqueAction.Properties.language)) {
				basePart.setLanguage(((OpaqueAction)semanticObject).getLanguages());
			}
