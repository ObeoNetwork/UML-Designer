 ...
 * @generated
 */
public class PrimitiveTypeAttributesPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * @generated
     */
    public PrimitiveTypeAttributesPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject primitiveType, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(UmlViewsRepository.Attributes.attributes_)) {
                attributesSettings = new ReferencesTableSettings(primitiveType, UMLPackage.eINSTANCE.getDataType_OwnedAttribute());
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (UMLPackage.eINSTANCE.getDataType_OwnedAttribute().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.Attributes.attributes_))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(UMLPackage.eINSTANCE.getDataType_OwnedAttribute());
