...
public class InstanceValuePropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof InstanceValue)
				&& (InstanceValuePropertiesEditionComponent.GENERAL_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof InstanceValue) {
			return new InstanceValuePropertiesEditionComponent(editingContext, editingContext.getEObject(),
					mode);
		}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof InstanceValue) {
			if (InstanceValuePropertiesEditionComponent.GENERAL_PART.equals(part))
				return new InstanceValuePropertiesEditionComponent(editingContext,
