 ...
 * @generated
 */
public class AssociationPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, AssociationPropertiesEditionPart {
	 ...
	 */
	public AssociationPropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AssociationPropertiesEditionPartForm.this,
							UmlViewsRepository.Association.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.Association.Properties.clientDependency, UmlMessages.AssociationPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Association.Properties.isLeaf, UmlMessages.AssociationPropertiesEditionPart_IsLeafLabel), SWT.CHECK);
	...
	protected Composite createIsAbstractCheckbox(FormToolkit widgetFactory, Composite parent) {
		isAbstract = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Association.Properties.isAbstract, UmlMessages.AssociationPropertiesEditionPart_IsAbstractLabel), SWT.CHECK);
	...
	protected Composite createPowertypeExtentReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.powertypeExtent = new ReferencesTable(getDescription(UmlViewsRepository.Association.Properties.powertypeExtent, UmlMessages.AssociationPropertiesEditionPart_PowertypeExtentLabel), new ReferencesTableListener	() {
	...
	protected Composite createRedefinedClassifierReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedClassifier = new ReferencesTable(getDescription(UmlViewsRepository.Association.Properties.redefinedClassifier, UmlMessages.AssociationPropertiesEditionPart_RedefinedClassifierLabel), new ReferencesTableListener	() {
	...
	protected Composite createUseCaseReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.useCase = new ReferencesTable(getDescription(UmlViewsRepository.Association.Properties.useCase, UmlMessages.AssociationPropertiesEditionPart_UseCaseLabel), new ReferencesTableListener	() {
	...
	protected Composite createMemberEndReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.memberEnd = new ReferencesTable(getDescription(UmlViewsRepository.Association.Properties.memberEnd, UmlMessages.AssociationPropertiesEditionPart_MemberEndLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsDerivedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isDerived = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.Association.Properties.isDerived, UmlMessages.AssociationPropertiesEditionPart_IsDerivedLabel), SWT.CHECK);
	...
	protected Composite createNavigableOwnedEndReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.navigableOwnedEnd = new ReferencesTable(getDescription(UmlViewsRepository.Association.Properties.navigableOwnedEnd, UmlMessages.AssociationPropertiesEditionPart_NavigableOwnedEndLabel), new ReferencesTableListener	() {
