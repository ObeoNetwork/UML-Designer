...
public class AttributesPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, AttributesPropertiesEditionPart {
	...
	protected Composite createAttributesAdvancedTableComposition(Composite parent) {
				...
				new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								AttributesPropertiesEditionPartImpl.this,
		...
		this.attributes.setHelpText(propertiesEditionComponent
				.getHelpContent(UmlViewsRepository.Attributes.attributes_, UmlViewsRepository.SWT_KIND));
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(
							new PropertiesEditionEvent(AttributesPropertiesEditionPartImpl.this,
