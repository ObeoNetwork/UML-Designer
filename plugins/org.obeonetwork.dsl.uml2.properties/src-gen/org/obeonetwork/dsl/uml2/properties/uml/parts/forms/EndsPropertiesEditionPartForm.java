 ...
 * @generated
 */
public class EndsPropertiesEditionPartForm extends CustomSectionPropertiesEditingPart implements IFormPropertiesEditionPart, EndsPropertiesEditionPart {
	 ...
	 */
	public EndsPropertiesEditionPartForm() {
		super();
	}
				...
				UmlMessages.EndsPropertiesEditionPart_EndsLabel), new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								EndsPropertiesEditionPartForm.this, UmlViewsRepository.Ends.ends_,
					...
					public void handleMove(EObject element, int oldIndex, int newIndex) {
						propertiesEditionComponent.firePropertiesChanged(
								new PropertiesEditionEvent(EndsPropertiesEditionPartForm.this,
