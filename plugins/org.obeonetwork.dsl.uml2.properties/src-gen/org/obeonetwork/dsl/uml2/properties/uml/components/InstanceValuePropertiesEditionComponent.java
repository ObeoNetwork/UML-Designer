...
public class InstanceValuePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public InstanceValuePropertiesEditionComponent(PropertiesEditingContext editingContext,
			EObject instanceValue, String editing_mode) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.name))
				generalPart.setName(EEFConverterUtil.convertToString(TypesPackage.Literals.STRING,
						instanceValue.getName()));

			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(
						EEFUtils.choiceOfValues(instanceValue,
								UMLPackage.eINSTANCE.getNamedElement_Visibility()),
						instanceValue.getVisibility());
			}
			if (isAccessible(UmlViewsRepository.General.instance)) {
				// init part
				instanceSettings = new EObjectFlatComboSettings(instanceValue,
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			instanceValue.setName((java.lang.String)EEFConverterUtil
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getInstanceValue_Instance().equals(msg.getFeature())
					&& generalPart != null && isAccessible(UmlViewsRepository.General.instance))
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == UmlViewsRepository.General.name || key == UmlViewsRepository.General.visibility
				|| key == UmlViewsRepository.General.instance;
	}
