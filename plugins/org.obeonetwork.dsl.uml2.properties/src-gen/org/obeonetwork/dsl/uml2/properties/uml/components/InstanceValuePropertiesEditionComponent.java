...
public class InstanceValuePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	/**
	 * Settings for instance LinkEReferenceViewer
	 */
	private EObjectFlatComboSettings instanceSettings;
	
	/**
	 * Creation Settings for instance LinkEReferenceViewer
	 */
	private ReferencesTableSettings instanceCreateSettings;
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.instance)) {
				...
				instanceCreateSettings = new ReferencesTableSettings(getinstanceCreateSettingsSource(), UMLPackage.eINSTANCE.getPackage_PackagedElement());
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.instance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				...
				EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext, this, instanceCreateSettings, editingContext.getAdapterFactory());
				context.addInstanciableTypeFilter(new InstanciableTypeFilter() {
					public boolean select(EClass instanciableType) {
						return UMLPackage.Literals.INSTANCE_SPECIFICATION == instanciableType;
					}
				});
				...
				instanceSettings.setToReference(context.getEObject());
				((GeneralPropertiesEditionPart)editingPart).setInstance(context.getEObject());
			}
		}
	}
	...
	/**
	 * @ return source setting for instanceCreateSettings
	 */
	public EObject getinstanceCreateSettingsSource() {
