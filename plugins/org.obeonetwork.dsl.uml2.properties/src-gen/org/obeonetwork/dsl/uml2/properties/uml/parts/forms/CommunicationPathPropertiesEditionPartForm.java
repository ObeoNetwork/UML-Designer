 ...
 * @generated
 */
public class CommunicationPathPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, CommunicationPathPropertiesEditionPart {
	 ...
	 */
	public CommunicationPathPropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CommunicationPathPropertiesEditionPartForm.this,
							UmlViewsRepository.CommunicationPath.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.CommunicationPath.Properties.clientDependency, UmlMessages.CommunicationPathPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.CommunicationPath.Properties.isLeaf, UmlMessages.CommunicationPathPropertiesEditionPart_IsLeafLabel), SWT.CHECK);
	...
	protected Composite createIsAbstractCheckbox(FormToolkit widgetFactory, Composite parent) {
		isAbstract = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.CommunicationPath.Properties.isAbstract, UmlMessages.CommunicationPathPropertiesEditionPart_IsAbstractLabel), SWT.CHECK);
	...
	protected Composite createPowertypeExtentReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.powertypeExtent = new ReferencesTable(getDescription(UmlViewsRepository.CommunicationPath.Properties.powertypeExtent, UmlMessages.CommunicationPathPropertiesEditionPart_PowertypeExtentLabel), new ReferencesTableListener	() {
	...
	protected Composite createRedefinedClassifierReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedClassifier = new ReferencesTable(getDescription(UmlViewsRepository.CommunicationPath.Properties.redefinedClassifier, UmlMessages.CommunicationPathPropertiesEditionPart_RedefinedClassifierLabel), new ReferencesTableListener	() {
	...
	protected Composite createUseCaseReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.useCase = new ReferencesTable(getDescription(UmlViewsRepository.CommunicationPath.Properties.useCase, UmlMessages.CommunicationPathPropertiesEditionPart_UseCaseLabel), new ReferencesTableListener	() {
	...
	protected Composite createMemberEndReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.memberEnd = new ReferencesTable(getDescription(UmlViewsRepository.CommunicationPath.Properties.memberEnd, UmlMessages.CommunicationPathPropertiesEditionPart_MemberEndLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsDerivedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isDerived = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.CommunicationPath.Properties.isDerived, UmlMessages.CommunicationPathPropertiesEditionPart_IsDerivedLabel), SWT.CHECK);
	...
	protected Composite createNavigableOwnedEndReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.navigableOwnedEnd = new ReferencesTable(getDescription(UmlViewsRepository.CommunicationPath.Properties.navigableOwnedEnd, UmlMessages.CommunicationPathPropertiesEditionPart_NavigableOwnedEndLabel), new ReferencesTableListener	() {
