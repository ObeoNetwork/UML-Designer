...
public class StereotypePropertiesEditionComponent extends ComposedPropertiesEditionComponent {
    ...
    public StereotypePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject stereotype, String editing_mode) {
        ...
        if (stereotype instanceof Stereotype) {
            ...
            stereotypeGeneralPropertiesEditionComponent = (StereotypeGeneralPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    StereotypeGeneralPropertiesEditionComponent.GENERAL_PART, StereotypeGeneralPropertiesEditionComponent.class);
            addSubComponent(stereotypeGeneralPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(stereotype, PropertiesEditingProvider.class);
            stereotypeOperationsPropertiesEditionComponent = (StereotypeOperationsPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    StereotypeOperationsPropertiesEditionComponent.OPERATIONS_PART, StereotypeOperationsPropertiesEditionComponent.class);
            addSubComponent(stereotypeOperationsPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(stereotype, PropertiesEditingProvider.class);
            stereotypeAttributesPropertiesEditionComponent = (StereotypeAttributesPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    StereotypeAttributesPropertiesEditionComponent.ATTRIBUTES_PART, StereotypeAttributesPropertiesEditionComponent.class);
