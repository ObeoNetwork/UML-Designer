...
public class StereotypePropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	 ...
	 * @generated
	 */
	public StereotypePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject stereotype,
			String editing_mode) {
		super(editingContext, editing_mode);
		if (stereotype instanceof Stereotype) {
			PropertiesEditingProvider provider = null;
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(stereotype,
					PropertiesEditingProvider.class);
			stereotypeGeneralPropertiesEditionComponent = (StereotypeGeneralPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							StereotypeGeneralPropertiesEditionComponent.GENERAL_PART,
							StereotypeGeneralPropertiesEditionComponent.class);
			addSubComponent(stereotypeGeneralPropertiesEditionComponent);
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(stereotype,
					PropertiesEditingProvider.class);
			stereotypeOperationsPropertiesEditionComponent = (StereotypeOperationsPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							StereotypeOperationsPropertiesEditionComponent.OPERATIONS_PART,
							StereotypeOperationsPropertiesEditionComponent.class);
			addSubComponent(stereotypeOperationsPropertiesEditionComponent);
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(stereotype,
					PropertiesEditingProvider.class);
			stereotypeAttributesPropertiesEditionComponent = (StereotypeAttributesPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							StereotypeAttributesPropertiesEditionComponent.ATTRIBUTES_PART,
							StereotypeAttributesPropertiesEditionComponent.class);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (StereotypeGeneralPropertiesEditionComponent.GENERAL_PART.equals(key)) {
			generalPart = (GeneralPropertiesEditionPart)stereotypeGeneralPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
			return (IPropertiesEditionPart)generalPart;
		}
		if (StereotypeOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(key)) {
			operationsPart = (OperationsPropertiesEditionPart)stereotypeOperationsPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
			return (IPropertiesEditionPart)operationsPart;
		}
		if (StereotypeAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(key)) {
			attributesPart = (AttributesPropertiesEditionPart)stereotypeAttributesPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
