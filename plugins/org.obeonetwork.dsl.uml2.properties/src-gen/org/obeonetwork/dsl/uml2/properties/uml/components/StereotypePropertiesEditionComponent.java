...
public class StereotypePropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The StereotypeDocumentationPropertiesEditionComponent sub component
	 * @generated
	 */
	protected StereotypeDocumentationPropertiesEditionComponent stereotypeDocumentationPropertiesEditionComponent;
	...
	public StereotypePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject stereotype, String editing_mode) {
		...
		if (stereotype instanceof Stereotype) {
			...
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(stereotype, PropertiesEditingProvider.class);
			stereotypeDocumentationPropertiesEditionComponent = (StereotypeDocumentationPropertiesEditionComponent)provider.getPropertiesEditingComponent(editingContext, editing_mode, StereotypeDocumentationPropertiesEditionComponent.DOCUMENTATION_PART, StereotypeDocumentationPropertiesEditionComponent.class);
			addSubComponent(stereotypeDocumentationPropertiesEditionComponent);
		}
	}
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		...
		if (StereotypeDocumentationPropertiesEditionComponent.DOCUMENTATION_PART.equals(key)) {
			documentationPart = (DocumentationPropertiesEditionPart)stereotypeDocumentationPropertiesEditionComponent.getPropertiesEditionPart(kind, key);
