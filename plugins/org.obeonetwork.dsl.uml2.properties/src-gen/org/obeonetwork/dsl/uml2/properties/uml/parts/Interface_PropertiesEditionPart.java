 ...
 * 
 */
public interface Interface_PropertiesEditionPart {
	 ...
	 * @param settings settings for the redefinedInterface ReferencesTable 
	 */
	...
	/**
	 * Adds the given filter to the redefinedInterface edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
