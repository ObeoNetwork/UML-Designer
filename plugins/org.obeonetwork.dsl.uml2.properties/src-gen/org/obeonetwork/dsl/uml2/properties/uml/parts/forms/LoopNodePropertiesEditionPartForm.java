 ...
 * @generated
 */
public class LoopNodePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, LoopNodePropertiesEditionPart {
	 ...
	 */
	public LoopNodePropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							LoopNodePropertiesEditionPartForm.this,
							UmlViewsRepository.LoopNode.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.LoopNode.Properties.clientDependency, UmlMessages.LoopNodePropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.LoopNode.Properties.isLeaf, UmlMessages.LoopNodePropertiesEditionPart_IsLeafLabel), SWT.CHECK);
	...
	protected Composite createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outgoing = new ReferencesTable(getDescription(UmlViewsRepository.LoopNode.Properties.outgoing, UmlMessages.LoopNodePropertiesEditionPart_OutgoingLabel), new ReferencesTableListener	() {
	...
	protected Composite createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incoming = new ReferencesTable(getDescription(UmlViewsRepository.LoopNode.Properties.incoming, UmlMessages.LoopNodePropertiesEditionPart_IncomingLabel), new ReferencesTableListener	() {
	...
	protected Composite createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inPartition = new ReferencesTable(getDescription(UmlViewsRepository.LoopNode.Properties.inPartition, UmlMessages.LoopNodePropertiesEditionPart_InPartitionLabel), new ReferencesTableListener	() {
	...
	protected Composite createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inInterruptibleRegion = new ReferencesTable(getDescription(UmlViewsRepository.LoopNode.Properties.inInterruptibleRegion, UmlMessages.LoopNodePropertiesEditionPart_InInterruptibleRegionLabel), new ReferencesTableListener	() {
	...
	protected Composite createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedNode = new ReferencesTable(getDescription(UmlViewsRepository.LoopNode.Properties.redefinedNode, UmlMessages.LoopNodePropertiesEditionPart_RedefinedNodeLabel), new ReferencesTableListener	() {
	...
	protected Composite createMustIsolateCheckbox(FormToolkit widgetFactory, Composite parent) {
		mustIsolate = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.LoopNode.Properties.mustIsolate, UmlMessages.LoopNodePropertiesEditionPart_MustIsolateLabel), SWT.CHECK);
	...
	protected Composite createIsTestedFirstCheckbox(FormToolkit widgetFactory, Composite parent) {
		isTestedFirst = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.LoopNode.Properties.isTestedFirst, UmlMessages.LoopNodePropertiesEditionPart_IsTestedFirstLabel), SWT.CHECK);
	...
	protected Composite createBodyPartReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.bodyPart = new ReferencesTable(getDescription(UmlViewsRepository.LoopNode.Properties.bodyPart, UmlMessages.LoopNodePropertiesEditionPart_BodyPartLabel), new ReferencesTableListener	() {
	...
	protected Composite createSetupPartReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.setupPart = new ReferencesTable(getDescription(UmlViewsRepository.LoopNode.Properties.setupPart, UmlMessages.LoopNodePropertiesEditionPart_SetupPartLabel), new ReferencesTableListener	() {
	...
	protected Composite createTestReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.test = new ReferencesTable(getDescription(UmlViewsRepository.LoopNode.Properties.test, UmlMessages.LoopNodePropertiesEditionPart_TestLabel), new ReferencesTableListener	() {
	...
	protected Composite createLoopVariableReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.loopVariable = new ReferencesTable(getDescription(UmlViewsRepository.LoopNode.Properties.loopVariable, UmlMessages.LoopNodePropertiesEditionPart_LoopVariableLabel), new ReferencesTableListener	() {
	...
	protected Composite createBodyOutputReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.bodyOutput = new ReferencesTable(getDescription(UmlViewsRepository.LoopNode.Properties.bodyOutput, UmlMessages.LoopNodePropertiesEditionPart_BodyOutputLabel), new ReferencesTableListener	() {
