...
public class ProtocolTransitionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (protocolTransition.getName() != null && isAccessible(UmlViewsRepository.ProtocolTransition.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.eINSTANCE.getString(), protocolTransition.getName()));
			
			if (isAccessible(UmlViewsRepository.ProtocolTransition.Properties.visibility)) {
				basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), protocolTransition.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.ProtocolTransition.Properties.kind)) {
				basePart.initKind((EEnum) UMLPackage.eINSTANCE.getTransition_Kind().getEType(), protocolTransition.getKind());
			}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.ProtocolTransition.Properties.name == event.getAffectedEditor()) {
			protocolTransition.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.ProtocolTransition.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.ProtocolTransition.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.ProtocolTransition.Properties.isLeaf))
				basePart.setIsLeaf((Boolean)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getTransition_Kind().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.ProtocolTransition.Properties.kind))
