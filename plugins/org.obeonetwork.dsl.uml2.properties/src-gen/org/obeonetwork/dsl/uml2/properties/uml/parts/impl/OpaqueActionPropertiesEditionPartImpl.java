...
public class OpaqueActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, OpaqueActionPropertiesEditionPart {
	...
	protected Composite createClientDependencyAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmlViewsRepository.OpaqueAction.Properties.clientDependency, UmlMessages.OpaqueActionPropertiesEditionPart_ClientDependencyLabel);		 
	...
	protected Composite createIsLeafCheckbox(Composite parent) {
		...
		isLeaf.setText(getDescription(UmlViewsRepository.OpaqueAction.Properties.isLeaf, UmlMessages.OpaqueActionPropertiesEditionPart_IsLeafLabel));
	...
	protected Composite createOutgoingAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmlViewsRepository.OpaqueAction.Properties.outgoing, UmlMessages.OpaqueActionPropertiesEditionPart_OutgoingLabel);		 
	...
	protected Composite createIncomingAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmlViewsRepository.OpaqueAction.Properties.incoming, UmlMessages.OpaqueActionPropertiesEditionPart_IncomingLabel);		 
	...
	protected Composite createInPartitionAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmlViewsRepository.OpaqueAction.Properties.inPartition, UmlMessages.OpaqueActionPropertiesEditionPart_InPartitionLabel);		 
	...
	protected Composite createInInterruptibleRegionAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmlViewsRepository.OpaqueAction.Properties.inInterruptibleRegion, UmlMessages.OpaqueActionPropertiesEditionPart_InInterruptibleRegionLabel);		 
	...
	protected Composite createRedefinedNodeAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmlViewsRepository.OpaqueAction.Properties.redefinedNode, UmlMessages.OpaqueActionPropertiesEditionPart_RedefinedNodeLabel);		 
	...
	protected Composite createBodyMultiValuedEditor(Composite parent) {
		...
		editBody.setText(getDescription(UmlViewsRepository.OpaqueAction.Properties.body, UmlMessages.OpaqueActionPropertiesEditionPart_BodyLabel));
	...
	protected Composite createLanguageMultiValuedEditor(Composite parent) {
		...
		editLanguage.setText(getDescription(UmlViewsRepository.OpaqueAction.Properties.language, UmlMessages.OpaqueActionPropertiesEditionPart_LanguageLabel));
