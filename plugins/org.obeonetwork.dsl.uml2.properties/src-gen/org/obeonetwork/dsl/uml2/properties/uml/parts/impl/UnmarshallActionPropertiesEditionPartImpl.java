...
public class UnmarshallActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, UnmarshallActionPropertiesEditionPart {
    ...
    String label = getDescription(UmlViewsRepository.UnmarshallAction.Properties.clientDependency, UmlMessages.UnmarshallActionPropertiesEditionPart_ClientDependencyLabel);		 
    ...
    isLeaf.setText(getDescription(UmlViewsRepository.UnmarshallAction.Properties.isLeaf, UmlMessages.UnmarshallActionPropertiesEditionPart_IsLeafLabel));
    ...
    String label = getDescription(UmlViewsRepository.UnmarshallAction.Properties.outgoing, UmlMessages.UnmarshallActionPropertiesEditionPart_OutgoingLabel);		 
    ...
    String label = getDescription(UmlViewsRepository.UnmarshallAction.Properties.incoming, UmlMessages.UnmarshallActionPropertiesEditionPart_IncomingLabel);		 
    ...
    String label = getDescription(UmlViewsRepository.UnmarshallAction.Properties.inPartition, UmlMessages.UnmarshallActionPropertiesEditionPart_InPartitionLabel);		 
    ...
    String label = getDescription(UmlViewsRepository.UnmarshallAction.Properties.inInterruptibleRegion, UmlMessages.UnmarshallActionPropertiesEditionPart_InInterruptibleRegionLabel);		 
    ...
    String label = getDescription(UmlViewsRepository.UnmarshallAction.Properties.redefinedNode, UmlMessages.UnmarshallActionPropertiesEditionPart_RedefinedNodeLabel);		 
