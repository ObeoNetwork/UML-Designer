 ...
 * @generated
 */
public class CentralBufferNodePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, CentralBufferNodePropertiesEditionPart {
	 ...
	 */
	public CentralBufferNodePropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CentralBufferNodePropertiesEditionPartForm.this,
							UmlViewsRepository.CentralBufferNode.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.CentralBufferNode.Properties.clientDependency, UmlMessages.CentralBufferNodePropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.CentralBufferNode.Properties.isLeaf, UmlMessages.CentralBufferNodePropertiesEditionPart_IsLeafLabel), SWT.CHECK);
	...
	protected Composite createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outgoing = new ReferencesTable(getDescription(UmlViewsRepository.CentralBufferNode.Properties.outgoing, UmlMessages.CentralBufferNodePropertiesEditionPart_OutgoingLabel), new ReferencesTableListener	() {
	...
	protected Composite createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incoming = new ReferencesTable(getDescription(UmlViewsRepository.CentralBufferNode.Properties.incoming, UmlMessages.CentralBufferNodePropertiesEditionPart_IncomingLabel), new ReferencesTableListener	() {
	...
	protected Composite createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inPartition = new ReferencesTable(getDescription(UmlViewsRepository.CentralBufferNode.Properties.inPartition, UmlMessages.CentralBufferNodePropertiesEditionPart_InPartitionLabel), new ReferencesTableListener	() {
	...
	protected Composite createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inInterruptibleRegion = new ReferencesTable(getDescription(UmlViewsRepository.CentralBufferNode.Properties.inInterruptibleRegion, UmlMessages.CentralBufferNodePropertiesEditionPart_InInterruptibleRegionLabel), new ReferencesTableListener	() {
	...
	protected Composite createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedNode = new ReferencesTable(getDescription(UmlViewsRepository.CentralBufferNode.Properties.redefinedNode, UmlMessages.CentralBufferNodePropertiesEditionPart_RedefinedNodeLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsControlTypeCheckbox(FormToolkit widgetFactory, Composite parent) {
		isControlType = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.CentralBufferNode.Properties.isControlType, UmlMessages.CentralBufferNodePropertiesEditionPart_IsControlTypeLabel), SWT.CHECK);
	...
	protected Composite createInStateReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inState = new ReferencesTable(getDescription(UmlViewsRepository.CentralBufferNode.Properties.inState, UmlMessages.CentralBufferNodePropertiesEditionPart_InStateLabel), new ReferencesTableListener	() {
