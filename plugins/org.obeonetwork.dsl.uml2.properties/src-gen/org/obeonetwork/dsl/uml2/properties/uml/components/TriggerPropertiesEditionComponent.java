...
public class TriggerPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public TriggerPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject trigger,
			String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.name))
				generalPart.setName(
						EEFConverterUtil.convertToString(TypesPackage.Literals.STRING, trigger.getName()));

			if (isAccessible(UmlViewsRepository.General.event)) {
				// init part
				eventSettings = new EObjectFlatComboSettings(trigger,
						UMLPackage.eINSTANCE.getTrigger_Event());
				eventCreateSettings = new ReferencesTableSettings(geteventCreateSettingsSource(),
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			trigger.setName((java.lang.String)EEFConverterUtil.createFromString(TypesPackage.Literals.STRING,
		...
		if (UmlViewsRepository.General.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				...
				EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(
						editingContext, this, eventSettings, editingContext.getAdapterFactory());
				PropertiesEditingProvider provider = (PropertiesEditingProvider)editingContext
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getTrigger_Event().equals(msg.getFeature()) && generalPart != null
					&& isAccessible(UmlViewsRepository.General.event))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
				UMLPackage.eINSTANCE.getNamedElement_Name(), UMLPackage.eINSTANCE.getTrigger_Event());
