 ...
 * @generated
 */
public class DocumentationPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, DocumentationPropertiesEditionPart {
	 ...
	 */
	public DocumentationPropertiesEditionPartForm() { super(); }
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              ...
              UmlViewsRepository.Documentation.comment,
    ...
    FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.Documentation.comment, UmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
