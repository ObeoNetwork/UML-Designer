...
public class PseudoStatePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public PseudoStatePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject pseudostate,
			String editing_mode) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(
						EEFUtils.choiceOfValues(pseudostate,
								UMLPackage.eINSTANCE.getNamedElement_Visibility()),
						pseudostate.getVisibility());
			}
			// init filters
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			pseudostate.setName((java.lang.String)EEFConverterUtil
