...
public class InteractionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.Interaction.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.Interaction.Properties.isAbstract)) {
			...
			if (isAccessible(UmlViewsRepository.Interaction.Properties.isActive)) {
				basePart.setIsActive(interaction.isActive());
			}
			if (isAccessible(UmlViewsRepository.Interaction.Properties.isReentrant)) {
