...
public class GeneralizationSetPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (generalizationSet.getName() != null && isAccessible(UmlViewsRepository.GeneralizationSet.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.eINSTANCE.getString(), generalizationSet.getName()));
			...
			// Start of user code for additional businessfilters for powertype
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.GeneralizationSet.Properties.name == event.getAffectedEditor()) {
			generalizationSet.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.GeneralizationSet.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.GeneralizationSet.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getGeneralizationSet_IsCovering().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.GeneralizationSet.Properties.isCovering))
				basePart.setIsCovering((Boolean)msg.getNewValue());
			
			if (UMLPackage.eINSTANCE.getGeneralizationSet_IsDisjoint().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.GeneralizationSet.Properties.isDisjoint))
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (UmlViewsRepository.GeneralizationSet.Properties.isCovering == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getGeneralizationSet_IsCovering().getEAttributeType(), (String)newValue);
					}
				...
				if (UmlViewsRepository.GeneralizationSet.Properties.isDisjoint == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getGeneralizationSet_IsDisjoint().getEAttributeType(), (String)newValue);
					}
