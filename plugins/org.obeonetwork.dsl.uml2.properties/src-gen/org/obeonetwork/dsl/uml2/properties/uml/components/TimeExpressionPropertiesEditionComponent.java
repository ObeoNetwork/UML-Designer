...
public class TimeExpressionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public TimeExpressionPropertiesEditionComponent(PropertiesEditingContext editingContext,
			EObject timeExpression, String editing_mode) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(
						EEFUtils.choiceOfValues(timeExpression,
								UMLPackage.eINSTANCE.getNamedElement_Visibility()),
						timeExpression.getVisibility());
			}
			if (isAccessible(UmlViewsRepository.General.observation)) {
				observationSettings = new ReferencesTableSettings(timeExpression,
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			timeExpression.setName((java.lang.String)EEFConverterUtil
