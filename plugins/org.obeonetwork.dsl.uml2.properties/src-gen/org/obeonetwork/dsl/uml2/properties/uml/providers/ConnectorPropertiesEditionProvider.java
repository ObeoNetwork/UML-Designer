...
public class ConnectorPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Connector) && (UMLPackage.Literals.CONNECTOR == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part) {
        return (editingContext.getEObject() instanceof Connector)
                && (ConnectorGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) || ConnectorEndsPropertiesEditionComponent.ENDS_PART.equals(part));
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof Connector)
                && ((ConnectorGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == ConnectorGeneralPropertiesEditionComponent.class) || (ConnectorEndsPropertiesEditionComponent.ENDS_PART
                        .equals(part) && refinement == ConnectorEndsPropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Connector) {
            if (ConnectorGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == ConnectorGeneralPropertiesEditionComponent.class)
                return new ConnectorGeneralPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (ConnectorEndsPropertiesEditionComponent.ENDS_PART.equals(part) && refinement == ConnectorEndsPropertiesEditionComponent.class)
                return new ConnectorEndsPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
