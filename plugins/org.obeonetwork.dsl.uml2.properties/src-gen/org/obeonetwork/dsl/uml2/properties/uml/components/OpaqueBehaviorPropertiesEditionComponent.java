...
public class OpaqueBehaviorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public OpaqueBehaviorPropertiesEditionComponent(PropertiesEditingContext editingContext,
			EObject opaqueBehavior, String editing_mode) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			opaqueBehavior.setName((java.lang.String)EEFConverterUtil
