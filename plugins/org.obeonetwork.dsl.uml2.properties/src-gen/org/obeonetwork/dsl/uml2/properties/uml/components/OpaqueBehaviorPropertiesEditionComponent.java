...
public class OpaqueBehaviorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.OpaqueBehavior.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.OpaqueBehavior.Properties.isAbstract)) {
			...
			if (isAccessible(UmlViewsRepository.OpaqueBehavior.Properties.isActive)) {
				basePart.setIsActive(opaqueBehavior.isActive());
			}
			if (isAccessible(UmlViewsRepository.OpaqueBehavior.Properties.isReentrant)) {
