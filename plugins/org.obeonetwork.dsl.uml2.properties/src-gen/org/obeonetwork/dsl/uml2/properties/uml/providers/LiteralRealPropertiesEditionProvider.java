...
public class LiteralRealPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof LiteralReal) && (UMLPackage.Literals.LITERAL_REAL == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part) {
        return (editingContext.getEObject() instanceof LiteralReal) && (LiteralRealPropertiesEditionComponent.GENERAL_PART.equals(part));
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof LiteralReal) && (refinement == LiteralRealPropertiesEditionComponent.class);
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof LiteralReal) && ((LiteralRealPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == LiteralRealPropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode) {
        if (editingContext.getEObject() instanceof LiteralReal) {
            return new LiteralRealPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof LiteralReal) {
            if (LiteralRealPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == LiteralRealPropertiesEditionComponent.class)
                return new LiteralRealPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
