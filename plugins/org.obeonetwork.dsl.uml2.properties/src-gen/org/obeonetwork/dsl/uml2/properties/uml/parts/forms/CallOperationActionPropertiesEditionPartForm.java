 ...
 * @generated
 */
public class CallOperationActionPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, CallOperationActionPropertiesEditionPart {
	 ...
	 */
	public CallOperationActionPropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CallOperationActionPropertiesEditionPartForm.this,
							UmlViewsRepository.CallOperationAction.Properties.name,
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.CallOperationAction.Properties.clientDependency, UmlMessages.CallOperationActionPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.CallOperationAction.Properties.isLeaf, UmlMessages.CallOperationActionPropertiesEditionPart_IsLeafLabel), SWT.CHECK);
	...
	protected Composite createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outgoing = new ReferencesTable(getDescription(UmlViewsRepository.CallOperationAction.Properties.outgoing, UmlMessages.CallOperationActionPropertiesEditionPart_OutgoingLabel), new ReferencesTableListener	() {
	...
	protected Composite createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incoming = new ReferencesTable(getDescription(UmlViewsRepository.CallOperationAction.Properties.incoming, UmlMessages.CallOperationActionPropertiesEditionPart_IncomingLabel), new ReferencesTableListener	() {
	...
	protected Composite createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inPartition = new ReferencesTable(getDescription(UmlViewsRepository.CallOperationAction.Properties.inPartition, UmlMessages.CallOperationActionPropertiesEditionPart_InPartitionLabel), new ReferencesTableListener	() {
	...
	protected Composite createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inInterruptibleRegion = new ReferencesTable(getDescription(UmlViewsRepository.CallOperationAction.Properties.inInterruptibleRegion, UmlMessages.CallOperationActionPropertiesEditionPart_InInterruptibleRegionLabel), new ReferencesTableListener	() {
	...
	protected Composite createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedNode = new ReferencesTable(getDescription(UmlViewsRepository.CallOperationAction.Properties.redefinedNode, UmlMessages.CallOperationActionPropertiesEditionPart_RedefinedNodeLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsSynchronousCheckbox(FormToolkit widgetFactory, Composite parent) {
		isSynchronous = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.CallOperationAction.Properties.isSynchronous, UmlMessages.CallOperationActionPropertiesEditionPart_IsSynchronousLabel), SWT.CHECK);
