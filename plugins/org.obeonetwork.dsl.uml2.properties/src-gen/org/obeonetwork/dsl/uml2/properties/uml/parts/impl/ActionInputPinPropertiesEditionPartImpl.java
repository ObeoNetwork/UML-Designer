 ...
 * @generated
 */
public class ActionInputPinPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ActionInputPinPropertiesEditionPart {
	 ...
	 * @generated
	 */
	public ActionInputPinPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
    ...
    propertiesGroup.setText(UmlMessages.ActionInputPinPropertiesEditionPart_PropertiesGroupLabel);
    ...
    createDescription(parent, UmlViewsRepository.ActionInputPin.Properties.name, UmlMessages.ActionInputPinPropertiesEditionPart_NameLabel);
    ...
    name.addFocusListener(new FocusAdapter() {
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null)
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
      }
    ...
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.name, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    createDescription(parent, UmlViewsRepository.ActionInputPin.Properties.visibility, UmlMessages.ActionInputPinPropertiesEditionPart_VisibilityLabel);
    ...
    visibility.addSelectionChangedListener(new ISelectionChangedListener() {
      ...
      public void selectionChanged(SelectionChangedEvent event) {
        if (propertiesEditionComponent != null)
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.visibility, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVisibility()));
      }

    });
    visibility.setID(UmlViewsRepository.ActionInputPin.Properties.visibility);
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.visibility, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    String label = getDescription(UmlViewsRepository.ActionInputPin.Properties.clientDependency, UmlMessages.ActionInputPinPropertiesEditionPart_ClientDependencyLabel);		 
    ...
    this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.clientDependency, UmlViewsRepository.SWT_KIND));
    this.clientDependency.createControls(parent);
    this.clientDependency.addSelectionListener(new SelectionAdapter() {
      
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.clientDependency, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
    ...
    "clientDependency", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
      ...
      public void process(IStructuredSelection selection) {
        for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
          ...
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.clientDependency,
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
    clientDependency.refresh();
  }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
    clientDependency.refresh();
  }
    ...
    isLeaf.setText(getDescription(UmlViewsRepository.ActionInputPin.Properties.isLeaf, UmlMessages.ActionInputPinPropertiesEditionPart_IsLeafLabel));
    isLeaf.addSelectionListener(new SelectionAdapter() {
      ...
      public void widgetSelected(SelectionEvent e) {
        if (propertiesEditionComponent != null)
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.isLeaf, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isLeaf.getSelection())));
      }
    ...
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.isLeaf, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    createDescription(parent, UmlViewsRepository.ActionInputPin.Properties.inStructuredNode, UmlMessages.ActionInputPinPropertiesEditionPart_InStructuredNodeLabel);
    inStructuredNode = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(UmlViewsRepository.ActionInputPin.Properties.inStructuredNode, UmlViewsRepository.SWT_KIND));
    ...
    inStructuredNode.addSelectionChangedListener(new ISelectionChangedListener() {
      ...
      public void selectionChanged(SelectionChangedEvent event) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inStructuredNode, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getInStructuredNode()));
      }
    ...
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.inStructuredNode, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    createDescription(parent, UmlViewsRepository.ActionInputPin.Properties.activity, UmlMessages.ActionInputPinPropertiesEditionPart_ActivityLabel);
    activity = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(UmlViewsRepository.ActionInputPin.Properties.activity, UmlViewsRepository.SWT_KIND));
    ...
    activity.addSelectionChangedListener(new ISelectionChangedListener() {
      ...
      public void selectionChanged(SelectionChangedEvent event) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.activity, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getActivity()));
      }
    ...
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.activity, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    String label = getDescription(UmlViewsRepository.ActionInputPin.Properties.outgoing, UmlMessages.ActionInputPinPropertiesEditionPart_OutgoingLabel);		 
    ...
    this.outgoing.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.outgoing, UmlViewsRepository.SWT_KIND));
    this.outgoing.createControls(parent);
    this.outgoing.addSelectionListener(new SelectionAdapter() {
      
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.outgoing, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
    ...
    "outgoing", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
      ...
      public void process(IStructuredSelection selection) {
        for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
          EObject elem = (EObject) iter.next();
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.outgoing,
            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
        }
        outgoing.refresh();
      }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.outgoing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
    outgoing.refresh();
  }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.outgoing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
    outgoing.refresh();
  }
    ...
    String label = getDescription(UmlViewsRepository.ActionInputPin.Properties.incoming, UmlMessages.ActionInputPinPropertiesEditionPart_IncomingLabel);		 
    ...
    this.incoming.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.incoming, UmlViewsRepository.SWT_KIND));
    this.incoming.createControls(parent);
    this.incoming.addSelectionListener(new SelectionAdapter() {
      
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.incoming, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
    ...
    "incoming", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
      ...
      public void process(IStructuredSelection selection) {
        for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
          EObject elem = (EObject) iter.next();
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.incoming,
            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
        }
        incoming.refresh();
      }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.incoming, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
    incoming.refresh();
  }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.incoming, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
    incoming.refresh();
  }
    ...
    String label = getDescription(UmlViewsRepository.ActionInputPin.Properties.inPartition, UmlMessages.ActionInputPinPropertiesEditionPart_InPartitionLabel);		 
    ...
    this.inPartition.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.inPartition, UmlViewsRepository.SWT_KIND));
    this.inPartition.createControls(parent);
    this.inPartition.addSelectionListener(new SelectionAdapter() {
      
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inPartition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
    ...
    "inPartition", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
      ...
      public void process(IStructuredSelection selection) {
        for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
          EObject elem = (EObject) iter.next();
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inPartition,
            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
        }
        inPartition.refresh();
      }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inPartition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
    inPartition.refresh();
  }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inPartition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
    inPartition.refresh();
  }
    ...
    String label = getDescription(UmlViewsRepository.ActionInputPin.Properties.inInterruptibleRegion, UmlMessages.ActionInputPinPropertiesEditionPart_InInterruptibleRegionLabel);		 
    ...
    this.inInterruptibleRegion.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.inInterruptibleRegion, UmlViewsRepository.SWT_KIND));
    this.inInterruptibleRegion.createControls(parent);
    this.inInterruptibleRegion.addSelectionListener(new SelectionAdapter() {
      
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inInterruptibleRegion, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
    ...
    "inInterruptibleRegion", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
      ...
      public void process(IStructuredSelection selection) {
        for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
          EObject elem = (EObject) iter.next();
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inInterruptibleRegion,
            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
        }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inInterruptibleRegion, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
    inInterruptibleRegion.refresh();
  }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inInterruptibleRegion, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
    inInterruptibleRegion.refresh();
  }
    ...
    String label = getDescription(UmlViewsRepository.ActionInputPin.Properties.redefinedNode, UmlMessages.ActionInputPinPropertiesEditionPart_RedefinedNodeLabel);		 
    ...
    this.redefinedNode.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.redefinedNode, UmlViewsRepository.SWT_KIND));
    this.redefinedNode.createControls(parent);
    this.redefinedNode.addSelectionListener(new SelectionAdapter() {
      
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.redefinedNode, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
    ...
    "redefinedNode", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
      ...
      public void process(IStructuredSelection selection) {
        for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
          EObject elem = (EObject) iter.next();
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.redefinedNode,
            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
        }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.redefinedNode, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
    redefinedNode.refresh();
  }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.redefinedNode, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
    redefinedNode.refresh();
  }
    ...
    createDescription(parent, UmlViewsRepository.ActionInputPin.Properties.type, UmlMessages.ActionInputPinPropertiesEditionPart_TypeLabel);
    type = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(UmlViewsRepository.ActionInputPin.Properties.type, UmlViewsRepository.SWT_KIND));
    type.setLabelProvider(new AdapterFactoryLabelProvider(adapterFactory));

    type.addSelectionChangedListener(new ISelectionChangedListener() {

      public void selectionChanged(SelectionChangedEvent event) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.type, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getType()));
      }
    ...
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.type, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    createDescription(parent, UmlViewsRepository.ActionInputPin.Properties.ordering, UmlMessages.ActionInputPinPropertiesEditionPart_OrderingLabel);
    ...
    ordering.addSelectionChangedListener(new ISelectionChangedListener() {
      ...
      public void selectionChanged(SelectionChangedEvent event) {
        if (propertiesEditionComponent != null)
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.ordering, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOrdering()));
      }

    });
    ordering.setID(UmlViewsRepository.ActionInputPin.Properties.ordering);
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.ordering, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    isControlType.setText(getDescription(UmlViewsRepository.ActionInputPin.Properties.isControlType, UmlMessages.ActionInputPinPropertiesEditionPart_IsControlTypeLabel));
    isControlType.addSelectionListener(new SelectionAdapter() {
      ...
      public void widgetSelected(SelectionEvent e) {
        if (propertiesEditionComponent != null)
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.isControlType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isControlType.getSelection())));
      }
    ...
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.isControlType, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    String label = getDescription(UmlViewsRepository.ActionInputPin.Properties.inState, UmlMessages.ActionInputPinPropertiesEditionPart_InStateLabel);		 
    ...
    this.inState.setHelpText(propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.inState, UmlViewsRepository.SWT_KIND));
    this.inState.createControls(parent);
    this.inState.addSelectionListener(new SelectionAdapter() {
      
      public void widgetSelected(SelectionEvent e) {
        if (e.item != null && e.item.getData() instanceof EObject) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inState, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
        }
      }
    ...
    "inState", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
      ...
      public void process(IStructuredSelection selection) {
        for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
          EObject elem = (EObject) iter.next();
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inState,
            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
        }
        inState.refresh();
      }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inState, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
    inState.refresh();
  }
    ...
    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.inState, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
    inState.refresh();
  }
    ...
    createDescription(parent, UmlViewsRepository.ActionInputPin.Properties.selection, UmlMessages.ActionInputPinPropertiesEditionPart_SelectionLabel);
    selection = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(UmlViewsRepository.ActionInputPin.Properties.selection, UmlViewsRepository.SWT_KIND));
    ...
    selection.addSelectionChangedListener(new ISelectionChangedListener() {
      ...
      public void selectionChanged(SelectionChangedEvent event) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.selection, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getSelection()));
      }
    ...
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.selection, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    isOrdered.setText(getDescription(UmlViewsRepository.ActionInputPin.Properties.isOrdered, UmlMessages.ActionInputPinPropertiesEditionPart_IsOrderedLabel));
    isOrdered.addSelectionListener(new SelectionAdapter() {
      ...
      public void widgetSelected(SelectionEvent e) {
        if (propertiesEditionComponent != null)
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.isOrdered, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isOrdered.getSelection())));
      }
    ...
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.isOrdered, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    isUnique.setText(getDescription(UmlViewsRepository.ActionInputPin.Properties.isUnique, UmlMessages.ActionInputPinPropertiesEditionPart_IsUniqueLabel));
    isUnique.addSelectionListener(new SelectionAdapter() {
      ...
      public void widgetSelected(SelectionEvent e) {
        if (propertiesEditionComponent != null)
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.isUnique, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isUnique.getSelection())));
      }
    ...
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.isUnique, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    isControl.setText(getDescription(UmlViewsRepository.ActionInputPin.Properties.isControl, UmlMessages.ActionInputPinPropertiesEditionPart_IsControlLabel));
    isControl.addSelectionListener(new SelectionAdapter() {
      ...
      public void widgetSelected(SelectionEvent e) {
        if (propertiesEditionComponent != null)
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UmlViewsRepository.ActionInputPin.Properties.isControl, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isControl.getSelection())));
      }
    ...
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmlViewsRepository.ActionInputPin.Properties.isControl, UmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
    return parent;
  }
    ...
    boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.name);
    if (readOnly && name.isEnabled()) {
      name.setEnabled(false);
      name.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.ActionInputPinPropertiesEditionPart#initVisibility(Object input, Enumerator current)
	 */
	public void initVisibility(Object input, Enumerator current) {
		visibility.setInput(input);
		visibility.modelUpdating(new StructuredSelection(current));
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.visibility);
		if (readOnly && visibility.isEnabled()) {
			visibility.setEnabled(false);
			visibility.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
	...
	public void initClientDependency(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.clientDependency);
		if (readOnly && clientDependency.getTable().isEnabled()) {
			clientDependency.setEnabled(false);
			clientDependency.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
  ...
  clientDependency.refresh();
    ...
    boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.isLeaf);
    if (readOnly && isLeaf.isEnabled()) {
      isLeaf.setEnabled(false);
      isLeaf.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
	...
	public void initInStructuredNode(EObjectFlatComboSettings settings) {
		...
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.inStructuredNode);
		if (readOnly && inStructuredNode.isEnabled()) {
			inStructuredNode.setEnabled(false);
			inStructuredNode.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
	...
	public void initActivity(EObjectFlatComboSettings settings) {
		...
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.activity);
		if (readOnly && activity.isEnabled()) {
			activity.setEnabled(false);
			activity.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
	...
	public void initOutgoing(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.outgoing);
		if (readOnly && outgoing.getTable().isEnabled()) {
			outgoing.setEnabled(false);
			outgoing.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
  ...
  outgoing.refresh();
	...
	public void initIncoming(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.incoming);
		if (readOnly && incoming.getTable().isEnabled()) {
			incoming.setEnabled(false);
			incoming.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
  ...
  incoming.refresh();
	...
	public void initInPartition(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.inPartition);
		if (readOnly && inPartition.getTable().isEnabled()) {
			inPartition.setEnabled(false);
			inPartition.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
  ...
  inPartition.refresh();
	...
	public void initInInterruptibleRegion(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.inInterruptibleRegion);
		if (readOnly && inInterruptibleRegion.getTable().isEnabled()) {
			inInterruptibleRegion.setEnabled(false);
			inInterruptibleRegion.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
  ...
  inInterruptibleRegion.refresh();
	...
	public void initRedefinedNode(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.redefinedNode);
		if (readOnly && redefinedNode.getTable().isEnabled()) {
			redefinedNode.setEnabled(false);
			redefinedNode.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
  ...
  redefinedNode.refresh();
	...
	public void initType(EObjectFlatComboSettings settings) {
		...
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.type);
		if (readOnly && type.isEnabled()) {
			type.setEnabled(false);
			type.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.ActionInputPinPropertiesEditionPart#initOrdering(Object input, Enumerator current)
	 */
	public void initOrdering(Object input, Enumerator current) {
		...
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.ordering);
		if (readOnly && ordering.isEnabled()) {
			ordering.setEnabled(false);
			ordering.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
    ...
    boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.isControlType);
    if (readOnly && isControlType.isEnabled()) {
      isControlType.setEnabled(false);
      isControlType.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
	...
	public void initInState(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.inState);
		if (readOnly && inState.getTable().isEnabled()) {
			inState.setEnabled(false);
			inState.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
  ...
  inState.refresh();
	...
	public void initSelection(EObjectFlatComboSettings settings) {
		...
		boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.selection);
		if (readOnly && selection.isEnabled()) {
			selection.setEnabled(false);
			selection.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
    ...
    boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.isOrdered);
    if (readOnly && isOrdered.isEnabled()) {
      isOrdered.setEnabled(false);
      isOrdered.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
    ...
    boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.isUnique);
    if (readOnly && isUnique.isEnabled()) {
      isUnique.setEnabled(false);
      isUnique.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
    ...
    boolean readOnly = isReadOnly(UmlViewsRepository.ActionInputPin.Properties.isControl);
    if (readOnly && isControl.isEnabled()) {
      isControl.setEnabled(false);
      isControl.setToolTipText(UmlMessages.ActionInputPin_ReadOnly);
