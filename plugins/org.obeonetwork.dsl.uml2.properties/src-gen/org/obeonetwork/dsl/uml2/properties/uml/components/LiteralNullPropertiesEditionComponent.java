...
public class LiteralNullPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public LiteralNullPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject literalNull,
			String editing_mode) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(
						EEFUtils.choiceOfValues(literalNull,
								UMLPackage.eINSTANCE.getNamedElement_Visibility()),
						literalNull.getVisibility());
			}
			// init filters
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			literalNull.setName((java.lang.String)EEFConverterUtil
