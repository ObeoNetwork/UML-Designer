...
import org.obeonetwork.dsl.uml2.properties.uml.components.ClearStructuralFeatureActionPropertiesEditionComponent;

/**
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 * 
 */
public class ClearStructuralFeatureActionPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public ClearStructuralFeatureActionPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public ClearStructuralFeatureActionPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof ClearStructuralFeatureAction) 
					&& (UMLPackage.eINSTANCE.getClearStructuralFeatureAction() == editingContext.getEObject().eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
		if (editingContext.getEObject() instanceof ClearStructuralFeatureAction) {
			if (ClearStructuralFeatureActionPropertiesEditionComponent.BASE_PART.equals(part)
				&& refinement == ClearStructuralFeatureActionPropertiesEditionComponent.class)
				return new ClearStructuralFeatureActionPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
