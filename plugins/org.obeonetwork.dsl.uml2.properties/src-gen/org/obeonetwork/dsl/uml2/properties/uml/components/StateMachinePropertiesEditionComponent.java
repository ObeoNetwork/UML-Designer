...
public class StateMachinePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.StateMachine.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.StateMachine.Properties.isAbstract)) {
			...
			if (isAccessible(UmlViewsRepository.StateMachine.Properties.isActive)) {
				basePart.setIsActive(stateMachine.isActive());
			}
			if (isAccessible(UmlViewsRepository.StateMachine.Properties.isReentrant)) {
