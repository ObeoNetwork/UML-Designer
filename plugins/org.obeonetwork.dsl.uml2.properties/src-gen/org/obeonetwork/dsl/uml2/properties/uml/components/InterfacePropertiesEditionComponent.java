...
public class InterfacePropertiesEditionComponent extends ComposedPropertiesEditionComponent {
    ...
    public InterfacePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject interface_, String editing_mode) {
        ...
        if (interface_ instanceof Interface) {
            ...
            interfaceGeneralPropertiesEditionComponent = (InterfaceGeneralPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    InterfaceGeneralPropertiesEditionComponent.GENERAL_PART, InterfaceGeneralPropertiesEditionComponent.class);
            addSubComponent(interfaceGeneralPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(interface_, PropertiesEditingProvider.class);
            interfaceOperationsPropertiesEditionComponent = (InterfaceOperationsPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    InterfaceOperationsPropertiesEditionComponent.OPERATIONS_PART, InterfaceOperationsPropertiesEditionComponent.class);
            addSubComponent(interfaceOperationsPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(interface_, PropertiesEditingProvider.class);
            interfaceAttributesPropertiesEditionComponent = (InterfaceAttributesPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    InterfaceAttributesPropertiesEditionComponent.ATTRIBUTES_PART, InterfaceAttributesPropertiesEditionComponent.class);
