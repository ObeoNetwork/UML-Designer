...
public class InterfacePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(UmlViewsRepository.Interface_.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, interface_.getName()));
			
			if (isAccessible(UmlViewsRepository.Interface_.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(interface_, UMLPackage.eINSTANCE.getNamedElement_Visibility()), interface_.getVisibility());
			}
			...
			if (isAccessible(UmlViewsRepository.Interface_.Properties.isLeaf)) {
			...
			if (isAccessible(UmlViewsRepository.Interface_.Properties.isAbstract)) {
			...
			if (isAccessible(UmlViewsRepository.Interface_.Properties.redefinedInterface)) {
				...
				basePart.addFilterToRedefinedInterface(new EObjectFilter(UMLPackage.Literals.INTERFACE));
			}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.Interface_.Properties.name == event.getAffectedEditor()) {
			interface_.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
		}
		...
		if (UmlViewsRepository.Interface_.Properties.redefinedInterface == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				...
				redefinedInterfaceSettings.move(event.getNewIndex(), (Interface) event.getNewValue());
			}
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Interface_.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.Interface_.Properties.visibility))
			...
			if (UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Interface_.Properties.isLeaf))
			...
			if (UMLPackage.eINSTANCE.getClassifier_IsAbstract().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Interface_.Properties.isAbstract))
