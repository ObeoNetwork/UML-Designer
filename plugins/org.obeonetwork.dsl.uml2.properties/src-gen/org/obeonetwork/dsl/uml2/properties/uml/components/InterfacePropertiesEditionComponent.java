...
public class InterfacePropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	 ...
	 * @generated
	 */
	public InterfacePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject interface_,
			String editing_mode) {
		super(editingContext, editing_mode);
		if (interface_ instanceof Interface) {
			PropertiesEditingProvider provider = null;
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(interface_,
					PropertiesEditingProvider.class);
			interfaceGeneralPropertiesEditionComponent = (InterfaceGeneralPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							InterfaceGeneralPropertiesEditionComponent.GENERAL_PART,
							InterfaceGeneralPropertiesEditionComponent.class);
			addSubComponent(interfaceGeneralPropertiesEditionComponent);
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(interface_,
					PropertiesEditingProvider.class);
			interfaceOperationsPropertiesEditionComponent = (InterfaceOperationsPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							InterfaceOperationsPropertiesEditionComponent.OPERATIONS_PART,
							InterfaceOperationsPropertiesEditionComponent.class);
			addSubComponent(interfaceOperationsPropertiesEditionComponent);
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(interface_,
					PropertiesEditingProvider.class);
			interfaceAttributesPropertiesEditionComponent = (InterfaceAttributesPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							InterfaceAttributesPropertiesEditionComponent.ATTRIBUTES_PART,
							InterfaceAttributesPropertiesEditionComponent.class);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (InterfaceGeneralPropertiesEditionComponent.GENERAL_PART.equals(key)) {
			generalPart = (GeneralPropertiesEditionPart)interfaceGeneralPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
			return (IPropertiesEditionPart)generalPart;
		}
		if (InterfaceOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(key)) {
			operationsPart = (OperationsPropertiesEditionPart)interfaceOperationsPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
			return (IPropertiesEditionPart)operationsPart;
		}
		if (InterfaceAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(key)) {
			attributesPart = (AttributesPropertiesEditionPart)interfaceAttributesPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
