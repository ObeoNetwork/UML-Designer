...
public class ExecutionOccurrenceSpecificationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (executionOccurrenceSpecification.getName() != null && isAccessible(UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(UMLPackage.eINSTANCE.getString(), executionOccurrenceSpecification.getName()));
			
			if (isAccessible(UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.visibility)) {
				basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), executionOccurrenceSpecification.getVisibility());
			}
			...
			// Start of user code for additional businessfilters for execution
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.name == event.getAffectedEditor()) {
			executionOccurrenceSpecification.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.visibility))
