...
public class InteractionOperandPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
    ...
    if (editingPart != null && key == partKey) {
      ...
      // init values
      if (isAccessible(UmlViewsRepository.InteractionOperand.Properties.name))
        basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, interactionOperand.getName()));
      
      if (isAccessible(UmlViewsRepository.InteractionOperand.Properties.visibility)) {
        basePart.initVisibility(EEFUtils.choiceOfValues(interactionOperand, UMLPackage.eINSTANCE.getNamedElement_Visibility()), interactionOperand.getVisibility());
      }
    ...
    if (UmlViewsRepository.InteractionOperand.Properties.name == event.getAffectedEditor()) {
      interactionOperand.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
    }
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.InteractionOperand.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.InteractionOperand.Properties.visibility))
