...
public class EnumerationPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
    ...
    public EnumerationPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject enumeration, String editing_mode) {
        ...
        if (enumeration instanceof Enumeration) {
            ...
            enumerationGeneralPropertiesEditionComponent = (EnumerationGeneralPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    EnumerationGeneralPropertiesEditionComponent.GENERAL_PART, EnumerationGeneralPropertiesEditionComponent.class);
            addSubComponent(enumerationGeneralPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(enumeration, PropertiesEditingProvider.class);
            enumerationLiteralsPropertiesEditionComponent = (EnumerationLiteralsPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    EnumerationLiteralsPropertiesEditionComponent.LITERALS_PART, EnumerationLiteralsPropertiesEditionComponent.class);
            addSubComponent(enumerationLiteralsPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(enumeration, PropertiesEditingProvider.class);
            enumerationAttributesPropertiesEditionComponent = (EnumerationAttributesPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    EnumerationAttributesPropertiesEditionComponent.ATTRIBUTES_PART, EnumerationAttributesPropertiesEditionComponent.class);
            addSubComponent(enumerationAttributesPropertiesEditionComponent);
            provider = (PropertiesEditingProvider) editingContext.getAdapterFactory().adapt(enumeration, PropertiesEditingProvider.class);
            enumerationOperationsPropertiesEditionComponent = (EnumerationOperationsPropertiesEditionComponent) provider.getPropertiesEditingComponent(editingContext, editing_mode,
                    EnumerationOperationsPropertiesEditionComponent.OPERATIONS_PART, EnumerationOperationsPropertiesEditionComponent.class);
