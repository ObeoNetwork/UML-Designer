...
public class EnumerationPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	 ...
	 * @generated
	 */
	public EnumerationPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject enumeration,
			String editing_mode) {
		super(editingContext, editing_mode);
		if (enumeration instanceof Enumeration) {
			PropertiesEditingProvider provider = null;
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(enumeration,
					PropertiesEditingProvider.class);
			enumerationGeneralPropertiesEditionComponent = (EnumerationGeneralPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							EnumerationGeneralPropertiesEditionComponent.GENERAL_PART,
							EnumerationGeneralPropertiesEditionComponent.class);
			addSubComponent(enumerationGeneralPropertiesEditionComponent);
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(enumeration,
					PropertiesEditingProvider.class);
			enumerationLiteralsPropertiesEditionComponent = (EnumerationLiteralsPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							EnumerationLiteralsPropertiesEditionComponent.LITERALS_PART,
							EnumerationLiteralsPropertiesEditionComponent.class);
			addSubComponent(enumerationLiteralsPropertiesEditionComponent);
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(enumeration,
					PropertiesEditingProvider.class);
			enumerationAttributesPropertiesEditionComponent = (EnumerationAttributesPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							EnumerationAttributesPropertiesEditionComponent.ATTRIBUTES_PART,
							EnumerationAttributesPropertiesEditionComponent.class);
			addSubComponent(enumerationAttributesPropertiesEditionComponent);
			provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(enumeration,
					PropertiesEditingProvider.class);
			enumerationOperationsPropertiesEditionComponent = (EnumerationOperationsPropertiesEditionComponent)provider
					.getPropertiesEditingComponent(editingContext, editing_mode,
							EnumerationOperationsPropertiesEditionComponent.OPERATIONS_PART,
							EnumerationOperationsPropertiesEditionComponent.class);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (EnumerationGeneralPropertiesEditionComponent.GENERAL_PART.equals(key)) {
			generalPart = (GeneralPropertiesEditionPart)enumerationGeneralPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
			return (IPropertiesEditionPart)generalPart;
		}
		if (EnumerationLiteralsPropertiesEditionComponent.LITERALS_PART.equals(key)) {
			literalsPart = (LiteralsPropertiesEditionPart)enumerationLiteralsPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
			return (IPropertiesEditionPart)literalsPart;
		}
		if (EnumerationAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(key)) {
			attributesPart = (AttributesPropertiesEditionPart)enumerationAttributesPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
		...
		if (EnumerationOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(key)) {
			operationsPart = (OperationsPropertiesEditionPart)enumerationOperationsPropertiesEditionComponent
					.getPropertiesEditionPart(kind, key);
