...
public class SignalEventPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof SignalEvent) && (UMLPackage.Literals.SIGNAL_EVENT == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part) {
        return (editingContext.getEObject() instanceof SignalEvent) && (SignalEventPropertiesEditionComponent.GENERAL_PART.equals(part));
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof SignalEvent) && (refinement == SignalEventPropertiesEditionComponent.class);
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof SignalEvent) && ((SignalEventPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == SignalEventPropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode) {
        if (editingContext.getEObject() instanceof SignalEvent) {
            return new SignalEventPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof SignalEvent) {
            if (SignalEventPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == SignalEventPropertiesEditionComponent.class)
                return new SignalEventPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
