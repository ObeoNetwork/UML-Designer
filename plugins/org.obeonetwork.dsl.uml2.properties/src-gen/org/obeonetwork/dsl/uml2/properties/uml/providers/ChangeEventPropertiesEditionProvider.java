...
public class ChangeEventPropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof ChangeEvent)
				&& (ChangeEventPropertiesEditionComponent.GENERAL_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof ChangeEvent) {
			return new ChangeEventPropertiesEditionComponent(editingContext, editingContext.getEObject(),
					mode);
		}
