...
public class ChangeEventPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof ChangeEvent) && (UMLPackage.Literals.CHANGE_EVENT == editingContext.getEObject().eClass());
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof ChangeEvent) {
            if (ChangeEventPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == ChangeEventPropertiesEditionComponent.class)
                return new ChangeEventPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
