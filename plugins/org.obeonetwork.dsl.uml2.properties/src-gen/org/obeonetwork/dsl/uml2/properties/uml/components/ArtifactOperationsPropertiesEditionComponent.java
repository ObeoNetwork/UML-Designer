...
public class ArtifactOperationsPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public ArtifactOperationsPropertiesEditionComponent(PropertiesEditingContext editingContext,
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.Operations.operations_)) {
				operationsSettings = new ReferencesTableSettings(artifact,
		...
		if (UmlViewsRepository.Operations.operations_ == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(
						editingContext, this, operationsSettings, editingContext.getAdapterFactory());
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getArtifact_OwnedOperation().equals(msg.getFeature())
					&& isAccessible(UmlViewsRepository.Operations.operations_))
