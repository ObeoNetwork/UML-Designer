 ...
 * @generated
 */
public class ArtifactOperationsPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * @generated
     */
    public ArtifactOperationsPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject artifact, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(UmlViewsRepository.Operations.operations_)) {
                operationsSettings = new ReferencesTableSettings(artifact, UMLPackage.eINSTANCE.getArtifact_OwnedOperation());
    ...
    public EStructuralFeature associatedFeature(Object editorKey) {
        if (editorKey == UmlViewsRepository.Operations.operations_) {
            return UMLPackage.eINSTANCE.getArtifact_OwnedOperation();
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (UMLPackage.eINSTANCE.getArtifact_OwnedOperation().equals(msg.getFeature()) && isAccessible(UmlViewsRepository.Operations.operations_))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(UMLPackage.eINSTANCE.getArtifact_OwnedOperation());
