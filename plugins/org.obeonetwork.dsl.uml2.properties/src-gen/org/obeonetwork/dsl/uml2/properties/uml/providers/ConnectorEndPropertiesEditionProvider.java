...
public class ConnectorEndPropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof ConnectorEnd)
				&& (ConnectorEndPropertiesEditionComponent.GENERAL_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof ConnectorEnd) {
			return new ConnectorEndPropertiesEditionComponent(editingContext, editingContext.getEObject(),
					mode);
		}
