...
public class CallBehaviorActionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public CallBehaviorActionPropertiesEditionComponent(PropertiesEditingContext editingContext,
			EObject callBehaviorAction, String editing_mode) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.name))
				generalPart.setName(EEFConverterUtil.convertToString(TypesPackage.Literals.STRING,
						callBehaviorAction.getName()));

			if (isAccessible(UmlViewsRepository.General.behaviour)) {
				// init part
				refBehaviorSettings = new EObjectFlatComboSettings(callBehaviorAction,
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			callBehaviorAction.setName((java.lang.String)EEFConverterUtil
		...
		if (UmlViewsRepository.General.behaviour == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				...
				EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(
						editingContext, this, refBehaviorSettings, editingContext.getAdapterFactory());
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getCallBehaviorAction_Behavior().equals(msg.getFeature())
