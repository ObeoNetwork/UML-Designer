 ...
 * 
 */
public interface ReplyActionPropertiesEditionPart {
	...
	/**
	 * @return the replyToCall
	 * 
	 */
	public EObject getReplyToCall();

	/**
	 * Init the replyToCall
	 * @param settings the combo setting
	 */
	public void initReplyToCall(EObjectFlatComboSettings settings);

	/**
	 * Defines a new replyToCall
	 * @param newValue the new replyToCall to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the replyToCall edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
