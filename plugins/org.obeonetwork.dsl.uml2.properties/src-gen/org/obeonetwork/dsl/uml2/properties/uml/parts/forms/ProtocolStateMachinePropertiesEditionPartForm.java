 ...
 * @generated
 */
public class ProtocolStateMachinePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ProtocolStateMachinePropertiesEditionPart {
	 ...
	 */
	public ProtocolStateMachinePropertiesEditionPartForm() { super(); }
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              ...
              UmlViewsRepository.ProtocolStateMachine.Properties.name,
    ...
    this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.clientDependency, UmlMessages.ProtocolStateMachinePropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
    ...
    isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.isLeaf, UmlMessages.ProtocolStateMachinePropertiesEditionPart_IsLeafLabel), SWT.CHECK);
    ...
    isAbstract = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.isAbstract, UmlMessages.ProtocolStateMachinePropertiesEditionPart_IsAbstractLabel), SWT.CHECK);
    ...
    this.powertypeExtent = new ReferencesTable(getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.powertypeExtent, UmlMessages.ProtocolStateMachinePropertiesEditionPart_PowertypeExtentLabel), new ReferencesTableListener	() {
    ...
    this.redefinedClassifier = new ReferencesTable(getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.redefinedClassifier, UmlMessages.ProtocolStateMachinePropertiesEditionPart_RedefinedClassifierLabel), new ReferencesTableListener	() {
    ...
    this.useCase = new ReferencesTable(getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.useCase, UmlMessages.ProtocolStateMachinePropertiesEditionPart_UseCaseLabel), new ReferencesTableListener	() {
    ...
    isActive = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.isActive, UmlMessages.ProtocolStateMachinePropertiesEditionPart_IsActiveLabel), SWT.CHECK);
    ...
    isReentrant = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.isReentrant, UmlMessages.ProtocolStateMachinePropertiesEditionPart_IsReentrantLabel), SWT.CHECK);
    ...
    this.redefinedBehavior = new ReferencesTable(getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.redefinedBehavior, UmlMessages.ProtocolStateMachinePropertiesEditionPart_RedefinedBehaviorLabel), new ReferencesTableListener	() {
    ...
    this.precondition = new ReferencesTable(getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.precondition, UmlMessages.ProtocolStateMachinePropertiesEditionPart_PreconditionLabel), new ReferencesTableListener	() {
    ...
    this.postcondition = new ReferencesTable(getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.postcondition, UmlMessages.ProtocolStateMachinePropertiesEditionPart_PostconditionLabel), new ReferencesTableListener	() {
    ...
    this.submachineState = new ReferencesTable(getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.submachineState, UmlMessages.ProtocolStateMachinePropertiesEditionPart_SubmachineStateLabel), new ReferencesTableListener	() {
    ...
    this.extendedStateMachine = new ReferencesTable(getDescription(UmlViewsRepository.ProtocolStateMachine.Properties.extendedStateMachine, UmlMessages.ProtocolStateMachinePropertiesEditionPart_ExtendedStateMachineLabel), new ReferencesTableListener	() {
