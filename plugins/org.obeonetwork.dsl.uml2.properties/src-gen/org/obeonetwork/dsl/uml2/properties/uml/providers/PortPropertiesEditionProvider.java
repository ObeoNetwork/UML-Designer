 ...
 * @generated
 */
public class PortPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Port) && (UMLPackage.Literals.PORT == editingContext.getEObject().eClass());
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Port) {
            if (PortPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == PortPropertiesEditionComponent.class)
                return new PortPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
