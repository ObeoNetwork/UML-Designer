...
public class ControlNodePropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof ControlNode) && (UMLPackage.Literals.CONTROL_NODE == editingContext.getEObject().eClass());
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof ControlNode) {
            if (ControlNodePropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == ControlNodePropertiesEditionComponent.class)
                return new ControlNodePropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
