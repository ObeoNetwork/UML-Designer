...
public class ControlNodePropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof ControlNode)
				&& (ControlNodePropertiesEditionComponent.GENERAL_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof ControlNode) {
			return new ControlNodePropertiesEditionComponent(editingContext, editingContext.getEObject(),
					mode);
		}
