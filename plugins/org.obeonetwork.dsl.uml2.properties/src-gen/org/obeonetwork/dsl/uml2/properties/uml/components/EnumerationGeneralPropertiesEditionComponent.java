...
public class EnumerationGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public EnumerationGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext,
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(
						EEFUtils.choiceOfValues(enumeration,
								UMLPackage.eINSTANCE.getNamedElement_Visibility()),
						enumeration.getVisibility());
			}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmlViewsRepository.General.name == event.getAffectedEditor()) {
			enumeration.setName((java.lang.String)EEFConverterUtil
