 ...
 * @generated
 */
public class EnumerationGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public EnumerationGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject enumeration, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(UmlViewsRepository.General.name))
				generalPart.setName(EEFConverterUtil.convertToString(TypesPackage.Literals.STRING, enumeration.getName()));
			
			if (isAccessible(UmlViewsRepository.General.visibility)) {
				generalPart.initVisibility(EEFUtils.choiceOfValues(enumeration, UMLPackage.eINSTANCE.getNamedElement_Visibility()), enumeration.getVisibility());
			}
			generalPart.setAbstract_(enumeration.isAbstract());
			
			generalPart.setLeaf(enumeration.isLeaf());
