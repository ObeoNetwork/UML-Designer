 ...
 * 
 */
public class CallOperationActionPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof CallOperationAction) 
					&& (UMLPackage.eINSTANCE.getCallOperationAction() == editingContext.getEObject().eClass());
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof CallOperationAction) && (CallOperationActionPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof CallOperationAction) && ((CallOperationActionPropertiesEditionComponent.BASE_PART.equals(part) && refinement == CallOperationActionPropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part) {
		if (editingContext.getEObject() instanceof CallOperationAction) {
			if (CallOperationActionPropertiesEditionComponent.BASE_PART.equals(part))
				return new CallOperationActionPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
		if (editingContext.getEObject() instanceof CallOperationAction) {
			if (CallOperationActionPropertiesEditionComponent.BASE_PART.equals(part)
				&& refinement == CallOperationActionPropertiesEditionComponent.class)
				return new CallOperationActionPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
