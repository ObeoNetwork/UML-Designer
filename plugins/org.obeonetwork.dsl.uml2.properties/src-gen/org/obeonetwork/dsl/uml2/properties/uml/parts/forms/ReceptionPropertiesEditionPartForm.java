...
public class ReceptionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ReceptionPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ReceptionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Reception.Properties.name, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ReceptionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Reception.Properties.visibility, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable(UmlMessages.ReceptionPropertiesEditionPart_ClientDependencyLabel, new ReferencesTableListener	() {
	...
	protected Composite createMethodReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.method = new ReferencesTable(UmlMessages.ReceptionPropertiesEditionPart_MethodLabel, new ReferencesTableListener	() {
	...
	protected Composite createConcurrencyEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ReceptionPropertiesEditionPart_ConcurrencyLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Reception.Properties.concurrency, UmlViewsRepository.FORM_KIND));
	...
	protected Composite createRaisedExceptionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.raisedException = new ReferencesTable(UmlMessages.ReceptionPropertiesEditionPart_RaisedExceptionLabel, new ReferencesTableListener	() {
	...
	protected Composite createSignalFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmlMessages.ReceptionPropertiesEditionPart_SignalLabel, propertiesEditionComponent.isRequired(UmlViewsRepository.Reception.Properties.signal, UmlViewsRepository.FORM_KIND));
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.ReceptionPropertiesEditionPart#initVisibility(EEnum eenum, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.uml2.properties.uml.parts.ReceptionPropertiesEditionPart#initConcurrency(EEnum eenum, Enumerator current)
	 */
