 ...
 * @generated
 */
public class ExecutionEventPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ExecutionEventPropertiesEditionPart {
	 ...
	 */
	public ExecutionEventPropertiesEditionPartForm() { super(); }
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              ExecutionEventPropertiesEditionPartForm.this,
              UmlViewsRepository.ExecutionEvent.Properties.name,
    ...
    this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.ExecutionEvent.Properties.clientDependency, UmlMessages.ExecutionEventPropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
