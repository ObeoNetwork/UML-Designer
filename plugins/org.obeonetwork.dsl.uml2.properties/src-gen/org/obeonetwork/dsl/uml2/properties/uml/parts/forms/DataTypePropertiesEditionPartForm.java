 ...
 * @generated
 */
public class DataTypePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, DataTypePropertiesEditionPart {
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              ...
              UmlViewsRepository.DataType.Properties.name,
    ...
    this.clientDependency = new ReferencesTable(getDescription(UmlViewsRepository.DataType.Properties.clientDependency, UmlMessages.DataTypePropertiesEditionPart_ClientDependencyLabel), new ReferencesTableListener	() {
    ...
    isLeaf = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.DataType.Properties.isLeaf, UmlMessages.DataTypePropertiesEditionPart_IsLeafLabel), SWT.CHECK);
    ...
    isAbstract = widgetFactory.createButton(parent, getDescription(UmlViewsRepository.DataType.Properties.isAbstract, UmlMessages.DataTypePropertiesEditionPart_IsAbstractLabel), SWT.CHECK);
    ...
    this.powertypeExtent = new ReferencesTable(getDescription(UmlViewsRepository.DataType.Properties.powertypeExtent, UmlMessages.DataTypePropertiesEditionPart_PowertypeExtentLabel), new ReferencesTableListener	() {
    ...
    this.redefinedClassifier = new ReferencesTable(getDescription(UmlViewsRepository.DataType.Properties.redefinedClassifier, UmlMessages.DataTypePropertiesEditionPart_RedefinedClassifierLabel), new ReferencesTableListener	() {
    ...
    this.useCase = new ReferencesTable(getDescription(UmlViewsRepository.DataType.Properties.useCase, UmlMessages.DataTypePropertiesEditionPart_UseCaseLabel), new ReferencesTableListener	() {
