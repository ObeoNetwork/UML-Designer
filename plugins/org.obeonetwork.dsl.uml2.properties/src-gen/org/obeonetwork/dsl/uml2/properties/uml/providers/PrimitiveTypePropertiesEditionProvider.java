...
public class PrimitiveTypePropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof PrimitiveType) && (UMLPackage.Literals.PRIMITIVE_TYPE == editingContext.getEObject().eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part) {
        return (editingContext.getEObject() instanceof PrimitiveType)
                && (PrimitiveTypeGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) || PrimitiveTypeAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part) || PrimitiveTypeOperationsPropertiesEditionComponent.OPERATIONS_PART
                        .equals(part));
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof PrimitiveType)
                && (refinement == PrimitiveTypeGeneralPropertiesEditionComponent.class || refinement == PrimitiveTypeAttributesPropertiesEditionComponent.class || refinement == PrimitiveTypeOperationsPropertiesEditionComponent.class);
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
        return (editingContext.getEObject() instanceof PrimitiveType)
                && ((PrimitiveTypeGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == PrimitiveTypeGeneralPropertiesEditionComponent.class)
                        || (PrimitiveTypeAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part) && refinement == PrimitiveTypeAttributesPropertiesEditionComponent.class) || (PrimitiveTypeOperationsPropertiesEditionComponent.OPERATIONS_PART
                        .equals(part) && refinement == PrimitiveTypeOperationsPropertiesEditionComponent.class));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof PrimitiveType) {
            if (PrimitiveTypeGeneralPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == PrimitiveTypeGeneralPropertiesEditionComponent.class)
                return new PrimitiveTypeGeneralPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (PrimitiveTypeAttributesPropertiesEditionComponent.ATTRIBUTES_PART.equals(part) && refinement == PrimitiveTypeAttributesPropertiesEditionComponent.class)
                return new PrimitiveTypeAttributesPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
            if (PrimitiveTypeOperationsPropertiesEditionComponent.OPERATIONS_PART.equals(part) && refinement == PrimitiveTypeOperationsPropertiesEditionComponent.class)
                return new PrimitiveTypeOperationsPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
