...
public class DeploymentPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
    ...
    if (editingPart != null && key == partKey) {
      ...
      // init values
      if (isAccessible(UmlViewsRepository.Deployment.Properties.name))
        basePart.setName(EEFConverterUtil.convertToString(UMLPackage.Literals.STRING, deployment.getName()));
      
      if (isAccessible(UmlViewsRepository.Deployment.Properties.visibility)) {
        basePart.initVisibility(EEFUtils.choiceOfValues(deployment, UMLPackage.eINSTANCE.getNamedElement_Visibility()), deployment.getVisibility());
      }
      ...
      if (isAccessible(UmlViewsRepository.Deployment.Properties.deployedArtifact)) {
        ...
        basePart.addFilterToDeployedArtifact(new EObjectFilter(UMLPackage.Literals.DEPLOYED_ARTIFACT));
      }
      if (isAccessible(UmlViewsRepository.Deployment.Properties.location)) {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == UmlViewsRepository.Deployment.Properties.name) {
			return UMLPackage.eINSTANCE.getNamedElement_Name();
		}
		if (editorKey == UmlViewsRepository.Deployment.Properties.visibility) {
			return UMLPackage.eINSTANCE.getNamedElement_Visibility();
		}
		if (editorKey == UmlViewsRepository.Deployment.Properties.clientDependency) {
			return UMLPackage.eINSTANCE.getNamedElement_ClientDependency();
		}
		if (editorKey == UmlViewsRepository.Deployment.Properties.owningTemplateParameter) {
			return UMLPackage.eINSTANCE.getParameterableElement_OwningTemplateParameter();
		}
		if (editorKey == UmlViewsRepository.Deployment.Properties.templateParameter) {
			return UMLPackage.eINSTANCE.getParameterableElement_TemplateParameter();
		}
		if (editorKey == UmlViewsRepository.Deployment.Properties.supplier) {
			return UMLPackage.eINSTANCE.getDependency_Supplier();
		}
		if (editorKey == UmlViewsRepository.Deployment.Properties.client) {
			return UMLPackage.eINSTANCE.getDependency_Client();
		}
		if (editorKey == UmlViewsRepository.Deployment.Properties.deployedArtifact) {
			return UMLPackage.eINSTANCE.getDeployment_DeployedArtifact();
		}
		if (editorKey == UmlViewsRepository.Deployment.Properties.location) {
    ...
    if (UmlViewsRepository.Deployment.Properties.name == event.getAffectedEditor()) {
      deployment.setName((java.lang.String)EEFConverterUtil.createFromString(UMLPackage.Literals.STRING, (String)event.getNewValue()));
    }
    ...
    if (UmlViewsRepository.Deployment.Properties.deployedArtifact == event.getAffectedEditor()) {
      if (event.getKind() == PropertiesEditionEvent.ADD) {
        ...
        deployedArtifactSettings.move(event.getNewIndex(), (DeployedArtifact) event.getNewValue());
      }
    }
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(UmlViewsRepository.Deployment.Properties.name)) {
			...
			if (UMLPackage.eINSTANCE.getNamedElement_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(UmlViewsRepository.Deployment.Properties.visibility))
