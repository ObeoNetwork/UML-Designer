...
public class DependencyPropertiesEditionProvider extends UmlPropertiesEditionProvider {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof Dependency) && (UMLPackage.Literals.DEPENDENCY == editingContext.getEObject().eClass());
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
        if (editingContext.getEObject() instanceof Dependency) {
            if (DependencyPropertiesEditionComponent.GENERAL_PART.equals(part) && refinement == DependencyPropertiesEditionComponent.class)
                return new DependencyPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
        }
