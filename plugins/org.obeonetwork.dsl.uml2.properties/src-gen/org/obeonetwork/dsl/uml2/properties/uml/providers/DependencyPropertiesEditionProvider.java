 ...
 * @generated
 */
public class DependencyPropertiesEditionProvider extends UmlPropertiesEditionProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof Dependency)
				&& (DependencyPropertiesEditionComponent.GENERAL_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
		...
		if (editingContext.getEObject() instanceof Dependency) {
			return new DependencyPropertiesEditionComponent(editingContext, editingContext.getEObject(),
					mode);
		}
