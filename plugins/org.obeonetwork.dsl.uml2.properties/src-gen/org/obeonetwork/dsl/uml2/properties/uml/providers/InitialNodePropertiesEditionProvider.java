...
import org.obeonetwork.dsl.uml2.properties.uml.components.InitialNodePropertiesEditionComponent;
...
public class InitialNodePropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof InitialNode) 
					&& (UMLPackage.eINSTANCE.getInitialNode() == editingContext.getEObject().eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
		if (editingContext.getEObject() instanceof InitialNode) {
			if (InitialNodePropertiesEditionComponent.BASE_PART.equals(part)
				&& refinement == InitialNodePropertiesEditionComponent.class)
				return new InitialNodePropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
