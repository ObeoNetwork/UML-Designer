 ...
 *******************************************************************************/
package org.obeonetwork.dsl.uml2.design.properties.services;
...
import org.obeonetwork.dsl.uml2.design.properties.PropertiesLabelSwitch;
import org.obeonetwork.dsl.uml2.design.properties.PropertyGeneralSwitch;
import org.obeonetwork.dsl.uml2.design.properties.RelationshipLabelSwitch;
...
public class PropertiesViewServices {
	...
	/**
	 * Get relationship for which ActivityNode is the origin.
	 *
	 * @param element
	 *            the classifier
	 * @param origin
	 ...
	 */
	public List<ActivityEdge> getRelationShipOrigin(ActivityNode element, boolean origin) {
		if (origin) {
	...
	public boolean isDisplayedOperationsList(Element toTest) {
		if (toTest instanceof Component || toTest instanceof StateMachine) {
			return false;
		}
		return toTest instanceof Interface || toTest instanceof Class || toTest instanceof DataType
				|| toTest instanceof Artifact;
	}
	...
	public boolean isDisplayedRelationshipsGroup(Element toTest) {
		if (toTest != null) {
			return toTest instanceof org.eclipse.uml2.uml.Package || toTest instanceof Class
					...
					|| toTest instanceof CallOperationAction || toTest instanceof Collaboration
					|| toTest instanceof DataStoreNode || toTest instanceof ControlNode
					|| toTest instanceof FinalState || toTest instanceof Pin || toTest instanceof OpaqueAction
