...
public class ProfileVersionDialog extends TitleAreaDialog {
	 ...
	 */
	private final String PROFILE_VERSIONING = "Profile Versioning"; //$NON-NLS-1$
	...
	private Composite createInfoArea(final Composite composite) {
		...
		dateLabel.setText("Date"); //$NON-NLS-1$
	...
	private Composite createVersionArea(Composite composite) {
		...
		versionGroup.setText("Version"); //$NON-NLS-1$
		final GridLayout layout = new GridLayout(2, false);
		...
		revisionVersionButton.setText("Revision Version"); //$NON-NLS-1$
		gd = new GridData(SWT.FILL, SWT.CENTER, true, false);
