...
import org.obeonetwork.dsl.uml2.core.internal.services.ChangePropertyOwnerSwitch;
import org.obeonetwork.dsl.uml2.core.internal.services.LabelServices;
import org.obeonetwork.dsl.uml2.core.internal.services.PropertiesLabelSwitch;
import org.obeonetwork.dsl.uml2.core.internal.services.PropertyGeneralSwitch;
import org.obeonetwork.dsl.uml2.core.internal.services.RelationshipLabelSwitch;
...
public class PropertiesViewServices {
    ...
    private void computeProfileChildren(TreeItemWrapper parent, Profile profile, Element elem) {
        ...
        for (final EObject obj : stereotypes) {
            if (obj instanceof Stereotype && !elem.getAppliedStereotypes().contains(obj) && ((Stereotype) obj).containingProfile().equals(profile)) {
    ...
    public List<Object> getOperations(Element element) {
        ...
        for (final EStructuralFeature feature : features) {
            if (UMLPackage.eINSTANCE.getInterface_OwnedOperation().equals(feature) || UMLPackage.eINSTANCE.getDataType_OwnedOperation().equals(feature)
                    || UMLPackage.eINSTANCE.getClass_OwnedOperation().equals(feature) || UMLPackage.eINSTANCE.getArtifact_OwnedOperation().equals(feature)) {
    ...
    /**
     * Is displayed feature in advanced group. to avoid duplicated information
    ...
    public boolean isDisplayedAdvancedFeature(EStructuralFeature feature) {
        if (UMLPackage.Literals.ASSOCIATION__MEMBER_END.equals(feature) || UMLPackage.Literals.ASSOCIATION__NAVIGABLE_OWNED_END.equals(feature)) {
            return false;
        }
        return true;
    }
    ...
    public boolean isDisplayedAttributesList(StructuredClassifier toTest) {
        return isDisplayedAttributesList(UMLPackage.eINSTANCE.getStructuredClassifier_OwnedAttribute(), toTest);
    }
    ...
    public boolean isDisplayedOperationsList(Element toTest) {
        if (toTest instanceof Class) {
            final PropertyGeneralSwitch generalSwitch = new PropertyGeneralSwitch(UMLPackage.eINSTANCE.getClass_OwnedOperation());
            return generalSwitch.doSwitch(toTest).booleanValue();
        }
        if (toTest instanceof Interface) {
            final PropertyGeneralSwitch generalSwitch = new PropertyGeneralSwitch(UMLPackage.eINSTANCE.getInterface_OwnedOperation());
            return generalSwitch.doSwitch(toTest).booleanValue();
        }
        if (toTest instanceof DataType) {
            final PropertyGeneralSwitch generalSwitch = new PropertyGeneralSwitch(UMLPackage.eINSTANCE.getDataType_OwnedOperation());
            return generalSwitch.doSwitch(toTest).booleanValue();
        }
        if (toTest instanceof Artifact) {
            final PropertyGeneralSwitch generalSwitch = new PropertyGeneralSwitch(UMLPackage.eINSTANCE.getArtifact_OwnedOperation());
            return generalSwitch.doSwitch(toTest).booleanValue();
        }
        return false;
    }
    ...
    public boolean isDisplayedOperationsList(EStructuralFeature feature) {
        final boolean result = UMLPackage.eINSTANCE.getInterface_OwnedOperation().equals(feature) || UMLPackage.eINSTANCE.getClass_OwnedOperation().equals(feature)
                || UMLPackage.eINSTANCE.getDataType_OwnedOperation().equals(feature) || UMLPackage.eINSTANCE.getArtifact_OwnedOperation().equals(feature);
        return result;
    }
    ...
    public boolean isDisplayedRelationshipsGroup(Element toTest) {
        if (toTest != null) {
            return toTest instanceof org.eclipse.uml2.uml.Package || toTest instanceof Class || toTest instanceof Interface || toTest instanceof DataType || toTest instanceof PrimitiveType
                    || toTest instanceof Enumeration || toTest instanceof Parameter || toTest instanceof Property || toTest instanceof Component || toTest instanceof Port || toTest instanceof Actor
                    || toTest instanceof Artifact || toTest instanceof Collaboration || toTest instanceof FinalState || toTest instanceof Vertex || toTest instanceof Region
    ...
    public boolean isEnabled(EObject eObject, EStructuralFeature feature) {
        if (eObject instanceof Property) {
            ...
            if (property.getUpper() == 0 || property.getUpper() == 1) {
                if (UMLPackage.Literals.MULTIPLICITY_ELEMENT__IS_UNIQUE.equals(feature) || UMLPackage.Literals.MULTIPLICITY_ELEMENT__IS_ORDERED.equals(feature)) {
                    return false;
                }
            }
        }
    ...
    public void selectProfile(Package elem) {
        ...
        final EObjectPaneBasedSelectionWizard stereotypeSelectionWizard = new EObjectPaneBasedSelectionWizard(windowTitle, wizardPageTitle, wizardPageTitleImage, choiceOfValuesMessage,
        ...
        final WizardDialog dialog = new WizardDialog(Display.getCurrent().getActiveShell(), stereotypeSelectionWizard);
