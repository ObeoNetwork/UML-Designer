 ...
 *******************************************************************************/
package org.obeonetwork.dsl.uml2.core.preferences;
...
public class UmlDesignerPreferenceInitializer extends AbstractPreferenceInitializer {
    ...
    public void initializeDefaultPreferences() {
        UMLDesignerCorePlugin.getDefault().getPreferenceStore().setDefault(UmlDesignerPreferences.DELETION_CONFIRMATION_ENABLED_ID, true);
    }
}
