 ...
 */
public class UmlDesignerCoreSessionManagerListener implements SessionManagerListener {
    ...
    public void notify(Session updated, int notification) {
        ...
        if (notification == SessionListener.OPENED) {
            ...
            for (final Resource semResources : updated.getSemanticResources()) {
                final Iterator<ProfileApplication> it = Iterators.filter(EcoreUtil.getAllProperContents(semResources, true), ProfileApplication.class);
                while (it.hasNext()) {
    ...
    public void notifyAddSession(Session newSession) {
        ...
        newSession.getTransactionalEditingDomain().getCommandStack().addCommandStackListener(createNewChildListener);
