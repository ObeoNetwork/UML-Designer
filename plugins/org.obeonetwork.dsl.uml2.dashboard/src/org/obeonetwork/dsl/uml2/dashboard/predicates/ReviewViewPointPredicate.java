 ...
 */
public class ReviewViewPointPredicate implements IPredicate {

	/**
	 * Constructor.
	 */
	public ReviewViewPointPredicate() {
		super();
	}
	...
	public boolean isOk() {
		...
		if (ActivityExplorerManager.INSTANCE.getSession() != null) {
			return DashboardServices.INSTANCE.isEnabledVP(session, DashboardServices.INSTANCE.VP_REVIEW);
		}
		return false;
	}
}
