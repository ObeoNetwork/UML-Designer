...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.Actor;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for Actor
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ActorTestCase extends SWTBotEEFTestCase {
	...
	public void testEditActorName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Actor element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), actorMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(actorMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, actorMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Actor element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Actor.Properties.name, UPDATED_VALUE);
	...
	public void testEditActorVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Actor element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Actor.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditActorClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Actor.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveActorClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Actor element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Actor.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditActorIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Actor element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Actor.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditActorOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Actor.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveActorOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Actor element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Actor.Properties.owningTemplateParameter);
	...
	public void testEditActorTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Actor.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveActorTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Actor element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Actor.Properties.templateParameter);
	...
	public void testEditActorIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the Actor element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Actor.Properties.isAbstract, UPDATED_VALUE);
	...
	public void testEditActorPowertypeExtent() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Actor.Properties.powertypeExtent, referenceValueForPowertypeExtent);
	...
	public void testRemoveActorPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the Actor element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Actor.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditActorRepresentation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Actor.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1);
	...
	public void testRemoveActorRepresentation() throws Exception {
		...
		// Change value of the representation feature of the Actor element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Actor.Properties.representation);
	...
	public void testEditActorUseCase() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Actor.Properties.useCase, referenceValueForUseCase);
	...
	public void testRemoveActorUseCase() throws Exception {
		...
		// Change value of the useCase feature of the Actor element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Actor.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
