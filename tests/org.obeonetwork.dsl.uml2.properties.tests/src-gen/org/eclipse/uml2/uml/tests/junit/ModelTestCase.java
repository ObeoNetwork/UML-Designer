...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.Model;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for Model
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ModelTestCase extends SWTBotEEFTestCase {
	...
	public void testEditModelName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Model element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), modelMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(modelMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, modelMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Model element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Model.Properties.name, UPDATED_VALUE);
	...
	public void testEditModelVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Model element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Model.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditModelClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Model.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveModelClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Model element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Model.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditModelOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Model.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveModelOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Model element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Model.Properties.owningTemplateParameter);
	...
	public void testEditModelTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Model.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveModelTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Model element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Model.Properties.templateParameter);
	...
	public void testEditModelViewpoint() throws Exception {
		...
		// Change value of the viewpoint feature of the Model element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Model.Properties.viewpoint, UPDATED_VALUE);
