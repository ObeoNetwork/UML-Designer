 ...
 */
public class SubstitutionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditSubstitutionName() throws Exception {
		...
		// Open the EEF properties view to edit the Substitution element
		...
		// Change value of the name feature of the Substitution element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Substitution.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSubstitutionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Substitution element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Substitution.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSubstitutionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Substitution.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSubstitutionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Substitution element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Substitution.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSubstitutionOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Substitution.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSubstitutionOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Substitution element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Substitution.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSubstitutionTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Substitution.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSubstitutionTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Substitution element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Substitution.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
