 ...
 */
public class ClearVariableActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditClearVariableActionName() throws Exception {
		...
		// Open the EEF properties view to edit the ClearVariableAction element
		...
		// Change value of the name feature of the ClearVariableAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearVariableActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ClearVariableAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearVariableActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveClearVariableActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ClearVariableAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearVariableActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ClearVariableAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearVariableActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveClearVariableActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ClearVariableAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearVariableActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveClearVariableActionActivity() throws Exception {
		...
		// Change value of the activity feature of the ClearVariableAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearVariableActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveClearVariableActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ClearVariableAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearVariableActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveClearVariableActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ClearVariableAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearVariableActionVariable() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ClearVariableAction.Properties.variable, allInstancesOf.indexOf(referenceValueForVariable), bot.selectNode(modelEditor, firstInstanceOf));
