 ...
 */
public class CreateLinkObjectActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditCreateLinkObjectActionName() throws Exception {
		...
		// Open the EEF properties view to edit the CreateLinkObjectAction element
		...
		// Change value of the name feature of the CreateLinkObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCreateLinkObjectActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the CreateLinkObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCreateLinkObjectActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCreateLinkObjectActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the CreateLinkObjectAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCreateLinkObjectActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the CreateLinkObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCreateLinkObjectActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCreateLinkObjectActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the CreateLinkObjectAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCreateLinkObjectActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCreateLinkObjectActionActivity() throws Exception {
		...
		// Change value of the activity feature of the CreateLinkObjectAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCreateLinkObjectActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCreateLinkObjectActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the CreateLinkObjectAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCreateLinkObjectActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCreateLinkObjectActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the CreateLinkObjectAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CreateLinkObjectAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
