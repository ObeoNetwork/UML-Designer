...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ExecutionEvent;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ExecutionEvent
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ExecutionEventPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditExecutionEventName() throws Exception {
		...
		// Open the EEF properties view to edit the ExecutionEvent element
		...
		// Change value of the name feature of the ExecutionEvent element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExecutionEvent.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExecutionEventVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ExecutionEvent element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExecutionEvent.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExecutionEventClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExecutionEvent.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExecutionEventClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ExecutionEvent element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExecutionEvent.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExecutionEventOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExecutionEvent.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExecutionEventOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the ExecutionEvent element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExecutionEvent.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExecutionEventTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExecutionEvent.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExecutionEventTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the ExecutionEvent element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExecutionEvent.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
