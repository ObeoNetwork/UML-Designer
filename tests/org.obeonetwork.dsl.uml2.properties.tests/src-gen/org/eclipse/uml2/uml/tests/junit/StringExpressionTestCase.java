 ...
 */
public class StringExpressionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditStringExpressionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the StringExpression element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), stringExpressionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(stringExpressionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, stringExpressionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the StringExpression element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StringExpression.Properties.name, UPDATED_VALUE);
	...
	public void testEditStringExpressionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the StringExpression element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StringExpression.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditStringExpressionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StringExpression.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveStringExpressionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the StringExpression element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StringExpression.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStringExpressionOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StringExpression.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveStringExpressionOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the StringExpression element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StringExpression.Properties.owningTemplateParameter);
	...
	public void testEditStringExpressionTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StringExpression.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveStringExpressionTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the StringExpression element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StringExpression.Properties.templateParameter);
	...
	public void testEditStringExpressionSymbol() throws Exception {
		...
		// Change value of the symbol feature of the StringExpression element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StringExpression.Properties.symbol, UPDATED_VALUE);
	...
	public void testEditStringExpressionOwningExpression() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StringExpression.Properties.owningExpression, allInstancesOf.indexOf(referenceValueForOwningExpression)+1);
	...
	public void testRemoveStringExpressionOwningExpression() throws Exception {
		...
		// Change value of the owningExpression feature of the StringExpression element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StringExpression.Properties.owningExpression);
