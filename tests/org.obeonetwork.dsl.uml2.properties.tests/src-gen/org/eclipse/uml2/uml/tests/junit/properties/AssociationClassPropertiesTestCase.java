 ...
 */
public class AssociationClassPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditAssociationClassName() throws Exception {
		...
		// Open the EEF properties view to edit the AssociationClass element
		...
		// Change value of the name feature of the AssociationClass element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.AssociationClass.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassVisibility() throws Exception {
		...
		// Change value of the visibility feature of the AssociationClass element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.AssociationClass.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveAssociationClassClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the AssociationClass element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the AssociationClass element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.AssociationClass.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveAssociationClassOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the AssociationClass element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveAssociationClassTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the AssociationClass element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the AssociationClass element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.AssociationClass.Properties.isAbstract, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassPowertypeExtent() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.powertypeExtent, referenceValueForPowertypeExtent, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveAssociationClassPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the AssociationClass element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassRepresentation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveAssociationClassRepresentation() throws Exception {
		...
		// Change value of the representation feature of the AssociationClass element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.representation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassUseCase() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.useCase, referenceValueForUseCase, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveAssociationClassUseCase() throws Exception {
		...
		// Change value of the useCase feature of the AssociationClass element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassIsActive() throws Exception {
		...
		// Change value of the isActive feature of the AssociationClass element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.AssociationClass.Properties.isActive, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassMemberEnd() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.memberEnd, referenceValueForMemberEnd, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveAssociationClassMemberEnd() throws Exception {
		...
		// Change value of the memberEnd feature of the AssociationClass element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.memberEnd, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassIsDerived() throws Exception {
		...
		// Change value of the isDerived feature of the AssociationClass element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.AssociationClass.Properties.isDerived, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAssociationClassNavigableOwnedEnd() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.navigableOwnedEnd, referenceValueForNavigableOwnedEnd, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveAssociationClassNavigableOwnedEnd() throws Exception {
		...
		// Change value of the navigableOwnedEnd feature of the AssociationClass element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.AssociationClass.Properties.navigableOwnedEnd, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
