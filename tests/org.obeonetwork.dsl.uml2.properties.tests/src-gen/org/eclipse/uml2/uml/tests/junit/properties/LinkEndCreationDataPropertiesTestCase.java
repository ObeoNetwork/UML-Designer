...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.LinkEndCreationData;
/**
 * TestCase for LinkEndCreationData
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class LinkEndCreationDataPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditLinkEndCreationDataValue() throws Exception {
		...
		// Open the EEF properties view to edit the LinkEndCreationData element
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LinkEndCreationData.Properties.value, allInstancesOf.indexOf(referenceValueForValue)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLinkEndCreationDataValue() throws Exception {
		...
		// Change value of the value feature of the LinkEndCreationData element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LinkEndCreationData.Properties.value, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLinkEndCreationDataEnd() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LinkEndCreationData.Properties.end, allInstancesOf.indexOf(referenceValueForEnd), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLinkEndCreationDataIsReplaceAll() throws Exception {
		...
		// Change value of the isReplaceAll feature of the LinkEndCreationData element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LinkEndCreationData.Properties.isReplaceAll, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLinkEndCreationDataInsertAt() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LinkEndCreationData.Properties.insertAt, allInstancesOf.indexOf(referenceValueForInsertAt)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLinkEndCreationDataInsertAt() throws Exception {
		...
		// Change value of the insertAt feature of the LinkEndCreationData element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LinkEndCreationData.Properties.insertAt, bot.selectNode(modelEditor, firstInstanceOf));
