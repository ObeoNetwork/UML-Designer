 ...
 */
public class DestroyLinkActionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditDestroyLinkActionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the DestroyLinkAction element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), destroyLinkActionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(destroyLinkActionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, destroyLinkActionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the DestroyLinkAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.name, UPDATED_VALUE);
	...
	public void testEditDestroyLinkActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the DestroyLinkAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditDestroyLinkActionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveDestroyLinkActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the DestroyLinkAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditDestroyLinkActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the DestroyLinkAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditDestroyLinkActionInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveDestroyLinkActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the DestroyLinkAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.inStructuredNode);
	...
	public void testEditDestroyLinkActionActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveDestroyLinkActionActivity() throws Exception {
		...
		// Change value of the activity feature of the DestroyLinkAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.activity);
	...
	public void testEditDestroyLinkActionInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveDestroyLinkActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the DestroyLinkAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditDestroyLinkActionInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveDestroyLinkActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the DestroyLinkAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DestroyLinkAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
