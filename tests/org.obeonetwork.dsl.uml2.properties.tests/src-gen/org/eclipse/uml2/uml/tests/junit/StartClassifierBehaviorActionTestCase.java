...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.StartClassifierBehaviorAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for StartClassifierBehaviorAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class StartClassifierBehaviorActionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditStartClassifierBehaviorActionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the StartClassifierBehaviorAction element
		...
		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, startClassifierBehaviorActionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the StartClassifierBehaviorAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.name, UPDATED_VALUE);
	...
	public void testEditStartClassifierBehaviorActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the StartClassifierBehaviorAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditStartClassifierBehaviorActionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveStartClassifierBehaviorActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the StartClassifierBehaviorAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStartClassifierBehaviorActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the StartClassifierBehaviorAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditStartClassifierBehaviorActionInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveStartClassifierBehaviorActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the StartClassifierBehaviorAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.inStructuredNode);
	...
	public void testEditStartClassifierBehaviorActionActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveStartClassifierBehaviorActionActivity() throws Exception {
		...
		// Change value of the activity feature of the StartClassifierBehaviorAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.activity);
	...
	public void testEditStartClassifierBehaviorActionInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveStartClassifierBehaviorActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the StartClassifierBehaviorAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStartClassifierBehaviorActionInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveStartClassifierBehaviorActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the StartClassifierBehaviorAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StartClassifierBehaviorAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
