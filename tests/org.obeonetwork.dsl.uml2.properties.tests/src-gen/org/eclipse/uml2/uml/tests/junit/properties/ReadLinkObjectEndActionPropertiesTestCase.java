...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ReadLinkObjectEndAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ReadLinkObjectEndAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ReadLinkObjectEndActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditReadLinkObjectEndActionName() throws Exception {
		...
		// Open the EEF properties view to edit the ReadLinkObjectEndAction element
		...
		// Change value of the name feature of the ReadLinkObjectEndAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadLinkObjectEndActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ReadLinkObjectEndAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadLinkObjectEndActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReadLinkObjectEndActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ReadLinkObjectEndAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadLinkObjectEndActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ReadLinkObjectEndAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadLinkObjectEndActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReadLinkObjectEndActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ReadLinkObjectEndAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadLinkObjectEndActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReadLinkObjectEndActionActivity() throws Exception {
		...
		// Change value of the activity feature of the ReadLinkObjectEndAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadLinkObjectEndActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReadLinkObjectEndActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ReadLinkObjectEndAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadLinkObjectEndActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReadLinkObjectEndActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ReadLinkObjectEndAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadLinkObjectEndActionEnd() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReadLinkObjectEndAction.Properties.end, allInstancesOf.indexOf(referenceValueForEnd), bot.selectNode(modelEditor, firstInstanceOf));
