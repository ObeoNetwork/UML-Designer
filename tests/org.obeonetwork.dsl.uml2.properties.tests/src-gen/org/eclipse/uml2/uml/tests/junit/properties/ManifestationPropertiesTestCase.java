 ...
 */
public class ManifestationPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditManifestationName() throws Exception {
		...
		// Open the EEF properties view to edit the Manifestation element
		...
		// Change value of the name feature of the Manifestation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Manifestation.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditManifestationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Manifestation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Manifestation.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditManifestationClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Manifestation.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveManifestationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Manifestation element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Manifestation.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditManifestationOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Manifestation.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveManifestationOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Manifestation element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Manifestation.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditManifestationTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Manifestation.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveManifestationTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Manifestation element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Manifestation.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
