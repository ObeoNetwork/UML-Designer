...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.Activity;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for Activity
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ActivityTestCase extends SWTBotEEFTestCase {
	...
	public void testEditActivityName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Activity element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), activityMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(activityMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, activityMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Activity element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Activity.Properties.name, UPDATED_VALUE);
	...
	public void testEditActivityVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Activity element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Activity.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditActivityClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Activity.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveActivityClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Activity element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Activity.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditActivityIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Activity element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Activity.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditActivityOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Activity.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveActivityOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Activity element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Activity.Properties.owningTemplateParameter);
	...
	public void testEditActivityTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Activity.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveActivityTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Activity element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Activity.Properties.templateParameter);
	...
	public void testEditActivityIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the Activity element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Activity.Properties.isAbstract, UPDATED_VALUE);
	...
	public void testEditActivityPowertypeExtent() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Activity.Properties.powertypeExtent, referenceValueForPowertypeExtent);
	...
	public void testRemoveActivityPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the Activity element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Activity.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditActivityRepresentation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Activity.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1);
	...
	public void testRemoveActivityRepresentation() throws Exception {
		...
		// Change value of the representation feature of the Activity element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Activity.Properties.representation);
	...
	public void testEditActivityUseCase() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Activity.Properties.useCase, referenceValueForUseCase);
	...
	public void testRemoveActivityUseCase() throws Exception {
		...
		// Change value of the useCase feature of the Activity element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Activity.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditActivityIsActive() throws Exception {
		...
		// Change value of the isActive feature of the Activity element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Activity.Properties.isActive, UPDATED_VALUE);
	...
	public void testEditActivityIsReentrant() throws Exception {
		...
		// Change value of the isReentrant feature of the Activity element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Activity.Properties.isReentrant, UPDATED_VALUE);
	...
	public void testEditActivityPrecondition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Activity.Properties.precondition, referenceValueForPrecondition);
	...
	public void testRemoveActivityPrecondition() throws Exception {
		...
		// Change value of the precondition feature of the Activity element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Activity.Properties.precondition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditActivityPostcondition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Activity.Properties.postcondition, referenceValueForPostcondition);
	...
	public void testRemoveActivityPostcondition() throws Exception {
		...
		// Change value of the postcondition feature of the Activity element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Activity.Properties.postcondition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditActivityIsReadOnly() throws Exception {
		...
		// Change value of the isReadOnly feature of the Activity element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Activity.Properties.isReadOnly, UPDATED_VALUE);
	...
	public void testEditActivityPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Activity.Properties.partition, referenceValueForPartition);
	...
	public void testRemoveActivityPartition() throws Exception {
		...
		// Change value of the partition feature of the Activity element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Activity.Properties.partition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditActivityIsSingleExecution() throws Exception {
		...
		// Change value of the isSingleExecution feature of the Activity element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Activity.Properties.isSingleExecution, UPDATED_VALUE);
