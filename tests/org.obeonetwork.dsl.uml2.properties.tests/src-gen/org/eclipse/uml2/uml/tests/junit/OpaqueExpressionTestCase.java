...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.OpaqueExpression;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for OpaqueExpression
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class OpaqueExpressionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditOpaqueExpressionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the OpaqueExpression element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), opaqueExpressionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(opaqueExpressionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, opaqueExpressionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the OpaqueExpression element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.OpaqueExpression.Properties.name, UPDATED_VALUE);
	...
	public void testEditOpaqueExpressionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the OpaqueExpression element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.OpaqueExpression.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditOpaqueExpressionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OpaqueExpression.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveOpaqueExpressionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the OpaqueExpression element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OpaqueExpression.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditOpaqueExpressionOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OpaqueExpression.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveOpaqueExpressionOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the OpaqueExpression element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OpaqueExpression.Properties.owningTemplateParameter);
	...
	public void testEditOpaqueExpressionTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OpaqueExpression.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveOpaqueExpressionTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the OpaqueExpression element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OpaqueExpression.Properties.templateParameter);
	...
	public void testEditOpaqueExpressionBody() throws Exception {
		...
		// Change value of the body feature of the OpaqueExpression element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.OpaqueExpression.Properties.body, UPDATED_VALUE);
	...
	public void testEditOpaqueExpressionLanguage() throws Exception {
		...
		// Change value of the language feature of the OpaqueExpression element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.OpaqueExpression.Properties.language, UPDATED_VALUE);
