 ...
 */
public class ReadIsClassifiedObjectActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditReadIsClassifiedObjectActionName() throws Exception {
		...
		// Open the EEF properties view to edit the ReadIsClassifiedObjectAction element
		...
		// Change value of the name feature of the ReadIsClassifiedObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadIsClassifiedObjectActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ReadIsClassifiedObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadIsClassifiedObjectActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReadIsClassifiedObjectActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ReadIsClassifiedObjectAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadIsClassifiedObjectActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ReadIsClassifiedObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadIsClassifiedObjectActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReadIsClassifiedObjectActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ReadIsClassifiedObjectAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadIsClassifiedObjectActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReadIsClassifiedObjectActionActivity() throws Exception {
		...
		// Change value of the activity feature of the ReadIsClassifiedObjectAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadIsClassifiedObjectActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReadIsClassifiedObjectActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ReadIsClassifiedObjectAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadIsClassifiedObjectActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReadIsClassifiedObjectActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ReadIsClassifiedObjectAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReadIsClassifiedObjectActionIsDirect() throws Exception {
		...
		// Change value of the isDirect feature of the ReadIsClassifiedObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ReadIsClassifiedObjectAction.Properties.isDirect, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
