 ...
 */
public class ParameterTestCase extends SWTBotEEFTestCase {
	...
	public void testEditParameterName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Parameter element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), parameterMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(parameterMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, parameterMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Parameter element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Parameter.Properties.name, UPDATED_VALUE);
	...
	public void testEditParameterVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Parameter element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Parameter.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditParameterClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Parameter.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveParameterClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Parameter element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Parameter.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditParameterOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Parameter.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveParameterOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Parameter element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Parameter.Properties.owningTemplateParameter);
	...
	public void testEditParameterTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Parameter.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveParameterTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Parameter element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Parameter.Properties.templateParameter);
	...
	public void testEditParameterIsOrdered() throws Exception {
		...
		// Change value of the isOrdered feature of the Parameter element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Parameter.Properties.isOrdered, UPDATED_VALUE);
	...
	public void testEditParameterIsUnique() throws Exception {
		...
		// Change value of the isUnique feature of the Parameter element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Parameter.Properties.isUnique, UPDATED_VALUE);
	...
	public void testEditParameterParameterSet() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Parameter.Properties.parameterSet, referenceValueForParameterSet);
	...
	public void testRemoveParameterParameterSet() throws Exception {
		...
		// Change value of the parameterSet feature of the Parameter element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Parameter.Properties.parameterSet, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditParameterOperation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Parameter.Properties.operation, allInstancesOf.indexOf(referenceValueForOperation)+1);
	...
	public void testRemoveParameterOperation() throws Exception {
		...
		// Change value of the operation feature of the Parameter element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Parameter.Properties.operation);
	...
	public void testEditParameterDirection() throws Exception {
		...
		// Change value of the direction feature of the Parameter element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Parameter.Properties.direction, UPDATED_VALUE);
	...
	public void testEditParameterIsException() throws Exception {
		...
		// Change value of the isException feature of the Parameter element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Parameter.Properties.isException, UPDATED_VALUE);
	...
	public void testEditParameterIsStream() throws Exception {
		...
		// Change value of the isStream feature of the Parameter element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Parameter.Properties.isStream, UPDATED_VALUE);
	...
	public void testEditParameterEffect() throws Exception {
		...
		// Change value of the effect feature of the Parameter element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Parameter.Properties.effect, UPDATED_VALUE);
