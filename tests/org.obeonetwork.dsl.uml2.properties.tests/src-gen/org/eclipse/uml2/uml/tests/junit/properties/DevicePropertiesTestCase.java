 ...
 */
public class DevicePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditDeviceName() throws Exception {
		...
		// Open the EEF properties view to edit the Device element
		...
		// Change value of the name feature of the Device element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Device.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDeviceVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Device element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Device.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDeviceClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Device.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDeviceClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Device element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Device.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDeviceIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Device element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Device.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDeviceOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Device.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDeviceOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Device element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Device.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDeviceTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Device.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDeviceTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Device element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Device.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDeviceIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the Device element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Device.Properties.isAbstract, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDevicePowertypeExtent() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Device.Properties.powertypeExtent, referenceValueForPowertypeExtent, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDevicePowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the Device element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Device.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDeviceRepresentation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Device.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDeviceRepresentation() throws Exception {
		...
		// Change value of the representation feature of the Device element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Device.Properties.representation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDeviceUseCase() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Device.Properties.useCase, referenceValueForUseCase, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDeviceUseCase() throws Exception {
		...
		// Change value of the useCase feature of the Device element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Device.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDeviceIsActive() throws Exception {
		...
		// Change value of the isActive feature of the Device element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Device.Properties.isActive, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
