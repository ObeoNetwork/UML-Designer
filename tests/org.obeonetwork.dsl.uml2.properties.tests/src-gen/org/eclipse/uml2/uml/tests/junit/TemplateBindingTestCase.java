...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.TemplateBinding;
/**
 * TestCase for TemplateBinding
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class TemplateBindingTestCase extends SWTBotEEFTestCase {
	...
	public void testEditTemplateBindingSignature() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the TemplateBinding element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), templateBindingMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(templateBindingMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, templateBindingMetaClass, firstInstanceOf, null);

		// Change value of the signature feature of the TemplateBinding element 
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.TemplateBinding.Properties.signature, allInstancesOf.indexOf(referenceValueForSignature));
