 ...
 */
public class MessageOccurrenceSpecificationPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditMessageOccurrenceSpecificationName() throws Exception {
		...
		// Open the EEF properties view to edit the MessageOccurrenceSpecification element
		...
		// Change value of the name feature of the MessageOccurrenceSpecification element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditMessageOccurrenceSpecificationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the MessageOccurrenceSpecification element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditMessageOccurrenceSpecificationClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveMessageOccurrenceSpecificationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the MessageOccurrenceSpecification element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditMessageOccurrenceSpecificationCovered() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.covered, referenceValueForCovered, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveMessageOccurrenceSpecificationCovered() throws Exception {
		...
		// Change value of the covered feature of the MessageOccurrenceSpecification element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditMessageOccurrenceSpecificationEnclosingInteraction() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveMessageOccurrenceSpecificationEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the MessageOccurrenceSpecification element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.enclosingInteraction, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditMessageOccurrenceSpecificationEnclosingOperand() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveMessageOccurrenceSpecificationEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the MessageOccurrenceSpecification element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.enclosingOperand, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditMessageOccurrenceSpecificationToBefore() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.toBefore, referenceValueForToBefore, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveMessageOccurrenceSpecificationToBefore() throws Exception {
		...
		// Change value of the toBefore feature of the MessageOccurrenceSpecification element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.toBefore, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditMessageOccurrenceSpecificationToAfter() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.toAfter, referenceValueForToAfter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveMessageOccurrenceSpecificationToAfter() throws Exception {
		...
		// Change value of the toAfter feature of the MessageOccurrenceSpecification element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.toAfter, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditMessageOccurrenceSpecificationMessage() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.message, allInstancesOf.indexOf(referenceValueForMessage)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveMessageOccurrenceSpecificationMessage() throws Exception {
		...
		// Change value of the message feature of the MessageOccurrenceSpecification element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.MessageOccurrenceSpecification.Properties.message, bot.selectNode(modelEditor, firstInstanceOf));
