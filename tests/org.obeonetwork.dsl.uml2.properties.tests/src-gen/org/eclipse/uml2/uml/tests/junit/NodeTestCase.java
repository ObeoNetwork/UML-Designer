 ...
 */
public class NodeTestCase extends SWTBotEEFTestCase {
	...
	public void testEditNodeName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Node element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), nodeMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(nodeMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, nodeMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Node element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Node.Properties.name, UPDATED_VALUE);
	...
	public void testEditNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Node element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Node.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditNodeClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Node.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Node element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Node.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Node element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Node.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditNodeOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Node.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveNodeOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Node element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Node.Properties.owningTemplateParameter);
	...
	public void testEditNodeTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Node.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveNodeTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Node element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Node.Properties.templateParameter);
	...
	public void testEditNodeIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the Node element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Node.Properties.isAbstract, UPDATED_VALUE);
	...
	public void testEditNodePowertypeExtent() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Node.Properties.powertypeExtent, referenceValueForPowertypeExtent);
	...
	public void testRemoveNodePowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the Node element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Node.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditNodeRepresentation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Node.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1);
	...
	public void testRemoveNodeRepresentation() throws Exception {
		...
		// Change value of the representation feature of the Node element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Node.Properties.representation);
	...
	public void testEditNodeUseCase() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Node.Properties.useCase, referenceValueForUseCase);
	...
	public void testRemoveNodeUseCase() throws Exception {
		...
		// Change value of the useCase feature of the Node element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Node.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditNodeIsActive() throws Exception {
		...
		// Change value of the isActive feature of the Node element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Node.Properties.isActive, UPDATED_VALUE);
