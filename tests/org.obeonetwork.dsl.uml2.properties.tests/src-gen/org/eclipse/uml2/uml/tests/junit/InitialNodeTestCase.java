...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.InitialNode;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for InitialNode
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class InitialNodeTestCase extends SWTBotEEFTestCase {
	...
	public void testEditInitialNodeName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the InitialNode element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), initialNodeMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(initialNodeMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, initialNodeMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the InitialNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.name, UPDATED_VALUE);
	...
	public void testEditInitialNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the InitialNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditInitialNodeClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveInitialNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the InitialNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInitialNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the InitialNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditInitialNodeInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveInitialNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the InitialNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.inStructuredNode);
	...
	public void testEditInitialNodeActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveInitialNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the InitialNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.activity);
	...
	public void testEditInitialNodeInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveInitialNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the InitialNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInitialNodeInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveInitialNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the InitialNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InitialNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
