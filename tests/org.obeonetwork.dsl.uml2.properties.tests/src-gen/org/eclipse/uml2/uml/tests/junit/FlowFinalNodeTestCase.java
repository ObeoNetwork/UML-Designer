 ...
 */
public class FlowFinalNodeTestCase extends SWTBotEEFTestCase {
	...
	public void testEditFlowFinalNodeName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the FlowFinalNode element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), flowFinalNodeMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(flowFinalNodeMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, flowFinalNodeMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the FlowFinalNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.name, UPDATED_VALUE);
	...
	public void testEditFlowFinalNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the FlowFinalNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditFlowFinalNodeClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveFlowFinalNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the FlowFinalNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditFlowFinalNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the FlowFinalNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditFlowFinalNodeInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveFlowFinalNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the FlowFinalNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.inStructuredNode);
	...
	public void testEditFlowFinalNodeActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveFlowFinalNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the FlowFinalNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.activity);
	...
	public void testEditFlowFinalNodeInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveFlowFinalNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the FlowFinalNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditFlowFinalNodeInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveFlowFinalNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the FlowFinalNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FlowFinalNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
