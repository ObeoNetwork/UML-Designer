...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.EnumerationLiteral;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for EnumerationLiteral
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class EnumerationLiteralPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditEnumerationLiteralName() throws Exception {
		...
		// Open the EEF properties view to edit the EnumerationLiteral element
		...
		// Change value of the name feature of the EnumerationLiteral element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.EnumerationLiteral.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditEnumerationLiteralVisibility() throws Exception {
		...
		// Change value of the visibility feature of the EnumerationLiteral element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.EnumerationLiteral.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditEnumerationLiteralClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.EnumerationLiteral.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveEnumerationLiteralClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the EnumerationLiteral element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.EnumerationLiteral.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditEnumerationLiteralOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.EnumerationLiteral.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveEnumerationLiteralOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the EnumerationLiteral element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.EnumerationLiteral.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditEnumerationLiteralTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.EnumerationLiteral.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveEnumerationLiteralTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the EnumerationLiteral element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.EnumerationLiteral.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditEnumerationLiteralEnumeration() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.EnumerationLiteral.Properties.enumeration, allInstancesOf.indexOf(referenceValueForEnumeration)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveEnumerationLiteralEnumeration() throws Exception {
		...
		// Change value of the enumeration feature of the EnumerationLiteral element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.EnumerationLiteral.Properties.enumeration, bot.selectNode(modelEditor, firstInstanceOf));
