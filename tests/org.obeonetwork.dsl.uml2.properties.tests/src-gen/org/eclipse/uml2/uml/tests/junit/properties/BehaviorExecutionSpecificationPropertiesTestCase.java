...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.BehaviorExecutionSpecification;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for BehaviorExecutionSpecification
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class BehaviorExecutionSpecificationPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditBehaviorExecutionSpecificationName() throws Exception {
		...
		// Open the EEF properties view to edit the BehaviorExecutionSpecification element
		...
		// Change value of the name feature of the BehaviorExecutionSpecification element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.BehaviorExecutionSpecification.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditBehaviorExecutionSpecificationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the BehaviorExecutionSpecification element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.BehaviorExecutionSpecification.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditBehaviorExecutionSpecificationClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.BehaviorExecutionSpecification.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveBehaviorExecutionSpecificationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the BehaviorExecutionSpecification element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.BehaviorExecutionSpecification.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditBehaviorExecutionSpecificationCovered() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.BehaviorExecutionSpecification.Properties.covered, referenceValueForCovered, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveBehaviorExecutionSpecificationCovered() throws Exception {
		...
		// Change value of the covered feature of the BehaviorExecutionSpecification element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.BehaviorExecutionSpecification.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditBehaviorExecutionSpecificationEnclosingInteraction() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.BehaviorExecutionSpecification.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveBehaviorExecutionSpecificationEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the BehaviorExecutionSpecification element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.BehaviorExecutionSpecification.Properties.enclosingInteraction, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditBehaviorExecutionSpecificationEnclosingOperand() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.BehaviorExecutionSpecification.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveBehaviorExecutionSpecificationEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the BehaviorExecutionSpecification element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.BehaviorExecutionSpecification.Properties.enclosingOperand, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditBehaviorExecutionSpecificationStart() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.BehaviorExecutionSpecification.Properties.start, allInstancesOf.indexOf(referenceValueForStart), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditBehaviorExecutionSpecificationFinish() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.BehaviorExecutionSpecification.Properties.finish, allInstancesOf.indexOf(referenceValueForFinish), bot.selectNode(modelEditor, firstInstanceOf));
