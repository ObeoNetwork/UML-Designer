 ...
 */
public class SendOperationEventPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditSendOperationEventName() throws Exception {
		...
		// Open the EEF properties view to edit the SendOperationEvent element
		...
		// Change value of the name feature of the SendOperationEvent element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.SendOperationEvent.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendOperationEventVisibility() throws Exception {
		...
		// Change value of the visibility feature of the SendOperationEvent element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.SendOperationEvent.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendOperationEventClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendOperationEvent.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendOperationEventClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the SendOperationEvent element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendOperationEvent.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendOperationEventOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendOperationEvent.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendOperationEventOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the SendOperationEvent element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendOperationEvent.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendOperationEventTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendOperationEvent.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendOperationEventTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the SendOperationEvent element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendOperationEvent.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendOperationEventOperation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendOperationEvent.Properties.operation, allInstancesOf.indexOf(referenceValueForOperation), bot.selectNode(modelEditor, firstInstanceOf));
