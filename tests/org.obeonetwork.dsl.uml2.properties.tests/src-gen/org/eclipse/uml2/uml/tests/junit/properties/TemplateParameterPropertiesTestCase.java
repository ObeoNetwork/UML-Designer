 ...
 */
public class TemplateParameterPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditTemplateParameterSignature() throws Exception {
		...
		// Open the EEF properties view to edit the TemplateParameter element
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TemplateParameter.Properties.signature, allInstancesOf.indexOf(referenceValueForSignature), bot.selectNode(modelEditor, firstInstanceOf));
