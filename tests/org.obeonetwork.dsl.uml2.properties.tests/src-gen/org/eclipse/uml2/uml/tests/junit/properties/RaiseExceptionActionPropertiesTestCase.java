 ...
 */
public class RaiseExceptionActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditRaiseExceptionActionName() throws Exception {
		...
		// Open the EEF properties view to edit the RaiseExceptionAction element
		...
		// Change value of the name feature of the RaiseExceptionAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRaiseExceptionActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the RaiseExceptionAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRaiseExceptionActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRaiseExceptionActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the RaiseExceptionAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRaiseExceptionActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the RaiseExceptionAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRaiseExceptionActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRaiseExceptionActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the RaiseExceptionAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRaiseExceptionActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRaiseExceptionActionActivity() throws Exception {
		...
		// Change value of the activity feature of the RaiseExceptionAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRaiseExceptionActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRaiseExceptionActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the RaiseExceptionAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRaiseExceptionActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRaiseExceptionActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the RaiseExceptionAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RaiseExceptionAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
