...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.FunctionBehavior;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for FunctionBehavior
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class FunctionBehaviorTestCase extends SWTBotEEFTestCase {
	...
	public void testEditFunctionBehaviorName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the FunctionBehavior element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), functionBehaviorMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(functionBehaviorMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, functionBehaviorMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the FunctionBehavior element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.name, UPDATED_VALUE);
	...
	public void testEditFunctionBehaviorVisibility() throws Exception {
		...
		// Change value of the visibility feature of the FunctionBehavior element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditFunctionBehaviorClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveFunctionBehaviorClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the FunctionBehavior element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditFunctionBehaviorIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the FunctionBehavior element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditFunctionBehaviorOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveFunctionBehaviorOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the FunctionBehavior element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.owningTemplateParameter);
	...
	public void testEditFunctionBehaviorTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveFunctionBehaviorTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the FunctionBehavior element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.templateParameter);
	...
	public void testEditFunctionBehaviorIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the FunctionBehavior element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.isAbstract, UPDATED_VALUE);
	...
	public void testEditFunctionBehaviorPowertypeExtent() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.powertypeExtent, referenceValueForPowertypeExtent);
	...
	public void testRemoveFunctionBehaviorPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the FunctionBehavior element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditFunctionBehaviorRepresentation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1);
	...
	public void testRemoveFunctionBehaviorRepresentation() throws Exception {
		...
		// Change value of the representation feature of the FunctionBehavior element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.representation);
	...
	public void testEditFunctionBehaviorUseCase() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.useCase, referenceValueForUseCase);
	...
	public void testRemoveFunctionBehaviorUseCase() throws Exception {
		...
		// Change value of the useCase feature of the FunctionBehavior element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditFunctionBehaviorIsActive() throws Exception {
		...
		// Change value of the isActive feature of the FunctionBehavior element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.isActive, UPDATED_VALUE);
	...
	public void testEditFunctionBehaviorIsReentrant() throws Exception {
		...
		// Change value of the isReentrant feature of the FunctionBehavior element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.isReentrant, UPDATED_VALUE);
	...
	public void testEditFunctionBehaviorPrecondition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.precondition, referenceValueForPrecondition);
	...
	public void testRemoveFunctionBehaviorPrecondition() throws Exception {
		...
		// Change value of the precondition feature of the FunctionBehavior element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.precondition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditFunctionBehaviorPostcondition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.postcondition, referenceValueForPostcondition);
	...
	public void testRemoveFunctionBehaviorPostcondition() throws Exception {
		...
		// Change value of the postcondition feature of the FunctionBehavior element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.postcondition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditFunctionBehaviorBody() throws Exception {
		...
		// Change value of the body feature of the FunctionBehavior element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.body, UPDATED_VALUE);
	...
	public void testEditFunctionBehaviorLanguage() throws Exception {
		...
		// Change value of the language feature of the FunctionBehavior element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.FunctionBehavior.Properties.language, UPDATED_VALUE);
