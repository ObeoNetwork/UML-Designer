 ...
 */
public class RedefinableTemplateSignaturePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditRedefinableTemplateSignatureName() throws Exception {
		...
		// Open the EEF properties view to edit the RedefinableTemplateSignature element
		...
		// Change value of the name feature of the RedefinableTemplateSignature element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.RedefinableTemplateSignature.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRedefinableTemplateSignatureVisibility() throws Exception {
		...
		// Change value of the visibility feature of the RedefinableTemplateSignature element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.RedefinableTemplateSignature.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRedefinableTemplateSignatureClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RedefinableTemplateSignature.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRedefinableTemplateSignatureClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the RedefinableTemplateSignature element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RedefinableTemplateSignature.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRedefinableTemplateSignatureIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the RedefinableTemplateSignature element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.RedefinableTemplateSignature.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRedefinableTemplateSignatureParameter() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RedefinableTemplateSignature.Properties.parameter, referenceValueForParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRedefinableTemplateSignatureParameter() throws Exception {
		...
		// Change value of the parameter feature of the RedefinableTemplateSignature element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RedefinableTemplateSignature.Properties.parameter, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRedefinableTemplateSignatureExtendedSignature() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RedefinableTemplateSignature.Properties.extendedSignature, referenceValueForExtendedSignature, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRedefinableTemplateSignatureExtendedSignature() throws Exception {
		...
		// Change value of the extendedSignature feature of the RedefinableTemplateSignature element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RedefinableTemplateSignature.Properties.extendedSignature, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
