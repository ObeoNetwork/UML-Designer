 ...
 */
public class ConditionalNodeTestCase extends SWTBotEEFTestCase {
	...
	public void testEditConditionalNodeName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ConditionalNode element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), conditionalNodeMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(conditionalNodeMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, conditionalNodeMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ConditionalNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.name, UPDATED_VALUE);
	...
	public void testEditConditionalNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ConditionalNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditConditionalNodeClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveConditionalNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ConditionalNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditConditionalNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ConditionalNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditConditionalNodeInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveConditionalNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ConditionalNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.inStructuredNode);
	...
	public void testEditConditionalNodeActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveConditionalNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the ConditionalNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.activity);
	...
	public void testEditConditionalNodeInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveConditionalNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ConditionalNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditConditionalNodeInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveConditionalNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ConditionalNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditConditionalNodeInActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.inActivity, allInstancesOf.indexOf(referenceValueForInActivity)+1);
	...
	public void testRemoveConditionalNodeInActivity() throws Exception {
		...
		// Change value of the inActivity feature of the ConditionalNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.inActivity);
	...
	public void testEditConditionalNodeMustIsolate() throws Exception {
		...
		// Change value of the mustIsolate feature of the ConditionalNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.mustIsolate, UPDATED_VALUE);
	...
	public void testEditConditionalNodeIsDeterminate() throws Exception {
		...
		// Change value of the isDeterminate feature of the ConditionalNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.isDeterminate, UPDATED_VALUE);
	...
	public void testEditConditionalNodeIsAssured() throws Exception {
		...
		// Change value of the isAssured feature of the ConditionalNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ConditionalNode.Properties.isAssured, UPDATED_VALUE);
