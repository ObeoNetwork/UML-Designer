 ...
 */
public class UseCasePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditUseCaseName() throws Exception {
		...
		// Open the EEF properties view to edit the UseCase element
		...
		// Change value of the name feature of the UseCase element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.UseCase.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUseCaseVisibility() throws Exception {
		...
		// Change value of the visibility feature of the UseCase element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.UseCase.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUseCaseClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.UseCase.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveUseCaseClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the UseCase element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.UseCase.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUseCaseIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the UseCase element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.UseCase.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUseCaseOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.UseCase.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveUseCaseOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the UseCase element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.UseCase.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUseCaseTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.UseCase.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveUseCaseTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the UseCase element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.UseCase.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUseCaseIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the UseCase element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.UseCase.Properties.isAbstract, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUseCasePowertypeExtent() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.UseCase.Properties.powertypeExtent, referenceValueForPowertypeExtent, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveUseCasePowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the UseCase element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.UseCase.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUseCaseRepresentation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.UseCase.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveUseCaseRepresentation() throws Exception {
		...
		// Change value of the representation feature of the UseCase element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.UseCase.Properties.representation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUseCaseUseCase() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.UseCase.Properties.useCase_, referenceValueForUseCase, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveUseCaseUseCase() throws Exception {
		...
		// Change value of the useCase feature of the UseCase element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.UseCase.Properties.useCase_, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
