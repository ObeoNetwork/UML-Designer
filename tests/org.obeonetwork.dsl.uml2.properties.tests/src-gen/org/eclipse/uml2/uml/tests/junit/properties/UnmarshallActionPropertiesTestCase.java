...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.UnmarshallAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for UnmarshallAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class UnmarshallActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditUnmarshallActionName() throws Exception {
		...
		// Open the EEF properties view to edit the UnmarshallAction element
		...
		// Change value of the name feature of the UnmarshallAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUnmarshallActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the UnmarshallAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUnmarshallActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveUnmarshallActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the UnmarshallAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUnmarshallActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the UnmarshallAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUnmarshallActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveUnmarshallActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the UnmarshallAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUnmarshallActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveUnmarshallActionActivity() throws Exception {
		...
		// Change value of the activity feature of the UnmarshallAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUnmarshallActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveUnmarshallActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the UnmarshallAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditUnmarshallActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveUnmarshallActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the UnmarshallAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.UnmarshallAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
