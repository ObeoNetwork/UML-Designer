 ...
 */
public class ClassifierTemplateParameterPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditClassifierTemplateParameterSignature() throws Exception {
		...
		// Open the EEF properties view to edit the ClassifierTemplateParameter element
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ClassifierTemplateParameter.Properties.signature, allInstancesOf.indexOf(referenceValueForSignature), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClassifierTemplateParameterAllowSubstitutable() throws Exception {
		...
		// Change value of the allowSubstitutable feature of the ClassifierTemplateParameter element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ClassifierTemplateParameter.Properties.allowSubstitutable, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
