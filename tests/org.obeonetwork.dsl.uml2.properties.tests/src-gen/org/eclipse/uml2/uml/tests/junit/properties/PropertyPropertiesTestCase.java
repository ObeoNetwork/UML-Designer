 ...
 */
public class PropertyPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditPropertyName() throws Exception {
		...
		// Open the EEF properties view to edit the Property element
		...
		// Change value of the name feature of the Property element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Property.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Property element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Property.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Property.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePropertyClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Property element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Property.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Property element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Property.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyIsStatic() throws Exception {
		...
		// Change value of the isStatic feature of the Property element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Property.Properties.isStatic, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyIsOrdered() throws Exception {
		...
		// Change value of the isOrdered feature of the Property element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Property.Properties.isOrdered, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyIsUnique() throws Exception {
		...
		// Change value of the isUnique feature of the Property element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Property.Properties.isUnique, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyIsReadOnly() throws Exception {
		...
		// Change value of the isReadOnly feature of the Property element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Property.Properties.isReadOnly, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePropertyOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Property element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePropertyTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Property element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyClass() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.class_, allInstancesOf.indexOf(referenceValueForClass)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePropertyClass() throws Exception {
		...
		// Change value of the class feature of the Property element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.class_, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyDatatype() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.datatype, allInstancesOf.indexOf(referenceValueForDatatype)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePropertyDatatype() throws Exception {
		...
		// Change value of the datatype feature of the Property element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.datatype, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyIsDerived() throws Exception {
		...
		// Change value of the isDerived feature of the Property element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Property.Properties.isDerived, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyIsDerivedUnion() throws Exception {
		...
		// Change value of the isDerivedUnion feature of the Property element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Property.Properties.isDerivedUnion, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyAggregation() throws Exception {
		...
		// Change value of the aggregation feature of the Property element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Property.Properties.aggregation, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyRedefinedProperty() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Property.Properties.redefinedProperty, referenceValueForRedefinedProperty, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePropertyRedefinedProperty() throws Exception {
		...
		// Change value of the redefinedProperty feature of the Property element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Property.Properties.redefinedProperty, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyOwningAssociation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.owningAssociation, allInstancesOf.indexOf(referenceValueForOwningAssociation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePropertyOwningAssociation() throws Exception {
		...
		// Change value of the owningAssociation feature of the Property element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.owningAssociation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertySubsettedProperty() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Property.Properties.subsettedProperty, referenceValueForSubsettedProperty, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePropertySubsettedProperty() throws Exception {
		...
		// Change value of the subsettedProperty feature of the Property element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Property.Properties.subsettedProperty, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyAssociation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.association, allInstancesOf.indexOf(referenceValueForAssociation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePropertyAssociation() throws Exception {
		...
		// Change value of the association feature of the Property element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.association, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPropertyAssociationEnd() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.associationEnd, allInstancesOf.indexOf(referenceValueForAssociationEnd)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePropertyAssociationEnd() throws Exception {
		...
		// Change value of the associationEnd feature of the Property element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Property.Properties.associationEnd, bot.selectNode(modelEditor, firstInstanceOf));
