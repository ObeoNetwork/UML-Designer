 ...
 */
public class ProfilePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditProfileName() throws Exception {
		...
		// Open the EEF properties view to edit the Profile element
		...
		// Change value of the name feature of the Profile element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Profile.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProfileVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Profile element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Profile.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProfileClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Profile.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProfileClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Profile element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Profile.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProfileOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Profile.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProfileOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Profile element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Profile.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProfileTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Profile.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProfileTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Profile element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Profile.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProfileMetaclassReference() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Profile.Properties.metaclassReference, referenceValueForMetaclassReference, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProfileMetaclassReference() throws Exception {
		...
		// Change value of the metaclassReference feature of the Profile element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Profile.Properties.metaclassReference, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProfileMetamodelReference() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Profile.Properties.metamodelReference, referenceValueForMetamodelReference, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProfileMetamodelReference() throws Exception {
		...
		// Change value of the metamodelReference feature of the Profile element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Profile.Properties.metamodelReference, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
