 ...
 */
public class OperationPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditOperationName() throws Exception {
		...
		// Open the EEF properties view to edit the Operation element
		...
		// Change value of the name feature of the Operation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Operation.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Operation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Operation.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Operation.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOperationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Operation element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Operation.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Operation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Operation.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationIsStatic() throws Exception {
		...
		// Change value of the isStatic feature of the Operation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Operation.Properties.isStatic, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the Operation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Operation.Properties.isAbstract, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationConcurrency() throws Exception {
		...
		// Change value of the concurrency feature of the Operation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Operation.Properties.concurrency, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Operation.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOperationOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Operation element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Operation.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Operation.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOperationTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Operation element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Operation.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationInterface() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Operation.Properties.interface_, allInstancesOf.indexOf(referenceValueForInterface)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOperationInterface() throws Exception {
		...
		// Change value of the interface feature of the Operation element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Operation.Properties.interface_, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationClass() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Operation.Properties.class_, allInstancesOf.indexOf(referenceValueForClass)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOperationClass() throws Exception {
		...
		// Change value of the class feature of the Operation element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Operation.Properties.class_, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationIsQuery() throws Exception {
		...
		// Change value of the isQuery feature of the Operation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Operation.Properties.isQuery, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationPrecondition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Operation.Properties.precondition, referenceValueForPrecondition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOperationPrecondition() throws Exception {
		...
		// Change value of the precondition feature of the Operation element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Operation.Properties.precondition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationPostcondition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Operation.Properties.postcondition, referenceValueForPostcondition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOperationPostcondition() throws Exception {
		...
		// Change value of the postcondition feature of the Operation element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Operation.Properties.postcondition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationRedefinedOperation() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Operation.Properties.redefinedOperation, referenceValueForRedefinedOperation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOperationRedefinedOperation() throws Exception {
		...
		// Change value of the redefinedOperation feature of the Operation element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Operation.Properties.redefinedOperation, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationDatatype() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Operation.Properties.datatype, allInstancesOf.indexOf(referenceValueForDatatype)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOperationDatatype() throws Exception {
		...
		// Change value of the datatype feature of the Operation element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Operation.Properties.datatype, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOperationBodyCondition() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Operation.Properties.bodyCondition, allInstancesOf.indexOf(referenceValueForBodyCondition)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOperationBodyCondition() throws Exception {
		...
		// Change value of the bodyCondition feature of the Operation element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Operation.Properties.bodyCondition, bot.selectNode(modelEditor, firstInstanceOf));
