 ...
 */
public class StereotypeTestCase extends SWTBotEEFTestCase {
	...
	public void testEditStereotypeName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Stereotype element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), stereotypeMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(stereotypeMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, stereotypeMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Stereotype element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.name, UPDATED_VALUE);
	...
	public void testEditStereotypeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Stereotype element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditStereotypeClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveStereotypeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Stereotype element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStereotypeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Stereotype element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditStereotypeOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveStereotypeOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Stereotype element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.owningTemplateParameter);
	...
	public void testEditStereotypeTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveStereotypeTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Stereotype element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.templateParameter);
	...
	public void testEditStereotypeIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the Stereotype element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.isAbstract, UPDATED_VALUE);
	...
	public void testEditStereotypePowertypeExtent() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.powertypeExtent, referenceValueForPowertypeExtent);
	...
	public void testRemoveStereotypePowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the Stereotype element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStereotypeRepresentation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1);
	...
	public void testRemoveStereotypeRepresentation() throws Exception {
		...
		// Change value of the representation feature of the Stereotype element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.representation);
	...
	public void testEditStereotypeUseCase() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.useCase, referenceValueForUseCase);
	...
	public void testRemoveStereotypeUseCase() throws Exception {
		...
		// Change value of the useCase feature of the Stereotype element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStereotypeIsActive() throws Exception {
		...
		// Change value of the isActive feature of the Stereotype element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Stereotype.Properties.isActive, UPDATED_VALUE);
