 ...
 */
public class SendSignalActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditSendSignalActionName() throws Exception {
		...
		// Open the EEF properties view to edit the SendSignalAction element
		...
		// Change value of the name feature of the SendSignalAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.SendSignalAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendSignalActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the SendSignalAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.SendSignalAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendSignalActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendSignalActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the SendSignalAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendSignalActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the SendSignalAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.SendSignalAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendSignalActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendSignalActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the SendSignalAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendSignalActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendSignalActionActivity() throws Exception {
		...
		// Change value of the activity feature of the SendSignalAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendSignalActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendSignalActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the SendSignalAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendSignalActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendSignalActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the SendSignalAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendSignalActionOnPort() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.onPort, allInstancesOf.indexOf(referenceValueForOnPort)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendSignalActionOnPort() throws Exception {
		...
		// Change value of the onPort feature of the SendSignalAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.onPort, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendSignalActionSignal() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendSignalAction.Properties.signal, allInstancesOf.indexOf(referenceValueForSignal), bot.selectNode(modelEditor, firstInstanceOf));
