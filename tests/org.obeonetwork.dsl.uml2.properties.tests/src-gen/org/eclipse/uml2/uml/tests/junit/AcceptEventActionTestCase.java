...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.AcceptEventAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for AcceptEventAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class AcceptEventActionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditAcceptEventActionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the AcceptEventAction element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), acceptEventActionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(acceptEventActionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, acceptEventActionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the AcceptEventAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.name, UPDATED_VALUE);
	...
	public void testEditAcceptEventActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the AcceptEventAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditAcceptEventActionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveAcceptEventActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the AcceptEventAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAcceptEventActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the AcceptEventAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditAcceptEventActionInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveAcceptEventActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the AcceptEventAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.inStructuredNode);
	...
	public void testEditAcceptEventActionActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveAcceptEventActionActivity() throws Exception {
		...
		// Change value of the activity feature of the AcceptEventAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.activity);
	...
	public void testEditAcceptEventActionInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveAcceptEventActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the AcceptEventAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAcceptEventActionInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveAcceptEventActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the AcceptEventAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAcceptEventActionIsUnmarshall() throws Exception {
		...
		// Change value of the isUnmarshall feature of the AcceptEventAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.AcceptEventAction.Properties.isUnmarshall, UPDATED_VALUE);
