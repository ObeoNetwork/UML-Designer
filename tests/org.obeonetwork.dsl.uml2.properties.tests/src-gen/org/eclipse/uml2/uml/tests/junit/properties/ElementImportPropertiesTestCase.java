...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ElementImport;
/**
 * TestCase for ElementImport
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ElementImportPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditElementImportVisibility() throws Exception {
		...
		// Open the EEF properties view to edit the ElementImport element
		...
		// Change value of the visibility feature of the ElementImport element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ElementImport.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditElementImportAlias() throws Exception {
		...
		// Change value of the alias feature of the ElementImport element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ElementImport.Properties.alias, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
