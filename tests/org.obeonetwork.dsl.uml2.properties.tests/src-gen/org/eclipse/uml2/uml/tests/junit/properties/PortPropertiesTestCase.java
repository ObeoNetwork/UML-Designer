 ...
 */
public class PortPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditPortName() throws Exception {
		...
		// Open the EEF properties view to edit the Port element
		...
		// Change value of the name feature of the Port element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Port.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Port element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Port.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Port.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePortClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Port element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Port.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Port element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Port.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortIsStatic() throws Exception {
		...
		// Change value of the isStatic feature of the Port element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Port.Properties.isStatic, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortIsOrdered() throws Exception {
		...
		// Change value of the isOrdered feature of the Port element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Port.Properties.isOrdered, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortIsUnique() throws Exception {
		...
		// Change value of the isUnique feature of the Port element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Port.Properties.isUnique, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortIsReadOnly() throws Exception {
		...
		// Change value of the isReadOnly feature of the Port element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Port.Properties.isReadOnly, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePortOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Port element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePortTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Port element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortClass() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.class_, allInstancesOf.indexOf(referenceValueForClass)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePortClass() throws Exception {
		...
		// Change value of the class feature of the Port element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.class_, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortDatatype() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.datatype, allInstancesOf.indexOf(referenceValueForDatatype)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePortDatatype() throws Exception {
		...
		// Change value of the datatype feature of the Port element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.datatype, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortIsDerived() throws Exception {
		...
		// Change value of the isDerived feature of the Port element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Port.Properties.isDerived, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortIsDerivedUnion() throws Exception {
		...
		// Change value of the isDerivedUnion feature of the Port element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Port.Properties.isDerivedUnion, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortAggregation() throws Exception {
		...
		// Change value of the aggregation feature of the Port element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Port.Properties.aggregation, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortRedefinedProperty() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Port.Properties.redefinedProperty, referenceValueForRedefinedProperty, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePortRedefinedProperty() throws Exception {
		...
		// Change value of the redefinedProperty feature of the Port element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Port.Properties.redefinedProperty, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortOwningAssociation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.owningAssociation, allInstancesOf.indexOf(referenceValueForOwningAssociation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePortOwningAssociation() throws Exception {
		...
		// Change value of the owningAssociation feature of the Port element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.owningAssociation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortSubsettedProperty() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Port.Properties.subsettedProperty, referenceValueForSubsettedProperty, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePortSubsettedProperty() throws Exception {
		...
		// Change value of the subsettedProperty feature of the Port element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Port.Properties.subsettedProperty, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortAssociation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.association, allInstancesOf.indexOf(referenceValueForAssociation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePortAssociation() throws Exception {
		...
		// Change value of the association feature of the Port element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.association, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortAssociationEnd() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.associationEnd, allInstancesOf.indexOf(referenceValueForAssociationEnd)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePortAssociationEnd() throws Exception {
		...
		// Change value of the associationEnd feature of the Port element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.associationEnd, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortIsBehavior() throws Exception {
		...
		// Change value of the isBehavior feature of the Port element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Port.Properties.isBehavior, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortIsService() throws Exception {
		...
		// Change value of the isService feature of the Port element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Port.Properties.isService, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortRedefinedPort() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Port.Properties.redefinedPort, referenceValueForRedefinedPort, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePortRedefinedPort() throws Exception {
		...
		// Change value of the redefinedPort feature of the Port element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Port.Properties.redefinedPort, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPortProtocol() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.protocol, allInstancesOf.indexOf(referenceValueForProtocol)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePortProtocol() throws Exception {
		...
		// Change value of the protocol feature of the Port element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Port.Properties.protocol, bot.selectNode(modelEditor, firstInstanceOf));
