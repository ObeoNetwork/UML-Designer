 ...
 */
public class ActivityFinalNodeTestCase extends SWTBotEEFTestCase {
	...
	public void testEditActivityFinalNodeName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ActivityFinalNode element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), activityFinalNodeMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(activityFinalNodeMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, activityFinalNodeMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ActivityFinalNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.name, UPDATED_VALUE);
	...
	public void testEditActivityFinalNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ActivityFinalNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditActivityFinalNodeClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveActivityFinalNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ActivityFinalNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditActivityFinalNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ActivityFinalNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditActivityFinalNodeInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveActivityFinalNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ActivityFinalNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.inStructuredNode);
	...
	public void testEditActivityFinalNodeActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveActivityFinalNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the ActivityFinalNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.activity);
	...
	public void testEditActivityFinalNodeInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveActivityFinalNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ActivityFinalNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditActivityFinalNodeInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveActivityFinalNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ActivityFinalNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ActivityFinalNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
