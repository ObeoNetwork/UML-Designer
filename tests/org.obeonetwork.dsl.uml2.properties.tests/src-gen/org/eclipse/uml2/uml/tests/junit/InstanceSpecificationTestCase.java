...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.InstanceSpecification;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for InstanceSpecification
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class InstanceSpecificationTestCase extends SWTBotEEFTestCase {
	...
	public void testEditInstanceSpecificationName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the InstanceSpecification element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), instanceSpecificationMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(instanceSpecificationMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, instanceSpecificationMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the InstanceSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.InstanceSpecification.Properties.name, UPDATED_VALUE);
	...
	public void testEditInstanceSpecificationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the InstanceSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.InstanceSpecification.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditInstanceSpecificationClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InstanceSpecification.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveInstanceSpecificationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the InstanceSpecification element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InstanceSpecification.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInstanceSpecificationOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InstanceSpecification.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveInstanceSpecificationOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the InstanceSpecification element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InstanceSpecification.Properties.owningTemplateParameter);
	...
	public void testEditInstanceSpecificationTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InstanceSpecification.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveInstanceSpecificationTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the InstanceSpecification element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InstanceSpecification.Properties.templateParameter);
