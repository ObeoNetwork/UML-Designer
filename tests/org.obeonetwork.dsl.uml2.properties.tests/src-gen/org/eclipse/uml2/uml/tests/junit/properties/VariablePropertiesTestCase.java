 ...
 */
public class VariablePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditVariableName() throws Exception {
		...
		// Open the EEF properties view to edit the Variable element
		...
		// Change value of the name feature of the Variable element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Variable.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditVariableVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Variable element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Variable.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditVariableClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Variable.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveVariableClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Variable element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Variable.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditVariableOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Variable.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveVariableOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Variable element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Variable.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditVariableTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Variable.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveVariableTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Variable element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Variable.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditVariableIsOrdered() throws Exception {
		...
		// Change value of the isOrdered feature of the Variable element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Variable.Properties.isOrdered, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditVariableIsUnique() throws Exception {
		...
		// Change value of the isUnique feature of the Variable element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Variable.Properties.isUnique, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditVariableScope() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Variable.Properties.scope, allInstancesOf.indexOf(referenceValueForScope)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveVariableScope() throws Exception {
		...
		// Change value of the scope feature of the Variable element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Variable.Properties.scope, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditVariableActivityScope() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Variable.Properties.activityScope, allInstancesOf.indexOf(referenceValueForActivityScope)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveVariableActivityScope() throws Exception {
		...
		// Change value of the activityScope feature of the Variable element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Variable.Properties.activityScope, bot.selectNode(modelEditor, firstInstanceOf));
