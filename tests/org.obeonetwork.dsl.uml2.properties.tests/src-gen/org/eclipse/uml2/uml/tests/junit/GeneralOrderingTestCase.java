...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.GeneralOrdering;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for GeneralOrdering
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class GeneralOrderingTestCase extends SWTBotEEFTestCase {
	...
	public void testEditGeneralOrderingName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the GeneralOrdering element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), generalOrderingMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(generalOrderingMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, generalOrderingMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the GeneralOrdering element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.GeneralOrdering.Properties.name, UPDATED_VALUE);
	...
	public void testEditGeneralOrderingVisibility() throws Exception {
		...
		// Change value of the visibility feature of the GeneralOrdering element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.GeneralOrdering.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditGeneralOrderingClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.GeneralOrdering.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveGeneralOrderingClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the GeneralOrdering element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.GeneralOrdering.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditGeneralOrderingBefore() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.GeneralOrdering.Properties.before, allInstancesOf.indexOf(referenceValueForBefore));
	...
	public void testEditGeneralOrderingAfter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.GeneralOrdering.Properties.after, allInstancesOf.indexOf(referenceValueForAfter));
