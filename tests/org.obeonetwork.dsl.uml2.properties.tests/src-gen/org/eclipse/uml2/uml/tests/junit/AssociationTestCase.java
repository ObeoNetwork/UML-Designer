...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.Association;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for Association
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class AssociationTestCase extends SWTBotEEFTestCase {
	...
	public void testEditAssociationName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Association element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), associationMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(associationMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, associationMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Association element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Association.Properties.name, UPDATED_VALUE);
	...
	public void testEditAssociationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Association element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Association.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditAssociationClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Association.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveAssociationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Association element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Association.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAssociationIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Association element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Association.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditAssociationOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Association.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveAssociationOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Association element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Association.Properties.owningTemplateParameter);
	...
	public void testEditAssociationTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Association.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveAssociationTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Association element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Association.Properties.templateParameter);
	...
	public void testEditAssociationIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the Association element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Association.Properties.isAbstract, UPDATED_VALUE);
	...
	public void testEditAssociationPowertypeExtent() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Association.Properties.powertypeExtent, referenceValueForPowertypeExtent);
	...
	public void testRemoveAssociationPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the Association element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Association.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAssociationRepresentation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Association.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1);
	...
	public void testRemoveAssociationRepresentation() throws Exception {
		...
		// Change value of the representation feature of the Association element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Association.Properties.representation);
	...
	public void testEditAssociationUseCase() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Association.Properties.useCase, referenceValueForUseCase);
	...
	public void testRemoveAssociationUseCase() throws Exception {
		...
		// Change value of the useCase feature of the Association element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Association.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAssociationMemberEnd() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Association.Properties.memberEnd, referenceValueForMemberEnd);
	...
	public void testRemoveAssociationMemberEnd() throws Exception {
		...
		// Change value of the memberEnd feature of the Association element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Association.Properties.memberEnd, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAssociationIsDerived() throws Exception {
		...
		// Change value of the isDerived feature of the Association element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Association.Properties.isDerived, UPDATED_VALUE);
	...
	public void testEditAssociationNavigableOwnedEnd() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Association.Properties.navigableOwnedEnd, referenceValueForNavigableOwnedEnd);
	...
	public void testRemoveAssociationNavigableOwnedEnd() throws Exception {
		...
		// Change value of the navigableOwnedEnd feature of the Association element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Association.Properties.navigableOwnedEnd, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
