...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ExpansionNode;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ExpansionNode
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ExpansionNodeTestCase extends SWTBotEEFTestCase {
	...
	public void testEditExpansionNodeName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ExpansionNode element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), expansionNodeMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(expansionNodeMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, expansionNodeMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ExpansionNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.name, UPDATED_VALUE);
	...
	public void testEditExpansionNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ExpansionNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditExpansionNodeClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveExpansionNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ExpansionNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditExpansionNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ExpansionNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditExpansionNodeInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveExpansionNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ExpansionNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.inStructuredNode);
	...
	public void testEditExpansionNodeActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveExpansionNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the ExpansionNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.activity);
	...
	public void testEditExpansionNodeInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveExpansionNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ExpansionNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditExpansionNodeInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveExpansionNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ExpansionNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditExpansionNodeOrdering() throws Exception {
		...
		// Change value of the ordering feature of the ExpansionNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.ordering, UPDATED_VALUE);
	...
	public void testEditExpansionNodeIsControlType() throws Exception {
		...
		// Change value of the isControlType feature of the ExpansionNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.isControlType, UPDATED_VALUE);
	...
	public void testEditExpansionNodeInState() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.inState, referenceValueForInState);
	...
	public void testRemoveExpansionNodeInState() throws Exception {
		...
		// Change value of the inState feature of the ExpansionNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.inState, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditExpansionNodeRegionAsOutput() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.regionAsOutput, allInstancesOf.indexOf(referenceValueForRegionAsOutput)+1);
	...
	public void testRemoveExpansionNodeRegionAsOutput() throws Exception {
		...
		// Change value of the regionAsOutput feature of the ExpansionNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.regionAsOutput);
	...
	public void testEditExpansionNodeRegionAsInput() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.regionAsInput, allInstancesOf.indexOf(referenceValueForRegionAsInput)+1);
	...
	public void testRemoveExpansionNodeRegionAsInput() throws Exception {
		...
		// Change value of the regionAsInput feature of the ExpansionNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExpansionNode.Properties.regionAsInput);
