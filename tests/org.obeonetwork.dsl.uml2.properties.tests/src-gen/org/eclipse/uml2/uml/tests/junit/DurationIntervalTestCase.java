...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.DurationInterval;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for DurationInterval
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class DurationIntervalTestCase extends SWTBotEEFTestCase {
	...
	public void testEditDurationIntervalName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the DurationInterval element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), durationIntervalMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(durationIntervalMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, durationIntervalMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the DurationInterval element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DurationInterval.Properties.name, UPDATED_VALUE);
	...
	public void testEditDurationIntervalVisibility() throws Exception {
		...
		// Change value of the visibility feature of the DurationInterval element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DurationInterval.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditDurationIntervalClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DurationInterval.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveDurationIntervalClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the DurationInterval element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DurationInterval.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditDurationIntervalOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DurationInterval.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveDurationIntervalOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the DurationInterval element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DurationInterval.Properties.owningTemplateParameter);
	...
	public void testEditDurationIntervalTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DurationInterval.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveDurationIntervalTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the DurationInterval element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DurationInterval.Properties.templateParameter);
