 ...
 */
public class PseudostatePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditPseudostateName() throws Exception {
		...
		// Open the EEF properties view to edit the Pseudostate element
		...
		// Change value of the name feature of the Pseudostate element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Pseudostate.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPseudostateVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Pseudostate element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Pseudostate.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPseudostateClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Pseudostate.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePseudostateClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Pseudostate element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Pseudostate.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPseudostateContainer() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Pseudostate.Properties.container, allInstancesOf.indexOf(referenceValueForContainer)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePseudostateContainer() throws Exception {
		...
		// Change value of the container feature of the Pseudostate element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Pseudostate.Properties.container, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPseudostateKind() throws Exception {
		...
		// Change value of the kind feature of the Pseudostate element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Pseudostate.Properties.kind, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPseudostateStateMachine() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Pseudostate.Properties.stateMachine, allInstancesOf.indexOf(referenceValueForStateMachine)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePseudostateStateMachine() throws Exception {
		...
		// Change value of the stateMachine feature of the Pseudostate element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Pseudostate.Properties.stateMachine, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPseudostateState() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Pseudostate.Properties.state, allInstancesOf.indexOf(referenceValueForState)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePseudostateState() throws Exception {
		...
		// Change value of the state feature of the Pseudostate element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Pseudostate.Properties.state, bot.selectNode(modelEditor, firstInstanceOf));
