 ...
 */
public class LoopNodePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditLoopNodeName() throws Exception {
		...
		// Open the EEF properties view to edit the LoopNode element
		...
		// Change value of the name feature of the LoopNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LoopNode.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the LoopNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LoopNode.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLoopNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the LoopNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the LoopNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LoopNode.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLoopNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the LoopNode element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLoopNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the LoopNode element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLoopNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the LoopNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLoopNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the LoopNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeInActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.inActivity, allInstancesOf.indexOf(referenceValueForInActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLoopNodeInActivity() throws Exception {
		...
		// Change value of the inActivity feature of the LoopNode element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.inActivity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeMustIsolate() throws Exception {
		...
		// Change value of the mustIsolate feature of the LoopNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LoopNode.Properties.mustIsolate, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeIsTestedFirst() throws Exception {
		...
		// Change value of the isTestedFirst feature of the LoopNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LoopNode.Properties.isTestedFirst, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeDecider() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.decider, allInstancesOf.indexOf(referenceValueForDecider), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeLoopVariable() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.loopVariable, referenceValueForLoopVariable, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLoopNodeLoopVariable() throws Exception {
		...
		// Change value of the loopVariable feature of the LoopNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.loopVariable, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLoopNodeBodyOutput() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.bodyOutput, referenceValueForBodyOutput, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLoopNodeBodyOutput() throws Exception {
		...
		// Change value of the bodyOutput feature of the LoopNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LoopNode.Properties.bodyOutput, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
