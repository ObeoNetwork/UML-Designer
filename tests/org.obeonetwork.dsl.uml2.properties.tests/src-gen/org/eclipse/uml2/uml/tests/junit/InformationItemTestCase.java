 ...
 */
public class InformationItemTestCase extends SWTBotEEFTestCase {
	...
	public void testEditInformationItemName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the InformationItem element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), informationItemMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(informationItemMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, informationItemMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the InformationItem element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.name, UPDATED_VALUE);
	...
	public void testEditInformationItemVisibility() throws Exception {
		...
		// Change value of the visibility feature of the InformationItem element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditInformationItemClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveInformationItemClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the InformationItem element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInformationItemIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the InformationItem element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditInformationItemOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveInformationItemOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the InformationItem element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.owningTemplateParameter);
	...
	public void testEditInformationItemTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveInformationItemTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the InformationItem element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.templateParameter);
	...
	public void testEditInformationItemIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the InformationItem element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.isAbstract, UPDATED_VALUE);
	...
	public void testEditInformationItemPowertypeExtent() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.powertypeExtent, referenceValueForPowertypeExtent);
	...
	public void testRemoveInformationItemPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the InformationItem element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInformationItemRepresentation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1);
	...
	public void testRemoveInformationItemRepresentation() throws Exception {
		...
		// Change value of the representation feature of the InformationItem element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.representation);
	...
	public void testEditInformationItemUseCase() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.useCase, referenceValueForUseCase);
	...
	public void testRemoveInformationItemUseCase() throws Exception {
		...
		// Change value of the useCase feature of the InformationItem element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InformationItem.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
