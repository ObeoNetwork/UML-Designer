...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.AcceptCallAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for AcceptCallAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class AcceptCallActionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditAcceptCallActionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the AcceptCallAction element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), acceptCallActionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(acceptCallActionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, acceptCallActionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the AcceptCallAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.name, UPDATED_VALUE);
	...
	public void testEditAcceptCallActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the AcceptCallAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditAcceptCallActionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveAcceptCallActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the AcceptCallAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAcceptCallActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the AcceptCallAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditAcceptCallActionInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveAcceptCallActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the AcceptCallAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.inStructuredNode);
	...
	public void testEditAcceptCallActionActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveAcceptCallActionActivity() throws Exception {
		...
		// Change value of the activity feature of the AcceptCallAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.activity);
	...
	public void testEditAcceptCallActionInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveAcceptCallActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the AcceptCallAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAcceptCallActionInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveAcceptCallActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the AcceptCallAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAcceptCallActionIsUnmarshall() throws Exception {
		...
		// Change value of the isUnmarshall feature of the AcceptCallAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.AcceptCallAction.Properties.isUnmarshall, UPDATED_VALUE);
