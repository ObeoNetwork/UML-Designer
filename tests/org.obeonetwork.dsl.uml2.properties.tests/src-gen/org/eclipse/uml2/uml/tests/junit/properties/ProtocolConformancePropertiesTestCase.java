...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ProtocolConformance;
/**
 * TestCase for ProtocolConformance
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ProtocolConformancePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditProtocolConformanceGeneralMachine() throws Exception {
		...
		// Open the EEF properties view to edit the ProtocolConformance element
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolConformance.Properties.generalMachine, allInstancesOf.indexOf(referenceValueForGeneralMachine), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolConformanceSpecificMachine() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolConformance.Properties.specificMachine, allInstancesOf.indexOf(referenceValueForSpecificMachine), bot.selectNode(modelEditor, firstInstanceOf));
