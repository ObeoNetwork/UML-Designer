...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.TimeEvent;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for TimeEvent
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class TimeEventPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditTimeEventName() throws Exception {
		...
		// Open the EEF properties view to edit the TimeEvent element
		...
		// Change value of the name feature of the TimeEvent element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.TimeEvent.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeEventVisibility() throws Exception {
		...
		// Change value of the visibility feature of the TimeEvent element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.TimeEvent.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeEventClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.TimeEvent.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTimeEventClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the TimeEvent element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.TimeEvent.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeEventOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeEvent.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTimeEventOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the TimeEvent element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeEvent.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeEventTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeEvent.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTimeEventTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the TimeEvent element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeEvent.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeEventIsRelative() throws Exception {
		...
		// Change value of the isRelative feature of the TimeEvent element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.TimeEvent.Properties.isRelative, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
