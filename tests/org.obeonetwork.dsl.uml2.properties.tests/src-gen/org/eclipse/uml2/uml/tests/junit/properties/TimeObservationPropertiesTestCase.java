 ...
 */
public class TimeObservationPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditTimeObservationName() throws Exception {
		...
		// Open the EEF properties view to edit the TimeObservation element
		...
		// Change value of the name feature of the TimeObservation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.TimeObservation.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeObservationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the TimeObservation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.TimeObservation.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeObservationClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.TimeObservation.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTimeObservationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the TimeObservation element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.TimeObservation.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeObservationOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeObservation.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTimeObservationOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the TimeObservation element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeObservation.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeObservationTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeObservation.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTimeObservationTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the TimeObservation element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeObservation.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeObservationFirstEvent() throws Exception {
		...
		// Change value of the firstEvent feature of the TimeObservation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.TimeObservation.Properties.firstEvent, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
