...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.DecisionNode;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for DecisionNode
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class DecisionNodeTestCase extends SWTBotEEFTestCase {
	...
	public void testEditDecisionNodeName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the DecisionNode element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), decisionNodeMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(decisionNodeMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, decisionNodeMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the DecisionNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.name, UPDATED_VALUE);
	...
	public void testEditDecisionNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the DecisionNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditDecisionNodeClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveDecisionNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the DecisionNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditDecisionNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the DecisionNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditDecisionNodeInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveDecisionNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the DecisionNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.inStructuredNode);
	...
	public void testEditDecisionNodeActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveDecisionNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the DecisionNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.activity);
	...
	public void testEditDecisionNodeInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveDecisionNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the DecisionNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditDecisionNodeInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveDecisionNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the DecisionNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditDecisionNodeDecisionInputFlow() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.decisionInputFlow, allInstancesOf.indexOf(referenceValueForDecisionInputFlow)+1);
	...
	public void testRemoveDecisionNodeDecisionInputFlow() throws Exception {
		...
		// Change value of the decisionInputFlow feature of the DecisionNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DecisionNode.Properties.decisionInputFlow);
