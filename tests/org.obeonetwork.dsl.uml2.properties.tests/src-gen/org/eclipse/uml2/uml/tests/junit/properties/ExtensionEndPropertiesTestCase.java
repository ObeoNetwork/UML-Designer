 ...
 */
public class ExtensionEndPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditExtensionEndName() throws Exception {
		...
		// Open the EEF properties view to edit the ExtensionEnd element
		...
		// Change value of the name feature of the ExtensionEnd element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ExtensionEnd element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionEndClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ExtensionEnd element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ExtensionEnd element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndIsStatic() throws Exception {
		...
		// Change value of the isStatic feature of the ExtensionEnd element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.isStatic, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndIsOrdered() throws Exception {
		...
		// Change value of the isOrdered feature of the ExtensionEnd element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.isOrdered, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndIsUnique() throws Exception {
		...
		// Change value of the isUnique feature of the ExtensionEnd element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.isUnique, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndIsReadOnly() throws Exception {
		...
		// Change value of the isReadOnly feature of the ExtensionEnd element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.isReadOnly, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionEndOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the ExtensionEnd element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionEndTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the ExtensionEnd element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndClass() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.class_, allInstancesOf.indexOf(referenceValueForClass)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionEndClass() throws Exception {
		...
		// Change value of the class feature of the ExtensionEnd element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.class_, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndDatatype() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.datatype, allInstancesOf.indexOf(referenceValueForDatatype)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionEndDatatype() throws Exception {
		...
		// Change value of the datatype feature of the ExtensionEnd element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.datatype, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndIsDerived() throws Exception {
		...
		// Change value of the isDerived feature of the ExtensionEnd element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.isDerived, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndIsDerivedUnion() throws Exception {
		...
		// Change value of the isDerivedUnion feature of the ExtensionEnd element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.isDerivedUnion, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndAggregation() throws Exception {
		...
		// Change value of the aggregation feature of the ExtensionEnd element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.aggregation, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndRedefinedProperty() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.redefinedProperty, referenceValueForRedefinedProperty, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionEndRedefinedProperty() throws Exception {
		...
		// Change value of the redefinedProperty feature of the ExtensionEnd element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.redefinedProperty, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndOwningAssociation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.owningAssociation, allInstancesOf.indexOf(referenceValueForOwningAssociation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionEndOwningAssociation() throws Exception {
		...
		// Change value of the owningAssociation feature of the ExtensionEnd element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.owningAssociation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndSubsettedProperty() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.subsettedProperty, referenceValueForSubsettedProperty, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionEndSubsettedProperty() throws Exception {
		...
		// Change value of the subsettedProperty feature of the ExtensionEnd element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.subsettedProperty, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndAssociation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.association, allInstancesOf.indexOf(referenceValueForAssociation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionEndAssociation() throws Exception {
		...
		// Change value of the association feature of the ExtensionEnd element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.association, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionEndAssociationEnd() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.associationEnd, allInstancesOf.indexOf(referenceValueForAssociationEnd)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionEndAssociationEnd() throws Exception {
		...
		// Change value of the associationEnd feature of the ExtensionEnd element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionEnd.Properties.associationEnd, bot.selectNode(modelEditor, firstInstanceOf));
