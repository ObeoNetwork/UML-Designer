 ...
 */
public class ConsiderIgnoreFragmentPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditConsiderIgnoreFragmentName() throws Exception {
		...
		// Open the EEF properties view to edit the ConsiderIgnoreFragment element
		...
		// Change value of the name feature of the ConsiderIgnoreFragment element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ConsiderIgnoreFragment.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditConsiderIgnoreFragmentVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ConsiderIgnoreFragment element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ConsiderIgnoreFragment.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditConsiderIgnoreFragmentClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ConsiderIgnoreFragment.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveConsiderIgnoreFragmentClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ConsiderIgnoreFragment element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ConsiderIgnoreFragment.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditConsiderIgnoreFragmentCovered() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ConsiderIgnoreFragment.Properties.covered, referenceValueForCovered, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveConsiderIgnoreFragmentCovered() throws Exception {
		...
		// Change value of the covered feature of the ConsiderIgnoreFragment element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ConsiderIgnoreFragment.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditConsiderIgnoreFragmentEnclosingInteraction() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ConsiderIgnoreFragment.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveConsiderIgnoreFragmentEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the ConsiderIgnoreFragment element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ConsiderIgnoreFragment.Properties.enclosingInteraction, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditConsiderIgnoreFragmentEnclosingOperand() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ConsiderIgnoreFragment.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveConsiderIgnoreFragmentEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the ConsiderIgnoreFragment element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ConsiderIgnoreFragment.Properties.enclosingOperand, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditConsiderIgnoreFragmentInteractionOperator() throws Exception {
		...
		// Change value of the interactionOperator feature of the ConsiderIgnoreFragment element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ConsiderIgnoreFragment.Properties.interactionOperator, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
