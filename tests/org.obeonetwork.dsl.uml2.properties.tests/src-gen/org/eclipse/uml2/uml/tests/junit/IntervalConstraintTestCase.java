 ...
 */
public class IntervalConstraintTestCase extends SWTBotEEFTestCase {
	...
	public void testEditIntervalConstraintName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the IntervalConstraint element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), intervalConstraintMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(intervalConstraintMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, intervalConstraintMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the IntervalConstraint element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.IntervalConstraint.Properties.name, UPDATED_VALUE);
	...
	public void testEditIntervalConstraintVisibility() throws Exception {
		...
		// Change value of the visibility feature of the IntervalConstraint element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.IntervalConstraint.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditIntervalConstraintClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.IntervalConstraint.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveIntervalConstraintClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the IntervalConstraint element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.IntervalConstraint.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditIntervalConstraintOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.IntervalConstraint.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveIntervalConstraintOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the IntervalConstraint element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.IntervalConstraint.Properties.owningTemplateParameter);
	...
	public void testEditIntervalConstraintTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.IntervalConstraint.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveIntervalConstraintTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the IntervalConstraint element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.IntervalConstraint.Properties.templateParameter);
