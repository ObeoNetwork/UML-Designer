...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.InputPin;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for InputPin
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class InputPinPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditInputPinName() throws Exception {
		...
		// Open the EEF properties view to edit the InputPin element
		...
		// Change value of the name feature of the InputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InputPin.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinVisibility() throws Exception {
		...
		// Change value of the visibility feature of the InputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InputPin.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InputPin.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInputPinClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the InputPin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InputPin.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the InputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InputPin.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InputPin.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInputPinInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the InputPin element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InputPin.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InputPin.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInputPinActivity() throws Exception {
		...
		// Change value of the activity feature of the InputPin element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InputPin.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InputPin.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInputPinInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the InputPin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InputPin.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InputPin.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInputPinInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the InputPin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InputPin.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinOrdering() throws Exception {
		...
		// Change value of the ordering feature of the InputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InputPin.Properties.ordering, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinIsControlType() throws Exception {
		...
		// Change value of the isControlType feature of the InputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InputPin.Properties.isControlType, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinInState() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InputPin.Properties.inState, referenceValueForInState, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInputPinInState() throws Exception {
		...
		// Change value of the inState feature of the InputPin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InputPin.Properties.inState, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinIsOrdered() throws Exception {
		...
		// Change value of the isOrdered feature of the InputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InputPin.Properties.isOrdered, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinIsUnique() throws Exception {
		...
		// Change value of the isUnique feature of the InputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InputPin.Properties.isUnique, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInputPinIsControl() throws Exception {
		...
		// Change value of the isControl feature of the InputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InputPin.Properties.isControl, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
