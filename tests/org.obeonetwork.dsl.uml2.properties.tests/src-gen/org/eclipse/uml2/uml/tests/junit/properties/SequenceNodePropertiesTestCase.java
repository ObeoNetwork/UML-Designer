...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.SequenceNode;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for SequenceNode
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class SequenceNodePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditSequenceNodeName() throws Exception {
		...
		// Open the EEF properties view to edit the SequenceNode element
		...
		// Change value of the name feature of the SequenceNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.SequenceNode.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSequenceNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the SequenceNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.SequenceNode.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSequenceNodeClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SequenceNode.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSequenceNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the SequenceNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SequenceNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSequenceNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the SequenceNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.SequenceNode.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSequenceNodeInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SequenceNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSequenceNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the SequenceNode element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SequenceNode.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSequenceNodeActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SequenceNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSequenceNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the SequenceNode element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SequenceNode.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSequenceNodeInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SequenceNode.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSequenceNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the SequenceNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SequenceNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSequenceNodeInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SequenceNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSequenceNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the SequenceNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SequenceNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSequenceNodeInActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SequenceNode.Properties.inActivity, allInstancesOf.indexOf(referenceValueForInActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSequenceNodeInActivity() throws Exception {
		...
		// Change value of the inActivity feature of the SequenceNode element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SequenceNode.Properties.inActivity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSequenceNodeMustIsolate() throws Exception {
		...
		// Change value of the mustIsolate feature of the SequenceNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.SequenceNode.Properties.mustIsolate, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
