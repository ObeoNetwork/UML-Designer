...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.TemplateSignature;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for TemplateSignature
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class TemplateSignaturePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditTemplateSignatureParameter() throws Exception {
		...
		// Open the EEF properties view to edit the TemplateSignature element
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.TemplateSignature.Properties.parameter, referenceValueForParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTemplateSignatureParameter() throws Exception {
		...
		// Change value of the parameter feature of the TemplateSignature element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.TemplateSignature.Properties.parameter, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
