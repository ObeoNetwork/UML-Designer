...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ConnectionPointReference;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ConnectionPointReference
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ConnectionPointReferencePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditConnectionPointReferenceName() throws Exception {
		...
		// Open the EEF properties view to edit the ConnectionPointReference element
		...
		// Change value of the name feature of the ConnectionPointReference element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ConnectionPointReference.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditConnectionPointReferenceVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ConnectionPointReference element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ConnectionPointReference.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditConnectionPointReferenceClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ConnectionPointReference.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveConnectionPointReferenceClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ConnectionPointReference element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ConnectionPointReference.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditConnectionPointReferenceContainer() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ConnectionPointReference.Properties.container, allInstancesOf.indexOf(referenceValueForContainer)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveConnectionPointReferenceContainer() throws Exception {
		...
		// Change value of the container feature of the ConnectionPointReference element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ConnectionPointReference.Properties.container, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditConnectionPointReferenceEntry() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ConnectionPointReference.Properties.entry, referenceValueForEntry, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveConnectionPointReferenceEntry() throws Exception {
		...
		// Change value of the entry feature of the ConnectionPointReference element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ConnectionPointReference.Properties.entry, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditConnectionPointReferenceExit() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ConnectionPointReference.Properties.exit, referenceValueForExit, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveConnectionPointReferenceExit() throws Exception {
		...
		// Change value of the exit feature of the ConnectionPointReference element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ConnectionPointReference.Properties.exit, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditConnectionPointReferenceState() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ConnectionPointReference.Properties.state, allInstancesOf.indexOf(referenceValueForState)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveConnectionPointReferenceState() throws Exception {
		...
		// Change value of the state feature of the ConnectionPointReference element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ConnectionPointReference.Properties.state, bot.selectNode(modelEditor, firstInstanceOf));
