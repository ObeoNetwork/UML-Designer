...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.CollaborationUse;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for CollaborationUse
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class CollaborationUsePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditCollaborationUseName() throws Exception {
		...
		// Open the EEF properties view to edit the CollaborationUse element
		...
		// Change value of the name feature of the CollaborationUse element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CollaborationUse.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCollaborationUseVisibility() throws Exception {
		...
		// Change value of the visibility feature of the CollaborationUse element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CollaborationUse.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCollaborationUseClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CollaborationUse.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCollaborationUseClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the CollaborationUse element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CollaborationUse.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCollaborationUseType() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CollaborationUse.Properties.type, allInstancesOf.indexOf(referenceValueForType), bot.selectNode(modelEditor, firstInstanceOf));
