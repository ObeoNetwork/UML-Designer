...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.MergeNode;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for MergeNode
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class MergeNodeTestCase extends SWTBotEEFTestCase {
	...
	public void testEditMergeNodeName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the MergeNode element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), mergeNodeMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(mergeNodeMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, mergeNodeMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the MergeNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.name, UPDATED_VALUE);
	...
	public void testEditMergeNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the MergeNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditMergeNodeClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveMergeNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the MergeNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditMergeNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the MergeNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditMergeNodeInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveMergeNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the MergeNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.inStructuredNode);
	...
	public void testEditMergeNodeActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveMergeNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the MergeNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.activity);
	...
	public void testEditMergeNodeInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveMergeNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the MergeNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditMergeNodeInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveMergeNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the MergeNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.MergeNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
