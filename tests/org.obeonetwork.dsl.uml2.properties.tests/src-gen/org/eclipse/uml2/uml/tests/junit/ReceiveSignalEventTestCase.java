...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ReceiveSignalEvent;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ReceiveSignalEvent
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ReceiveSignalEventTestCase extends SWTBotEEFTestCase {
	...
	public void testEditReceiveSignalEventName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ReceiveSignalEvent element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), receiveSignalEventMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(receiveSignalEventMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, receiveSignalEventMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ReceiveSignalEvent element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReceiveSignalEvent.Properties.name, UPDATED_VALUE);
	...
	public void testEditReceiveSignalEventVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ReceiveSignalEvent element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReceiveSignalEvent.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditReceiveSignalEventClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReceiveSignalEvent.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveReceiveSignalEventClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ReceiveSignalEvent element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReceiveSignalEvent.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditReceiveSignalEventOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReceiveSignalEvent.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveReceiveSignalEventOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the ReceiveSignalEvent element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReceiveSignalEvent.Properties.owningTemplateParameter);
	...
	public void testEditReceiveSignalEventTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReceiveSignalEvent.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveReceiveSignalEventTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the ReceiveSignalEvent element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReceiveSignalEvent.Properties.templateParameter);
	...
	public void testEditReceiveSignalEventSignal() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReceiveSignalEvent.Properties.signal, allInstancesOf.indexOf(referenceValueForSignal));
