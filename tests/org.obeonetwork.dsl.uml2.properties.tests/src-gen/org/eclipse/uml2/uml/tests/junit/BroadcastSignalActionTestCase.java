...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.BroadcastSignalAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for BroadcastSignalAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class BroadcastSignalActionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditBroadcastSignalActionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the BroadcastSignalAction element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), broadcastSignalActionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(broadcastSignalActionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, broadcastSignalActionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the BroadcastSignalAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.name, UPDATED_VALUE);
	...
	public void testEditBroadcastSignalActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the BroadcastSignalAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditBroadcastSignalActionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveBroadcastSignalActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the BroadcastSignalAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditBroadcastSignalActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the BroadcastSignalAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditBroadcastSignalActionInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveBroadcastSignalActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the BroadcastSignalAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.inStructuredNode);
	...
	public void testEditBroadcastSignalActionActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveBroadcastSignalActionActivity() throws Exception {
		...
		// Change value of the activity feature of the BroadcastSignalAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.activity);
	...
	public void testEditBroadcastSignalActionInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveBroadcastSignalActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the BroadcastSignalAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditBroadcastSignalActionInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveBroadcastSignalActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the BroadcastSignalAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditBroadcastSignalActionOnPort() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.onPort, allInstancesOf.indexOf(referenceValueForOnPort)+1);
	...
	public void testRemoveBroadcastSignalActionOnPort() throws Exception {
		...
		// Change value of the onPort feature of the BroadcastSignalAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.onPort);
	...
	public void testEditBroadcastSignalActionSignal() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.BroadcastSignalAction.Properties.signal, allInstancesOf.indexOf(referenceValueForSignal));
