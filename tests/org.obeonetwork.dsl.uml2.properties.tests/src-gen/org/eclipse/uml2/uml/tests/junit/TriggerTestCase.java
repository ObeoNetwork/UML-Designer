...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.Trigger;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for Trigger
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class TriggerTestCase extends SWTBotEEFTestCase {
	...
	public void testEditTriggerName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Trigger element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), triggerMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(triggerMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, triggerMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Trigger element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Trigger.Properties.name, UPDATED_VALUE);
	...
	public void testEditTriggerVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Trigger element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Trigger.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditTriggerClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Trigger.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveTriggerClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Trigger element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Trigger.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditTriggerPort() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Trigger.Properties.port, referenceValueForPort);
	...
	public void testRemoveTriggerPort() throws Exception {
		...
		// Change value of the port feature of the Trigger element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Trigger.Properties.port, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
