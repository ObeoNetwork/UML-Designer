...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ProtocolStateMachine;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ProtocolStateMachine
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ProtocolStateMachinePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditProtocolStateMachineName() throws Exception {
		...
		// Open the EEF properties view to edit the ProtocolStateMachine element
		...
		// Change value of the name feature of the ProtocolStateMachine element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachineVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ProtocolStateMachine element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachineClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolStateMachineClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ProtocolStateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachineIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ProtocolStateMachine element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachineOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolStateMachineOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the ProtocolStateMachine element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachineTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolStateMachineTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the ProtocolStateMachine element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachineIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the ProtocolStateMachine element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.isAbstract, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachinePowertypeExtent() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.powertypeExtent, referenceValueForPowertypeExtent, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolStateMachinePowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the ProtocolStateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachineRepresentation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolStateMachineRepresentation() throws Exception {
		...
		// Change value of the representation feature of the ProtocolStateMachine element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.representation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachineUseCase() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.useCase, referenceValueForUseCase, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolStateMachineUseCase() throws Exception {
		...
		// Change value of the useCase feature of the ProtocolStateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachineIsActive() throws Exception {
		...
		// Change value of the isActive feature of the ProtocolStateMachine element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.isActive, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachineIsReentrant() throws Exception {
		...
		// Change value of the isReentrant feature of the ProtocolStateMachine element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.isReentrant, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachinePrecondition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.precondition, referenceValueForPrecondition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolStateMachinePrecondition() throws Exception {
		...
		// Change value of the precondition feature of the ProtocolStateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.precondition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachinePostcondition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.postcondition, referenceValueForPostcondition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolStateMachinePostcondition() throws Exception {
		...
		// Change value of the postcondition feature of the ProtocolStateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.postcondition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachineSubmachineState() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.submachineState, referenceValueForSubmachineState, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolStateMachineSubmachineState() throws Exception {
		...
		// Change value of the submachineState feature of the ProtocolStateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.submachineState, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolStateMachineExtendedStateMachine() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.extendedStateMachine, referenceValueForExtendedStateMachine, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolStateMachineExtendedStateMachine() throws Exception {
		...
		// Change value of the extendedStateMachine feature of the ProtocolStateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolStateMachine.Properties.extendedStateMachine, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
