...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.Lifeline;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for Lifeline
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class LifelinePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditLifelineName() throws Exception {
		...
		// Open the EEF properties view to edit the Lifeline element
		...
		// Change value of the name feature of the Lifeline element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Lifeline.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLifelineVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Lifeline element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Lifeline.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLifelineClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Lifeline.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLifelineClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Lifeline element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Lifeline.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLifelineInteraction() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Lifeline.Properties.interaction, allInstancesOf.indexOf(referenceValueForInteraction), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLifelineDecomposedAs() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Lifeline.Properties.decomposedAs, allInstancesOf.indexOf(referenceValueForDecomposedAs)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLifelineDecomposedAs() throws Exception {
		...
		// Change value of the decomposedAs feature of the Lifeline element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Lifeline.Properties.decomposedAs, bot.selectNode(modelEditor, firstInstanceOf));
