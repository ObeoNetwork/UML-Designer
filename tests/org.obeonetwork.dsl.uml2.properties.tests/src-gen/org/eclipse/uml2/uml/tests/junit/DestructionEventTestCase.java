...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.DestructionEvent;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for DestructionEvent
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class DestructionEventTestCase extends SWTBotEEFTestCase {
	...
	public void testEditDestructionEventName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the DestructionEvent element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), destructionEventMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(destructionEventMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, destructionEventMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the DestructionEvent element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DestructionEvent.Properties.name, UPDATED_VALUE);
	...
	public void testEditDestructionEventVisibility() throws Exception {
		...
		// Change value of the visibility feature of the DestructionEvent element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DestructionEvent.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditDestructionEventClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DestructionEvent.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveDestructionEventClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the DestructionEvent element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DestructionEvent.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditDestructionEventOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DestructionEvent.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveDestructionEventOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the DestructionEvent element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DestructionEvent.Properties.owningTemplateParameter);
	...
	public void testEditDestructionEventTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DestructionEvent.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveDestructionEventTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the DestructionEvent element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DestructionEvent.Properties.templateParameter);
