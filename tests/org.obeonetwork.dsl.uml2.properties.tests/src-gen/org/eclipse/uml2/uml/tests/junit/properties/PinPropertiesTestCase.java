...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.Pin;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for Pin
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class PinPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditPinName() throws Exception {
		...
		// Open the EEF properties view to edit the Pin element
		...
		// Change value of the name feature of the Pin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Pin.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Pin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Pin.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Pin.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePinClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Pin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Pin.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Pin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Pin.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Pin.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePinInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the Pin element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Pin.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Pin.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePinActivity() throws Exception {
		...
		// Change value of the activity feature of the Pin element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Pin.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Pin.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePinInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the Pin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Pin.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Pin.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePinInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the Pin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Pin.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinOrdering() throws Exception {
		...
		// Change value of the ordering feature of the Pin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Pin.Properties.ordering, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinIsControlType() throws Exception {
		...
		// Change value of the isControlType feature of the Pin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Pin.Properties.isControlType, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinInState() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Pin.Properties.inState, referenceValueForInState, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePinInState() throws Exception {
		...
		// Change value of the inState feature of the Pin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Pin.Properties.inState, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinIsOrdered() throws Exception {
		...
		// Change value of the isOrdered feature of the Pin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Pin.Properties.isOrdered, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinIsUnique() throws Exception {
		...
		// Change value of the isUnique feature of the Pin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Pin.Properties.isUnique, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPinIsControl() throws Exception {
		...
		// Change value of the isControl feature of the Pin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Pin.Properties.isControl, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
