...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ControlFlow;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ControlFlow
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ControlFlowTestCase extends SWTBotEEFTestCase {
	...
	public void testEditControlFlowName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ControlFlow element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), controlFlowMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(controlFlowMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, controlFlowMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ControlFlow element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.name, UPDATED_VALUE);
	...
	public void testEditControlFlowVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ControlFlow element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditControlFlowClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveControlFlowClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ControlFlow element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditControlFlowIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ControlFlow element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditControlFlowInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveControlFlowInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ControlFlow element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditControlFlowInterrupts() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.interrupts, allInstancesOf.indexOf(referenceValueForInterrupts)+1);
	...
	public void testRemoveControlFlowInterrupts() throws Exception {
		...
		// Change value of the interrupts feature of the ControlFlow element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.interrupts);
	...
	public void testEditControlFlowInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveControlFlowInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ControlFlow element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.inStructuredNode);
	...
	public void testEditControlFlowActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveControlFlowActivity() throws Exception {
		...
		// Change value of the activity feature of the ControlFlow element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ControlFlow.Properties.activity);
