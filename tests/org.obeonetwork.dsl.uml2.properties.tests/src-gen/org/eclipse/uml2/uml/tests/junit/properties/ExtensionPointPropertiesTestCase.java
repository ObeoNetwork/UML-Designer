 ...
 */
public class ExtensionPointPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditExtensionPointName() throws Exception {
		...
		// Open the EEF properties view to edit the ExtensionPoint element
		...
		// Change value of the name feature of the ExtensionPoint element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionPoint.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionPointVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ExtensionPoint element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionPoint.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionPointClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExtensionPoint.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionPointClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ExtensionPoint element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExtensionPoint.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionPointIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ExtensionPoint element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExtensionPoint.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionPointUseCase() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExtensionPoint.Properties.useCase, allInstancesOf.indexOf(referenceValueForUseCase), bot.selectNode(modelEditor, firstInstanceOf));
