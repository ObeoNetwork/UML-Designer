 ...
 */
public class StateMachinePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditStateMachineName() throws Exception {
		...
		// Open the EEF properties view to edit the StateMachine element
		...
		// Change value of the name feature of the StateMachine element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.StateMachine.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachineVisibility() throws Exception {
		...
		// Change value of the visibility feature of the StateMachine element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.StateMachine.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachineClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateMachineClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the StateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachineIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the StateMachine element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.StateMachine.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachineOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateMachineOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the StateMachine element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachineTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateMachineTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the StateMachine element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachineIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the StateMachine element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.StateMachine.Properties.isAbstract, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachinePowertypeExtent() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.powertypeExtent, referenceValueForPowertypeExtent, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateMachinePowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the StateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachineRepresentation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateMachineRepresentation() throws Exception {
		...
		// Change value of the representation feature of the StateMachine element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.representation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachineUseCase() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.useCase, referenceValueForUseCase, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateMachineUseCase() throws Exception {
		...
		// Change value of the useCase feature of the StateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachineIsActive() throws Exception {
		...
		// Change value of the isActive feature of the StateMachine element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.StateMachine.Properties.isActive, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachineIsReentrant() throws Exception {
		...
		// Change value of the isReentrant feature of the StateMachine element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.StateMachine.Properties.isReentrant, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachinePrecondition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.precondition, referenceValueForPrecondition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateMachinePrecondition() throws Exception {
		...
		// Change value of the precondition feature of the StateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.precondition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachinePostcondition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.postcondition, referenceValueForPostcondition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateMachinePostcondition() throws Exception {
		...
		// Change value of the postcondition feature of the StateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.postcondition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachineSubmachineState() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.submachineState, referenceValueForSubmachineState, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateMachineSubmachineState() throws Exception {
		...
		// Change value of the submachineState feature of the StateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.submachineState, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateMachineExtendedStateMachine() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.extendedStateMachine, referenceValueForExtendedStateMachine, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateMachineExtendedStateMachine() throws Exception {
		...
		// Change value of the extendedStateMachine feature of the StateMachine element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.StateMachine.Properties.extendedStateMachine, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
