 ...
 */
public class StatePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditStateName() throws Exception {
		...
		// Open the EEF properties view to edit the State element
		...
		// Change value of the name feature of the State element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.State.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateVisibility() throws Exception {
		...
		// Change value of the visibility feature of the State element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.State.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.State.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the State element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.State.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the State element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.State.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateContainer() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.State.Properties.container, allInstancesOf.indexOf(referenceValueForContainer)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateContainer() throws Exception {
		...
		// Change value of the container feature of the State element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.State.Properties.container, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateSubmachine() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.State.Properties.submachine, allInstancesOf.indexOf(referenceValueForSubmachine)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateSubmachine() throws Exception {
		...
		// Change value of the submachine feature of the State element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.State.Properties.submachine, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditStateRedefinedState() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.State.Properties.redefinedState, allInstancesOf.indexOf(referenceValueForRedefinedState)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveStateRedefinedState() throws Exception {
		...
		// Change value of the redefinedState feature of the State element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.State.Properties.redefinedState, bot.selectNode(modelEditor, firstInstanceOf));
