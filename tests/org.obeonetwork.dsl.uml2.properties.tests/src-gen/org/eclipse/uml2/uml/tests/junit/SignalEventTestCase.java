 ...
 */
public class SignalEventTestCase extends SWTBotEEFTestCase {
	...
	public void testEditSignalEventName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the SignalEvent element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), signalEventMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(signalEventMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, signalEventMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the SignalEvent element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.SignalEvent.Properties.name, UPDATED_VALUE);
	...
	public void testEditSignalEventVisibility() throws Exception {
		...
		// Change value of the visibility feature of the SignalEvent element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.SignalEvent.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditSignalEventClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.SignalEvent.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveSignalEventClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the SignalEvent element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.SignalEvent.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditSignalEventOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.SignalEvent.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveSignalEventOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the SignalEvent element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.SignalEvent.Properties.owningTemplateParameter);
	...
	public void testEditSignalEventTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.SignalEvent.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveSignalEventTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the SignalEvent element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.SignalEvent.Properties.templateParameter);
	...
	public void testEditSignalEventSignal() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.SignalEvent.Properties.signal, allInstancesOf.indexOf(referenceValueForSignal));
