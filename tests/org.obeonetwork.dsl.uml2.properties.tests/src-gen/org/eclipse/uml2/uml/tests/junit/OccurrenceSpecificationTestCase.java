 ...
 */
public class OccurrenceSpecificationTestCase extends SWTBotEEFTestCase {
	...
	public void testEditOccurrenceSpecificationName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the OccurrenceSpecification element
		...
		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, occurrenceSpecificationMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the OccurrenceSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.name, UPDATED_VALUE);
	...
	public void testEditOccurrenceSpecificationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the OccurrenceSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditOccurrenceSpecificationClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveOccurrenceSpecificationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the OccurrenceSpecification element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditOccurrenceSpecificationCovered() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.covered, referenceValueForCovered);
	...
	public void testRemoveOccurrenceSpecificationCovered() throws Exception {
		...
		// Change value of the covered feature of the OccurrenceSpecification element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditOccurrenceSpecificationEnclosingInteraction() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1);
	...
	public void testRemoveOccurrenceSpecificationEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the OccurrenceSpecification element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.enclosingInteraction);
	...
	public void testEditOccurrenceSpecificationEnclosingOperand() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1);
	...
	public void testRemoveOccurrenceSpecificationEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the OccurrenceSpecification element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.enclosingOperand);
	...
	public void testEditOccurrenceSpecificationToBefore() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.toBefore, referenceValueForToBefore);
	...
	public void testRemoveOccurrenceSpecificationToBefore() throws Exception {
		...
		// Change value of the toBefore feature of the OccurrenceSpecification element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.toBefore, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditOccurrenceSpecificationToAfter() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.toAfter, referenceValueForToAfter);
	...
	public void testRemoveOccurrenceSpecificationToAfter() throws Exception {
		...
		// Change value of the toAfter feature of the OccurrenceSpecification element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OccurrenceSpecification.Properties.toAfter, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
