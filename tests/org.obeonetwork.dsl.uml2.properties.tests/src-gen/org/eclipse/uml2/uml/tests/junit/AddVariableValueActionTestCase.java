 ...
 */
public class AddVariableValueActionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditAddVariableValueActionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the AddVariableValueAction element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), addVariableValueActionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(addVariableValueActionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, addVariableValueActionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the AddVariableValueAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.name, UPDATED_VALUE);
	...
	public void testEditAddVariableValueActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the AddVariableValueAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditAddVariableValueActionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveAddVariableValueActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the AddVariableValueAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAddVariableValueActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the AddVariableValueAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditAddVariableValueActionInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveAddVariableValueActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the AddVariableValueAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.inStructuredNode);
	...
	public void testEditAddVariableValueActionActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveAddVariableValueActionActivity() throws Exception {
		...
		// Change value of the activity feature of the AddVariableValueAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.activity);
	...
	public void testEditAddVariableValueActionInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveAddVariableValueActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the AddVariableValueAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAddVariableValueActionInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveAddVariableValueActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the AddVariableValueAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditAddVariableValueActionVariable() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.variable, allInstancesOf.indexOf(referenceValueForVariable));
	...
	public void testEditAddVariableValueActionIsReplaceAll() throws Exception {
		...
		// Change value of the isReplaceAll feature of the AddVariableValueAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.AddVariableValueAction.Properties.isReplaceAll, UPDATED_VALUE);
