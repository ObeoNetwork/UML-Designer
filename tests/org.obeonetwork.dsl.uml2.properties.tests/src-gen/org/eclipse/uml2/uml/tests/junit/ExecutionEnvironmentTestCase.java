 ...
 */
public class ExecutionEnvironmentTestCase extends SWTBotEEFTestCase {
	...
	public void testEditExecutionEnvironmentName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ExecutionEnvironment element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), executionEnvironmentMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(executionEnvironmentMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, executionEnvironmentMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ExecutionEnvironment element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.name, UPDATED_VALUE);
	...
	public void testEditExecutionEnvironmentVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ExecutionEnvironment element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditExecutionEnvironmentClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveExecutionEnvironmentClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ExecutionEnvironment element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditExecutionEnvironmentIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ExecutionEnvironment element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditExecutionEnvironmentOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveExecutionEnvironmentOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the ExecutionEnvironment element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.owningTemplateParameter);
	...
	public void testEditExecutionEnvironmentTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveExecutionEnvironmentTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the ExecutionEnvironment element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.templateParameter);
	...
	public void testEditExecutionEnvironmentIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the ExecutionEnvironment element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.isAbstract, UPDATED_VALUE);
	...
	public void testEditExecutionEnvironmentPowertypeExtent() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.powertypeExtent, referenceValueForPowertypeExtent);
	...
	public void testRemoveExecutionEnvironmentPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the ExecutionEnvironment element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditExecutionEnvironmentRepresentation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1);
	...
	public void testRemoveExecutionEnvironmentRepresentation() throws Exception {
		...
		// Change value of the representation feature of the ExecutionEnvironment element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.representation);
	...
	public void testEditExecutionEnvironmentUseCase() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.useCase, referenceValueForUseCase);
	...
	public void testRemoveExecutionEnvironmentUseCase() throws Exception {
		...
		// Change value of the useCase feature of the ExecutionEnvironment element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditExecutionEnvironmentIsActive() throws Exception {
		...
		// Change value of the isActive feature of the ExecutionEnvironment element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ExecutionEnvironment.Properties.isActive, UPDATED_VALUE);
