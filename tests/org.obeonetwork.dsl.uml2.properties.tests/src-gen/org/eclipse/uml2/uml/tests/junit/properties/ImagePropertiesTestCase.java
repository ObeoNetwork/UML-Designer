 ...
 */
public class ImagePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditImageContent() throws Exception {
		...
		// Open the EEF properties view to edit the Image element
		...
		// Change value of the content feature of the Image element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Image.Properties.content, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditImageLocation() throws Exception {
		...
		// Change value of the location feature of the Image element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Image.Properties.location, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditImageFormat() throws Exception {
		...
		// Change value of the format feature of the Image element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Image.Properties.format, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
