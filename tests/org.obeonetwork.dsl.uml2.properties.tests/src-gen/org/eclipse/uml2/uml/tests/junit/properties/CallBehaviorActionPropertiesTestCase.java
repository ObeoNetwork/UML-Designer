...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.CallBehaviorAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for CallBehaviorAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class CallBehaviorActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditCallBehaviorActionName() throws Exception {
		...
		// Open the EEF properties view to edit the CallBehaviorAction element
		...
		// Change value of the name feature of the CallBehaviorAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallBehaviorActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the CallBehaviorAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallBehaviorActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCallBehaviorActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the CallBehaviorAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallBehaviorActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the CallBehaviorAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallBehaviorActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCallBehaviorActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the CallBehaviorAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallBehaviorActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCallBehaviorActionActivity() throws Exception {
		...
		// Change value of the activity feature of the CallBehaviorAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallBehaviorActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCallBehaviorActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the CallBehaviorAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallBehaviorActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCallBehaviorActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the CallBehaviorAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallBehaviorActionOnPort() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.onPort, allInstancesOf.indexOf(referenceValueForOnPort)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCallBehaviorActionOnPort() throws Exception {
		...
		// Change value of the onPort feature of the CallBehaviorAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.onPort, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallBehaviorActionIsSynchronous() throws Exception {
		...
		// Change value of the isSynchronous feature of the CallBehaviorAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CallBehaviorAction.Properties.isSynchronous, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
