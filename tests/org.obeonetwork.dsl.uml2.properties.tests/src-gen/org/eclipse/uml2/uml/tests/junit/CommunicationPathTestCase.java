...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.CommunicationPath;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for CommunicationPath
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class CommunicationPathTestCase extends SWTBotEEFTestCase {
	...
	public void testEditCommunicationPathName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the CommunicationPath element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), communicationPathMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(communicationPathMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, communicationPathMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the CommunicationPath element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.name, UPDATED_VALUE);
	...
	public void testEditCommunicationPathVisibility() throws Exception {
		...
		// Change value of the visibility feature of the CommunicationPath element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditCommunicationPathClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveCommunicationPathClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the CommunicationPath element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditCommunicationPathIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the CommunicationPath element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditCommunicationPathOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveCommunicationPathOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the CommunicationPath element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.owningTemplateParameter);
	...
	public void testEditCommunicationPathTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveCommunicationPathTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the CommunicationPath element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.templateParameter);
	...
	public void testEditCommunicationPathIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the CommunicationPath element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.isAbstract, UPDATED_VALUE);
	...
	public void testEditCommunicationPathPowertypeExtent() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.powertypeExtent, referenceValueForPowertypeExtent);
	...
	public void testRemoveCommunicationPathPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the CommunicationPath element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditCommunicationPathRepresentation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1);
	...
	public void testRemoveCommunicationPathRepresentation() throws Exception {
		...
		// Change value of the representation feature of the CommunicationPath element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.representation);
	...
	public void testEditCommunicationPathUseCase() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.useCase, referenceValueForUseCase);
	...
	public void testRemoveCommunicationPathUseCase() throws Exception {
		...
		// Change value of the useCase feature of the CommunicationPath element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditCommunicationPathMemberEnd() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.memberEnd, referenceValueForMemberEnd);
	...
	public void testRemoveCommunicationPathMemberEnd() throws Exception {
		...
		// Change value of the memberEnd feature of the CommunicationPath element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.memberEnd, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditCommunicationPathIsDerived() throws Exception {
		...
		// Change value of the isDerived feature of the CommunicationPath element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.isDerived, UPDATED_VALUE);
	...
	public void testEditCommunicationPathNavigableOwnedEnd() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.navigableOwnedEnd, referenceValueForNavigableOwnedEnd);
	...
	public void testRemoveCommunicationPathNavigableOwnedEnd() throws Exception {
		...
		// Change value of the navigableOwnedEnd feature of the CommunicationPath element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.CommunicationPath.Properties.navigableOwnedEnd, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
