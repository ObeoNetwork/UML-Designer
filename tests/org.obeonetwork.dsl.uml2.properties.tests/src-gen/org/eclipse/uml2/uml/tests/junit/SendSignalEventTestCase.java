...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.SendSignalEvent;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for SendSignalEvent
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class SendSignalEventTestCase extends SWTBotEEFTestCase {
	...
	public void testEditSendSignalEventName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the SendSignalEvent element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), sendSignalEventMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(sendSignalEventMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, sendSignalEventMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the SendSignalEvent element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.SendSignalEvent.Properties.name, UPDATED_VALUE);
	...
	public void testEditSendSignalEventVisibility() throws Exception {
		...
		// Change value of the visibility feature of the SendSignalEvent element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.SendSignalEvent.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditSendSignalEventClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.SendSignalEvent.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveSendSignalEventClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the SendSignalEvent element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.SendSignalEvent.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditSendSignalEventOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.SendSignalEvent.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveSendSignalEventOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the SendSignalEvent element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.SendSignalEvent.Properties.owningTemplateParameter);
	...
	public void testEditSendSignalEventTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.SendSignalEvent.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveSendSignalEventTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the SendSignalEvent element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.SendSignalEvent.Properties.templateParameter);
	...
	public void testEditSendSignalEventSignal() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.SendSignalEvent.Properties.signal, allInstancesOf.indexOf(referenceValueForSignal));
