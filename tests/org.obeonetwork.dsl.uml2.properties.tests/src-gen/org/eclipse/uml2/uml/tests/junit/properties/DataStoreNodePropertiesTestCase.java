 ...
 */
public class DataStoreNodePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditDataStoreNodeName() throws Exception {
		...
		// Open the EEF properties view to edit the DataStoreNode element
		...
		// Change value of the name feature of the DataStoreNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DataStoreNode.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataStoreNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the DataStoreNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DataStoreNode.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataStoreNodeClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataStoreNode.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDataStoreNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the DataStoreNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataStoreNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataStoreNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the DataStoreNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DataStoreNode.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataStoreNodeInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DataStoreNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDataStoreNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the DataStoreNode element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DataStoreNode.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataStoreNodeActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DataStoreNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDataStoreNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the DataStoreNode element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DataStoreNode.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataStoreNodeInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataStoreNode.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDataStoreNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the DataStoreNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataStoreNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataStoreNodeInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataStoreNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDataStoreNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the DataStoreNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataStoreNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataStoreNodeOrdering() throws Exception {
		...
		// Change value of the ordering feature of the DataStoreNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DataStoreNode.Properties.ordering, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataStoreNodeIsControlType() throws Exception {
		...
		// Change value of the isControlType feature of the DataStoreNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DataStoreNode.Properties.isControlType, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataStoreNodeInState() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataStoreNode.Properties.inState, referenceValueForInState, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDataStoreNodeInState() throws Exception {
		...
		// Change value of the inState feature of the DataStoreNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataStoreNode.Properties.inState, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
