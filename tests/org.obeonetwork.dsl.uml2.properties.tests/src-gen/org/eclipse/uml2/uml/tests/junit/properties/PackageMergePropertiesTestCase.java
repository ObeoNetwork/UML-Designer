...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.PackageMerge;
/**
 * TestCase for PackageMerge
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class PackageMergePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditPackageMergeMergedPackage() throws Exception {
		...
		// Open the EEF properties view to edit the PackageMerge element
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PackageMerge.Properties.mergedPackage, allInstancesOf.indexOf(referenceValueForMergedPackage), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPackageMergeReceivingPackage() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PackageMerge.Properties.receivingPackage, allInstancesOf.indexOf(referenceValueForReceivingPackage), bot.selectNode(modelEditor, firstInstanceOf));
