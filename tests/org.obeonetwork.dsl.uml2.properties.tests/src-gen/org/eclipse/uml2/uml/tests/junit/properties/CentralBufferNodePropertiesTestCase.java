...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.CentralBufferNode;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for CentralBufferNode
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class CentralBufferNodePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditCentralBufferNodeName() throws Exception {
		...
		// Open the EEF properties view to edit the CentralBufferNode element
		...
		// Change value of the name feature of the CentralBufferNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCentralBufferNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the CentralBufferNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCentralBufferNodeClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCentralBufferNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the CentralBufferNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCentralBufferNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the CentralBufferNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCentralBufferNodeInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCentralBufferNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the CentralBufferNode element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCentralBufferNodeActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCentralBufferNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the CentralBufferNode element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCentralBufferNodeInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCentralBufferNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the CentralBufferNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCentralBufferNodeInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCentralBufferNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the CentralBufferNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCentralBufferNodeOrdering() throws Exception {
		...
		// Change value of the ordering feature of the CentralBufferNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.ordering, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCentralBufferNodeIsControlType() throws Exception {
		...
		// Change value of the isControlType feature of the CentralBufferNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.isControlType, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCentralBufferNodeInState() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.inState, referenceValueForInState, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCentralBufferNodeInState() throws Exception {
		...
		// Change value of the inState feature of the CentralBufferNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CentralBufferNode.Properties.inState, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
