...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.DestroyObjectAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for DestroyObjectAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class DestroyObjectActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditDestroyObjectActionName() throws Exception {
		...
		// Open the EEF properties view to edit the DestroyObjectAction element
		...
		// Change value of the name feature of the DestroyObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDestroyObjectActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the DestroyObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDestroyObjectActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDestroyObjectActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the DestroyObjectAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDestroyObjectActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the DestroyObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDestroyObjectActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDestroyObjectActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the DestroyObjectAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDestroyObjectActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDestroyObjectActionActivity() throws Exception {
		...
		// Change value of the activity feature of the DestroyObjectAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDestroyObjectActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDestroyObjectActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the DestroyObjectAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDestroyObjectActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDestroyObjectActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the DestroyObjectAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDestroyObjectActionIsDestroyLinks() throws Exception {
		...
		// Change value of the isDestroyLinks feature of the DestroyObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.isDestroyLinks, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDestroyObjectActionIsDestroyOwnedObjects() throws Exception {
		...
		// Change value of the isDestroyOwnedObjects feature of the DestroyObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DestroyObjectAction.Properties.isDestroyOwnedObjects, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
