 ...
 */
public class ReadVariableActionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditReadVariableActionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ReadVariableAction element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), readVariableActionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(readVariableActionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, readVariableActionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ReadVariableAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.name, UPDATED_VALUE);
	...
	public void testEditReadVariableActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ReadVariableAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditReadVariableActionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveReadVariableActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ReadVariableAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditReadVariableActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ReadVariableAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditReadVariableActionInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveReadVariableActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ReadVariableAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.inStructuredNode);
	...
	public void testEditReadVariableActionActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveReadVariableActionActivity() throws Exception {
		...
		// Change value of the activity feature of the ReadVariableAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.activity);
	...
	public void testEditReadVariableActionInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveReadVariableActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ReadVariableAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditReadVariableActionInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveReadVariableActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ReadVariableAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditReadVariableActionVariable() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReadVariableAction.Properties.variable, allInstancesOf.indexOf(referenceValueForVariable));
