 ...
 */
public class ContinuationTestCase extends SWTBotEEFTestCase {
	...
	public void testEditContinuationName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Continuation element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), continuationMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(continuationMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, continuationMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Continuation element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Continuation.Properties.name, UPDATED_VALUE);
	...
	public void testEditContinuationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Continuation element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Continuation.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditContinuationClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Continuation.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveContinuationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Continuation element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Continuation.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditContinuationCovered() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Continuation.Properties.covered, referenceValueForCovered);
	...
	public void testRemoveContinuationCovered() throws Exception {
		...
		// Change value of the covered feature of the Continuation element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Continuation.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditContinuationEnclosingInteraction() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Continuation.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1);
	...
	public void testRemoveContinuationEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the Continuation element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Continuation.Properties.enclosingInteraction);
	...
	public void testEditContinuationEnclosingOperand() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Continuation.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1);
	...
	public void testRemoveContinuationEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the Continuation element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Continuation.Properties.enclosingOperand);
	...
	public void testEditContinuationSetting() throws Exception {
		...
		// Change value of the setting feature of the Continuation element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Continuation.Properties.setting, UPDATED_VALUE);
