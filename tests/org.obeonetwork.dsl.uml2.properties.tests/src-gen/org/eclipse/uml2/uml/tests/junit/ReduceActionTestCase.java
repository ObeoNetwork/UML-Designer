...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ReduceAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ReduceAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ReduceActionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditReduceActionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ReduceAction element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), reduceActionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(reduceActionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, reduceActionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ReduceAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.name, UPDATED_VALUE);
	...
	public void testEditReduceActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ReduceAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditReduceActionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveReduceActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ReduceAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditReduceActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ReduceAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditReduceActionInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveReduceActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ReduceAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.inStructuredNode);
	...
	public void testEditReduceActionActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveReduceActionActivity() throws Exception {
		...
		// Change value of the activity feature of the ReduceAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.activity);
	...
	public void testEditReduceActionInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveReduceActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ReduceAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditReduceActionInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveReduceActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ReduceAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditReduceActionIsOrdered() throws Exception {
		...
		// Change value of the isOrdered feature of the ReduceAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReduceAction.Properties.isOrdered, UPDATED_VALUE);
