 ...
 */
public class InterruptibleActivityRegionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditInterruptibleActivityRegionInActivity() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the InterruptibleActivityRegion element
		...
		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, interruptibleActivityRegionMetaClass, firstInstanceOf, null);

		// Change value of the inActivity feature of the InterruptibleActivityRegion element 
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InterruptibleActivityRegion.Properties.inActivity, allInstancesOf.indexOf(referenceValueForInActivity)+1);
	...
	public void testRemoveInterruptibleActivityRegionInActivity() throws Exception {
		...
		// Change value of the inActivity feature of the InterruptibleActivityRegion element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InterruptibleActivityRegion.Properties.inActivity);
