 ...
 */
public class TimeIntervalPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditTimeIntervalName() throws Exception {
		...
		// Open the EEF properties view to edit the TimeInterval element
		...
		// Change value of the name feature of the TimeInterval element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.TimeInterval.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeIntervalVisibility() throws Exception {
		...
		// Change value of the visibility feature of the TimeInterval element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.TimeInterval.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeIntervalClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.TimeInterval.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTimeIntervalClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the TimeInterval element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.TimeInterval.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeIntervalOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeInterval.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTimeIntervalOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the TimeInterval element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeInterval.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeIntervalTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeInterval.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTimeIntervalTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the TimeInterval element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeInterval.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
