 ...
 */
public class RealizationTestCase extends SWTBotEEFTestCase {
	...
	public void testEditRealizationName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Realization element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), realizationMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(realizationMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, realizationMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Realization element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Realization.Properties.name, UPDATED_VALUE);
	...
	public void testEditRealizationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Realization element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Realization.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditRealizationClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Realization.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveRealizationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Realization element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Realization.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditRealizationOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Realization.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveRealizationOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Realization element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Realization.Properties.owningTemplateParameter);
	...
	public void testEditRealizationTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Realization.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveRealizationTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Realization element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Realization.Properties.templateParameter);
