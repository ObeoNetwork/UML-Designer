 ...
 */
public class ExpressionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditExpressionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Expression element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), expressionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(expressionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, expressionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Expression element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Expression.Properties.name, UPDATED_VALUE);
	...
	public void testEditExpressionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Expression element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Expression.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditExpressionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Expression.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveExpressionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Expression element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Expression.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditExpressionOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Expression.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveExpressionOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Expression element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Expression.Properties.owningTemplateParameter);
	...
	public void testEditExpressionTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Expression.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveExpressionTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Expression element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Expression.Properties.templateParameter);
	...
	public void testEditExpressionSymbol() throws Exception {
		...
		// Change value of the symbol feature of the Expression element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Expression.Properties.symbol, UPDATED_VALUE);
