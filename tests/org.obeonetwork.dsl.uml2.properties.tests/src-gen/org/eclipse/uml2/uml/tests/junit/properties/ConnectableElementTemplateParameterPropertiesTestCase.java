 ...
 */
public class ConnectableElementTemplateParameterPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditConnectableElementTemplateParameterSignature() throws Exception {
		...
		// Open the EEF properties view to edit the ConnectableElementTemplateParameter element
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ConnectableElementTemplateParameter.Properties.signature, allInstancesOf.indexOf(referenceValueForSignature), bot.selectNode(modelEditor, firstInstanceOf));
