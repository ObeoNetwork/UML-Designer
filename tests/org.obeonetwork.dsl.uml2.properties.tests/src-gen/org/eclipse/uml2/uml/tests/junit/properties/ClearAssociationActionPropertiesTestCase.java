...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ClearAssociationAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ClearAssociationAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ClearAssociationActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditClearAssociationActionName() throws Exception {
		...
		// Open the EEF properties view to edit the ClearAssociationAction element
		...
		// Change value of the name feature of the ClearAssociationAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearAssociationActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ClearAssociationAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearAssociationActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveClearAssociationActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ClearAssociationAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearAssociationActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ClearAssociationAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearAssociationActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveClearAssociationActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ClearAssociationAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearAssociationActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveClearAssociationActionActivity() throws Exception {
		...
		// Change value of the activity feature of the ClearAssociationAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearAssociationActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveClearAssociationActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ClearAssociationAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearAssociationActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveClearAssociationActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ClearAssociationAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditClearAssociationActionAssociation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ClearAssociationAction.Properties.association, allInstancesOf.indexOf(referenceValueForAssociation), bot.selectNode(modelEditor, firstInstanceOf));
