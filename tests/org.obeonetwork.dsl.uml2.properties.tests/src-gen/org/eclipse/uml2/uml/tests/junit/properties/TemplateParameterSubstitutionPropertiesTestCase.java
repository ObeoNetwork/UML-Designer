...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.TemplateParameterSubstitution;
/**
 * TestCase for TemplateParameterSubstitution
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class TemplateParameterSubstitutionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditTemplateParameterSubstitutionFormal() throws Exception {
		...
		// Open the EEF properties view to edit the TemplateParameterSubstitution element
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TemplateParameterSubstitution.Properties.formal, allInstancesOf.indexOf(referenceValueForFormal), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTemplateParameterSubstitutionTemplateBinding() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TemplateParameterSubstitution.Properties.templateBinding, allInstancesOf.indexOf(referenceValueForTemplateBinding), bot.selectNode(modelEditor, firstInstanceOf));
