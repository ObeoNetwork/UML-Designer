 ...
 */
public class ArtifactPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditArtifactName() throws Exception {
		...
		// Open the EEF properties view to edit the Artifact element
		...
		// Change value of the name feature of the Artifact element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Artifact.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditArtifactVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Artifact element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Artifact.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditArtifactClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Artifact.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveArtifactClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Artifact element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Artifact.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditArtifactIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Artifact element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Artifact.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditArtifactOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Artifact.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveArtifactOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Artifact element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Artifact.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditArtifactTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Artifact.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveArtifactTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Artifact element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Artifact.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditArtifactIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the Artifact element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Artifact.Properties.isAbstract, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditArtifactPowertypeExtent() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Artifact.Properties.powertypeExtent, referenceValueForPowertypeExtent, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveArtifactPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the Artifact element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Artifact.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditArtifactRepresentation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Artifact.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveArtifactRepresentation() throws Exception {
		...
		// Change value of the representation feature of the Artifact element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Artifact.Properties.representation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditArtifactUseCase() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Artifact.Properties.useCase, referenceValueForUseCase, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveArtifactUseCase() throws Exception {
		...
		// Change value of the useCase feature of the Artifact element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Artifact.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditArtifactFileName() throws Exception {
		...
		// Change value of the fileName feature of the Artifact element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Artifact.Properties.fileName, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
