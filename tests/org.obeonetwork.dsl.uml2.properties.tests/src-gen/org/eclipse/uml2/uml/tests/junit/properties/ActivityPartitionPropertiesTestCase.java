...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ActivityPartition;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ActivityPartition
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ActivityPartitionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditActivityPartitionName() throws Exception {
		...
		// Open the EEF properties view to edit the ActivityPartition element
		...
		// Change value of the name feature of the ActivityPartition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActivityPartition.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityPartitionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ActivityPartition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActivityPartition.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityPartitionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActivityPartition.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActivityPartitionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ActivityPartition element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActivityPartition.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityPartitionInActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActivityPartition.Properties.inActivity, allInstancesOf.indexOf(referenceValueForInActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActivityPartitionInActivity() throws Exception {
		...
		// Change value of the inActivity feature of the ActivityPartition element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActivityPartition.Properties.inActivity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityPartitionIsDimension() throws Exception {
		...
		// Change value of the isDimension feature of the ActivityPartition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActivityPartition.Properties.isDimension, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityPartitionIsExternal() throws Exception {
		...
		// Change value of the isExternal feature of the ActivityPartition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActivityPartition.Properties.isExternal, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityPartitionSuperPartition() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActivityPartition.Properties.superPartition, allInstancesOf.indexOf(referenceValueForSuperPartition)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActivityPartitionSuperPartition() throws Exception {
		...
		// Change value of the superPartition feature of the ActivityPartition element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActivityPartition.Properties.superPartition, bot.selectNode(modelEditor, firstInstanceOf));
