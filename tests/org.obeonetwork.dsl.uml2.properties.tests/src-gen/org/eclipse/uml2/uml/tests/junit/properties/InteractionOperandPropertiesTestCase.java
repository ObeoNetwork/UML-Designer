...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.InteractionOperand;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for InteractionOperand
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class InteractionOperandPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditInteractionOperandName() throws Exception {
		...
		// Open the EEF properties view to edit the InteractionOperand element
		...
		// Change value of the name feature of the InteractionOperand element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InteractionOperand.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionOperandVisibility() throws Exception {
		...
		// Change value of the visibility feature of the InteractionOperand element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InteractionOperand.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionOperandClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InteractionOperand.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInteractionOperandClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the InteractionOperand element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InteractionOperand.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionOperandCovered() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InteractionOperand.Properties.covered, referenceValueForCovered, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInteractionOperandCovered() throws Exception {
		...
		// Change value of the covered feature of the InteractionOperand element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InteractionOperand.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionOperandEnclosingInteraction() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionOperand.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInteractionOperandEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the InteractionOperand element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionOperand.Properties.enclosingInteraction, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionOperandEnclosingOperand() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionOperand.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInteractionOperandEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the InteractionOperand element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionOperand.Properties.enclosingOperand, bot.selectNode(modelEditor, firstInstanceOf));
