...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.InstanceValue;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for InstanceValue
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class InstanceValuePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditInstanceValueName() throws Exception {
		...
		// Open the EEF properties view to edit the InstanceValue element
		...
		// Change value of the name feature of the InstanceValue element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InstanceValue.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInstanceValueVisibility() throws Exception {
		...
		// Change value of the visibility feature of the InstanceValue element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InstanceValue.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInstanceValueClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InstanceValue.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInstanceValueClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the InstanceValue element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InstanceValue.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInstanceValueOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InstanceValue.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInstanceValueOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the InstanceValue element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InstanceValue.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInstanceValueTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InstanceValue.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInstanceValueTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the InstanceValue element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InstanceValue.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInstanceValueInstance() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InstanceValue.Properties.instance, allInstancesOf.indexOf(referenceValueForInstance), bot.selectNode(modelEditor, firstInstanceOf));
