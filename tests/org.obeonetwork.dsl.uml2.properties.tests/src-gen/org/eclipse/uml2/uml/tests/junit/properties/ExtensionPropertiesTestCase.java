 ...
 */
public class ExtensionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditExtensionName() throws Exception {
		...
		// Open the EEF properties view to edit the Extension element
		...
		// Change value of the name feature of the Extension element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Extension.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Extension element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Extension.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Extension.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Extension element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Extension.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Extension element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Extension.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Extension.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Extension element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Extension.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Extension.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Extension element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Extension.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the Extension element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Extension.Properties.isAbstract, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionPowertypeExtent() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Extension.Properties.powertypeExtent, referenceValueForPowertypeExtent, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the Extension element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Extension.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionRepresentation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Extension.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionRepresentation() throws Exception {
		...
		// Change value of the representation feature of the Extension element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Extension.Properties.representation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionUseCase() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Extension.Properties.useCase, referenceValueForUseCase, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionUseCase() throws Exception {
		...
		// Change value of the useCase feature of the Extension element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Extension.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionMemberEnd() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Extension.Properties.memberEnd, referenceValueForMemberEnd, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionMemberEnd() throws Exception {
		...
		// Change value of the memberEnd feature of the Extension element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Extension.Properties.memberEnd, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionIsDerived() throws Exception {
		...
		// Change value of the isDerived feature of the Extension element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Extension.Properties.isDerived, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExtensionNavigableOwnedEnd() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Extension.Properties.navigableOwnedEnd, referenceValueForNavigableOwnedEnd, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExtensionNavigableOwnedEnd() throws Exception {
		...
		// Change value of the navigableOwnedEnd feature of the Extension element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Extension.Properties.navigableOwnedEnd, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
