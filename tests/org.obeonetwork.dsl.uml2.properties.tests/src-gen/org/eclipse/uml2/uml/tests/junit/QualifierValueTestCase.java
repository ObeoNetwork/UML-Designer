 ...
 */
public class QualifierValueTestCase extends SWTBotEEFTestCase {
	...
	public void testEditQualifierValueQualifier() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the QualifierValue element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), qualifierValueMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(qualifierValueMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, qualifierValueMetaClass, firstInstanceOf, null);

		// Change value of the qualifier feature of the QualifierValue element 
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.QualifierValue.Properties.qualifier, allInstancesOf.indexOf(referenceValueForQualifier));
	...
	public void testEditQualifierValueValue() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.QualifierValue.Properties.value, allInstancesOf.indexOf(referenceValueForValue));
