 ...
 */
public class ActivityParameterNodePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditActivityParameterNodeName() throws Exception {
		...
		// Open the EEF properties view to edit the ActivityParameterNode element
		...
		// Change value of the name feature of the ActivityParameterNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityParameterNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ActivityParameterNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityParameterNodeClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActivityParameterNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ActivityParameterNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityParameterNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ActivityParameterNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityParameterNodeInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActivityParameterNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ActivityParameterNode element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityParameterNodeActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActivityParameterNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the ActivityParameterNode element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityParameterNodeInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActivityParameterNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ActivityParameterNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityParameterNodeInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActivityParameterNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ActivityParameterNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityParameterNodeOrdering() throws Exception {
		...
		// Change value of the ordering feature of the ActivityParameterNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.ordering, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityParameterNodeIsControlType() throws Exception {
		...
		// Change value of the isControlType feature of the ActivityParameterNode element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.isControlType, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityParameterNodeInState() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.inState, referenceValueForInState, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActivityParameterNodeInState() throws Exception {
		...
		// Change value of the inState feature of the ActivityParameterNode element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.inState, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActivityParameterNodeParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActivityParameterNode.Properties.parameter, allInstancesOf.indexOf(referenceValueForParameter), bot.selectNode(modelEditor, firstInstanceOf));
