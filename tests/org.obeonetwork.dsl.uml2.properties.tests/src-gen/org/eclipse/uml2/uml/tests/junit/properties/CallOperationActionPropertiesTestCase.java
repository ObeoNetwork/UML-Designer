...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.CallOperationAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for CallOperationAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class CallOperationActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditCallOperationActionName() throws Exception {
		...
		// Open the EEF properties view to edit the CallOperationAction element
		...
		// Change value of the name feature of the CallOperationAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CallOperationAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallOperationActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the CallOperationAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CallOperationAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallOperationActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCallOperationActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the CallOperationAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallOperationActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the CallOperationAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CallOperationAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallOperationActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCallOperationActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the CallOperationAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallOperationActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCallOperationActionActivity() throws Exception {
		...
		// Change value of the activity feature of the CallOperationAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallOperationActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCallOperationActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the CallOperationAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallOperationActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCallOperationActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the CallOperationAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallOperationActionOnPort() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.onPort, allInstancesOf.indexOf(referenceValueForOnPort)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCallOperationActionOnPort() throws Exception {
		...
		// Change value of the onPort feature of the CallOperationAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.onPort, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallOperationActionIsSynchronous() throws Exception {
		...
		// Change value of the isSynchronous feature of the CallOperationAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CallOperationAction.Properties.isSynchronous, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCallOperationActionOperation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CallOperationAction.Properties.operation, allInstancesOf.indexOf(referenceValueForOperation), bot.selectNode(modelEditor, firstInstanceOf));
