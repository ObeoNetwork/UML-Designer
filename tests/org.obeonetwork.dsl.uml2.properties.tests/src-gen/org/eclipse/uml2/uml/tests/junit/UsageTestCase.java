...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.Usage;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for Usage
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class UsageTestCase extends SWTBotEEFTestCase {
	...
	public void testEditUsageName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Usage element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), usageMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(usageMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, usageMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Usage element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Usage.Properties.name, UPDATED_VALUE);
	...
	public void testEditUsageVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Usage element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Usage.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditUsageClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Usage.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveUsageClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Usage element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Usage.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditUsageOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Usage.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveUsageOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Usage element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Usage.Properties.owningTemplateParameter);
	...
	public void testEditUsageTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Usage.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveUsageTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Usage element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Usage.Properties.templateParameter);
