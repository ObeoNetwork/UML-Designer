 ...
 */
public class ProfileApplicationTestCase extends SWTBotEEFTestCase {
	...
	public void testEditProfileApplicationAppliedProfile() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ProfileApplication element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), profileApplicationMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(profileApplicationMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, profileApplicationMetaClass, firstInstanceOf, null);

		// Change value of the appliedProfile feature of the ProfileApplication element 
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ProfileApplication.Properties.appliedProfile, allInstancesOf.indexOf(referenceValueForAppliedProfile));
	...
	public void testEditProfileApplicationIsStrict() throws Exception {
		...
		// Change value of the isStrict feature of the ProfileApplication element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ProfileApplication.Properties.isStrict, UPDATED_VALUE);
	...
	public void testEditProfileApplicationApplyingPackage() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ProfileApplication.Properties.applyingPackage, allInstancesOf.indexOf(referenceValueForApplyingPackage));
