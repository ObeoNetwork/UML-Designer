 ...
 */
public class LiteralNullPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditLiteralNullName() throws Exception {
		...
		// Open the EEF properties view to edit the LiteralNull element
		...
		// Change value of the name feature of the LiteralNull element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LiteralNull.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralNullVisibility() throws Exception {
		...
		// Change value of the visibility feature of the LiteralNull element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LiteralNull.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralNullClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LiteralNull.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLiteralNullClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the LiteralNull element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LiteralNull.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralNullOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralNull.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLiteralNullOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the LiteralNull element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralNull.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralNullTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralNull.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLiteralNullTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the LiteralNull element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralNull.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
