...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.LiteralInteger;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for LiteralInteger
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class LiteralIntegerPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditLiteralIntegerName() throws Exception {
		...
		// Open the EEF properties view to edit the LiteralInteger element
		...
		// Change value of the name feature of the LiteralInteger element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LiteralInteger.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralIntegerVisibility() throws Exception {
		...
		// Change value of the visibility feature of the LiteralInteger element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LiteralInteger.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralIntegerClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LiteralInteger.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLiteralIntegerClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the LiteralInteger element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LiteralInteger.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralIntegerOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralInteger.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLiteralIntegerOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the LiteralInteger element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralInteger.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralIntegerTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralInteger.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLiteralIntegerTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the LiteralInteger element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralInteger.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralIntegerValue() throws Exception {
		...
		// Change value of the value feature of the LiteralInteger element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LiteralInteger.Properties.value, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
