 ...
 */
public class PartDecompositionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditPartDecompositionName() throws Exception {
		...
		// Open the EEF properties view to edit the PartDecomposition element
		...
		// Change value of the name feature of the PartDecomposition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.PartDecomposition.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPartDecompositionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the PartDecomposition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.PartDecomposition.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPartDecompositionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.PartDecomposition.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePartDecompositionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the PartDecomposition element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.PartDecomposition.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPartDecompositionCovered() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.PartDecomposition.Properties.covered, referenceValueForCovered, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePartDecompositionCovered() throws Exception {
		...
		// Change value of the covered feature of the PartDecomposition element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.PartDecomposition.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPartDecompositionEnclosingInteraction() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PartDecomposition.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePartDecompositionEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the PartDecomposition element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PartDecomposition.Properties.enclosingInteraction, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPartDecompositionEnclosingOperand() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PartDecomposition.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePartDecompositionEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the PartDecomposition element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PartDecomposition.Properties.enclosingOperand, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPartDecompositionRefersTo() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PartDecomposition.Properties.refersTo, allInstancesOf.indexOf(referenceValueForRefersTo), bot.selectNode(modelEditor, firstInstanceOf));
