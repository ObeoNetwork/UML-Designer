 ...
 */
public class ActionExecutionSpecificationTestCase extends SWTBotEEFTestCase {
	...
	public void testEditActionExecutionSpecificationName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ActionExecutionSpecification element
		...
		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, actionExecutionSpecificationMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ActionExecutionSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ActionExecutionSpecification.Properties.name, UPDATED_VALUE);
	...
	public void testEditActionExecutionSpecificationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ActionExecutionSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ActionExecutionSpecification.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditActionExecutionSpecificationClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ActionExecutionSpecification.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveActionExecutionSpecificationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ActionExecutionSpecification element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ActionExecutionSpecification.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditActionExecutionSpecificationCovered() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ActionExecutionSpecification.Properties.covered, referenceValueForCovered);
	...
	public void testRemoveActionExecutionSpecificationCovered() throws Exception {
		...
		// Change value of the covered feature of the ActionExecutionSpecification element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ActionExecutionSpecification.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditActionExecutionSpecificationEnclosingInteraction() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ActionExecutionSpecification.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1);
	...
	public void testRemoveActionExecutionSpecificationEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the ActionExecutionSpecification element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ActionExecutionSpecification.Properties.enclosingInteraction);
	...
	public void testEditActionExecutionSpecificationEnclosingOperand() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ActionExecutionSpecification.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1);
	...
	public void testRemoveActionExecutionSpecificationEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the ActionExecutionSpecification element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ActionExecutionSpecification.Properties.enclosingOperand);
	...
	public void testEditActionExecutionSpecificationStart() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ActionExecutionSpecification.Properties.start, allInstancesOf.indexOf(referenceValueForStart));
	...
	public void testEditActionExecutionSpecificationFinish() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ActionExecutionSpecification.Properties.finish, allInstancesOf.indexOf(referenceValueForFinish));
