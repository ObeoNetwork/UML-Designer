...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.JoinNode;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for JoinNode
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class JoinNodeTestCase extends SWTBotEEFTestCase {
	...
	public void testEditJoinNodeName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the JoinNode element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), joinNodeMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(joinNodeMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, joinNodeMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the JoinNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.name, UPDATED_VALUE);
	...
	public void testEditJoinNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the JoinNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditJoinNodeClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveJoinNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the JoinNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditJoinNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the JoinNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditJoinNodeInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveJoinNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the JoinNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.inStructuredNode);
	...
	public void testEditJoinNodeActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveJoinNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the JoinNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.activity);
	...
	public void testEditJoinNodeInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveJoinNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the JoinNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditJoinNodeInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveJoinNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the JoinNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditJoinNodeIsCombineDuplicate() throws Exception {
		...
		// Change value of the isCombineDuplicate feature of the JoinNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.JoinNode.Properties.isCombineDuplicate, UPDATED_VALUE);
