 ...
 */
public class CollaborationPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditCollaborationName() throws Exception {
		...
		// Open the EEF properties view to edit the Collaboration element
		...
		// Change value of the name feature of the Collaboration element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Collaboration.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCollaborationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Collaboration element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Collaboration.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCollaborationClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Collaboration.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCollaborationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Collaboration element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Collaboration.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCollaborationIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Collaboration element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Collaboration.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCollaborationOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Collaboration.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCollaborationOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Collaboration element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Collaboration.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCollaborationTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Collaboration.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCollaborationTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Collaboration element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Collaboration.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCollaborationIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the Collaboration element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Collaboration.Properties.isAbstract, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCollaborationPowertypeExtent() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Collaboration.Properties.powertypeExtent, referenceValueForPowertypeExtent, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCollaborationPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the Collaboration element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Collaboration.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCollaborationRepresentation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Collaboration.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCollaborationRepresentation() throws Exception {
		...
		// Change value of the representation feature of the Collaboration element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Collaboration.Properties.representation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCollaborationUseCase() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Collaboration.Properties.useCase, referenceValueForUseCase, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCollaborationUseCase() throws Exception {
		...
		// Change value of the useCase feature of the Collaboration element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Collaboration.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
