 ...
 */
public class ForkNodeTestCase extends SWTBotEEFTestCase {
	...
	public void testEditForkNodeName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ForkNode element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), forkNodeMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(forkNodeMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, forkNodeMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ForkNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.name, UPDATED_VALUE);
	...
	public void testEditForkNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ForkNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditForkNodeClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveForkNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ForkNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditForkNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ForkNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditForkNodeInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveForkNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ForkNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.inStructuredNode);
	...
	public void testEditForkNodeActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveForkNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the ForkNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.activity);
	...
	public void testEditForkNodeInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveForkNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ForkNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditForkNodeInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveForkNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ForkNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ForkNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
