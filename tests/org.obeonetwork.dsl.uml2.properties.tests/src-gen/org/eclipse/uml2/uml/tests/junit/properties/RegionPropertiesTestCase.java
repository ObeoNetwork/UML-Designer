 ...
 */
public class RegionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditRegionName() throws Exception {
		...
		// Open the EEF properties view to edit the Region element
		...
		// Change value of the name feature of the Region element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Region.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRegionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Region element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Region.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRegionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Region.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRegionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Region element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Region.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRegionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Region element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Region.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRegionState() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Region.Properties.state, allInstancesOf.indexOf(referenceValueForState)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRegionState() throws Exception {
		...
		// Change value of the state feature of the Region element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Region.Properties.state, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRegionExtendedRegion() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Region.Properties.extendedRegion, allInstancesOf.indexOf(referenceValueForExtendedRegion)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRegionExtendedRegion() throws Exception {
		...
		// Change value of the extendedRegion feature of the Region element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Region.Properties.extendedRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRegionStateMachine() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Region.Properties.stateMachine, allInstancesOf.indexOf(referenceValueForStateMachine)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRegionStateMachine() throws Exception {
		...
		// Change value of the stateMachine feature of the Region element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Region.Properties.stateMachine, bot.selectNode(modelEditor, firstInstanceOf));
