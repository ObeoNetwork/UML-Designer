 ...
 */
public class ParameterSetPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditParameterSetName() throws Exception {
		...
		// Open the EEF properties view to edit the ParameterSet element
		...
		// Change value of the name feature of the ParameterSet element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ParameterSet.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditParameterSetVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ParameterSet element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ParameterSet.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditParameterSetClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ParameterSet.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveParameterSetClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ParameterSet element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ParameterSet.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditParameterSetParameter() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ParameterSet.Properties.parameter, referenceValueForParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveParameterSetParameter() throws Exception {
		...
		// Change value of the parameter feature of the ParameterSet element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ParameterSet.Properties.parameter, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
