 ...
 */
public class LiteralStringPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditLiteralStringName() throws Exception {
		...
		// Open the EEF properties view to edit the LiteralString element
		...
		// Change value of the name feature of the LiteralString element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LiteralString.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralStringVisibility() throws Exception {
		...
		// Change value of the visibility feature of the LiteralString element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LiteralString.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralStringClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LiteralString.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLiteralStringClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the LiteralString element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LiteralString.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralStringOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralString.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLiteralStringOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the LiteralString element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralString.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralStringTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralString.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLiteralStringTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the LiteralString element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralString.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralStringValue() throws Exception {
		...
		// Change value of the value feature of the LiteralString element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LiteralString.Properties.value, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
