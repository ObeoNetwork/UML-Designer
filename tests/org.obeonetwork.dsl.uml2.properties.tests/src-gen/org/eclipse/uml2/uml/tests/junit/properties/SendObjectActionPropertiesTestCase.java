...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.SendObjectAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for SendObjectAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class SendObjectActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditSendObjectActionName() throws Exception {
		...
		// Open the EEF properties view to edit the SendObjectAction element
		...
		// Change value of the name feature of the SendObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.SendObjectAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendObjectActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the SendObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.SendObjectAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendObjectActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendObjectAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendObjectActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the SendObjectAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendObjectAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendObjectActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the SendObjectAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.SendObjectAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendObjectActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendObjectAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendObjectActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the SendObjectAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendObjectAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendObjectActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendObjectAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendObjectActionActivity() throws Exception {
		...
		// Change value of the activity feature of the SendObjectAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendObjectAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendObjectActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendObjectAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendObjectActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the SendObjectAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendObjectAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendObjectActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendObjectAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendObjectActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the SendObjectAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.SendObjectAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditSendObjectActionOnPort() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendObjectAction.Properties.onPort, allInstancesOf.indexOf(referenceValueForOnPort)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveSendObjectActionOnPort() throws Exception {
		...
		// Change value of the onPort feature of the SendObjectAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.SendObjectAction.Properties.onPort, bot.selectNode(modelEditor, firstInstanceOf));
