...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.DurationConstraint;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for DurationConstraint
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class DurationConstraintPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditDurationConstraintName() throws Exception {
		...
		// Open the EEF properties view to edit the DurationConstraint element
		...
		// Change value of the name feature of the DurationConstraint element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DurationConstraint.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDurationConstraintVisibility() throws Exception {
		...
		// Change value of the visibility feature of the DurationConstraint element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DurationConstraint.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDurationConstraintClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DurationConstraint.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDurationConstraintClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the DurationConstraint element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DurationConstraint.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDurationConstraintOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DurationConstraint.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDurationConstraintOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the DurationConstraint element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DurationConstraint.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDurationConstraintTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DurationConstraint.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDurationConstraintTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the DurationConstraint element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DurationConstraint.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDurationConstraintFirstEvent() throws Exception {
		...
		// Change value of the firstEvent feature of the DurationConstraint element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DurationConstraint.Properties.firstEvent, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
