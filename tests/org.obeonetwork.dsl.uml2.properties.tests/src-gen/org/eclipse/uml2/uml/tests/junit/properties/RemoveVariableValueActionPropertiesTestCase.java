 ...
 */
public class RemoveVariableValueActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditRemoveVariableValueActionName() throws Exception {
		...
		// Open the EEF properties view to edit the RemoveVariableValueAction element
		...
		// Change value of the name feature of the RemoveVariableValueAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRemoveVariableValueActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the RemoveVariableValueAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRemoveVariableValueActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRemoveVariableValueActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the RemoveVariableValueAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRemoveVariableValueActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the RemoveVariableValueAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRemoveVariableValueActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRemoveVariableValueActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the RemoveVariableValueAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRemoveVariableValueActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRemoveVariableValueActionActivity() throws Exception {
		...
		// Change value of the activity feature of the RemoveVariableValueAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRemoveVariableValueActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRemoveVariableValueActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the RemoveVariableValueAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRemoveVariableValueActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveRemoveVariableValueActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the RemoveVariableValueAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRemoveVariableValueActionVariable() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.variable, allInstancesOf.indexOf(referenceValueForVariable), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditRemoveVariableValueActionIsRemoveDuplicates() throws Exception {
		...
		// Change value of the isRemoveDuplicates feature of the RemoveVariableValueAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.RemoveVariableValueAction.Properties.isRemoveDuplicates, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
