...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.TestIdentityAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for TestIdentityAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class TestIdentityActionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditTestIdentityActionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the TestIdentityAction element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), testIdentityActionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(testIdentityActionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, testIdentityActionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the TestIdentityAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.name, UPDATED_VALUE);
	...
	public void testEditTestIdentityActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the TestIdentityAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditTestIdentityActionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveTestIdentityActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the TestIdentityAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditTestIdentityActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the TestIdentityAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditTestIdentityActionInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveTestIdentityActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the TestIdentityAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.inStructuredNode);
	...
	public void testEditTestIdentityActionActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveTestIdentityActionActivity() throws Exception {
		...
		// Change value of the activity feature of the TestIdentityAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.activity);
	...
	public void testEditTestIdentityActionInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveTestIdentityActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the TestIdentityAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditTestIdentityActionInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveTestIdentityActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the TestIdentityAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.TestIdentityAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
