...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.DataType;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for DataType
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class DataTypePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditDataTypeName() throws Exception {
		...
		// Open the EEF properties view to edit the DataType element
		...
		// Change value of the name feature of the DataType element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DataType.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataTypeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the DataType element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DataType.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataTypeClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataType.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDataTypeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the DataType element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataType.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataTypeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the DataType element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DataType.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataTypeOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DataType.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDataTypeOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the DataType element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DataType.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataTypeTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DataType.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDataTypeTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the DataType element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DataType.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataTypeIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the DataType element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DataType.Properties.isAbstract, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataTypePowertypeExtent() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataType.Properties.powertypeExtent, referenceValueForPowertypeExtent, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDataTypePowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the DataType element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataType.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataTypeRepresentation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DataType.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDataTypeRepresentation() throws Exception {
		...
		// Change value of the representation feature of the DataType element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DataType.Properties.representation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDataTypeUseCase() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataType.Properties.useCase, referenceValueForUseCase, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDataTypeUseCase() throws Exception {
		...
		// Change value of the useCase feature of the DataType element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DataType.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
