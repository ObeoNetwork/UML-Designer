...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.Extend;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for Extend
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ExtendTestCase extends SWTBotEEFTestCase {
	...
	public void testEditExtendName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Extend element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), extendMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(extendMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, extendMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Extend element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Extend.Properties.name, UPDATED_VALUE);
	...
	public void testEditExtendVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Extend element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Extend.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditExtendClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Extend.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveExtendClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Extend element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Extend.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditExtendExtendedCase() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Extend.Properties.extendedCase, allInstancesOf.indexOf(referenceValueForExtendedCase));
	...
	public void testEditExtendExtensionLocation() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Extend.Properties.extensionLocation, referenceValueForExtensionLocation);
	...
	public void testRemoveExtendExtensionLocation() throws Exception {
		...
		// Change value of the extensionLocation feature of the Extend element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Extend.Properties.extensionLocation, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditExtendExtension() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Extend.Properties.extension, allInstancesOf.indexOf(referenceValueForExtension));
