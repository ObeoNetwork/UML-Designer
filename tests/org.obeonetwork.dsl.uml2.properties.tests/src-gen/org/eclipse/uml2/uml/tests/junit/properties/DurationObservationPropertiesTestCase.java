 ...
 */
public class DurationObservationPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditDurationObservationName() throws Exception {
		...
		// Open the EEF properties view to edit the DurationObservation element
		...
		// Change value of the name feature of the DurationObservation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DurationObservation.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDurationObservationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the DurationObservation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DurationObservation.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDurationObservationClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DurationObservation.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDurationObservationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the DurationObservation element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.DurationObservation.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDurationObservationOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DurationObservation.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDurationObservationOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the DurationObservation element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DurationObservation.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDurationObservationTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DurationObservation.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveDurationObservationTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the DurationObservation element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.DurationObservation.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditDurationObservationFirstEvent() throws Exception {
		...
		// Change value of the firstEvent feature of the DurationObservation element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.DurationObservation.Properties.firstEvent, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
