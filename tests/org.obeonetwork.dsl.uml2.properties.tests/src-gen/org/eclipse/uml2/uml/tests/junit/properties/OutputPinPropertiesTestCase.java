 ...
 */
public class OutputPinPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditOutputPinName() throws Exception {
		...
		// Open the EEF properties view to edit the OutputPin element
		...
		// Change value of the name feature of the OutputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.OutputPin.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinVisibility() throws Exception {
		...
		// Change value of the visibility feature of the OutputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.OutputPin.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.OutputPin.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOutputPinClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the OutputPin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.OutputPin.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the OutputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.OutputPin.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.OutputPin.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOutputPinInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the OutputPin element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.OutputPin.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.OutputPin.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOutputPinActivity() throws Exception {
		...
		// Change value of the activity feature of the OutputPin element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.OutputPin.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.OutputPin.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOutputPinInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the OutputPin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.OutputPin.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.OutputPin.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOutputPinInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the OutputPin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.OutputPin.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinOrdering() throws Exception {
		...
		// Change value of the ordering feature of the OutputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.OutputPin.Properties.ordering, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinIsControlType() throws Exception {
		...
		// Change value of the isControlType feature of the OutputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.OutputPin.Properties.isControlType, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinInState() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.OutputPin.Properties.inState, referenceValueForInState, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveOutputPinInState() throws Exception {
		...
		// Change value of the inState feature of the OutputPin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.OutputPin.Properties.inState, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinIsOrdered() throws Exception {
		...
		// Change value of the isOrdered feature of the OutputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.OutputPin.Properties.isOrdered, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinIsUnique() throws Exception {
		...
		// Change value of the isUnique feature of the OutputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.OutputPin.Properties.isUnique, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditOutputPinIsControl() throws Exception {
		...
		// Change value of the isControl feature of the OutputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.OutputPin.Properties.isControl, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
