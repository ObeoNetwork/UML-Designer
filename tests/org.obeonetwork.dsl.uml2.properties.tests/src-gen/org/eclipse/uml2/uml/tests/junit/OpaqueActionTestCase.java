 ...
 */
public class OpaqueActionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditOpaqueActionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the OpaqueAction element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), opaqueActionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(opaqueActionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, opaqueActionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the OpaqueAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.name, UPDATED_VALUE);
	...
	public void testEditOpaqueActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the OpaqueAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditOpaqueActionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveOpaqueActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the OpaqueAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditOpaqueActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the OpaqueAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditOpaqueActionInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveOpaqueActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the OpaqueAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.inStructuredNode);
	...
	public void testEditOpaqueActionActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveOpaqueActionActivity() throws Exception {
		...
		// Change value of the activity feature of the OpaqueAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.activity);
	...
	public void testEditOpaqueActionInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveOpaqueActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the OpaqueAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditOpaqueActionInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveOpaqueActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the OpaqueAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditOpaqueActionBody() throws Exception {
		...
		// Change value of the body feature of the OpaqueAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.body, UPDATED_VALUE);
	...
	public void testEditOpaqueActionLanguage() throws Exception {
		...
		// Change value of the language feature of the OpaqueAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.OpaqueAction.Properties.language, UPDATED_VALUE);
