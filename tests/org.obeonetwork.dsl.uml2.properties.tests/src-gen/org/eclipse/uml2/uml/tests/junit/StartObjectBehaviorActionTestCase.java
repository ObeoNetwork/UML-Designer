 ...
 */
public class StartObjectBehaviorActionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditStartObjectBehaviorActionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the StartObjectBehaviorAction element
		...
		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, startObjectBehaviorActionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the StartObjectBehaviorAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.name, UPDATED_VALUE);
	...
	public void testEditStartObjectBehaviorActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the StartObjectBehaviorAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditStartObjectBehaviorActionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveStartObjectBehaviorActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the StartObjectBehaviorAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStartObjectBehaviorActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the StartObjectBehaviorAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditStartObjectBehaviorActionInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveStartObjectBehaviorActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the StartObjectBehaviorAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.inStructuredNode);
	...
	public void testEditStartObjectBehaviorActionActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveStartObjectBehaviorActionActivity() throws Exception {
		...
		// Change value of the activity feature of the StartObjectBehaviorAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.activity);
	...
	public void testEditStartObjectBehaviorActionInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveStartObjectBehaviorActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the StartObjectBehaviorAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStartObjectBehaviorActionInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveStartObjectBehaviorActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the StartObjectBehaviorAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStartObjectBehaviorActionOnPort() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.onPort, allInstancesOf.indexOf(referenceValueForOnPort)+1);
	...
	public void testRemoveStartObjectBehaviorActionOnPort() throws Exception {
		...
		// Change value of the onPort feature of the StartObjectBehaviorAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.onPort);
	...
	public void testEditStartObjectBehaviorActionIsSynchronous() throws Exception {
		...
		// Change value of the isSynchronous feature of the StartObjectBehaviorAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StartObjectBehaviorAction.Properties.isSynchronous, UPDATED_VALUE);
