 ...
 */
public class ExecutionOccurrenceSpecificationPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditExecutionOccurrenceSpecificationName() throws Exception {
		...
		// Open the EEF properties view to edit the ExecutionOccurrenceSpecification element
		...
		// Change value of the name feature of the ExecutionOccurrenceSpecification element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExecutionOccurrenceSpecificationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ExecutionOccurrenceSpecification element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExecutionOccurrenceSpecificationClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExecutionOccurrenceSpecificationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ExecutionOccurrenceSpecification element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExecutionOccurrenceSpecificationCovered() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.covered, referenceValueForCovered, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExecutionOccurrenceSpecificationCovered() throws Exception {
		...
		// Change value of the covered feature of the ExecutionOccurrenceSpecification element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExecutionOccurrenceSpecificationEnclosingInteraction() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExecutionOccurrenceSpecificationEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the ExecutionOccurrenceSpecification element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.enclosingInteraction, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExecutionOccurrenceSpecificationEnclosingOperand() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExecutionOccurrenceSpecificationEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the ExecutionOccurrenceSpecification element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.enclosingOperand, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExecutionOccurrenceSpecificationToBefore() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.toBefore, referenceValueForToBefore, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExecutionOccurrenceSpecificationToBefore() throws Exception {
		...
		// Change value of the toBefore feature of the ExecutionOccurrenceSpecification element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.toBefore, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditExecutionOccurrenceSpecificationToAfter() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.toAfter, referenceValueForToAfter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveExecutionOccurrenceSpecificationToAfter() throws Exception {
		...
		// Change value of the toAfter feature of the ExecutionOccurrenceSpecification element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ExecutionOccurrenceSpecification.Properties.toAfter, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
