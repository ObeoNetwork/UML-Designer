 ...
 */
public class InformationFlowTestCase extends SWTBotEEFTestCase {
	...
	public void testEditInformationFlowName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the InformationFlow element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), informationFlowMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(informationFlowMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, informationFlowMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the InformationFlow element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.InformationFlow.Properties.name, UPDATED_VALUE);
	...
	public void testEditInformationFlowVisibility() throws Exception {
		...
		// Change value of the visibility feature of the InformationFlow element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.InformationFlow.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditInformationFlowClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InformationFlow.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveInformationFlowClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the InformationFlow element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InformationFlow.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInformationFlowOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InformationFlow.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveInformationFlowOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the InformationFlow element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InformationFlow.Properties.owningTemplateParameter);
	...
	public void testEditInformationFlowTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InformationFlow.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveInformationFlowTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the InformationFlow element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.InformationFlow.Properties.templateParameter);
	...
	public void testEditInformationFlowRealizingConnector() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InformationFlow.Properties.realizingConnector, referenceValueForRealizingConnector);
	...
	public void testRemoveInformationFlowRealizingConnector() throws Exception {
		...
		// Change value of the realizingConnector feature of the InformationFlow element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InformationFlow.Properties.realizingConnector, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInformationFlowRealizingMessage() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InformationFlow.Properties.realizingMessage, referenceValueForRealizingMessage);
	...
	public void testRemoveInformationFlowRealizingMessage() throws Exception {
		...
		// Change value of the realizingMessage feature of the InformationFlow element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.InformationFlow.Properties.realizingMessage, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
