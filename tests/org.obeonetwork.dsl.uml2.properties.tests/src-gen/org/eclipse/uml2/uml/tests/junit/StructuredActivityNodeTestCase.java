...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.StructuredActivityNode;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for StructuredActivityNode
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class StructuredActivityNodeTestCase extends SWTBotEEFTestCase {
	...
	public void testEditStructuredActivityNodeName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the StructuredActivityNode element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), structuredActivityNodeMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(structuredActivityNodeMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, structuredActivityNodeMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the StructuredActivityNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.name, UPDATED_VALUE);
	...
	public void testEditStructuredActivityNodeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the StructuredActivityNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditStructuredActivityNodeClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveStructuredActivityNodeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the StructuredActivityNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStructuredActivityNodeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the StructuredActivityNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditStructuredActivityNodeInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveStructuredActivityNodeInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the StructuredActivityNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.inStructuredNode);
	...
	public void testEditStructuredActivityNodeActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveStructuredActivityNodeActivity() throws Exception {
		...
		// Change value of the activity feature of the StructuredActivityNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.activity);
	...
	public void testEditStructuredActivityNodeInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveStructuredActivityNodeInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the StructuredActivityNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStructuredActivityNodeInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveStructuredActivityNodeInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the StructuredActivityNode element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStructuredActivityNodeInActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.inActivity, allInstancesOf.indexOf(referenceValueForInActivity)+1);
	...
	public void testRemoveStructuredActivityNodeInActivity() throws Exception {
		...
		// Change value of the inActivity feature of the StructuredActivityNode element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.inActivity);
	...
	public void testEditStructuredActivityNodeMustIsolate() throws Exception {
		...
		// Change value of the mustIsolate feature of the StructuredActivityNode element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StructuredActivityNode.Properties.mustIsolate, UPDATED_VALUE);
