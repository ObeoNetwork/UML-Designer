 ...
 */
public class ValuePinTestCase extends SWTBotEEFTestCase {
	...
	public void testEditValuePinName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ValuePin element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), valuePinMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(valuePinMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, valuePinMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ValuePin element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.name, UPDATED_VALUE);
	...
	public void testEditValuePinVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ValuePin element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditValuePinClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveValuePinClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ValuePin element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditValuePinIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ValuePin element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditValuePinInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveValuePinInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ValuePin element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.inStructuredNode);
	...
	public void testEditValuePinActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveValuePinActivity() throws Exception {
		...
		// Change value of the activity feature of the ValuePin element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.activity);
	...
	public void testEditValuePinInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveValuePinInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ValuePin element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditValuePinInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveValuePinInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ValuePin element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditValuePinOrdering() throws Exception {
		...
		// Change value of the ordering feature of the ValuePin element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.ordering, UPDATED_VALUE);
	...
	public void testEditValuePinIsControlType() throws Exception {
		...
		// Change value of the isControlType feature of the ValuePin element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.isControlType, UPDATED_VALUE);
	...
	public void testEditValuePinInState() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.inState, referenceValueForInState);
	...
	public void testRemoveValuePinInState() throws Exception {
		...
		// Change value of the inState feature of the ValuePin element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.inState, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditValuePinIsOrdered() throws Exception {
		...
		// Change value of the isOrdered feature of the ValuePin element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.isOrdered, UPDATED_VALUE);
	...
	public void testEditValuePinIsUnique() throws Exception {
		...
		// Change value of the isUnique feature of the ValuePin element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.isUnique, UPDATED_VALUE);
	...
	public void testEditValuePinIsControl() throws Exception {
		...
		// Change value of the isControl feature of the ValuePin element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ValuePin.Properties.isControl, UPDATED_VALUE);
