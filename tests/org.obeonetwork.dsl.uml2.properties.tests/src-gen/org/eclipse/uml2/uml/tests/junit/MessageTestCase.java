 ...
 */
public class MessageTestCase extends SWTBotEEFTestCase {
	...
	public void testEditMessageName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Message element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), messageMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(messageMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, messageMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Message element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Message.Properties.name, UPDATED_VALUE);
	...
	public void testEditMessageVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Message element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Message.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditMessageClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Message.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveMessageClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Message element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Message.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditMessageMessageSort() throws Exception {
		...
		// Change value of the messageSort feature of the Message element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Message.Properties.messageSort, UPDATED_VALUE);
	...
	public void testEditMessageConnector() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Message.Properties.connector, allInstancesOf.indexOf(referenceValueForConnector)+1);
	...
	public void testRemoveMessageConnector() throws Exception {
		...
		// Change value of the connector feature of the Message element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Message.Properties.connector);
	...
	public void testEditMessageInteraction() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Message.Properties.interaction, allInstancesOf.indexOf(referenceValueForInteraction));
