...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.DeploymentSpecification;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for DeploymentSpecification
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class DeploymentSpecificationTestCase extends SWTBotEEFTestCase {
	...
	public void testEditDeploymentSpecificationName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the DeploymentSpecification element
		...
		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, deploymentSpecificationMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the DeploymentSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.name, UPDATED_VALUE);
	...
	public void testEditDeploymentSpecificationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the DeploymentSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditDeploymentSpecificationClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveDeploymentSpecificationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the DeploymentSpecification element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditDeploymentSpecificationIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the DeploymentSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditDeploymentSpecificationOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveDeploymentSpecificationOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the DeploymentSpecification element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.owningTemplateParameter);
	...
	public void testEditDeploymentSpecificationTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveDeploymentSpecificationTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the DeploymentSpecification element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.templateParameter);
	...
	public void testEditDeploymentSpecificationIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the DeploymentSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.isAbstract, UPDATED_VALUE);
	...
	public void testEditDeploymentSpecificationPowertypeExtent() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.powertypeExtent, referenceValueForPowertypeExtent);
	...
	public void testRemoveDeploymentSpecificationPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the DeploymentSpecification element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditDeploymentSpecificationRepresentation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1);
	...
	public void testRemoveDeploymentSpecificationRepresentation() throws Exception {
		...
		// Change value of the representation feature of the DeploymentSpecification element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.representation);
	...
	public void testEditDeploymentSpecificationUseCase() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.useCase, referenceValueForUseCase);
	...
	public void testRemoveDeploymentSpecificationUseCase() throws Exception {
		...
		// Change value of the useCase feature of the DeploymentSpecification element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditDeploymentSpecificationFileName() throws Exception {
		...
		// Change value of the fileName feature of the DeploymentSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.fileName, UPDATED_VALUE);
	...
	public void testEditDeploymentSpecificationDeploymentLocation() throws Exception {
		...
		// Change value of the deploymentLocation feature of the DeploymentSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.deploymentLocation, UPDATED_VALUE);
	...
	public void testEditDeploymentSpecificationExecutionLocation() throws Exception {
		...
		// Change value of the executionLocation feature of the DeploymentSpecification element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.executionLocation, UPDATED_VALUE);
	...
	public void testEditDeploymentSpecificationDeployment() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.deployment, allInstancesOf.indexOf(referenceValueForDeployment)+1);
	...
	public void testRemoveDeploymentSpecificationDeployment() throws Exception {
		...
		// Change value of the deployment feature of the DeploymentSpecification element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.DeploymentSpecification.Properties.deployment);
