 ...
 */
public class PrimitiveTypePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditPrimitiveTypeName() throws Exception {
		...
		// Open the EEF properties view to edit the PrimitiveType element
		...
		// Change value of the name feature of the PrimitiveType element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.PrimitiveType.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPrimitiveTypeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the PrimitiveType element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.PrimitiveType.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPrimitiveTypeClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.PrimitiveType.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePrimitiveTypeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the PrimitiveType element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.PrimitiveType.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPrimitiveTypeIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the PrimitiveType element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.PrimitiveType.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPrimitiveTypeOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PrimitiveType.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePrimitiveTypeOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the PrimitiveType element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PrimitiveType.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPrimitiveTypeTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PrimitiveType.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePrimitiveTypeTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the PrimitiveType element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PrimitiveType.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPrimitiveTypeIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the PrimitiveType element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.PrimitiveType.Properties.isAbstract, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPrimitiveTypePowertypeExtent() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.PrimitiveType.Properties.powertypeExtent, referenceValueForPowertypeExtent, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePrimitiveTypePowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the PrimitiveType element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.PrimitiveType.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPrimitiveTypeRepresentation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PrimitiveType.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePrimitiveTypeRepresentation() throws Exception {
		...
		// Change value of the representation feature of the PrimitiveType element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.PrimitiveType.Properties.representation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPrimitiveTypeUseCase() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.PrimitiveType.Properties.useCase, referenceValueForUseCase, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemovePrimitiveTypeUseCase() throws Exception {
		...
		// Change value of the useCase feature of the PrimitiveType element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.PrimitiveType.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
