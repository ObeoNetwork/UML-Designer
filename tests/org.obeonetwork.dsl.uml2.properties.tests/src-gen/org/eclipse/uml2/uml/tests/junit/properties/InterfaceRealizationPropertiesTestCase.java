 ...
 */
public class InterfaceRealizationPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditInterfaceRealizationName() throws Exception {
		...
		// Open the EEF properties view to edit the InterfaceRealization element
		...
		// Change value of the name feature of the InterfaceRealization element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InterfaceRealization.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInterfaceRealizationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the InterfaceRealization element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InterfaceRealization.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInterfaceRealizationClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InterfaceRealization.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInterfaceRealizationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the InterfaceRealization element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InterfaceRealization.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInterfaceRealizationOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InterfaceRealization.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInterfaceRealizationOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the InterfaceRealization element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InterfaceRealization.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInterfaceRealizationTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InterfaceRealization.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInterfaceRealizationTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the InterfaceRealization element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InterfaceRealization.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInterfaceRealizationContract() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InterfaceRealization.Properties.contract, allInstancesOf.indexOf(referenceValueForContract), bot.selectNode(modelEditor, firstInstanceOf));
