 ...
 */
public class ComponentPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditComponentName() throws Exception {
		...
		// Open the EEF properties view to edit the Component element
		...
		// Change value of the name feature of the Component element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Component.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditComponentVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Component element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Component.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditComponentClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Component.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveComponentClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Component element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Component.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditComponentIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Component element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Component.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditComponentOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Component.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveComponentOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Component element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Component.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditComponentTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Component.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveComponentTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Component element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Component.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditComponentIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the Component element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Component.Properties.isAbstract, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditComponentPowertypeExtent() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Component.Properties.powertypeExtent, referenceValueForPowertypeExtent, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveComponentPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the Component element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Component.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditComponentRepresentation() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Component.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveComponentRepresentation() throws Exception {
		...
		// Change value of the representation feature of the Component element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Component.Properties.representation, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditComponentUseCase() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Component.Properties.useCase, referenceValueForUseCase, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveComponentUseCase() throws Exception {
		...
		// Change value of the useCase feature of the Component element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Component.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditComponentIsActive() throws Exception {
		...
		// Change value of the isActive feature of the Component element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Component.Properties.isActive, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditComponentIsIndirectlyInstantiated() throws Exception {
		...
		// Change value of the isIndirectlyInstantiated feature of the Component element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Component.Properties.isIndirectlyInstantiated, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
