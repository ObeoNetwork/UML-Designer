...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.Include;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for Include
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class IncludePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditIncludeName() throws Exception {
		...
		// Open the EEF properties view to edit the Include element
		...
		// Change value of the name feature of the Include element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Include.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditIncludeVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Include element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Include.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditIncludeClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Include.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveIncludeClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Include element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Include.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditIncludeAddition() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Include.Properties.addition, allInstancesOf.indexOf(referenceValueForAddition), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditIncludeIncludingCase() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Include.Properties.includingCase, allInstancesOf.indexOf(referenceValueForIncludingCase), bot.selectNode(modelEditor, firstInstanceOf));
