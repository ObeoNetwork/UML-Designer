 ...
 */
public class AnyReceiveEventPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditAnyReceiveEventName() throws Exception {
		...
		// Open the EEF properties view to edit the AnyReceiveEvent element
		...
		// Change value of the name feature of the AnyReceiveEvent element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.AnyReceiveEvent.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAnyReceiveEventVisibility() throws Exception {
		...
		// Change value of the visibility feature of the AnyReceiveEvent element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.AnyReceiveEvent.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAnyReceiveEventClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.AnyReceiveEvent.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveAnyReceiveEventClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the AnyReceiveEvent element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.AnyReceiveEvent.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAnyReceiveEventOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.AnyReceiveEvent.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveAnyReceiveEventOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the AnyReceiveEvent element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.AnyReceiveEvent.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditAnyReceiveEventTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.AnyReceiveEvent.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveAnyReceiveEventTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the AnyReceiveEvent element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.AnyReceiveEvent.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
