...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.LinkEndDestructionData;
/**
 * TestCase for LinkEndDestructionData
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class LinkEndDestructionDataPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditLinkEndDestructionDataValue() throws Exception {
		...
		// Open the EEF properties view to edit the LinkEndDestructionData element
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LinkEndDestructionData.Properties.value, allInstancesOf.indexOf(referenceValueForValue)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLinkEndDestructionDataValue() throws Exception {
		...
		// Change value of the value feature of the LinkEndDestructionData element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LinkEndDestructionData.Properties.value, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLinkEndDestructionDataEnd() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LinkEndDestructionData.Properties.end, allInstancesOf.indexOf(referenceValueForEnd), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLinkEndDestructionDataIsDestroyDuplicates() throws Exception {
		...
		// Change value of the isDestroyDuplicates feature of the LinkEndDestructionData element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LinkEndDestructionData.Properties.isDestroyDuplicates, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLinkEndDestructionDataDestroyAt() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LinkEndDestructionData.Properties.destroyAt, allInstancesOf.indexOf(referenceValueForDestroyAt)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLinkEndDestructionDataDestroyAt() throws Exception {
		...
		// Change value of the destroyAt feature of the LinkEndDestructionData element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LinkEndDestructionData.Properties.destroyAt, bot.selectNode(modelEditor, firstInstanceOf));
