 ...
 */
public class ReplyActionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditReplyActionName() throws Exception {
		...
		// Open the EEF properties view to edit the ReplyAction element
		...
		// Change value of the name feature of the ReplyAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ReplyAction.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReplyActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ReplyAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ReplyAction.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReplyActionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReplyAction.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReplyActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ReplyAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReplyAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReplyActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ReplyAction element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ReplyAction.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReplyActionInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReplyAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReplyActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ReplyAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReplyAction.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReplyActionActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReplyAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReplyActionActivity() throws Exception {
		...
		// Change value of the activity feature of the ReplyAction element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReplyAction.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReplyActionInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReplyAction.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReplyActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ReplyAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReplyAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReplyActionInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReplyAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveReplyActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ReplyAction element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ReplyAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditReplyActionReplyToCall() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ReplyAction.Properties.replyToCall, allInstancesOf.indexOf(referenceValueForReplyToCall), bot.selectNode(modelEditor, firstInstanceOf));
