 ...
 */
public class ActionInputPinPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditActionInputPinName() throws Exception {
		...
		// Open the EEF properties view to edit the ActionInputPin element
		...
		// Change value of the name feature of the ActionInputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActionInputPin.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ActionInputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActionInputPin.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActionInputPin.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActionInputPinClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ActionInputPin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActionInputPin.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ActionInputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActionInputPin.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinInStructuredNode() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActionInputPin.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActionInputPinInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ActionInputPin element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActionInputPin.Properties.inStructuredNode, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinActivity() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActionInputPin.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActionInputPinActivity() throws Exception {
		...
		// Change value of the activity feature of the ActionInputPin element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ActionInputPin.Properties.activity, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinInPartition() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActionInputPin.Properties.inPartition, referenceValueForInPartition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActionInputPinInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ActionInputPin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActionInputPin.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinInInterruptibleRegion() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActionInputPin.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActionInputPinInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ActionInputPin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActionInputPin.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinOrdering() throws Exception {
		...
		// Change value of the ordering feature of the ActionInputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActionInputPin.Properties.ordering, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinIsControlType() throws Exception {
		...
		// Change value of the isControlType feature of the ActionInputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActionInputPin.Properties.isControlType, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinInState() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActionInputPin.Properties.inState, referenceValueForInState, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveActionInputPinInState() throws Exception {
		...
		// Change value of the inState feature of the ActionInputPin element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ActionInputPin.Properties.inState, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinIsOrdered() throws Exception {
		...
		// Change value of the isOrdered feature of the ActionInputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActionInputPin.Properties.isOrdered, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinIsUnique() throws Exception {
		...
		// Change value of the isUnique feature of the ActionInputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActionInputPin.Properties.isUnique, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditActionInputPinIsControl() throws Exception {
		...
		// Change value of the isControl feature of the ActionInputPin element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ActionInputPin.Properties.isControl, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
