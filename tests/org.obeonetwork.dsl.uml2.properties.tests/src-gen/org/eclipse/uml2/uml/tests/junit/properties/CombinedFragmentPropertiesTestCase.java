 ...
 */
public class CombinedFragmentPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditCombinedFragmentName() throws Exception {
		...
		// Open the EEF properties view to edit the CombinedFragment element
		...
		// Change value of the name feature of the CombinedFragment element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CombinedFragment.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCombinedFragmentVisibility() throws Exception {
		...
		// Change value of the visibility feature of the CombinedFragment element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CombinedFragment.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCombinedFragmentClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CombinedFragment.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCombinedFragmentClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the CombinedFragment element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CombinedFragment.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCombinedFragmentCovered() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CombinedFragment.Properties.covered, referenceValueForCovered, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCombinedFragmentCovered() throws Exception {
		...
		// Change value of the covered feature of the CombinedFragment element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.CombinedFragment.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCombinedFragmentEnclosingInteraction() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CombinedFragment.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCombinedFragmentEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the CombinedFragment element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CombinedFragment.Properties.enclosingInteraction, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCombinedFragmentEnclosingOperand() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CombinedFragment.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveCombinedFragmentEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the CombinedFragment element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.CombinedFragment.Properties.enclosingOperand, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditCombinedFragmentInteractionOperator() throws Exception {
		...
		// Change value of the interactionOperator feature of the CombinedFragment element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.CombinedFragment.Properties.interactionOperator, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
