 ...
 */
public class ProtocolTransitionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditProtocolTransitionName() throws Exception {
		...
		// Open the EEF properties view to edit the ProtocolTransition element
		...
		// Change value of the name feature of the ProtocolTransition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolTransitionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ProtocolTransition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolTransitionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolTransitionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ProtocolTransition element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolTransitionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ProtocolTransition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolTransitionKind() throws Exception {
		...
		// Change value of the kind feature of the ProtocolTransition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.kind, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolTransitionContainer() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.container, allInstancesOf.indexOf(referenceValueForContainer), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolTransitionRedefinedTransition() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.redefinedTransition, allInstancesOf.indexOf(referenceValueForRedefinedTransition)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolTransitionRedefinedTransition() throws Exception {
		...
		// Change value of the redefinedTransition feature of the ProtocolTransition element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.redefinedTransition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolTransitionGuard() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.guard, allInstancesOf.indexOf(referenceValueForGuard)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolTransitionGuard() throws Exception {
		...
		// Change value of the guard feature of the ProtocolTransition element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.guard, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolTransitionPostCondition() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.postCondition, allInstancesOf.indexOf(referenceValueForPostCondition)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolTransitionPostCondition() throws Exception {
		...
		// Change value of the postCondition feature of the ProtocolTransition element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.postCondition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditProtocolTransitionPreCondition() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.preCondition, allInstancesOf.indexOf(referenceValueForPreCondition)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveProtocolTransitionPreCondition() throws Exception {
		...
		// Change value of the preCondition feature of the ProtocolTransition element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.ProtocolTransition.Properties.preCondition, bot.selectNode(modelEditor, firstInstanceOf));
