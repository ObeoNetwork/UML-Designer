...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.OperationTemplateParameter;
/**
 * TestCase for OperationTemplateParameter
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class OperationTemplateParameterTestCase extends SWTBotEEFTestCase {
	...
	public void testEditOperationTemplateParameterSignature() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the OperationTemplateParameter element
		...
		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, operationTemplateParameterMetaClass, firstInstanceOf, null);

		// Change value of the signature feature of the OperationTemplateParameter element 
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.OperationTemplateParameter.Properties.signature, allInstancesOf.indexOf(referenceValueForSignature));
