...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.Generalization;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for Generalization
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class GeneralizationTestCase extends SWTBotEEFTestCase {
	...
	public void testEditGeneralizationIsSubstitutable() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Generalization element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), generalizationMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(generalizationMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, generalizationMetaClass, firstInstanceOf, null);

		// Change value of the isSubstitutable feature of the Generalization element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Generalization.Properties.isSubstitutable, UPDATED_VALUE);
	...
	public void testEditGeneralizationGeneralizationSet() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Generalization.Properties.generalizationSet, referenceValueForGeneralizationSet);
	...
	public void testRemoveGeneralizationGeneralizationSet() throws Exception {
		...
		// Change value of the generalizationSet feature of the Generalization element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Generalization.Properties.generalizationSet, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
