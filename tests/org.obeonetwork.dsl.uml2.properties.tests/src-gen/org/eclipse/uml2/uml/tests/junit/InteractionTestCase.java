 ...
 */
public class InteractionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditInteractionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Interaction element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), interactionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(interactionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, interactionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Interaction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Interaction.Properties.name, UPDATED_VALUE);
	...
	public void testEditInteractionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Interaction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Interaction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditInteractionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Interaction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveInteractionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Interaction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Interaction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInteractionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Interaction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Interaction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditInteractionOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Interaction.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveInteractionOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Interaction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Interaction.Properties.owningTemplateParameter);
	...
	public void testEditInteractionTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Interaction.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveInteractionTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Interaction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Interaction.Properties.templateParameter);
	...
	public void testEditInteractionIsAbstract() throws Exception {
		...
		// Change value of the isAbstract feature of the Interaction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Interaction.Properties.isAbstract, UPDATED_VALUE);
	...
	public void testEditInteractionPowertypeExtent() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Interaction.Properties.powertypeExtent, referenceValueForPowertypeExtent);
	...
	public void testRemoveInteractionPowertypeExtent() throws Exception {
		...
		// Change value of the powertypeExtent feature of the Interaction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Interaction.Properties.powertypeExtent, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInteractionRepresentation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Interaction.Properties.representation, allInstancesOf.indexOf(referenceValueForRepresentation)+1);
	...
	public void testRemoveInteractionRepresentation() throws Exception {
		...
		// Change value of the representation feature of the Interaction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Interaction.Properties.representation);
	...
	public void testEditInteractionUseCase() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Interaction.Properties.useCase, referenceValueForUseCase);
	...
	public void testRemoveInteractionUseCase() throws Exception {
		...
		// Change value of the useCase feature of the Interaction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Interaction.Properties.useCase, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInteractionIsActive() throws Exception {
		...
		// Change value of the isActive feature of the Interaction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Interaction.Properties.isActive, UPDATED_VALUE);
	...
	public void testEditInteractionIsReentrant() throws Exception {
		...
		// Change value of the isReentrant feature of the Interaction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Interaction.Properties.isReentrant, UPDATED_VALUE);
	...
	public void testEditInteractionPrecondition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Interaction.Properties.precondition, referenceValueForPrecondition);
	...
	public void testRemoveInteractionPrecondition() throws Exception {
		...
		// Change value of the precondition feature of the Interaction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Interaction.Properties.precondition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInteractionPostcondition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Interaction.Properties.postcondition, referenceValueForPostcondition);
	...
	public void testRemoveInteractionPostcondition() throws Exception {
		...
		// Change value of the postcondition feature of the Interaction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Interaction.Properties.postcondition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInteractionCovered() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Interaction.Properties.covered, referenceValueForCovered);
	...
	public void testRemoveInteractionCovered() throws Exception {
		...
		// Change value of the covered feature of the Interaction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Interaction.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditInteractionEnclosingInteraction() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Interaction.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1);
	...
	public void testRemoveInteractionEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the Interaction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Interaction.Properties.enclosingInteraction);
	...
	public void testEditInteractionEnclosingOperand() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Interaction.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1);
	...
	public void testRemoveInteractionEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the Interaction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Interaction.Properties.enclosingOperand);
