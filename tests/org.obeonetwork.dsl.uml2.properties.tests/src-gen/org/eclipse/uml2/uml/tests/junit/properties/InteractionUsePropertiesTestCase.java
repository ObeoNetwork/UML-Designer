...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.InteractionUse;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for InteractionUse
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class InteractionUsePropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditInteractionUseName() throws Exception {
		...
		// Open the EEF properties view to edit the InteractionUse element
		...
		// Change value of the name feature of the InteractionUse element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InteractionUse.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionUseVisibility() throws Exception {
		...
		// Change value of the visibility feature of the InteractionUse element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InteractionUse.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionUseClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InteractionUse.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInteractionUseClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the InteractionUse element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InteractionUse.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionUseCovered() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InteractionUse.Properties.covered, referenceValueForCovered, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInteractionUseCovered() throws Exception {
		...
		// Change value of the covered feature of the InteractionUse element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InteractionUse.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionUseEnclosingInteraction() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionUse.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInteractionUseEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the InteractionUse element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionUse.Properties.enclosingInteraction, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionUseEnclosingOperand() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionUse.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInteractionUseEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the InteractionUse element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionUse.Properties.enclosingOperand, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionUseRefersTo() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionUse.Properties.refersTo, allInstancesOf.indexOf(referenceValueForRefersTo), bot.selectNode(modelEditor, firstInstanceOf));
