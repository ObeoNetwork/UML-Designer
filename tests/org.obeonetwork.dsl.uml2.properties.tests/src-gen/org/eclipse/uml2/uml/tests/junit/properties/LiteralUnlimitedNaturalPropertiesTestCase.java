...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.LiteralUnlimitedNatural;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for LiteralUnlimitedNatural
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class LiteralUnlimitedNaturalPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditLiteralUnlimitedNaturalName() throws Exception {
		...
		// Open the EEF properties view to edit the LiteralUnlimitedNatural element
		...
		// Change value of the name feature of the LiteralUnlimitedNatural element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LiteralUnlimitedNatural.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralUnlimitedNaturalVisibility() throws Exception {
		...
		// Change value of the visibility feature of the LiteralUnlimitedNatural element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LiteralUnlimitedNatural.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralUnlimitedNaturalClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LiteralUnlimitedNatural.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLiteralUnlimitedNaturalClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the LiteralUnlimitedNatural element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.LiteralUnlimitedNatural.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralUnlimitedNaturalOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralUnlimitedNatural.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLiteralUnlimitedNaturalOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the LiteralUnlimitedNatural element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralUnlimitedNatural.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralUnlimitedNaturalTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralUnlimitedNatural.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveLiteralUnlimitedNaturalTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the LiteralUnlimitedNatural element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.LiteralUnlimitedNatural.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditLiteralUnlimitedNaturalValue() throws Exception {
		...
		// Change value of the value feature of the LiteralUnlimitedNatural element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.LiteralUnlimitedNatural.Properties.value, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
