...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ReadExtentAction;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ReadExtentAction
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ReadExtentActionTestCase extends SWTBotEEFTestCase {
	...
	public void testEditReadExtentActionName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ReadExtentAction element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), readExtentActionMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(readExtentActionMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, readExtentActionMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ReadExtentAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.name, UPDATED_VALUE);
	...
	public void testEditReadExtentActionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ReadExtentAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditReadExtentActionClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveReadExtentActionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ReadExtentAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditReadExtentActionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ReadExtentAction element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditReadExtentActionInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveReadExtentActionInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ReadExtentAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.inStructuredNode);
	...
	public void testEditReadExtentActionActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveReadExtentActionActivity() throws Exception {
		...
		// Change value of the activity feature of the ReadExtentAction element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.activity);
	...
	public void testEditReadExtentActionInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveReadExtentActionInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ReadExtentAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditReadExtentActionInInterruptibleRegion() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.inInterruptibleRegion, referenceValueForInInterruptibleRegion);
	...
	public void testRemoveReadExtentActionInInterruptibleRegion() throws Exception {
		...
		// Change value of the inInterruptibleRegion feature of the ReadExtentAction element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReadExtentAction.Properties.inInterruptibleRegion, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
