...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.InteractionConstraint;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for InteractionConstraint
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class InteractionConstraintPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditInteractionConstraintName() throws Exception {
		...
		// Open the EEF properties view to edit the InteractionConstraint element
		...
		// Change value of the name feature of the InteractionConstraint element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InteractionConstraint.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionConstraintVisibility() throws Exception {
		...
		// Change value of the visibility feature of the InteractionConstraint element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.InteractionConstraint.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionConstraintClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InteractionConstraint.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInteractionConstraintClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the InteractionConstraint element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.InteractionConstraint.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionConstraintOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionConstraint.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInteractionConstraintOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the InteractionConstraint element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionConstraint.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditInteractionConstraintTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionConstraint.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveInteractionConstraintTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the InteractionConstraint element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.InteractionConstraint.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
