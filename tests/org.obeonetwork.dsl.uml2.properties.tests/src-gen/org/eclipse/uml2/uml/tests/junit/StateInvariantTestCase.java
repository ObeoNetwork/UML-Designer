 ...
 */
public class StateInvariantTestCase extends SWTBotEEFTestCase {
	...
	public void testEditStateInvariantName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the StateInvariant element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), stateInvariantMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(stateInvariantMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, stateInvariantMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the StateInvariant element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StateInvariant.Properties.name, UPDATED_VALUE);
	...
	public void testEditStateInvariantVisibility() throws Exception {
		...
		// Change value of the visibility feature of the StateInvariant element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.StateInvariant.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditStateInvariantClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StateInvariant.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveStateInvariantClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the StateInvariant element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StateInvariant.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStateInvariantCovered() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StateInvariant.Properties.covered, referenceValueForCovered);
	...
	public void testRemoveStateInvariantCovered() throws Exception {
		...
		// Change value of the covered feature of the StateInvariant element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.StateInvariant.Properties.covered, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditStateInvariantEnclosingInteraction() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StateInvariant.Properties.enclosingInteraction, allInstancesOf.indexOf(referenceValueForEnclosingInteraction)+1);
	...
	public void testRemoveStateInvariantEnclosingInteraction() throws Exception {
		...
		// Change value of the enclosingInteraction feature of the StateInvariant element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StateInvariant.Properties.enclosingInteraction);
	...
	public void testEditStateInvariantEnclosingOperand() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StateInvariant.Properties.enclosingOperand, allInstancesOf.indexOf(referenceValueForEnclosingOperand)+1);
	...
	public void testRemoveStateInvariantEnclosingOperand() throws Exception {
		...
		// Change value of the enclosingOperand feature of the StateInvariant element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.StateInvariant.Properties.enclosingOperand);
