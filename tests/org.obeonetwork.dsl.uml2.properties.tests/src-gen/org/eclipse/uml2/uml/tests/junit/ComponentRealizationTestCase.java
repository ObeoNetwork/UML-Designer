...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ComponentRealization;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ComponentRealization
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ComponentRealizationTestCase extends SWTBotEEFTestCase {
	...
	public void testEditComponentRealizationName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ComponentRealization element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), componentRealizationMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(componentRealizationMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, componentRealizationMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ComponentRealization element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ComponentRealization.Properties.name, UPDATED_VALUE);
	...
	public void testEditComponentRealizationVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ComponentRealization element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ComponentRealization.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditComponentRealizationClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ComponentRealization.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveComponentRealizationClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ComponentRealization element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ComponentRealization.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditComponentRealizationOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ComponentRealization.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveComponentRealizationOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the ComponentRealization element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ComponentRealization.Properties.owningTemplateParameter);
	...
	public void testEditComponentRealizationTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ComponentRealization.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveComponentRealizationTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the ComponentRealization element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ComponentRealization.Properties.templateParameter);
	...
	public void testEditComponentRealizationAbstraction() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ComponentRealization.Properties.abstraction, allInstancesOf.indexOf(referenceValueForAbstraction)+1);
	...
	public void testRemoveComponentRealizationAbstraction() throws Exception {
		...
		// Change value of the abstraction feature of the ComponentRealization element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ComponentRealization.Properties.abstraction);
