 ...
 */
public class ReceiveOperationEventTestCase extends SWTBotEEFTestCase {
	...
	public void testEditReceiveOperationEventName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ReceiveOperationEvent element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), receiveOperationEventMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(receiveOperationEventMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, receiveOperationEventMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ReceiveOperationEvent element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReceiveOperationEvent.Properties.name, UPDATED_VALUE);
	...
	public void testEditReceiveOperationEventVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ReceiveOperationEvent element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ReceiveOperationEvent.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditReceiveOperationEventClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReceiveOperationEvent.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveReceiveOperationEventClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ReceiveOperationEvent element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ReceiveOperationEvent.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditReceiveOperationEventOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReceiveOperationEvent.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveReceiveOperationEventOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the ReceiveOperationEvent element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReceiveOperationEvent.Properties.owningTemplateParameter);
	...
	public void testEditReceiveOperationEventTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReceiveOperationEvent.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveReceiveOperationEventTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the ReceiveOperationEvent element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReceiveOperationEvent.Properties.templateParameter);
	...
	public void testEditReceiveOperationEventOperation() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ReceiveOperationEvent.Properties.operation, allInstancesOf.indexOf(referenceValueForOperation));
