...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.ObjectFlow;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for ObjectFlow
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class ObjectFlowTestCase extends SWTBotEEFTestCase {
	...
	public void testEditObjectFlowName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the ObjectFlow element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), objectFlowMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(objectFlowMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, objectFlowMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the ObjectFlow element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.name, UPDATED_VALUE);
	...
	public void testEditObjectFlowVisibility() throws Exception {
		...
		// Change value of the visibility feature of the ObjectFlow element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditObjectFlowClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveObjectFlowClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the ObjectFlow element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditObjectFlowIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the ObjectFlow element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.isLeaf, UPDATED_VALUE);
	...
	public void testEditObjectFlowInPartition() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.inPartition, referenceValueForInPartition);
	...
	public void testRemoveObjectFlowInPartition() throws Exception {
		...
		// Change value of the inPartition feature of the ObjectFlow element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.inPartition, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditObjectFlowInterrupts() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.interrupts, allInstancesOf.indexOf(referenceValueForInterrupts)+1);
	...
	public void testRemoveObjectFlowInterrupts() throws Exception {
		...
		// Change value of the interrupts feature of the ObjectFlow element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.interrupts);
	...
	public void testEditObjectFlowInStructuredNode() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.inStructuredNode, allInstancesOf.indexOf(referenceValueForInStructuredNode)+1);
	...
	public void testRemoveObjectFlowInStructuredNode() throws Exception {
		...
		// Change value of the inStructuredNode feature of the ObjectFlow element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.inStructuredNode);
	...
	public void testEditObjectFlowActivity() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.activity, allInstancesOf.indexOf(referenceValueForActivity)+1);
	...
	public void testRemoveObjectFlowActivity() throws Exception {
		...
		// Change value of the activity feature of the ObjectFlow element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.activity);
	...
	public void testEditObjectFlowIsMulticast() throws Exception {
		...
		// Change value of the isMulticast feature of the ObjectFlow element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.isMulticast, UPDATED_VALUE);
	...
	public void testEditObjectFlowIsMultireceive() throws Exception {
		...
		// Change value of the isMultireceive feature of the ObjectFlow element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.ObjectFlow.Properties.isMultireceive, UPDATED_VALUE);
