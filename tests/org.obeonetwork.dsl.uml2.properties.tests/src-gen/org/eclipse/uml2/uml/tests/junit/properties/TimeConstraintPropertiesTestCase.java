...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.TimeConstraint;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for TimeConstraint
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class TimeConstraintPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditTimeConstraintName() throws Exception {
		...
		// Open the EEF properties view to edit the TimeConstraint element
		...
		// Change value of the name feature of the TimeConstraint element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.TimeConstraint.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeConstraintVisibility() throws Exception {
		...
		// Change value of the visibility feature of the TimeConstraint element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.TimeConstraint.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeConstraintClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.TimeConstraint.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTimeConstraintClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the TimeConstraint element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.TimeConstraint.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeConstraintOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeConstraint.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTimeConstraintOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the TimeConstraint element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeConstraint.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeConstraintTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeConstraint.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTimeConstraintTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the TimeConstraint element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.TimeConstraint.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTimeConstraintFirstEvent() throws Exception {
		...
		// Change value of the firstEvent feature of the TimeConstraint element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.TimeConstraint.Properties.firstEvent, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
