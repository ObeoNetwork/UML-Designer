...
import org.obeonetwork.dsl.uml2.properties.uml.parts.UmlViewsRepository.Deployment;
import org.obeonetwork.dsl.uml2.properties.uml.providers.UmlMessages;
/**
 * TestCase for Deployment
 * @author <a href="mailto:stephane.bouchet@obeo.fr">Stephane Bouchet</a>
 */
public class DeploymentTestCase extends SWTBotEEFTestCase {
	...
	public void testEditDeploymentName() throws Exception {
		...
		// Open the EEF wizard (by double click) to edit the Deployment element
		EObject firstInstanceOf = EEFTestsModelsUtils.getFirstInstanceOf(bot.getActiveResource(), deploymentMetaClass);
		if (firstInstanceOf == null)
			throw new InputModelInvalidException(deploymentMetaClass.getName());

		SWTBotShell wizardShell = bot.prepareBatchEditing(modelEditor, deploymentMetaClass, firstInstanceOf, null);

		// Change value of the name feature of the Deployment element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Deployment.Properties.name, UPDATED_VALUE);
	...
	public void testEditDeploymentVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Deployment element 
				bot.editTextFeature(wizardShell, UmlViewsRepository.Deployment.Properties.visibility, UPDATED_VALUE);
	...
	public void testEditDeploymentClientDependency() throws Exception {
		...
		bot.editAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Deployment.Properties.clientDependency, referenceValueForClientDependency);
	...
	public void testRemoveDeploymentClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Deployment element 
		bot.removeAdvancedReferencesTableFeature(wizardShell, UmlViewsRepository.Deployment.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel);
	...
	public void testEditDeploymentOwningTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Deployment.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1);
	...
	public void testRemoveDeploymentOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the Deployment element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Deployment.Properties.owningTemplateParameter);
	...
	public void testEditDeploymentTemplateParameter() throws Exception {
		...
		bot.editEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Deployment.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1);
	...
	public void testRemoveDeploymentTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the Deployment element
		bot.removeEObjectFlatComboViewerFeature(wizardShell, UmlViewsRepository.Deployment.Properties.templateParameter);
