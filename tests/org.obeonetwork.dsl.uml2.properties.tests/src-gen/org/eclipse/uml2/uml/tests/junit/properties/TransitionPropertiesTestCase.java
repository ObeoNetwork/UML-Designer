 ...
 */
public class TransitionPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditTransitionName() throws Exception {
		...
		// Open the EEF properties view to edit the Transition element
		...
		// Change value of the name feature of the Transition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Transition.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTransitionVisibility() throws Exception {
		...
		// Change value of the visibility feature of the Transition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Transition.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTransitionClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Transition.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTransitionClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the Transition element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.Transition.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTransitionIsLeaf() throws Exception {
		...
		// Change value of the isLeaf feature of the Transition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Transition.Properties.isLeaf, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTransitionKind() throws Exception {
		...
		// Change value of the kind feature of the Transition element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.Transition.Properties.kind, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTransitionContainer() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Transition.Properties.container, allInstancesOf.indexOf(referenceValueForContainer), bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTransitionRedefinedTransition() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Transition.Properties.redefinedTransition, allInstancesOf.indexOf(referenceValueForRedefinedTransition)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTransitionRedefinedTransition() throws Exception {
		...
		// Change value of the redefinedTransition feature of the Transition element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Transition.Properties.redefinedTransition, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditTransitionGuard() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Transition.Properties.guard, allInstancesOf.indexOf(referenceValueForGuard)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveTransitionGuard() throws Exception {
		...
		// Change value of the guard feature of the Transition element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.Transition.Properties.guard, bot.selectNode(modelEditor, firstInstanceOf));
