 ...
 */
public class GeneralizationSetPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditGeneralizationSetName() throws Exception {
		...
		// Open the EEF properties view to edit the GeneralizationSet element
		...
		// Change value of the name feature of the GeneralizationSet element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.GeneralizationSet.Properties.name, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditGeneralizationSetVisibility() throws Exception {
		...
		// Change value of the visibility feature of the GeneralizationSet element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.GeneralizationSet.Properties.visibility, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditGeneralizationSetClientDependency() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.GeneralizationSet.Properties.clientDependency, referenceValueForClientDependency, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveGeneralizationSetClientDependency() throws Exception {
		...
		// Change value of the clientDependency feature of the GeneralizationSet element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.GeneralizationSet.Properties.clientDependency, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditGeneralizationSetOwningTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.GeneralizationSet.Properties.owningTemplateParameter, allInstancesOf.indexOf(referenceValueForOwningTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveGeneralizationSetOwningTemplateParameter() throws Exception {
		...
		// Change value of the owningTemplateParameter feature of the GeneralizationSet element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.GeneralizationSet.Properties.owningTemplateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditGeneralizationSetTemplateParameter() throws Exception {
		...
		bot.editPropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.GeneralizationSet.Properties.templateParameter, allInstancesOf.indexOf(referenceValueForTemplateParameter)+1, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveGeneralizationSetTemplateParameter() throws Exception {
		...
		// Change value of the templateParameter feature of the GeneralizationSet element 
		bot.removePropertyEObjectFlatComboViewerFeature(propertiesView, UmlViewsRepository.GeneralizationSet.Properties.templateParameter, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditGeneralizationSetIsCovering() throws Exception {
		...
		// Change value of the isCovering feature of the GeneralizationSet element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.GeneralizationSet.Properties.isCovering, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditGeneralizationSetIsDisjoint() throws Exception {
		...
		// Change value of the isDisjoint feature of the GeneralizationSet element 
				bot.editPropertyEEFText(propertiesView, UmlViewsRepository.GeneralizationSet.Properties.isDisjoint, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditGeneralizationSetGeneralization() throws Exception {
		...
		bot.editPropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.GeneralizationSet.Properties.generalization, referenceValueForGeneralization, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testRemoveGeneralizationSetGeneralization() throws Exception {
		...
		// Change value of the generalization feature of the GeneralizationSet element 
		bot.removePropertyAdvancedReferencesTableFeature(propertiesView, UmlViewsRepository.GeneralizationSet.Properties.generalization, UmlMessages.PropertiesEditionPart_RemoveListViewerLabel, bot.selectNode(modelEditor, firstInstanceOf));
