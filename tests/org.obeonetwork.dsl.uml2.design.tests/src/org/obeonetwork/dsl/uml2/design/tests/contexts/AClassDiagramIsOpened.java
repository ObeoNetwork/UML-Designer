...
public class AClassDiagramIsOpened extends UnactivateUmlUsage {
	...
	//
	// /**
	// * Action : I select the interface realization creation tool from the palette and I select a source
	// class
	// * and a target interface
	// */
	// public void
	// actionISelectTheInterfaceRealizationCreationToolFromThePaletteAndISelectASourceClassAndATargetInterface()
	// {
	// // Start of user code
	...
	//
	// /**
	// * Action : I select the association class creation tool from the palette and I select a source class
	// and
	// * a target class
	// */
	// public void
	// actionISelectTheAssociationClassCreationToolFromThePaletteAndISelectASourceClassAndATargetClass() {
	// // Start of user code
	...
	// */
	// public void
	// actionISelectThePackageCreationToolFromThePaletteAndISelectInTheDiagramAPackageAsContainer() {
	// // Start of user code
	...
	// */
	// public void
	// actionISelectTheTypedPropertyCreationToolFromThePaletteAndISelectAnInterfaceAndISelectAType() {
	// // Start of user code
	...
	// */
	// public void
	// actionISelectTheCompositionCreationToolFromThePaletteAndISelectASourceClassAndATargetClass() {
	// // Start of user code
	...
	//
	// /**
	// * Action : I select the delete from model tool in toolbar and I click on an association in a class in
	// the
	// * diagram
	// */
	...
	// */
	// public void
	// actionISelectTheAssociationCreationToolFromThePaletteAndISelectASourceClassAndATargetClass() {
	// // Start of user code
	...
	// */
	// public void
	// actionISelectTheGeneralizationCreationToolFromThePaletteAndISelectASourceClassAndATargetClass() {
	// // Start of user code
	...
	//
	// /**
	// * Action : I select the typed property creation tool from the palette and I select a class and I select
	// a
	// * type
	// */
	...
	// */
	// public void
	// actionISelectTheAggregationCreationToolFromThePaletteAndISelectASourceClassAndATargetClass() {
	// // Start of user code
	...
	//
	// /**
	// * Action : I select the typed property creation tool from the palette and I select a primitive type and
	// I
	// * select a type
	// */
	// public void
	// actionISelectTheTypedPropertyCreationToolFromThePaletteAndISelectAPrimitiveTypeAndISelectAType() {
	// // Start of user code
	...
	// */
	// public void assertANewElementAppearsInThe(String aNewElementAppearsInThe0, String
	// aNewElementAppearsInThe1) {
