...
public class ServiceExpressionReviewViewpointTests {
	private InterpretedExpression underTest;

	private static Set<String> allServices = new HashSet<String>();

	public ServiceExpressionReviewViewpointTests(InterpretedExpression expression) {
		this.underTest = expression;
	}

	private final static String VP_NAME = "Review";
