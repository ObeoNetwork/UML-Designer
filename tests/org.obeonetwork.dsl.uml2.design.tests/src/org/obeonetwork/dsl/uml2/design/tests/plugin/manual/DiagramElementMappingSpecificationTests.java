...
public class DiagramElementMappingSpecificationTests {
	...
	private static Set<String> reconnectWhiteList = Sets.newHashSet("CD_TemplateBinding",
			"CD_BrokenAssociationToClasses", "CD_NestedClass", "CD_BrokenAssociation",
			"CD_AssociationClassToAssociation", "PD_Extension", "OD_InstanceSlot", "OD_CompositeSlot",
			"OD_InstanceSlot_Composition", "OD_ClassType", "OD_EnumerationType", "OD_PrimitiveTypeType",
			"OD_InterfaceType", "SD_Message", "CO_U_ComponentOrPort2Interface",
			"CO_C_ProvidedInterface2RequiredInterface", "CO_C_SubProvidedInterface2Port",
			"CO_C_Port2SubRequiredInterface", "CO_C_RequiredInterface2ProvidedInterface",
			"CO_C_Port2SubProvidedInterface", "CO_C_SubRequiredInterface2Port",
